var gt=Object.defineProperty;var ht=(a,e,t)=>e in a?gt(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var pe=(a,e,t)=>ht(a,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const yt="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",ft="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function bt(){var e,t,s,n,i,o,r,l,u,c,d,g,h,f,y;const a={EUR:1};try{const k=await(await fetch(yt)).json();a.BTC=((e=k.bitcoin)==null?void 0:e.eur)||4e4,a.ETH=((t=k.ethereum)==null?void 0:t.eur)||2200,a.XRP=((s=k.ripple)==null?void 0:s.eur)||.5,a.KAS=((n=k.kaspa)==null?void 0:n.eur)||.1,a.SOL=((i=k.solana)==null?void 0:i.eur)||90,a.XLM=((o=k.stellar)==null?void 0:o.eur)||.11,a.ALGO=((r=k.algorand)==null?void 0:r.eur)||.18,a.LTC=((l=k.litecoin)==null?void 0:l.eur)||65,a.SUI=((u=k.sui)==null?void 0:u.eur)||1.1,a.LINK=((c=k.chainlink)==null?void 0:c.eur)||14,a.RNDR=((d=k["render-token"])==null?void 0:d.eur)||4.5,a.ADA=((g=k.cardano)==null?void 0:g.eur)||.45,a.ONDO=((h=k["ondo-finance"])==null?void 0:h.eur)||.7,(f=k.bitcoin)!=null&&f.ars&&((y=k.bitcoin)!=null&&y.eur)&&(a.ARS=k.bitcoin.eur/k.bitcoin.ars);const L=await fetch(ft);if(L.ok){const E=await L.json();a.USD=1/E.rates.USD,a.CHF=1/E.rates.CHF,a.GBP=1/E.rates.GBP,a.AUD=1/E.rates.AUD}a.GOLD=2100,a.SP500=4700}catch(x){console.error("Failed to fetch some prices:",x),a.USD=a.USD||.92,a.CHF=a.CHF||1.05,a.GBP=a.GBP||1.15,a.AUD=a.AUD||.6,a.ARS=a.ARS||.001}return a}class H{static async hash(e,t="salt_life_dashboard_2026"){const n=new TextEncoder().encode(e+t),i=await crypto.subtle.digest("SHA-512",n);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,t){const s=new TextEncoder,n=await crypto.subtle.importKey("raw",s.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:s.encode(t),iterations:25e4,hash:"SHA-512"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,t){try{const s=crypto.getRandomValues(new Uint8Array(16)),n=crypto.getRandomValues(new Uint8Array(12)),i=await this.deriveKey(t,this.bufToBase64(s)),o=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(o),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},i,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(n),salt:this.bufToBase64(s),v:"5.0"}}catch(s){throw console.error("[Security] Encryption failed:",s),new Error("No se pudo encriptar la información")}}static async decrypt(e,t){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:s,iv:n,salt:i}=e,o=await this.deriveKey(t,i),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(n)},o,this.base64ToBuf(s)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(s){throw console.error("[Security] Decryption failed:",s),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(t=>t.charCodeAt(0)))}}const Me=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:H},Symbol.toStringTag,{value:"Module"})),M={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class S{static isSetup(){return!!localStorage.getItem(M.MASTER_HASH)}static async setup(e){const t=await H.hash(e),s=await H.deriveVaultKey(e);return localStorage.setItem(M.MASTER_HASH,t),sessionStorage.setItem(M.VAULT_KEY,s),s}static async unlock(e){const t=await H.hash(e),s=localStorage.getItem(M.MASTER_HASH);if(t===s){const n=await H.deriveVaultKey(e);return sessionStorage.setItem(M.VAULT_KEY,n),n}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const t=sessionStorage.getItem(M.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const s=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:s,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(M.BIO_ENABLED,"true"),localStorage.setItem(M.VAULT_KEY,t),!0}catch(s){throw console.error("Biometric setup failed:",s),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(M.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const t=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:t,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const s=localStorage.getItem(M.VAULT_KEY);if(s)return sessionStorage.setItem(M.VAULT_KEY,s),s;throw new Error("Llave no encontrada. Usa contraseña.")}catch(t){throw console.error("Biometric auth failed:",t),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(M.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(M.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(M.BIO_ENABLED)==="true"}}const Ee="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",Be=[71,79,67,83,80,88,45,112,121,52,68,109,80,83,107,45,100,75,55,99,73,66,116,106,65,81,75,90,70,75,118,95,66,87,95].map(a=>String.fromCharCode(a)).join(""),wt="https://www.googleapis.com/auth/drive.file";class U{static hasToken(){const e=!!this.accessToken;return localStorage.getItem("life-dashboard/drive_connected")==="true"&&e}static async init(){return this._initPromise?this._initPromise:(this._initPromise=new Promise((e,t)=>{const s=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.codeClient=google.accounts.oauth2.initCodeClient({client_id:Ee,scope:wt,ux_mode:"popup",access_type:"offline",prompt:"consent",callback:async n=>{if(n.error){console.error("[Drive] Auth callback error:",n);return}if(n.code)try{const i=sessionStorage.getItem("life-dashboard/pkce_verifier"),o=localStorage.getItem("life-dashboard/drive_client_secret")||Be,r=await this.exchangeCodeForTokens(n.code,i,Ee,o);r.refresh_token&&await this.saveRefreshToken(r.refresh_token),this.saveSession(r),console.log("[Drive] Connected successfully via offline flow."),window.ns&&window.ns.toast("Google Drive vinculado"),typeof window.reRender=="function"&&window.reRender()}catch(i){console.error("[Drive] Token exchange error:",i),window.ns&&window.ns.alert("Error Auth","No se pudieron obtener tokens. Verifica el Client Secret.")}}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&this.ensureValidToken().catch(n=>{console.log("[Drive] Initial silent restoration skipped:",n.message)}),e(!0)}catch(n){console.error("[Drive] Init error:",n),t(n)}}):setTimeout(s,200)};s()}),this._initPromise)}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const t=e.expires_in||3600,s=Date.now()+t*1e3;localStorage.setItem("life-dashboard/drive_token_expiry",s.toString())}static async authenticate(){this.codeClient||await this.init();const{verifier:e}=await this.generatePKCE();sessionStorage.setItem("life-dashboard/pkce_verifier",e),this.codeClient.requestCode()}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(!(localStorage.getItem("life-dashboard/drive_connected")==="true"))return null;if(!this.accessToken||Date.now()>e-3e5){console.log("[Drive] Access token expired or near expiry, attempting refresh...");const n=await this.getRefreshToken();if(n)try{const i=localStorage.getItem("life-dashboard/drive_client_secret")||Be,o=await this.refreshAccessToken(n,Ee,i),r={access_token:o.access_token,expires_in:o.expires_in,refresh_token:o.refresh_token||n};return o.refresh_token&&await this.saveRefreshToken(o.refresh_token),this.saveSession(r),this.accessToken}catch(i){throw console.error("[Drive] Token refresh failed:",i),new Error("Sesión de Google Drive expirada. Por favor reconecta en Configuración.")}else throw console.warn("[Drive] No refresh token found."),new Error("Google Drive no está vinculado para acceso offline.")}return this.accessToken&&(!gapi.client.getToken()||gapi.client.getToken().access_token!==this.accessToken)&&gapi.client.setToken({access_token:this.accessToken}),this.accessToken}static async generatePKCE(){const e=Array.from(crypto.getRandomValues(new Uint8Array(32))).map(o=>("0"+o.toString(16)).slice(-2)).join(""),s=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",s),i=btoa(String.fromCharCode(...new Uint8Array(n))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return{verifier:e,challenge:i}}static async exchangeCodeForTokens(e,t,s,n=null){const i=new URLSearchParams({client_id:s,code:e,grant_type:"authorization_code",redirect_uri:"postmessage"});t&&!n&&i.append("code_verifier",t),n&&i.append("client_secret",n);const o=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:i});if(!o.ok){const r=await o.json();throw new Error(r.error_description||"Failed to exchange code")}return await o.json()}static async refreshAccessToken(e,t,s=null){const n=new URLSearchParams({client_id:t,refresh_token:e,grant_type:"refresh_token"});s&&n.append("client_secret",s);const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n});if(!i.ok){const o=await i.json();throw new Error(o.error_description||"Failed to refresh token")}return await i.json()}static async saveRefreshToken(e){return new Promise((t,s)=>{const n=indexedDB.open("LifeDashboardAuthDB",1);n.onupgradeneeded=i=>{const o=i.target.result;o.objectStoreNames.contains("tokens")||o.createObjectStore("tokens")},n.onsuccess=i=>{const r=i.target.result.transaction("tokens","readwrite");r.objectStore("tokens").put(e,"drive_refresh_token"),r.oncomplete=()=>t(),r.onerror=l=>s(l)},n.onerror=i=>s(i)})}static async getRefreshToken(){return new Promise((e,t)=>{const s=indexedDB.open("LifeDashboardAuthDB",1);s.onupgradeneeded=n=>{const i=n.target.result;i.objectStoreNames.contains("tokens")||i.createObjectStore("tokens")},s.onsuccess=n=>{const i=n.target.result;if(!i.objectStoreNames.contains("tokens")){e(null);return}const l=i.transaction("tokens","readonly").objectStore("tokens").get("drive_refresh_token");l.onsuccess=()=>e(l.result),l.onerror=u=>t(u)},s.onerror=n=>t(n)})}static async clearTokens(){return localStorage.removeItem("life-dashboard/drive_access_token"),localStorage.removeItem("life-dashboard/drive_connected"),localStorage.removeItem("life-dashboard/drive_token_expiry"),new Promise(e=>{const t=indexedDB.open("LifeDashboardAuthDB",1);t.onsuccess=s=>{const n=s.target.result;if(n.objectStoreNames.contains("tokens")){const i=n.transaction("tokens","readwrite");i.objectStore("tokens").clear(),i.oncomplete=()=>e()}else e()},t.onerror=()=>e()})}static async getOrCreateFolderPath(e){var n;await this.ensureValidToken(),(n=gapi.client)!=null&&n.drive||await this.init();const t=e.split("/").filter(i=>i);let s="root";for(const i of t){const o=`name = '${i}' and mimeType = 'application/vnd.google-apps.folder' and '${s}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)"})).result.files;if(l&&l.length>0)s=l[0].id;else{const u={name:i,mimeType:"application/vnd.google-apps.folder",parents:[s]};s=(await gapi.client.drive.files.create({resource:u,fields:"id"})).result.id}}return s}static async pushData(e,t,s=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pushing encrypted data...${s?" (Retry)":""}`);const n=await this.getOrCreateFolderPath("/backup/life-dashboard/"),i=await H.encrypt(e,t),o="dashboard_vault_v5.bin",r=`name = '${o}' and '${n}' in parents and trashed = false`,u=(await gapi.client.drive.files.list({q:r,fields:"files(id)"})).result.files,c=new Blob([JSON.stringify(i)],{type:"application/json"});if(u&&u.length>0){const d=u[0].id,g=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${d}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:c});if(g.status===401&&!s)return await this.ensureValidToken(),await this.pushData(e,t,!0);if(!g.ok)throw new Error(`Error al actualizar backup: ${g.status}`)}else{const d={name:o,parents:[n]},g=new FormData;g.append("metadata",new Blob([JSON.stringify(d)],{type:"application/json"})),g.append("file",c);const h=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:g});if(h.status===401&&!s)return await this.ensureValidToken(),await this.pushData(e,t,!0);if(!h.ok)throw new Error(`Error al crear backup: ${h.status}`)}return!0}catch(n){throw console.error("[Drive] Push failed:",n),new Error(n.message||"Fallo al subir datos a Drive")}}static async pullData(e,t=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pulling data...${t?" (Retry)":""}`);const i=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,r=(await gapi.client.drive.files.list({q:i,fields:"files(id, name)"})).result.files;if(!r||r.length===0)return null;const l=r[0].id,u=await fetch(`https://www.googleapis.com/drive/v3/files/${l}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(u.status===401&&!t)return await this.ensureValidToken(),await this.pullData(e,!0);if(!u.ok)throw new Error(`Error al descargar backup: ${u.status}`);const c=await u.json();return await H.decrypt(c,e)}catch(s){throw console.error("[Drive] Pull failed:",s),new Error(s.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");const s=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,i=(await gapi.client.drive.files.list({q:s,fields:"files(id)"})).result.files;if(i&&i.length>0){const o=i[0].id;return await gapi.client.drive.files.delete({fileId:o}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(e){throw console.error("[Drive] Deletion failed:",e),new Error(e.message||"Fallo al borrar backup en Drive")}}}pe(U,"codeClient",null),pe(U,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null),pe(U,"_initPromise",null);const Re={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',chevronUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>',chevronDown:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',uploadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12V21"/><path d="m16 16-4-4-4 4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>',moreVertical:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>',check:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',menu:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>',users:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',messageSquare:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',phone:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',instagram:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>',facebook:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>',linkedin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>',alertCircle:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>',fingerprint:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 15.1a7 7 0 0 0 10.9 0"/><path d="M6 13.6a7 7 0 0 0 4.6 2.4"/><path d="M13.4 16a7 7 0 0 0 4.6-2.4"/><path d="M8 12.1a5 5 0 0 0 6.9 0"/><path d="M9.1 11a3 3 0 0 0 3.9 0"/><path d="M12 18.5V20"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',palette:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.555C21.965 6.012 17.461 2 12 2z"/></svg>',star:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',eye:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>',eyeOff:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.52 13.52 0 0 0 2 12c0 0 3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><line x1="2" x2="22" y1="2" y2="22"/></svg>',play:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg>',pause:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>',clock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',barChart2:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>',brain:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 4.44-2.54Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-4.44-2.54Z"/></svg>',rocket:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-5c1.62-2.2 5-3 5-3"/><path d="M12 15v5s3.03-.55 5-2c2.2-1.62 3-5 3-5"/></svg>',coffee:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>',bookOpen:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>',dumbbell:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6.5 6.5 11 11"/><path d="m21 21-1-1"/><path d="m3 3 1 1"/><path d="m18 22 4-4"/><path d="m2 6 4-4"/><path d="m3 10 7-7"/><path d="m14 21 7-7"/></svg>',code:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',music:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>',monitor:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" x2="16" y1="21" y2="21"/><line x1="12" x2="12" y1="17" y2="21"/></svg>'};function m(a,e=""){return(Re[a]||Re.package).replace("<svg",`<svg class="${e}"`)}class xt{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,t="success",s=3e3){const n=document.createElement("div");n.className=`toast toast-${t} stagger-in`;const i=t==="success"?"check":t==="error"?"alertCircle":"info";n.innerHTML=`
        ...
        `,this.toastContainer.appendChild(n),setTimeout(()=>{n.classList.add("fade-out"),setTimeout(()=>n.remove(),500)},s)}alert(e,t){return new Promise(s=>{this._showModal({title:e,message:t,centered:!0,buttons:[{text:"Entendido",type:"primary",onClick:()=>s(!0)}]})})}confirm(e,t,s="Confirmar",n="Cancelar"){return new Promise(i=>{this._showModal({title:e,message:t,centered:!0,buttons:[{text:n,type:"secondary",onClick:()=>i(!1)},{text:s,type:"danger",onClick:()=>i(!0)}]})})}prompt(e,t,s="",n="text"){return new Promise(i=>{const o=`prompt-input-${Date.now()}`;this._showModal({title:e,message:t,centered:!0,content:`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>i(null)}]});const r=document.querySelector(".modal-overlay.active");r&&r.querySelectorAll(".select-option-btn").forEach(l=>{l.addEventListener("click",()=>{i(l.dataset.value),this._closeModal(r)})})})}hardConfirm(e,t,s="BORRAR"){return new Promise(n=>{const i=`hard-confirm-input-${Date.now()}`,o=`hard-confirm-btn-${Date.now()}`;this._showModal({title:e,message:`<div style="color: var(--accent-danger); font-weight: 600; margin-bottom: 8px;">ACCIÓN IRREVERSIBLE</div>${t}<br><br>Escribe <strong>${s}</strong> para confirmar:`,centered:!0,content:`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>n(!1)},{text:"Borrar Todo",type:"danger",id:o,disabled:!0,onClick:()=>n(!0)}]});const r=document.getElementById(i),l=document.getElementById(o);r.addEventListener("input",()=>{const u=r.value.trim().toUpperCase()===s.toUpperCase();l.disabled=!u,l.style.opacity=u?"1":"0.3",l.style.pointerEvents=u?"auto":"none"})})}performance(e,t){const s=[{rating:1,emoji:"🫣",label:"Baja"},{rating:3,emoji:"😐",label:"Media"},{rating:5,emoji:"😎",label:"Alta"}];return new Promise(n=>{this._showModal({title:e,message:t,centered:!0,content:`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>n(null)}]});const i=document.querySelector(".modal-overlay.active");i&&i.querySelectorAll(".perf-emoji-btn").forEach(o=>{o.addEventListener("click",()=>{n(parseInt(o.dataset.value)),this._closeModal(i)})})})}_showModal({title:e,message:t,content:s="",buttons:n=[],centered:i=!1}){const o=document.createElement("div");o.className=`modal-overlay ${i?"overlay-centered":""}`,o.style.zIndex="9999";const r=`modal-${Date.now()}-${Math.floor(Math.random()*1e3)}`;o.id=r;const l=`
      ...
      <div class="form-row">
          <div class="form-group" style="flex: 1.5;">
              ...
              <select class="form-input form-select" id="edit-type">
                  ${s.map(i=>`<option value="${i.value}" ${i.value===a.type?"selected":""}>${i.label}</option>`).join("")}
              </select>
          </div>
          <div class="form-group" style="flex: 1;">
              ...
              <select class="form-input form-select" id="edit-currency">
                  <optgroup label="Divisas">
                      ${At.map(i=>`<option value="${i.value}" ${i.value===a.currency?"selected":""}>${i.label}</option>`).join("")}
                  </optgroup>
                  ${t?`
                  <optgroup label="Mercados Reales">
                      ${Y.map(i=>`<option value="${i.symbol}" ${i.symbol===a.currency?"selected":""}>${i.name} (${i.symbol})</option>`).join("")}
                  </optgroup>
                  `:""}
              </select>
          </div>
  ...
  `}function Dt(a){const e=document.getElementById("edit-modal"),t=document.getElementById("edit-modal-close"),s=document.getElementById("btn-update"),n=document.getElementById("btn-delete");e.addEventListener("click",i=>{i.target===e&&he()}),t.addEventListener("click",he),s.addEventListener("click",()=>Mt(a)),n.addEventListener("click",()=>Bt(a))}function Mt(a){var u,c,d,g,h,f,y,x,k;const e=(c=(u=document.getElementById("edit-name"))==null?void 0:u.value)==null?void 0:c.trim(),t=(d=document.getElementById("edit-type"))==null?void 0:d.value,s=(g=document.getElementById("edit-currency"))==null?void 0:g.value,n=(f=(h=document.getElementById("edit-details"))==null?void 0:h.value)==null?void 0:f.trim(),i=parseFloat((y=document.getElementById("edit-value"))==null?void 0:y.value)||0,o=parseFloat((x=document.getElementById("edit-amount"))==null?void 0:x.value)||0,r=parseFloat((k=document.getElementById("edit-monthly"))==null?void 0:k.value)||0;if(!e){v.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:t,currency:s,details:n};a.fields.includes("value")&&(l.value=i),a.fields.includes("amount")&&(l.amount=o),a.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),a.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),p[a.updateMethod](de.id,l),he()}function Bt(a){v.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${de.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(p[a.deleteMethod](de.id),v.toast("Eliminado correctamente","info"),he())})}function he(){const a=document.getElementById("edit-modal");a&&(a.classList.remove("active"),setTimeout(()=>a.remove(),300)),de=null,ee=null}let te=!1,se=!1,$={key:"price",direction:"desc"},ne="USD",F=null;function Rt(){const a=p.getState(),e=a.lastMarketData||[],t=a.marketFavorites||[];F===null&&(F=t.length>0?"favorites":"all"),!se&&!te&&Ot();const s=ne==="EUR"?"€":"$";let n=e;F==="favorites"&&(n=e.filter(o=>t.includes(o.id)));const i=Object.values(b);return`
        <div class="market-view animate-fade-in" style="padding: 4px;">
            ...
            <!-- Content -->
            ${n.length===0&&F==="favorites"?jt():""}
            ${n.length===0&&F==="all"?Ut():""}
            
            ${i.map(o=>{const r=n.filter(l=>l.category===o);return r.length===0?"":Pt(o,r,s,t)}).join("")}
        </div>
    `}function Pt(a,e,t,s){const n=[...e].sort((i,o)=>{let r=i[$.key],l=o[$.key];return typeof r=="string"&&(r=r.toLowerCase()),typeof l=="string"&&(l=l.toLowerCase()),r<l?$.direction==="asc"?-1:1:r>l?$.direction==="asc"?1:-1:0});return`
            ...
            <div class="card market-table-card" style="padding: 0 !important; overflow: hidden; background: rgba(10, 15, 30, 0.4); border: 1px solid rgba(255,255,255,0.05); box-shadow: 0 4px 20px rgba(0,0,0,0.2);">
                <div class="table-container">
                    <table class="market-table">
                        ...
                        <tbody>
                            ${n.map(i=>_t(i,t,s.includes(i.id))).join("")}
                        </tbody>
                    </table>
                </div>
            </div>
        </div>
    `}function _t(a,e,t){let s=a.price;if(a.price!==null&&ne==="EUR"){const r=p.getState().rates.USD||.92;s=a.price*r}const n=Se(a.change24h),i=Se(a.change30d),o=Se(a.change1y);return`
        <tr class="market-row" data-id="${a.id}">
            <td style="padding: 0 0 0 12px; width: 44px;">
                <button class="btn-favorite ${t?"active":""}" data-id="${a.id}">
                    ${m("star")}
                </button>
            </td>
            <td>
                <div class="asset-cell">
                     ${a.image?`<img src="${a.image}" alt="${a.symbol}" style="width: 22px; height: 22px; border-radius: 50%; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.2));">`:`<div class="asset-icon-tiny" style="background: rgba(255,255,255,0.05); color: var(--text-muted); width: 22px; height: 22px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">${m(a.icon||"trendingUp")}</div>`}
            ...
            <td class="text-right font-mono ${n}" style="font-weight: 700;">
                ${a.change24h!==null?re(a.change24h):"-"}
            </td>
            <td class="text-right font-mono ${i}" style="font-size: 11px; opacity: 0.9;">
                ${a.change30d!==null?re(a.change30d):"-"}
            </td>
            <td class="text-right font-mono ${o}" style="font-size: 11px; opacity: 0.9;">
                ${a.change1y!==null?re(a.change1y):"-"}
            </td>
        </tr>
    `}function Se(a){return a==null?"":te?a>=0?"text-positive":"text-negative":"text-accent-primary"}function jt(){return`
    ...
    `}async function Ot(){var a,e;if(!se){se=!0,(a=window.reRender)==null||a.call(window);try{const t=await Qe();p.saveMarketData(t),te=!0}catch(t){console.error("Market update failed",t)}finally{se=!1,(e=window.reRender)==null||e.call(window)}}}function Nt(){var a,e,t;document.querySelectorAll(".capsule-btn").forEach(s=>{s.addEventListener("click",()=>{var i;const n=s.dataset.curr;n!==ne&&(ne=n,(i=window.reRender)==null||i.call(window))})}),(a=document.getElementById("filter-all"))==null||a.addEventListener("click",()=>{var s;F="all",(s=window.reRender)==null||s.call(window)}),(e=document.getElementById("filter-favs"))==null||e.addEventListener("click",()=>{var s;F="favorites",(s=window.reRender)==null||s.call(window)}),(t=document.getElementById("btn-show-all"))==null||t.addEventListener("click",()=>{var s;F="all",(s=window.reRender)==null||s.call(window)}),document.querySelectorAll(".btn-favorite").forEach(s=>{s.addEventListener("click",n=>{var o;n.stopPropagation();const i=s.dataset.id;p.toggleMarketFavorite(i),(o=window.reRender)==null||o.call(window)})}),document.querySelectorAll(".market-table th.sortable").forEach(s=>{s.addEventListener("click",()=>{var i;const n=s.dataset.sort;$.key===n?$.direction=$.direction==="asc"?"desc":"asc":($.key=n,$.direction="desc",n==="name"&&($.direction="asc")),(i=window.reRender)==null||i.call(window)})})}function Gt(){const a=p.getState(),{wealthGoals:e=[],inflationRate:t=3,projectionYears:s=10,currencySymbol:n}=a,i=p.getAllExpenses();let o=0;e.forEach(d=>{const g=d.cost*(d.dividendYield/100)/12;o+=p.convertValue(g,d.currency||a.currency)});const r=o-i,l=i*Math.pow(1+t/100,s);let u=0;e.forEach(d=>{const h=d.cost*Math.pow(1+d.annualGrowth/100,s)*(d.dividendYield/100)/12;u+=p.convertValue(h,d.currency||a.currency)});const c=u-l;return`
    <div class="wealth-goals-view animate-fade-in">
        ...
        <div class="card projection-summary-card">
            ...
            <div class="projection-grid">
                ...
                <div class="projection-col">
                    <div class="projection-label">En ${s} años (${t}% inf.)</div>
                    <div class="stat-row">
    ...
    `}function Ft(a,e){const t=e.currencySymbol,s=a.cost*(a.dividendYield/100)/12,n=p.convertValue(s,a.currency||e.currency);return`
        ...
        <div class="goal-card-details">
            ...
            <div class="goal-actions">
                <div class="goal-reorder-actions">
                    <button class="icon-btn reorder-wealth-goal" data-id="${a.id}" data-dir="up">${m("chevronUp")}</button>
                    <button class="icon-btn reorder-wealth-goal" data-id="${a.id}" data-dir="down">${m("chevronDown")}</button>
                </div>
                <div style="flex: 1;"></div>
                <button class="icon-btn edit-wealth-goal" data-id="${a.id}">${m("edit")}</button>
                <button class="icon-btn delete-wealth-goal" data-id="${a.id}">${m("trash")}</button>
            </div>
        </div>
    </div>
    `}function qt(){var t;(t=document.getElementById("btn-add-wealth-goal"))==null||t.addEventListener("click",async()=>{je()}),document.querySelectorAll(".edit-wealth-goal").forEach(s=>{s.addEventListener("click",n=>{n.stopPropagation();const i=s.dataset.id,o=p.getState().wealthGoals.find(r=>r.id===i);o&&je(o)})}),document.querySelectorAll(".delete-wealth-goal").forEach(s=>{s.addEventListener("click",async n=>{var r;n.stopPropagation();const i=s.dataset.id;await v.confirm("Eliminar objetivo","¿Estás seguro de que deseas eliminar este objetivo?")&&(p.deleteWealthGoal(i),(r=window.reRender)==null||r.call(window))})}),document.querySelectorAll(".reorder-wealth-goal").forEach(s=>{s.addEventListener("click",n=>{var r;n.stopPropagation();const i=s.dataset.id,o=s.dataset.dir;p.reorderWealthGoals(i,o),(r=window.reRender)==null||r.call(window)})});const a=document.getElementById("inflation-slider");a&&a.addEventListener("change",s=>{var n;p.setInflationRate(s.target.value),(n=window.reRender)==null||n.call(window)});const e=document.getElementById("years-slider");e&&e.addEventListener("change",s=>{var n;p.setProjectionYears(s.target.value),(n=window.reRender)==null||n.call(window)})}async function je(a=null){const e=!!a,t=e?"Editar Objetivo":"Nuevo Objetivo Patrimonial",s=document.createElement("div");s.className="modal-overlay active overlay-centered",s.innerHTML=`
    ...
    <div class="finance-page stagger-children" style="padding-bottom: 80px;">
      ...
      ${j==="summary"?Ht(a,e):j==="goals"?Gt():Rt()}
      
    </div>
  `}function Ht(a,e){const t=p.getPassiveIncome(),s=p.getLivingExpenses(),n=p.getNetPassiveIncome(),i=p.getInvestmentAssetsValue(),o=p.getTotalLiabilities(),r=p.getNetWorth(),l=p.getAllIncomes(),u=p.getAllExpenses(),c=p.getNetIncome();return`
      ...
      <div class="allocation-container">
        <div class="pie-chart" style="background: conic-gradient(${u});">
          <div class="pie-center">
            <div class="pie-total">${w(o,a.currencySymbol)}</div>
  ...
  `}function Vt(a){const e=[...(a.activeIncomes||[]).map(s=>({...s,category:"activeIncome"})),...a.passiveAssets.map(s=>({...s,category:"passive"})),...a.investmentAssets.map(s=>({...s,category:"investment"})),...a.liabilities.map(s=>({...s,category:"liability"}))];if(e.length===0)return`
      <div class="empty-state">
    ...
    `;const t=a.currencySymbol;return`
    <div class="asset-list">
      ${e.map(s=>{const n=Kt(s.currency||s.type),i=Yt(s.currency||s.type),o=s.category==="liability",r=s.value||s.amount||0,l=p.convertValue(r,s.currency||"EUR");let u="";if(s.currency!==a.currency){const d={EUR:"€",USD:"$",BTC:"₿",ETH:"Ξ",XRP:"✕",GOLD:"oz",SP500:"pts",CHF:"Fr",GBP:"£",AUD:"A$",ARS:"$"}[s.currency]||s.currency;u=`<div class="asset-original-value">${r} ${d}</div>`}return`
          <div class="asset-item" data-id="${s.id}" data-category="${s.category}">
            ...
            <div>
              <div class="asset-value ${o?"text-warning":""}">
                ${s.category==="activeIncome"?"+":o?"-":""}${w(l,t)}
                ${s.category==="activeIncome"?'<span style="font-size: 10px; opacity: 0.7; font-weight: 400;">/mes</span>':""}
              </div>
              ${s.monthlyIncome?`<div class="asset-yield">+${w(p.convertValue(s.monthlyIncome,s.currency),t)}/mes</div>`:""}
              ${s.monthlyPayment?`<div class="asset-yield text-negative">-${w(p.convertValue(s.monthlyPayment,s.currency),t)}/mes</div>`:""}
            </div>
          </div>
        `}).join("")}
    </div>
  `}function Kt(a){return{property:"property",rental:"property",stocks:"stocks",etf:"stocks",SP500:"stocks",crypto:"crypto",BTC:"crypto",ETH:"crypto",XRP:"crypto",GOLD:"investment",cash:"cash",USD:"cash",EUR:"cash",savings:"cash",vehicle:"vehicle",debt:"debt",loan:"debt",mortgage:"debt",creditcard:"debt",salary:"cash",freelance:"cash",business:"property"}[a]||"cash"}function Yt(a){return{property:"building",rental:"building",stocks:"trendingUp",etf:"trendingUp",SP500:"trendingUp",crypto:"bitcoin",BTC:"bitcoin",ETH:"bitcoin",XRP:"bitcoin",GOLD:"package",cash:"dollarSign",USD:"dollarSign",EUR:"dollarSign",savings:"piggyBank",vehicle:"car",debt:"creditCard",loan:"landmark",mortgage:"home",creditcard:"creditCard",salary:"briefcase",freelance:"users",business:"building"}[a]||"dollarSign"}function Oe(){const a=document.getElementById("tab-summary"),e=document.getElementById("tab-markets"),t=document.getElementById("tab-goals");if(a&&e&&t&&(a.addEventListener("click",()=>{var o;j="summary",(o=window.reRender)==null||o.call(window)}),e.addEventListener("click",()=>{var o;j="markets",(o=window.reRender)==null||o.call(window)}),t.addEventListener("click",()=>{var o;j="goals",(o=window.reRender)==null||o.call(window)})),j==="markets"){Nt();return}if(j==="goals"){qt();return}document.querySelectorAll(".asset-item").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.id,l=o.dataset.category;et(r,l)})});const n=document.getElementById("toggle-real-estate");n&&n.addEventListener("change",()=>{p.toggleRealEstate()});const i=document.getElementById("display-currency-select");i&&i.addEventListener("change",o=>{p.setCurrency(o.target.value)})}let z=10,W=7,J=null,Z=null;function Wt(){const e=p.getState().currencySymbol,t=p.getNetWorth(),n=p.getNetIncome()*12,i=J!==null?J:t,o=Z!==null?Z:n,r=tt(i,o,W,z);return`
    <div class="compound-page stagger-children" style="padding-bottom: 80px;">
      ...
      <div class="projection-chart" id="projection-chart">
        ${at(r.yearlyBreakdown)}
      </div>
      
      <div class="projection-table" id="projection-table">
        ${st(r.yearlyBreakdown,e)}
      </div>
    </div>
  `}function tt(a,e,t,s){const n=t/100,i=[];let o=a,r=0,l=0;for(let u=1;u<=s;u++){const c=o,d=o*n;o+=d+e,r+=e,l+=d,i.push({year:u,startBalance:c,contribution:e,interest:d,endBalance:o,totalContributions:r,totalInterest:l})}return{finalValue:o,totalContributions:r,totalInterest:l,totalGrowth:o-a,growthMultiple:a>0?o/a:0,yearlyBreakdown:i}}function at(a,e){if(a.length===0)return"";const t=Math.max(...a.map(n=>Math.abs(n.endBalance))),s=a.map((n,i)=>{const o=i/(a.length-1)*100,r=100-n.endBalance/t*100;return`${o},${r}`});return`
  ...
  `}function st(a,e){const t=[];for(let s=0;s<a.length;s++){const n=a[s];(s<5||(s+1)%5===0||s===a.length-1)&&t.push(n)}return`
    <div class="table-container">
  ...
  `}function Xt(a){const e=document.getElementById("back-to-finance"),t=document.getElementById("rate-slider"),s=document.getElementById("years-slider"),n=document.getElementById("principal-input"),i=document.getElementById("contribution-input"),o=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",a),n&&n.addEventListener("input",l=>{J=parseFloat(l.target.value)||0,Q()}),i&&i.addEventListener("input",l=>{Z=parseFloat(l.target.value)||0,Q()}),o&&o.addEventListener("click",()=>{J=null;const l=p.getNetWorth();n.value=l,Q()}),r&&r.addEventListener("click",()=>{Z=null;const l=p.getNetIncome()*12;i.value=l,Q()}),t&&t.addEventListener("input",l=>{W=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${W}%`,Q()}),s&&s.addEventListener("input",l=>{z=parseInt(l.target.value),document.getElementById("years-value").textContent=`${z} años`,Q()})}function Q(){const e=p.getState().currencySymbol,t=J!==null?J:p.getNetWorth(),s=Z!==null?Z:p.getNetIncome()*12,n=tt(t,s,W,z),i=document.getElementById("future-value"),o=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),u=document.getElementById("total-contributed"),c=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),g=document.getElementById("projection-chart"),h=document.getElementById("projection-table");i&&(i.textContent=w(n.finalValue,e)),o&&(o.textContent=`Valor Futuro en ${z} años`),r&&(r.innerHTML=`${n.totalGrowth>=0?"📈":"📉"} ${n.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=w(t,e)),u&&(u.textContent=w(n.totalContributions,e),u.className=`stat-value ${n.totalContributions>=0?"positive":"negative"}`),c&&(c.textContent=w(n.totalInterest,e)),d&&(d.textContent=w(n.finalValue,e)),g&&(g.innerHTML=at(n.yearlyBreakdown)),h&&(h.innerHTML=st(n.yearlyBreakdown,e))}function Jt(){z=10,W=7,J=null,Z=null}let le=p.getState().lastMarketData||[],ce=!1,A={key:"price",direction:"desc"},nt="";function Zt(){const a=p.getState(),e=a.currency||"EUR",t=a.currencySymbol||"€";if((le.length===0||nt!==e)&&(ce||it(),le.length===0))return`
        ...
        <div class="market-page stagger-children" style="padding-bottom: 80px;">
            ...
            ${s.map(n=>{const i=le.filter(o=>o.category===n);return i.length===0?"":Qt(n,i,t)}).join("")}
        </div>
    `}function Qt(a,e,t){const s=[...e].sort((n,i)=>{let o=n[A.key],r=i[A.key];return typeof o=="string"&&(o=o.toLowerCase()),typeof r=="string"&&(r=r.toLowerCase()),o<r?A.direction==="asc"?-1:1:o>r?A.direction==="asc"?1:-1:0});return`
    ...
    `}async function it(){const e=p.getState().currency||"EUR";ce||(ce=!0,nt=e,le=await Qe(),p.saveMarketData(le),ce=!1,window.dispatchEvent(new CustomEvent("market-ready")))}function ea(a){const e=document.getElementById("market-back");e&&e.addEventListener("click",a),document.querySelectorAll(".market-table th[data-sort]").forEach(n=>{n.addEventListener("click",()=>{const i=n.dataset.sort;A.key===i?A.direction=A.direction==="asc"?"desc":"asc":(A.key=i,A.direction="desc",i==="name"&&(A.direction="asc")),typeof window.reRender=="function"&&window.reRender()})}),document.querySelectorAll(".market-currency-toggle .btn-toggle").forEach(n=>{n.addEventListener("click",()=>{const i=n.dataset.curr;p.setCurrency(i),it()})}),window.addEventListener("market-ready",()=>{typeof window.reRender=="function"&&window.reRender()})}class Ne{static getApiKey(){return localStorage.getItem("life-dashboard/db_gemini_api_key")}static setApiKey(e){localStorage.setItem("life-dashboard/db_gemini_api_key",e)}static hasKey(){return!!this.getApiKey()}static async analyzeFood(e){var r;const t=this.getApiKey();if(!t)throw new Error("Se requiere una API Key de Gemini en Configuración.");const n=(await this.fileToBase64(e)).split(",")[1],i=e.type,o=`Identify the food in this image. 
        Provide the name of the dish and the approximate total calories for a standard portion.
        Return ONLY a JSON object like this: {"name": "Dish Name", "calories": 500}`;try{const l=await fetch(`https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=${t}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:o},{inline_data:{mime_type:i,data:n}}]}],generationConfig:{response_mime_type:"application/json"}})});if(!l.ok){const d=await l.json();throw new Error(((r=d.error)==null?void 0:r.message)||"Error al conectar con Gemini AI")}const c=(await l.json()).candidates[0].content.parts[0].text;return JSON.parse(c)}catch(l){throw console.error("[Gemini] Analysis failed:",l),l}}static fileToBase64(e){return new Promise((t,s)=>{const n=new FileReader;n.readAsDataURL(e),n.onload=()=>t(n.result),n.onerror=i=>s(i)})}}let ie=localStorage.getItem("life-dashboard/health_current_tab")||"diet";function ta(){const a=p.getState(),{health:e}=a;return`
                        ...
                        <div class="ex-health-main">
                            ...
                            <div class="ex-health-info">
                                ...
                                <div class="ex-health-stats">
                                    ...
                                    ${i.lastLog?`
                                        <span style="opacity: 0.3;">•</span>
                                        <span class="last-effort-badge-emoji" title="Último esfuerzo">${ia(i.lastLog.rating)}</span>
                                    `:""}
                                </div>
                            </div>
                        </div>
    ...
    `}function sa(a){const e=a.weightLogs.length>0?a.weightLogs[a.weightLogs.length-1].weight:"--",t=a.fatLogs.length>0?a.fatLogs[a.fatLogs.length-1].fat:null;let s="rgba(255,255,255,0.1)",n="linear-gradient(135deg, rgba(255,255,255,0.05) 0%, rgba(0,0,0,0) 100%)",i="var(--text-primary)",o="Sin datos";return t!==null&&(t<12?(s="var(--accent-success)",n="linear-gradient(135deg, rgba(16, 185, 129, 0.1) 0%, rgba(16, 185, 129, 0.05) 100%)",i="var(--accent-success)",o="Excelente (Atlético)"):t<=18?(s="var(--accent-tertiary)",n="linear-gradient(135deg, rgba(245, 158, 11, 0.1) 0%, rgba(245, 158, 11, 0.05) 100%)",i="var(--accent-tertiary)",o="Bueno (Fitness)"):(s="var(--accent-danger)",n="linear-gradient(135deg, rgba(239, 68, 68, 0.1) 0%, rgba(239, 68, 68, 0.05) 100%)",i="var(--accent-danger)",o="Atención (Reducción)")),`
      ...
      <div class="card highlight-card" style="margin-bottom: var(--spacing-xl); background: ${n}; border-color: ${s}; padding: 24px !important; transition: all 0.3s ease;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; align-items: center;">
              ...
              <div class="clickable" id="log-weight-btn" style="text-align: center; border-right: 1px solid rgba(255,255,255,0.1);">
                  <div class="highlight-value" style="color: ${i} !important; font-size: 32px; margin: 0; line-height: 1;">${e} <span style="font-size: 14px; opacity: 0.6;">kg</span></div>
              ...
              <div class="clickable" id="log-fat-btn" style="text-align: center;">
                  <div class="highlight-value" style="color: ${i} !important; font-size: 32px; margin: 0; line-height: 1;">${t!==null?t+"%":"--"}</div>
      ...
      <div class="card ai-calorie-card" id="ai-scan-photo" style="display: flex; flex-direction: row; align-items: center; justify-content: space-between; padding: 20px !important; margin-bottom: var(--spacing-2xl); cursor: pointer; background: linear-gradient(135deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.02) 100%);">
          <div style="display: flex; align-items: center; gap: 15px;">
              ...
              <div>
                <div style="font-size: 18px; font-weight: 800; color: var(--text-primary);">${oa(a)} kcal</div>
    ...
    `}function na(a){const e=[...a.weightLogs||[]].sort((G,ke)=>G.date-ke.date);if(e.length<1||!a.weightGoalDate)return`
        ...
        `;const t=e[0],s=e[e.length-1],n=t.date,i=new Date(a.weightGoalDate).getTime(),o=Date.now(),l=Math.max(i,o)-n,u=e.map(G=>G.weight),c=Math.min(...u,a.weightGoal)-2,g=Math.max(...u,t.weight)+2-c,h=300,f=150,y=G=>(G-n)/l*h,x=G=>f-(G-c)/g*f,k=y(i),L=x(a.weightGoal),E=y(n),B=x(t.weight),D=e.map((G,ke)=>`${ke===0?"M":"L"} ${y(G.date)} ${x(G.weight)}`).join(" "),R=y(o),V=i-n,K=o-n,pt=Math.min(1,K/V),mt=t.weight-(t.weight-a.weightGoal)*pt,xe=s.weight-mt,Te=a.weightGoal<t.weight?xe<0:xe>0,De=V/(1e3*60*60*24*7),vt=De>0?(t.weight-a.weightGoal)/De:0;return`
    <div class="card chart-card" style="margin-bottom: var(--spacing-lg);">
        <div class="card-header">
            ...
            <span class="badge ${Te?"badge-success":"badge-danger"}" style="font-size: 10px;">
                ${Te?"Vas bien":"Por debajo del ritmo"} (${Math.abs(xe).toFixed(1)}kg)
            </span>
        </div>
        ...
        <div class="chart-legend" style="margin-top: 15px; display: flex; flex-direction: column; gap: 4px; font-size: 10px; color: var(--text-muted);">
            ...
            <div style="display: flex; justify-content: center; font-weight: 600; color: var(--text-secondary); margin-top: 4px;">
                <span>Ritmo requerido: ${vt.toFixed(2)} kg / semana</span>
            </div>
        </div>
    </div>
    `}function ia(a){return a<=2?"😰":a<=4?"😐":"😄"}function oa(a){const e=new Date().toDateString();return(a.calorieLogs||[]).filter(t=>new Date(t.date).toDateString()===e).reduce((t,s)=>t+(s.calories||0),0)}function ra(){document.querySelectorAll(".health-tab-btn").forEach(a=>{a.addEventListener("click",()=>{const e=a.dataset.tab;e!==ie&&(ie=e,localStorage.setItem("life-dashboard/health_current_tab",e),typeof window.reRender=="function"&&window.reRender())})}),ie==="exercise"?la():ca()}function la(){var a;document.querySelectorAll(".add-ex-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=e.dataset.id,s=await v.prompt("Nuevo Ejercicio","Nombre del ejercicio:");s&&(p.addExerciseToRoutine(t,{name:s}),v.toast("Ejercicio añadido"))})}),document.querySelectorAll(".rename-routine").forEach(e=>{e.addEventListener("click",async()=>{const t=e.dataset.id,s=e.dataset.current,n=await v.prompt("Editar Rutina","Nombre de la rutina:",s);n&&n!==s&&(p.renameRoutine(t,n),v.toast("Rutina renombrada"))})}),document.querySelectorAll(".delete-routine-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=e.dataset.id;await v.confirm("¿Borrar Rutina?","Esta acción no se puede deshacer.","Eliminar","Cancelar")&&(p.deleteRoutine(t),v.toast("Rutina eliminada"))})}),document.querySelectorAll(".routine-more-btn").forEach(e=>{e.addEventListener("click",async t=>{t.stopPropagation();const s=e.dataset.id,n=parseInt(e.dataset.index),i=e.dataset.name,o=[{value:"rename",label:"✏️ Renombrar"},{value:"up",label:"⬆️ Mover Arriba"},{value:"down",label:"⬇️ Mover Abajo"},{value:"delete",label:"🗑️ Eliminar Rutina"}],r=await v.select(`Menú: ${i}`,"Elige una acción:",o,1);if(r==="rename"){const l=await v.prompt("Editar Rutina","Nuevo nombre:",i);l&&l!==i&&(p.renameRoutine(s,l),v.toast("Rutina renombrada"))}else r==="up"?p.reorderRoutine(n,"up"):r==="down"?p.reorderRoutine(n,"down"):r==="delete"&&await v.confirm("¿Borrar Rutina?","No se puede deshacer.","Eliminar","Cancelar")&&(p.deleteRoutine(s),v.toast("Rutina eliminada"))})}),document.querySelectorAll(".rename-exercise").forEach(e=>{e.addEventListener("click",async()=>{const t=e.dataset.routine,s=parseInt(e.dataset.index),n=e.dataset.current,i=await v.prompt("Renombrar Ejercicio","Nuevo nombre:",n);i&&i!==n&&(p.updateExercise(t,s,{name:i}),v.toast("Ejercicio renombrado"))})}),document.querySelectorAll(".delete-exercise-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=e.dataset.routine,s=parseInt(e.dataset.index);await v.confirm("Eliminar Ejercicio","¿Quitar este ejercicio de la rutina?","Eliminar","Cancelar")&&(p.deleteExerciseFromRoutine(t,s),v.toast("Ejercicio eliminado"))})}),document.querySelectorAll(".ex-more-btn").forEach(e=>{e.addEventListener("click",async t=>{t.stopPropagation();const s=e.dataset.routine,n=parseInt(e.dataset.index),i=e.dataset.name,o=[{value:"rename",label:"✏️ Renombrar"},{value:"up",label:"⬆️ Mover Arriba"},{value:"down",label:"⬇️ Mover Abajo"},{value:"delete",label:"🗑️ Eliminar Ejercicio"}],r=await v.select(`Ejercicio: ${i}`,"Elige una acción:",o,1);if(r==="rename"){const l=await v.prompt("Renombrar Ejercicio","Nuevo nombre:",i);l&&l!==i&&(p.updateExercise(s,n,{name:l}),v.toast("Ejercicio renombrado"))}else r==="up"?p.reorderExercise(s,n,"up"):r==="down"?p.reorderExercise(s,n,"down"):r==="delete"&&await v.confirm("Eliminar Ejercicio","¿Quitar de la rutina?","Eliminar","Cancelar")&&(p.deleteExerciseFromRoutine(s,n),v.toast("Ejercicio eliminado"))})}),document.querySelectorAll(".reorder-routine-btn").forEach(e=>{e.addEventListener("click",t=>{t.stopPropagation();const s=parseInt(e.dataset.index),n=e.dataset.dir;p.reorderRoutine(s,n)})}),document.querySelectorAll(".reorder-ex-btn").forEach(e=>{e.addEventListener("click",t=>{t.stopPropagation();const s=e.dataset.routine,n=parseInt(e.dataset.index),i=e.dataset.dir;p.reorderExercise(s,n,i)})}),document.querySelectorAll(".update-weight").forEach(e=>{e.addEventListener("click",async t=>{t.stopPropagation();const s=e.dataset.routine,n=parseInt(e.dataset.index),i=[];for(let r=10;r<=150;r+=2.5)i.push(`${r}kg`);const o=await v.select("Seleccionar Peso","Elige el peso para este ejercicio:",i,4);if(o){const r=parseFloat(o.replace("kg",""));p.updateExercise(s,n,{weight:r}),v.toast("Peso actualizado")}})}),document.querySelectorAll(".update-reps").forEach(e=>{e.addEventListener("click",async t=>{t.stopPropagation();const s=e.dataset.routine,n=parseInt(e.dataset.index),i=[];for(let r=7;r<=20;r++)i.push(`${r} reps`);const o=await v.select("Seleccionar Reps","Elige las repeticiones objetivo:",i,4);if(o){const r=parseInt(o.replace(" reps",""));p.updateExercise(s,n,{reps:r}),v.toast("Reps actualizadas")}})}),document.querySelectorAll(".log-stars-btn").forEach(e=>{e.addEventListener("click",async t=>{t.stopPropagation();const s=e.dataset.rid,n=parseInt(e.dataset.idx),i=await v.performance("Finalizar Ejercicio","¿Qué tan intenso te ha parecido?");i&&(p.logExercise(s,n,i),v.toast("Ejercicio registrado","success"))})}),(a=document.getElementById("add-routine-btn"))==null||a.addEventListener("click",async()=>{const e=await v.prompt("Nueva Rutina","Nombre (ej: Pecho y Triceps):","Día X");e&&(p.saveRoutine({name:e,exercises:[]}),v.toast("Rutina creada"))})}function ca(){var a,e,t,s,n,i;(a=document.getElementById("log-weight-btn"))==null||a.addEventListener("click",async()=>{const o=await v.prompt("Registrar Peso","Peso actual (kg):","","number");o&&(p.addWeightLog(parseFloat(o)),v.toast("Peso registrado"))}),(e=document.getElementById("log-fat-btn"))==null||e.addEventListener("click",async()=>{const o=await v.prompt("Registrar Grasa","Porcentaje de grasa (%):","","number");o&&(p.addFatLog(parseFloat(o)),v.toast("Grasa registrada"))}),(t=document.getElementById("set-weight-goal-btn"))==null||t.addEventListener("click",async()=>{const o=p.getState().health.weightGoal,r=await v.prompt("Objetivo de Peso","Introduce tu peso ideal (kg):",o,"number");r&&(p.updateHealthGoal("weightGoal",parseFloat(r)),v.toast("Objetivo actualizado"))}),(s=document.getElementById("set-weight-date-btn"))==null||s.addEventListener("click",async()=>{const o=p.getState().health.weightGoalDate||new Date().toISOString().split("T")[0],r=await v.prompt("Fecha Objetivo","¿Cuándo quieres llegar a tu meta?",o,"date");r&&(p.updateHealthGoal("weightGoalDate",r),v.toast("Fecha actualizada"))}),(n=document.getElementById("set-fat-goal-btn"))==null||n.addEventListener("click",async()=>{const o=p.getState().health.fatGoal,r=await v.prompt("Objetivo de Grasa","Introduce tu porcentaje ideal (%):",o,"number");r&&(p.updateHealthGoal("fatGoal",parseFloat(r)),v.toast("Objetivo actualizado"))}),(i=document.getElementById("ai-scan-photo"))==null||i.addEventListener("click",()=>{const o=document.createElement("input");o.type="file",o.accept="image/*",o.onchange=async l=>{var c;const u=l.target.files[0];if(u){if(!Ne.hasKey()){if(await v.confirm("IA no configurada","Añade tu Gemini API Key en Ajustes.","Configurar","Simulación")){(c=document.querySelector('[data-nav="settings"]'))==null||c.click();return}v.toast("Usando simulación...","info"),r();return}try{v.toast("Analizando con Gemini...","info");const d=await Ne.analyzeFood(u);await v.confirm("IA Detectada",`Identificado: "${d.name}" (${d.calories} kcal). ¿Registrar?`)&&(p.addCalorieLog(d.calories,`${d.name} (AI)`),v.toast("Calorías registradas"))}catch(d){v.alert("Error IA",d.message)}}};function r(){setTimeout(async()=>{const l={name:"Bowl Saludable",calories:450};await v.confirm("IA Simulada",`Detectado "${l.name}" con ${l.calories} kcal. ¿Registrar?`)&&(p.addCalorieLog(l.calories,l.name),v.toast("Registrado"))},1e3)}o.click()})}const Le=["#ffffff","#00D4AA","#7C3AED","#F59E0B","#EF4444","#3B82F6","#EC4899","#10B981","#A855F7","#64748B"];let oe="focus";function Ge(){const a=p.getState(),{goals:e,scheduledTasks:t}=a;return`
  ...
  `}function da(a){return`
      <div class="goals-grid-layout">
        ${[{id:"day",label:"Today",icon:"zap",color:"#FFD700"},{id:"week",label:"This Week",icon:"calendar",color:"#00D4AA"},{id:"year",label:"Year 2026",icon:"target",color:"#7C3AED"},{id:"long",label:"Long Term",icon:"trendingUp",color:"#EF4444"}].map(t=>{const s=a.filter(r=>r.timeframe===t.id),n=s.filter(r=>r.completed).length,i=s.length,o=i>0?n/i*100:0;return`
    ...
    `}function pa(a){const e=ma(a),t=a.color||"var(--accent-primary)";return`
    <div class="card schedule-card ${a.active?"":"is-inactive"}" 
        ...
        <div class="schedule-card-body" style="padding: 16px; display: flex; align-items: center; gap: 16px;">
            <div class="schedule-type-icon" style="background: ${t}22; color: ${t}; width: 40px; height: 40px; border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                ${m(a.type==="weekly"?"refreshCw":a.type==="monthly"?"calendar":"pin")}
            </div>
            <div class="schedule-info" style="flex: 1;">
                <div class="schedule-title" style="color: ${t}; font-weight: 700; font-size: 16px;">${a.title}</div>
                <div class="schedule-meta" style="margin-top: 4px;">
                    ...
                    ${a.lastProcessed?`<span class="schedule-last" style="opacity: 0.5; font-size: 10px; margin-left: 10px;">Última vez: ${a.lastProcessed}</span>`:""}
                </div>
            </div>
            <div class="schedule-actions" style="display: flex; gap: 12px;">
                <button class="icon-btn toggle-schedule" data-id="${a.id}" style="color: ${a.active?"var(--accent-success)":"var(--text-muted)"}; background: none; width: 32px; height: 32px;">
                    ${m(a.active?"checkCircle":"circle")}
                </button>
                <button class="icon-btn delete-schedule" data-id="${a.id}" style="opacity: 0.5; background: none; width: 32px; height: 32px;">
                    ${m("trash")}
                </button>
            </div>
        </div>
    </div>
    `}function ma(a){if(a.type==="fixed")return`Fecha: ${a.date}`;if(a.type==="monthly")return`Día ${a.dayOfMonth}`;if(a.type==="weekly"){const e=["Dom","Lun","Mar","Mié","Jue","Vie","Sáb"];return`${a.days.map(t=>e[t]).join(", ")}`}return"Recurrente"}function va(a,e){return a.length===0?`
            <div class="empty-column-state">
                <div class="empty-column-icon" style="opacity: 0.2">${m("package")}</div>
            </div>
        `:[...a].sort((s,n)=>s.completed!==n.completed?s.completed?1:-1:s.order!==void 0&&n.order!==void 0?s.order-n.order:(n.createdAt||0)-(s.createdAt||0)).map(s=>{const n=s.subGoals&&s.subGoals.length>0,i=n?s.subGoals.filter(r=>r.completed).length/s.subGoals.length*100:0,o=s.color||"#ffffff";return`
      ...
      <div class="calendar-top-layout">
        ...
        <div class="card calendar-view-card">
            <div class="calendar-mini-header">
                ...
                <span class="current-month">${fa()}</span>
        ...
        <div class="events-list-container" style="margin-top: var(--spacing-xl);">
            ...
            <div class="events-list">
                ...
                `:e.filter(t=>{const s=new Date(t.date);return s.getMonth()===q.getMonth()&&s.getFullYear()===q.getFullYear()}).sort((t,s)=>new Date(t.date)-new Date(s.date)).map(t=>`
                    <div class="card event-card">
                        <div class="event-icon-wrapper ${t.category||"event"}">
                            ${m(wa(t.category||"event"))}
                        </div>
                        <div class="event-main-col" style="flex: 1;">
                            <div class="event-title" style="font-weight: 700;">${t.title}</div>
                            <div class="event-details-row">
                                <span class="event-date-text">${ba(t.date)}</span>
                                <span class="event-dot-separator"></span>
                                <span class="event-time-text">${t.time}</span>
                                ${t.repeat!=="none"?`<span class="event-repeat-tag">${xa(t.repeat)}</span>`:""}
                            </div>
                        </div>
  ...
  `}function ya(a){const e=q.getMonth(),t=q.getFullYear(),s=new Date().getDate(),n=new Date().getMonth()===e&&new Date().getFullYear()===t,i=new Date(t,e+1,0).getDate(),o=new Date(t,e,1).getDay(),r=["D","L","M","M","J","V","S"],l=new Set;a.forEach(c=>{const d=new Date(c.date);d.getMonth()===e&&d.getFullYear()===t&&l.add(d.getDate())});let u=r.map(c=>`<div class="calendar-day-label">${c}</div>`).join("");for(let c=0;c<o;c++)u+='<div class="calendar-day empty"></div>';for(let c=1;c<=i;c++){const d=n&&c===s,g=l.has(c);u+=`
            <div class="calendar-day ${d?"today":""} ${g?"has-event":""}">
                ${c}
                ${g?'<span class="event-dot-indicator"></span>':""}
            </div>
        `}return u}function fa(){return`${["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"][q.getMonth()]} ${q.getFullYear()}`}function ba(a){const e={day:"numeric",month:"short"};return new Date(a).toLocaleDateString("es-ES",e).toUpperCase()}function wa(a){switch(a){case"reminder":return"bell";case"meeting":return"users";default:return"calendar"}}function xa(a){return{daily:"Diario",weekly:"Semanal",monthly:"Mensual",yearly:"Anual"}[a]||""}function ka(){var a,e,t;(a=document.querySelector(".prev-month"))==null||a.addEventListener("click",()=>{q.setMonth(q.getMonth()-1),typeof window.reRender=="function"&&window.reRender()}),(e=document.querySelector(".next-month"))==null||e.addEventListener("click",()=>{q.setMonth(q.getMonth()+1),typeof window.reRender=="function"&&window.reRender()}),document.querySelectorAll(".event-delete-btn").forEach(s=>{s.addEventListener("click",async()=>{await v.confirm("¿Eliminar evento?","¿Borrar este evento de tu agenda?")&&(p.deleteEvent(s.dataset.id),v.toast("Evento eliminado"))})}),(t=document.getElementById("add-event-manual-btn"))==null||t.addEventListener("click",async()=>{const s=await v.prompt("Nuevo Evento","Título del evento:");if(!s)return;const n=await v.prompt("Fecha","Formato YYYY-MM-DD:",new Date().toISOString().split("T")[0]);if(!n)return;const i=await v.prompt("Hora","Formato HH:MM:","10:00");if(!i)return;const o=[{value:"event",label:"Evento"},{value:"reminder",label:"Recordatorio"},{value:"meeting",label:"Reunión"}],r=await v.select("Categoría","Tipo de evento:",o,0);p.addEvent({title:s,date:n,time:i,category:r||"event",repeat:"none"}),v.toast("Evento agendado","success")})}function Ea(){const a=p.getState(),e=a.currencySymbol,t=a.livingExpenses,s=a.otherExpenses||[],n=a.liabilities,i=p.sumItems(t,"amount"),o=p.sumItems(s,"amount"),r=p.sumItems(n,"monthlyPayment"),l=i+o+r,u=[...(t||[]).map(c=>({...c,category:"livingExpense",typeLabel:"Gasto de Vida"})),...(s||[]).map(c=>({...c,category:"otherExpense",typeLabel:"Otro Gasto"})),...(n||[]).filter(c=>c.monthlyPayment>0).map(c=>({...c,amount:c.monthlyPayment,category:"liability",typeLabel:"Deuda / Hipoteca"}))].sort((c,d)=>d.amount-c.amount);return`
  ...
  `}function $a(a,e){if(a.length===0)return`
            <div class="empty-state">
        ...
        <div class="asset-list">
            ${a.map(s=>{const n=p.convertValue(s.amount,s.currency||"EUR"),i=Sa(s.category);return`
    ...
    `}function Sa(a){switch(a){case"liability":return"landmark";case"livingExpense":return"shoppingCart";default:return"creditCard"}}function Ia(a){const e=document.getElementById("back-to-finance");e&&e.addEventListener("click",a),document.querySelectorAll(".expense-item").forEach(s=>{s.addEventListener("click",()=>{const n=s.dataset.id,i=s.dataset.category;et(n,i)})})}const La="modulepreload",Aa=function(a){return"/life-dashboard/"+a},qe={},ye=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),r=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));n=Promise.allSettled(t.map(l=>{if(l=Aa(l),l in qe)return;qe[l]=!0;const u=l.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":La,u||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),u)return new Promise((g,h)=>{d.addEventListener("load",g),d.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(o){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=o,window.dispatchEvent(r),!r.defaultPrevented)throw o}return n.then(o=>{for(const r of o||[])r.status==="rejected"&&i(r.reason);return e().catch(i)})};function Ca(){const a=S.isBioEnabled(),e=U.hasToken();return`
    ...
    `}function Ma(a){var e,t,s,n,i,o,r;(e=document.getElementById("open-calendar"))==null||e.addEventListener("click",()=>{a("calendar")}),(t=document.getElementById("open-skills"))==null||t.addEventListener("click",()=>{a("skills")}),(s=document.getElementById("open-schedule"))==null||s.addEventListener("click",()=>{a("goals")}),(n=document.getElementById("open-settings"))==null||n.addEventListener("click",()=>{a("settings")}),(i=document.getElementById("btn-upload-menu"))==null||i.addEventListener("click",async()=>{const l=document.getElementById("btn-upload-menu"),u=l.innerHTML;try{if(!await v.confirm("Subir a la Nube","Esto reemplazará TODO lo que tengas en Google Drive con tus datos locales. ¿Continuar?"))return;l.innerHTML='<div style="margin: auto;"><div class="loading-spinner-sm"></div></div>',l.style.pointerEvents="none";const d=S.getVaultKey();await U.pushData(p.getState(),d),v.toast("Bóveda subida correctamente")}catch(c){console.error(c),v.alert("Error al subir",c.message)}finally{l.innerHTML=u,l.style.pointerEvents="auto"}}),(o=document.getElementById("btn-download-menu"))==null||o.addEventListener("click",async()=>{const l=document.getElementById("btn-download-menu"),u=l.innerHTML;try{if(!await v.confirm("Descargar de la Nube","Esto reemplazará TODOS tus datos locales con los que hay en la nube. Esta acción no se puede deshacer. ¿Continuar?"))return;l.innerHTML='<div style="margin: auto;"><div class="loading-spinner-sm"></div></div>',l.style.pointerEvents="none";const d=S.getVaultKey(),g=await U.pullData(d);g?(p.resetState(g),await p.saveState(),v.toast("Datos descargados correctamente","success"),setTimeout(()=>window.location.reload(),1e3)):v.alert("Error","No se encontró una bóveda válida en Drive o el descifrado falló (¿Contraseña incorrecta?)")}catch(c){console.error("[Menu] Download failed:",c),v.alert("Error de Descarga",c.message||"Error desconocido al bajar datos")}finally{l.innerHTML=u,l.style.pointerEvents="auto"}}),(r=document.getElementById("btn-force-update"))==null||r.addEventListener("click",async()=>{if(await v.confirm("¿Forzar Actualización?","Esto recargará la página y limpiará la caché para obtener la última versión.")){if(window.caches)try{const u=await caches.keys();for(let c of u)await caches.delete(c)}catch(u){console.error("Error clearing cache",u)}window.location.reload(!0)}})}function Ba(){const{social:a}=p.getState(),{people:e,columns:t,idealLeadProfile:s}=a,n=e.length,i=t.find(u=>u.name.toLowerCase().includes("closed")||u.name.toLowerCase().includes("cerrado")||u.name.toLowerCase().includes("exito"));let o=0;if(n>0){const u=s&&s.trim().length>0;(i?e.filter(d=>d.columnId===i.id).length:0)>0?o=u?100:80:(o=Math.min(40,n*5),u&&(o+=10))}let r="var(--accent-danger)",l="linear-gradient(135deg, rgba(239, 68, 68, 0.1) 0%, rgba(239, 68, 68, 0.05) 100%)";return o>=60?(r="var(--accent-success)",l="linear-gradient(135deg, rgba(16, 185, 129, 0.1) 0%, rgba(16, 185, 129, 0.05) 100%)"):o>=25&&(r="var(--accent-tertiary)",l="linear-gradient(135deg, rgba(245, 158, 11, 0.1) 0%, rgba(245, 158, 11, 0.05) 100%)"),`
            ...
            <div class="header-content">
                ...
                <div class="finance-top-grid" style="margin-top: 20px; margin-bottom: 20px;">
                    <div class="card highlight-card" style="background: ${l}; border-color: ${r}; transition: all 0.3s ease;">
                        ...
                        <div class="highlight-value" style="color: ${r} !important;">${o}%</div>
    ...
    `}function Ra(a){const e=a.lastContact?Math.floor((Date.now()-new Date(a.lastContact).getTime())/864e5):null,t=a.color||"#3b82f6";return`
    ...
    `}function Pa(){window.socialListenersAttached||(window.socialListenersAttached=!0,document.addEventListener("click",a=>{const e=a.target.closest(".col-opts-btn");if(e){a.preventDefault(),a.stopPropagation(),Na(e.dataset.id,e);return}if(a.target.closest("#add-social-col-btn")){_a();return}if(a.target.closest("#add-person-btn")){window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person"}}));return}if(a.target.closest("#ideal-lead-btn")){ja();return}if(a.target.closest("#communications-mgr-btn")){ye(()=>import("./CommunicationsModal-m8nrkZ45.js"),[]).then(n=>n.openCommunicationsModal());return}if(a.target.closest("#contact-sources-btn")){Fa();return}const t=a.target.closest(".person-chat-btn");if(t){a.preventDefault(),a.stopPropagation(),ye(()=>import("./CommunicationsModal-m8nrkZ45.js"),[]).then(n=>n.openCommunicationsModal(t.dataset.id));return}const s=a.target.closest(".person-card");if(s){Ua(s.dataset.id);return}}),document.addEventListener("dragstart",a=>{const e=a.target.closest(".person-card");e&&(a.dataTransfer.setData("text/plain",e.dataset.id),e.classList.add("dragging"))}),document.addEventListener("dragend",a=>{const e=a.target.closest(".person-card");e&&e.classList.remove("dragging")}),document.addEventListener("dragover",a=>{const e=a.target.closest(".kanban-cards");e&&(a.preventDefault(),e.classList.add("drag-over"))}),document.addEventListener("dragleave",a=>{const e=a.target.closest(".kanban-cards");e&&e.classList.remove("drag-over")}),document.addEventListener("drop",a=>{const e=a.target.closest(".kanban-cards");if(e){a.preventDefault(),e.classList.remove("drag-over");const t=a.dataTransfer.getData("text/plain"),s=e.dataset.colId;t&&s&&p.movePerson(t,s)}}))}async function _a(){const a=await v.prompt("Etapa","Nombre de la etapa:");a&&(p.addSocialColumn({name:a,color:"#94a3b8"}),v.toast("Etapa agregada correctamente","success"))}async function ja(){const a=p.getState().social.idealLeadProfile||"",e=await Oa(a);e!==null&&(p.updateIdealLeadProfile(e),v.toast("Perfil Ideal actualizado"))}function Ua(a){const e=p.getState().social.people.find(t=>t.id===a);e&&window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person",person:e}}))}function Oa(a){return new Promise(e=>{const t=document.createElement("div");t.className="modal-overlay active",t.style.zIndex="9999",t.innerHTML=`
            <div class="modal">
                <div class="modal-header">
        ...
        `,document.body.appendChild(t);const s=()=>{t.remove(),e(null)};t.querySelector(".modal-close").addEventListener("click",s),t.querySelector("#save-ideal-lead").addEventListener("click",()=>{const n=t.querySelector("#ideal-lead-text").value;t.remove(),e(n)}),t.addEventListener("click",n=>{n.target===t&&s()})})}function Na(a,e){document.querySelectorAll(".column-options-menu").forEach(o=>o.remove());const t=p.getState().social.columns.find(o=>o.id===a);if(!t)return;const s=document.createElement("div");s.className="column-options-menu",s.innerHTML=`
    ...
    `;const n=e.getBoundingClientRect();s.style.position="fixed",s.style.top=`${n.bottom+8}px`,s.style.right=`${window.innerWidth-n.right}px`,s.style.zIndex="9999",document.body.appendChild(s),s.querySelectorAll(".menu-item").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.action;if(s.remove(),r==="edit"){const l=await v.prompt("Nombre de Columna","Nuevo nombre:",t.name);l!=null&&l.trim()&&p.updateSocialColumn(a,{name:l.trim()})}else if(r==="color"){const l=await Ga(t.color);l&&p.updateSocialColumn(a,{color:l})}else if(r==="delete")await v.confirm("Eliminar Etapa",`¿Eliminar "${t.name}"?`)&&p.deleteSocialColumn(a);else if(r==="move_up"||r==="move_down"){const l=[...p.getState().social.columns].sort((d,g)=>d.order-g.order),u=l.findIndex(d=>d.id===a);if(u===-1)return;const c=r==="move_up"?u-1:u+1;c>=0&&c<l.length&&([l[u].order,l[c].order]=[l[c].order,l[u].order],p.reorderSocialColumns(l))}})});const i=o=>{!s.contains(o.target)&&o.target!==e&&(s.remove(),document.removeEventListener("click",i))};setTimeout(()=>document.addEventListener("click",i),10)}function Ga(a){return new Promise(e=>{const t=document.createElement("div");t.className="modal-overlay active",t.style.zIndex="99999",t.innerHTML=`
        ...
        `,document.body.appendChild(t);const s=()=>{t.remove(),e(null)};t.querySelector(".modal-close").addEventListener("click",s),t.querySelector("#save-contact-sources").addEventListener("click",()=>{const i=t.querySelector("#contact-sources-text").value.split(",").map(o=>o.trim()).filter(o=>o.length>0);t.remove(),e(i)}),t.addEventListener("click",n=>{n.target===t&&s()})})}let ue="tracker",T=null,we=!1,ae=null;function Ha(){const a=p.getState(),{activities:e=[],logs:t=[]}=a.timeInvest||{};return`
    ...
    `}function za(a,e){var t;if(ae){const s=a.find(n=>n.id===ae);if(s&&((t=s.subActivities)==null?void 0:t.length)>0)return Va(s)}return ue==="tracker"?Ka(a):Ya(a,e)}function Va(a){return`
        ...
        <div class="card stats-card">
            ...
            <div class="line-chart-container" style="height: ${o}px; width: 100%; position: relative; margin-top: 20px;">
                ...
                <div class="chart-labels" style="display: flex; justify-content: space-between; margin-top: 10px;">
                    ${t.map(c=>`<span style="font-size: 10px; color: var(--text-muted);">${s[new Date(c).getUTCDay()]}</span>`).join("")}
                </div>
            </div>
    ...
    `}function Wa(a){var n;const e=a.find(i=>i.id===T.activityId),t=(n=e==null?void 0:e.subActivities)==null?void 0:n.find(i=>i.id===T.subActivityId),s=ot(T.elapsedSeconds);return`
    ...
    `}function ot(a){const e=Math.floor(a/3600),t=Math.floor(a%3600/60),s=a%60;return`${e>0?e+":":""}${String(t).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function Xa(){var a,e,t,s,n,i,o;(a=document.getElementById("tab-tracker"))==null||a.addEventListener("click",()=>{var r;ue="tracker",(r=window.reRender)==null||r.call(window)}),(e=document.getElementById("tab-stats"))==null||e.addEventListener("click",()=>{var r;ue="stats",(r=window.reRender)==null||r.call(window)}),document.querySelectorAll(".activity-btn").forEach(r=>{r.classList.contains("sub-opt")||r.addEventListener("click",()=>{var c,d;const l=r.dataset.id;((c=p.getState().timeInvest.activities.find(g=>g.id===l).subActivities)==null?void 0:c.length)>0?(ae=l,(d=window.reRender)==null||d.call(window)):ze(l)})}),document.querySelectorAll(".sub-opt").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.subId==="none"?null:r.dataset.subId;ze(ae,l),ae=null})}),(t=document.getElementById("btn-back-to-activities"))==null||t.addEventListener("click",()=>{var r;ae=null,(r=window.reRender)==null||r.call(window)}),(s=document.getElementById("pomodoro-toggle"))==null||s.addEventListener("change",r=>{we=r.target.checked}),(n=document.getElementById("btn-stop-timer"))==null||n.addEventListener("click",()=>{confirm("¿Deseas cancelar esta sesión? No se guardarán los datos.")&&Ve(!1)}),(i=document.getElementById("btn-complete-timer"))==null||i.addEventListener("click",()=>{Ve(!0)}),(o=document.getElementById("btn-add-activity"))==null||o.addEventListener("click",()=>{fe()})}function fe(){var r,l,u;const a=p.getState().timeInvest,{activities:e=[],pomodoroTime:t=25}=a,s=document.createElement("div");s.className="modal-overlay active",s.id="time-invest-config-modal",s.innerHTML=`
    ...
    `,document.body.appendChild(s);const n=()=>{var c;s.classList.remove("active"),setTimeout(()=>s.remove(),300),(c=window.reRender)==null||c.call(window)};(r=document.getElementById("close-config-modal"))==null||r.addEventListener("click",n),(l=document.getElementById("save-config"))==null||l.addEventListener("click",n);const i=document.getElementById("pomodoro-input"),o=document.getElementById("pomodoro-val");i==null||i.addEventListener("input",c=>{const d=c.target.value;o.textContent=d,p.setPomodoroTime(d)}),s.querySelectorAll(".edit-activity").forEach(c=>{c.addEventListener("click",()=>{const d=c.dataset.id,g=e.find(h=>h.id===d);He(g),s.remove()})}),s.querySelectorAll(".delete-activity").forEach(c=>{c.addEventListener("click",async()=>{const d=c.dataset.id;await v.confirm("¿Eliminar actividad?","Se perderán también los registros asociados.")&&(p.deleteTimeActivity(d),s.remove(),fe())})}),(u=document.getElementById("btn-new-activity"))==null||u.addEventListener("click",()=>{He(),s.remove()})}function He(a=null){var c,d;const e=!!a,t=["brain","rocket","coffee","bookOpen","zap","heart","briefcase","users","dumbbell","code","music","monitor"],s=["#8b5cf6","#f59e0b","#ef4444","#3b82f6","#10b981","#ec4899","#06b6d4","#f97316","#84cc16","#a855f7","#6366f1","#d946ef"];let n=(a==null?void 0:a.icon)||"brain",i=(a==null?void 0:a.color)||"#8b5cf6";const o=document.createElement("div");o.className="modal-overlay active",o.innerHTML=`
    ...
    `,document.body.appendChild(o);const r=[...(a==null?void 0:a.subActivities)||[]];o.querySelector("#btn-add-sub").addEventListener("click",()=>{const g=o.querySelector("#new-sub-name"),h=g.value.trim();h&&(r.push({id:Date.now().toString(),name:h}),g.value="",l())});function l(){const g=o.querySelector("#sub-activities-list");g.innerHTML=r.map(h=>`
            <div class="activity-edit-item" style="padding: 8px 12px; margin-bottom: 4px;">
                <span style="flex: 1; font-size: 13px;">${h.name}</span>
                <button class="btn-mini-action delete-sub" data-sub-id="${h.id}">${m("trash")}</button>
            </div>
        `).join(""),g.querySelectorAll(".delete-sub").forEach(h=>{h.addEventListener("click",()=>{const f=h.dataset.subId,y=r.findIndex(x=>x.id===f);y!==-1&&r.splice(y,1),l()})})}l();const u=()=>{o.classList.remove("active"),setTimeout(()=>o.remove(),300),fe()};(c=document.getElementById("close-activity-form"))==null||c.addEventListener("click",u),o.querySelectorAll(".icon-option").forEach(g=>{g.addEventListener("click",()=>{o.querySelectorAll(".icon-option").forEach(h=>h.classList.remove("selected")),g.classList.add("selected"),n=g.dataset.icon})}),o.querySelectorAll(".color-option").forEach(g=>{g.addEventListener("click",()=>{o.querySelectorAll(".color-option").forEach(h=>h.classList.remove("selected")),g.classList.add("selected"),i=g.dataset.color})}),(d=document.getElementById("save-activity"))==null||d.addEventListener("click",()=>{const g=document.getElementById("activity-name").value.trim();if(!g){v.toast("Por favor, indica un nombre","error");return}const h={name:g,icon:n,color:i,subActivities:r};e?p.updateTimeActivity(a.id,h):p.addTimeActivity(h),o.classList.remove("active"),setTimeout(()=>o.remove(),300),fe()})}function ze(a,e=null){var t;T||(T={activityId:a,subActivityId:e,startTime:Date.now(),elapsedSeconds:0,interval:setInterval(()=>{T.elapsedSeconds=Math.floor((Date.now()-T.startTime)/1e3);const s=document.querySelector(".timer-display");if(s&&(s.textContent=ot(T.elapsedSeconds)),we){const n=p.getState().timeInvest.pomodoroTime||25;T.elapsedSeconds===n*60&&(Ja(),v.toast("¡Tiempo Pomodoro cumplido!","success"))}},1e3)},(t=window.reRender)==null||t.call(window))}function Ve(a=!1){var e;if(T){if(clearInterval(T.interval),a){const t=Math.floor(T.elapsedSeconds/60);t>=1?(p.addTimeLog({activityId:T.activityId,subActivityId:T.subActivityId,date:new Date().toISOString(),durationMinutes:t}),v.toast(`¡Excelente! Has invertido ${t} min.`,"success")):v.toast("Sesión muy corta para ser registrada.","info")}T=null,(e=window.reRender)==null||e.call(window)}}function Ja(){try{const a=new(window.AudioContext||window.webkitAudioContext),e=a.createOscillator(),t=a.createGain();e.connect(t),t.connect(a.destination),e.type="sine",e.frequency.setValueAtTime(880,a.currentTime),t.gain.setValueAtTime(0,a.currentTime),t.gain.linearRampToValueAtTime(.5,a.currentTime+.1),t.gain.exponentialRampToValueAtTime(.01,a.currentTime+1),e.start(a.currentTime),e.stop(a.currentTime+1)}catch(a){console.error("Audio error:",a)}}function Za(){const{skills:a}=p.getState(),e=(a||[]).filter(n=>n.category==="current"),t=(a||[]).filter(n=>n.category==="next"),s=e.length>0?Math.round(e.reduce((n,i)=>n+i.level,0)/e.length):0;return`
    <div class="skills-page stagger-children" style="padding-bottom: 80px;">
        ...
        <div class="card highlight-card" style="margin-bottom: var(--spacing-xl); background: linear-gradient(135deg, rgba(124, 58, 237, 0.1) 0%, rgba(124, 58, 237, 0.05) 100%); border-color: rgba(124, 58, 237, 0.3);">
            ...
            <div class="highlight-value" style="color: #7c3aed;">${s}<span style="font-size: 16px; opacity: 0.6;">%</span></div>
        ...
        <div class="skills-grid" style="display: grid; grid-template-columns: 1fr; gap: var(--spacing-xl);">
            ...
            <section class="skills-section">
                <div class="section-divider">
                    ...
                    <button class="icon-btn add-skill-btn" data-category="current">${m("plus")}</button>
                </div>
                <div class="skills-list">
                    ${e.length===0?Ke():e.map(n=>Qa(n)).join("")}
                </div>
            </section>
            ...
            <section class="skills-section">
                <div class="section-divider">
                    ...
                    <button class="icon-btn add-skill-btn" data-category="next">${m("plus")}</button>
                </div>
                <div class="skills-list" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px;">
                    ${t.length===0?Ke():t.map(n=>es(n)).join("")}
                </div>
            </section>
        </div>
    </div>
    ...
    <div class="card skill-card" style="margin-bottom: 12px; padding: 16px !important;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            ...
            <div style="display: flex; gap: 8px;">
                <button class="icon-btn edit-skill" data-id="${a.id}">${m("edit")}</button>
                <button class="icon-btn delete-skill" data-id="${a.id}" style="color: var(--accent-danger);">${m("trash")}</button>
            </div>
        </div>
    ...
    `}function ts(){document.querySelectorAll(".add-skill-btn").forEach(a=>{a.addEventListener("click",async()=>{const e=a.dataset.category,t=await v.prompt("Nueva Skill",`¿Qué skill quieres ${e==="current"?"registrar":"aprender"}?`);if(t){let s=0;if(e==="current"){const n=await v.prompt("Nivel de Dominio","Del 0 al 100:","50","number");s=parseInt(n)||0}p.addSkill({name:t,level:s,category:e}),v.toast("Skill añadida")}})}),document.querySelectorAll(".edit-skill").forEach(a=>{a.addEventListener("click",async e=>{e.stopPropagation();const t=a.dataset.id,s=p.getState().skills.find(i=>i.id===t);if(!s)return;const n=await v.prompt("Editar Skill","Nombre:",s.name);if(n){let i=s.level;if(s.category==="current"){const o=await v.prompt("Nivel de Dominio","Del 0 al 100:",s.level.toString(),"number");i=parseInt(o)||0}p.updateSkill(t,{name:n,level:i}),v.toast("Skill actualizada")}})}),document.querySelectorAll(".delete-skill").forEach(a=>{a.addEventListener("click",async e=>{e.stopPropagation();const t=a.dataset.id;await v.confirm("Eliminar Skill","¿Estás seguro de que quieres eliminar esta skill?")&&(p.deleteSkill(t),v.toast("Skill eliminada"))})})}function as(a="current"){const e=`modal-skills-${Date.now()}`;v._showModal({title:"Gestión de Mastery",message:"Añade una nueva habilidad a tu ecosistema",centered:!0,content:`
            <div id="${e}" style="margin-top: var(--spacing-md);">
    ...
    <div class="modal">
      ...
      <div class="type-selector category-selector">
        ${Object.entries(Ce).filter(([e])=>!rt.includes(e)).map(([e,t])=>`
  ...
  `}function lt(){const a=Ce[C],e=C==="investmentAsset"||C==="passiveAsset";if(e){const s=Y.map(n=>({value:n.symbol,label:`${n.name} (${n.symbol})`}));[...Ye,...s]}let t="";return C==="passiveAsset"||C==="investmentAsset"?t=`
    ...
    <div class="form-row">
        <div class="form-group" style="flex: 1.5;">
            ...
            <select class="form-input form-select" id="input-type">
                ${a.types.map(s=>`<option value="${s.value}">${s.label}</option>`).join("")}
            </select>
        </div>
        <div class="form-group" style="flex: 1.5;">
            <label class="form-label">Activo/Moneda</label>
            <select class="form-input form-select" id="input-currency">
                <optgroup label="Divisas">
                    ${Ye.map(s=>`<option value="${s.value}">${s.label}</option>`).join("")}
                </optgroup>
                ${e?`
  ...
  `}function is(){const a=document.getElementById("add-modal"),e=document.getElementById("modal-close");a.addEventListener("click",s=>{s.target===a&&Ae()}),e.addEventListener("click",Ae);const t=a.querySelectorAll(".category-selector .type-option");t.forEach(s=>{s.addEventListener("click",()=>{C=s.dataset.category,t.forEach(n=>n.classList.remove("active")),s.classList.add("active"),document.getElementById("form-container").innerHTML=lt(),We()})}),We()}function We(){const a=document.getElementById("btn-save");a&&a.addEventListener("click",os);const e=document.getElementById("mode-qty"),t=document.getElementById("mode-total"),s=document.getElementById("input-qty"),n=document.getElementById("input-value"),i=document.getElementById("input-currency"),o=document.getElementById("input-name");if(e&&t){const l=u=>{u==="qty"?(e.style.background="var(--accent-primary)",e.style.color="var(--bg-primary)",t.style.background="transparent",t.style.color="var(--text-secondary)",s.focus()):(t.style.background="var(--accent-primary)",t.style.color="var(--bg-primary)",e.style.background="transparent",e.style.color="var(--text-secondary)",n.focus())};e.addEventListener("click",()=>l("qty")),t.addEventListener("click",()=>l("total"))}const r=l=>{const u=p.getState().rates,c=i==null?void 0:i.value,d=u[c]||1;if(l==="qty"){const g=parseFloat(s.value)||0;n.value=(g*d).toFixed(2)}else{const g=parseFloat(n.value)||0;s.value=(g/d).toFixed(6)}};s==null||s.addEventListener("input",()=>r("qty")),n==null||n.addEventListener("input",()=>r("total")),i&&i.addEventListener("change",()=>{if(o&&!o.value){const l=i.options[i.selectedIndex].text;o.value=l.split(" (")[0]}r("qty")})}function os(){var h,f,y,x,k,L,E,B,D,R,V,K;const a=(f=(h=document.getElementById("input-name"))==null?void 0:h.value)==null?void 0:f.trim(),e=(y=document.getElementById("input-type"))==null?void 0:y.value,t=(x=document.getElementById("input-currency"))==null?void 0:x.value,s=(L=(k=document.getElementById("input-details"))==null?void 0:k.value)==null?void 0:L.trim(),n=parseFloat((E=document.getElementById("input-value"))==null?void 0:E.value)||0,i=document.getElementById("input-qty"),o=i?parseFloat(i.value)||0:n,r=parseFloat((B=document.getElementById("input-amount"))==null?void 0:B.value)||0,l=parseFloat((D=document.getElementById("input-monthly"))==null?void 0:D.value)||0,u=(R=document.getElementById("input-date"))==null?void 0:R.value,c=(V=document.getElementById("input-time"))==null?void 0:V.value,d=(K=document.getElementById("input-repeat"))==null?void 0:K.value;if(!a){v.alert("Campo Obligatorio","Por favor ingresa un nombre para el elemento.");return}const g={name:a,type:e,currency:t,details:s};switch(C){case"passiveAsset":p.addPassiveAsset({...g,value:o,monthlyIncome:l});break;case"activeIncome":p.addActiveIncome({...g,amount:r});break;case"livingExpense":p.addLivingExpense({...g,amount:r});break;case"investmentAsset":p.addInvestmentAsset({...g,value:o});break;case"liability":p.addLiability({...g,amount:r,monthlyPayment:l});break;case"event":p.addEvent({title:a,date:u,time:c,repeat:d,category:e});break}Ae()}function Ae(){const a=document.getElementById("add-modal");a&&(a.classList.remove("active"),setTimeout(()=>a.remove(),300))}let X=null;function ct(a=null){console.log("[LeadModal] Opening modal",{personToEdit:a});const e=document.getElementById("add-person-modal");e&&(console.log("[LeadModal] Removing existing modal"),e.remove()),X=a?a.id:null;const t=document.createElement("div");t.className="modal-overlay",t.id="add-person-modal",t.setAttribute("role","dialog"),t.innerHTML=rs(a),document.body.appendChild(t),setTimeout(()=>{var s;t.classList.add("active"),(s=t.querySelector("#person-name"))==null||s.focus()},50),ls(t)}function rs(a=null){const e=a?"Editar Lead":"Lead",t=a?"Guardar Cambios":"Lead";return`
    <div class="modal">
      <div class="modal-handle"></div>
      <div class="modal-header">
      ...
      <div id="person-form-container" style="margin-top: var(--spacing-lg);">
            ...
            <div class="form-group">
                ...
                <select class="form-input form-select" id="person-source">
                    ${p.getState().social.contactSources.map(s=>`
                        <option value="${s}" ${(a==null?void 0:a.source)===s?"selected":""}>${s}</option>
                    `).join("")}
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="goal-color-dots" id="person-color-picker" style="justify-content: flex-start; margin-top: 0; background: none; border: none; padding: 5px 0;">
                    ${["#3b82f6","#10b981","#f59e0b","#ef4444","#8b5cf6","#ec4899"].map(s=>`
                        <div class="goal-color-dot ${(a==null?void 0:a.color)===s||!(a!=null&&a.color)&&s==="#3b82f6"?"active":""}" 
                             data-color="${s}" 
        ...
        <div class="form-group" style="margin-top: var(--spacing-md);">
             ...
             <select class="form-input form-select" id="person-column">
                ${p.getState().social.columns.sort((s,n)=>s.order-n.order).map(s=>`<option value="${s.id}" ${(a==null?void 0:a.columnId)===s.id?"selected":""}>${s.name}</option>`).join("")}
             </select>
        </div>
  ...
  `}function ls(a){const e=a.querySelector("#person-modal-close"),t=a.querySelector("#btn-save-person-lead"),s=a.querySelector("#btn-delete-person"),n=a.querySelector("#person-rating-slider"),i=a.querySelector("#rating-value");if(a.addEventListener("click",l=>{l.target===a&&(console.log("[LeadModal] Overlay clicked, closing"),be(a))}),e==null||e.addEventListener("click",()=>{console.log("[LeadModal] Close button clicked"),be(a)}),n&&i){const l=()=>{console.log("[LeadModal] Slider updated:",n.value),i.textContent=n.value};n.oninput=l,n.onchange=l}t&&(t.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Save button clicked"),ds(a)}),s&&(s.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Delete button clicked"),cs(a)});const o=a.querySelectorAll(".goal-color-dot"),r=a.querySelector("#person-color-value");o.forEach(l=>{l.addEventListener("click",()=>{o.forEach(u=>u.classList.remove("active")),l.classList.add("active"),r&&(r.value=l.dataset.color),console.log("[LeadModal] Color selected:",l.dataset.color)})})}async function cs(a){X&&await v.confirm("Eliminar Lead","¿Estás seguro de eliminar este lead?")&&(p.deletePerson(X),v.toast("Lead eliminado","success"),be(a))}function ds(a){var t,s,n,i,o,r,l,u,c,d,g,h,f;const e=a.querySelector("#btn-save-person-lead");if(e.disabled){console.log("[LeadModal] Save ignored, already processing");return}try{const y=(s=(t=a.querySelector("#person-name"))==null?void 0:t.value)==null?void 0:s.trim(),x=(i=(n=a.querySelector("#person-phone"))==null?void 0:n.value)==null?void 0:i.trim(),k=(r=(o=a.querySelector("#person-city"))==null?void 0:o.value)==null?void 0:r.trim(),L=(l=a.querySelector("#person-source"))==null?void 0:l.value,E=(u=a.querySelector("#person-rating-slider"))==null?void 0:u.value,B=(d=(c=a.querySelector("#person-desc"))==null?void 0:c.value)==null?void 0:d.trim(),D=(g=a.querySelector("#person-column"))==null?void 0:g.value,R=(h=a.querySelector("#person-color-value"))==null?void 0:h.value,V=(f=a.querySelector("#person-last-contact"))==null?void 0:f.value;if(console.log("[LeadModal] Attempting to save",{name:y,rating:E,columnId:D,color:R,lastContact:V}),!y){console.warn("[LeadModal] Save failed: Missing name"),v.toast("El nombre es obligatorio","error");return}e.disabled=!0,e.innerHTML='<span class="loading-spinner-sm"></span> Guardando...';const K={name:y,phone:x,city:k,source:L,rating:parseInt(E)||5,description:B,columnId:D,color:R,lastContact:V};X?(console.log("[LeadModal] Updating person",X),p.updatePerson(X,K),v.toast("Lead actualizado correctamente","success")):(console.log("[LeadModal] Adding new person"),p.addPerson(K),v.toast("Lead guardado correctamente","success")),console.log("[LeadModal] Save successful, closing modal"),be(a)}catch(y){console.error("[LeadModal] Error saving lead:",y),v.toast("Error al guardar el lead","error"),e.disabled=!1,e.innerHTML=`${m("plus")} Lead`}}function be(a){a&&(console.log("[LeadModal] Closing modal"),a.classList.remove("active"),setTimeout(()=>{a.parentNode&&(console.log("[LeadModal] Removing modal from DOM"),a.remove())},400))}function us(){const a=S.isSetup(),e=S.isBioEnabled();return`
    ...
    `}function ps(a){var i;const e=document.getElementById("auth-submit-btn"),t=document.getElementById("auth-bio-btn"),s=document.getElementById("auth-password"),n=async()=>{const o=s.value,r=document.getElementById("auth-confirm"),l=S.isSetup();try{let u;if(l)u=await S.unlock(o);else{if(!o||o.length<4)throw new Error("Contraseña demasiado corta");if(o!==r.value)throw new Error("Las contraseñas no coinciden");u=await S.setup(o)}await p.loadEncrypted(u),a()}catch(u){v.alert("Error",u.message)}};e==null||e.addEventListener("click",n),s==null||s.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),n())}),(i=document.getElementById("auth-confirm"))==null||i.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),n())}),t==null||t.addEventListener("click",async()=>{try{const o=await S.unlockWithBiometrics();await p.loadEncrypted(o),a()}catch(o){v.alert("Identificación",o.message)}}),S.isBioEnabled()&&setTimeout(async()=>{try{const o=await S.unlockWithBiometrics();await p.loadEncrypted(o),a()}catch{console.log("Auto-bio failed or cancelled")}},500)}let P=localStorage.getItem("life-dashboard/app_current_page")||"finance",I=localStorage.getItem("life-dashboard/app_current_sub_page")||null;I==="null"&&(I=null);async function Xe(){window.addEventListener("open-add-modal",e=>{var s,n;const t=(s=e.detail)==null?void 0:s.type;t==="person"?ct((n=e.detail)==null?void 0:n.person):ge(t)}),U.init().catch(e=>console.warn("[Drive] Pre-init failed:",e)),window.addEventListener("nav-change",e=>{var s;const t=(s=e.detail)==null?void 0:s.page;if(t){P=t,I=null,localStorage.setItem("life-dashboard/app_current_page",P),_();const n=document.getElementById("bottom-nav");n&&(n.innerHTML=Ie(P))}});const a=S.getVaultKey();a?await p.loadEncrypted(a)?dt():(console.error("[Boot] Decryption failed, invalid vault key in session?"),S.logout(),Je()):Je()}function Je(){const a=document.getElementById("app");a.innerHTML=us(),ps(()=>{dt()})}function dt(){const a=document.getElementById("app");a.innerHTML=`
        <main id="main-content"></main>
        <nav id="bottom-nav"></nav>
    `,ut(),p.subscribe(()=>{_()}),window.reRender=()=>_(),ms()}function ms(){var s,n;const a=localStorage.getItem("life-dashboard/pwa_install_dismissed");if(a&&(Date.now()-parseInt(a))/864e5<7||window.matchMedia("(display-mode: standalone)").matches)return;const e=document.createElement("div");e.className="pwa-install-banner",e.id="pwa-install-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(e);const t=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};t(),window.addEventListener("beforeinstallprompt",t),(s=document.getElementById("pwa-banner-install"))==null||s.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:i}=await window.deferredPrompt.userChoice;i==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(n=document.getElementById("pwa-banner-close"))==null||n.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function ut(){const a=document.getElementById("bottom-nav");a.innerHTML=Ie(P),_e(e=>{P=e,I=null,localStorage.setItem("life-dashboard/app_current_page",P),localStorage.setItem("life-dashboard/app_current_sub_page",I),O(),_(),a.innerHTML=Ie(P),_e(t=>{P=t,I=null,localStorage.setItem("life-dashboard/app_current_page",P),localStorage.setItem("life-dashboard/app_current_sub_page",I),O(),_(),ut()})}),vs(),_()}function _(){const a=document.getElementById("main-content");if(!a)return;const e=a.scrollTop;if(I==="compound"){a.innerHTML=Wt(),Xt(()=>{I=null,Jt(),O(),_()}),a.scrollTop=e;return}if(I==="expenses"){a.innerHTML=Ea(),Ia(()=>{I=null,O(),_()}),a.scrollTop=e;return}if(I==="market"){a.innerHTML=Zt(),ea(()=>{I=null,O(),_()}),a.scrollTop=e;return}switch(a.classList.toggle("no-padding-mobile",P==="health"),P){case"finance":O(),a.innerHTML=Ue(),Oe(),Ze();break;case"goals":N(),a.innerHTML=Ge(),Fe();break;case"time-invest":N(),a.innerHTML=Ha(),Xa();break;case"social":N(),a.innerHTML=Ba(),Pa();break;case"health":a.innerHTML=ta(),ra(),N();break;case"menu":a.innerHTML=Da(),Ma(t=>{P=t,O(),_()}),N();break;case"calendar":a.innerHTML=ha(),ka(),O();break;case"goals":N(),a.innerHTML=Ge(),Fe();break;case"skills":a.innerHTML=Za(),ts(),O();break;case"settings":a.innerHTML=Ca(),Ta(),N();break;default:O(),a.innerHTML=Ue(),Oe(),Ze()}requestAnimationFrame(()=>{a.scrollTop=e})}function Ze(){const a=document.getElementById("open-compound");a&&a.addEventListener("click",()=>{I="compound",localStorage.setItem("life-dashboard/app_current_sub_page",I),N(),_()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{I="market",localStorage.setItem("life-dashboard/app_current_sub_page",I),N(),_()});const t=document.getElementById("open-expenses");t&&t.addEventListener("click",()=>{I="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",I),N(),_()})}function vs(){const a=document.querySelector(".fab");a&&a.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=m("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{const t=localStorage.getItem("life-dashboard/app_current_page")||P;if(t==="calendar")ge("event");else if(t==="health"){const s=await ns.confirm("Log Metric","What do you want to record today?","Weight","Body Fat");if(s===!0){const n=await ns.prompt("Log Weight","Enter your current weight in kg:","","number");n&&p.addWeightLog(n)}else if(s===!1){const n=await ns.prompt("Body Fat","Enter your body fat %:","","number");n&&p.addFatLog(n)}}else t==="social"?ct():t==="skills"?as():t==="finance"||t==="goals"||!t?ge("passiveAsset",["event"]):ge()}),document.body.appendChild(e)}function N(){const a=document.getElementById("main-fab");a&&(a.style.display="none")}function O(){const a=document.getElementById("main-fab");a&&(a.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Xe):Xe();window.addEventListener("beforeinstallprompt",a=>{a.preventDefault(),window.deferredPrompt=a,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});export{m as g,v as n,p as s};
