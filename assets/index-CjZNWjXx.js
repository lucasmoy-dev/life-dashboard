var Ce=Object.defineProperty;var Le=(s,e,a)=>e in s?Ce(s,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[e]=a;var J=(s,e,a)=>Le(s,typeof e!="symbol"?e+"":e,a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}})();const Te="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",Re="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function Be(){var e,a,t,n,i,o,r,l,u,c,d,m,h,f,E;const s={EUR:1};try{const w=await(await fetch(Te)).json();s.BTC=((e=w.bitcoin)==null?void 0:e.eur)||4e4,s.ETH=((a=w.ethereum)==null?void 0:a.eur)||2200,s.XRP=((t=w.ripple)==null?void 0:t.eur)||.5,s.KAS=((n=w.kaspa)==null?void 0:n.eur)||.1,s.SOL=((i=w.solana)==null?void 0:i.eur)||90,s.XLM=((o=w.stellar)==null?void 0:o.eur)||.11,s.ALGO=((r=w.algorand)==null?void 0:r.eur)||.18,s.LTC=((l=w.litecoin)==null?void 0:l.eur)||65,s.SUI=((u=w.sui)==null?void 0:u.eur)||1.1,s.LINK=((c=w.chainlink)==null?void 0:c.eur)||14,s.RNDR=((d=w["render-token"])==null?void 0:d.eur)||4.5,s.ADA=((m=w.cardano)==null?void 0:m.eur)||.45,s.ONDO=((h=w["ondo-finance"])==null?void 0:h.eur)||.7,(f=w.bitcoin)!=null&&f.ars&&((E=w.bitcoin)!=null&&E.eur)&&(s.ARS=w.bitcoin.eur/w.bitcoin.ars);const C=await fetch(Re);if(C.ok){const L=await C.json();s.USD=1/L.rates.USD,s.CHF=1/L.rates.CHF,s.GBP=1/L.rates.GBP,s.AUD=1/L.rates.AUD}s.GOLD=2100,s.SP500=4700}catch(k){console.error("Failed to fetch some prices:",k),s.USD=s.USD||.92,s.CHF=s.CHF||1.05,s.GBP=s.GBP||1.15,s.AUD=s.AUD||.6,s.ARS=s.ARS||.001}return s}class P{static async hash(e,a="salt_life_dashboard_2026"){const n=new TextEncoder().encode(e+a),i=await crypto.subtle.digest("SHA-512",n);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,a){const t=new TextEncoder,n=await crypto.subtle.importKey("raw",t.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode(a),iterations:25e4,hash:"SHA-512"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,a){try{const t=crypto.getRandomValues(new Uint8Array(16)),n=crypto.getRandomValues(new Uint8Array(12)),i=await this.deriveKey(a,this.bufToBase64(t)),o=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(o),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},i,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(n),salt:this.bufToBase64(t),v:"5.0"}}catch(t){throw console.error("[Security] Encryption failed:",t),new Error("No se pudo encriptar la información")}}static async decrypt(e,a){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:t,iv:n,salt:i}=e,o=await this.deriveKey(a,i),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(n)},o,this.base64ToBuf(t)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(t){throw console.error("[Security] Decryption failed:",t),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(a=>a.charCodeAt(0)))}}const ne=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:P},Symbol.toStringTag,{value:"Module"})),A={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class x{static isSetup(){return!!localStorage.getItem(A.MASTER_HASH)}static async setup(e){const a=await P.hash(e),t=await P.deriveVaultKey(e);return localStorage.setItem(A.MASTER_HASH,a),sessionStorage.setItem(A.VAULT_KEY,t),t}static async unlock(e){const a=await P.hash(e),t=localStorage.getItem(A.MASTER_HASH);if(a===t){const n=await P.deriveVaultKey(e);return sessionStorage.setItem(A.VAULT_KEY,n),n}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const a=sessionStorage.getItem(A.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const t=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:t,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(A.BIO_ENABLED,"true"),localStorage.setItem(A.VAULT_KEY,a),!0}catch(t){throw console.error("Biometric setup failed:",t),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(A.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const a=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:a,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const t=localStorage.getItem(A.VAULT_KEY);if(t)return sessionStorage.setItem(A.VAULT_KEY,t),t;throw new Error("Llave no encontrada. Usa contraseña.")}catch(a){throw console.error("Biometric auth failed:",a),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(A.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(A.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(A.BIO_ENABLED)==="true"}}const De="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",Pe="https://www.googleapis.com/auth/drive.file";class T{static hasToken(){return!!this.accessToken&&localStorage.getItem("life-dashboard/drive_connected")==="true"}static async init(){return new Promise((e,a)=>{const t=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.tokenClient=google.accounts.oauth2.initTokenClient({client_id:De,scope:Pe,callback:n=>{if(n.error){console.error("[Drive] Auth callback error:",n);return}this.saveSession(n)}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&(console.log("[Drive] Attempting silent token restoration..."),this.tokenClient.requestAccessToken({prompt:"none"})),e(!0)}catch(n){console.error("[Drive] Init error:",n),a(n)}}):setTimeout(t,200)};t()})}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const a=Date.now()+(e.expires_in?e.expires_in*1e3:36e5);localStorage.setItem("life-dashboard/drive_token_expiry",a.toString())}static async authenticate(e=!1){return this.tokenClient||await this.init(),new Promise((a,t)=>{this.tokenClient.callback=n=>{if(n.error){e?(localStorage.setItem("life-dashboard/drive_connected","false"),t(new Error("Silent auth failed"))):t(new Error(n.error_description||"Fallo en la autenticación"));return}this.saveSession(n),a(n.access_token)},e?this.tokenClient.requestAccessToken({prompt:"none"}):this.tokenClient.requestAccessToken({prompt:"consent"})})}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(localStorage.getItem("life-dashboard/drive_connected")==="true"&&Date.now()>e-3e5){console.log("[Drive] Token expired or near expiry, refreshing...");try{return await this.authenticate(!0),this.accessToken}catch{throw console.warn("[Drive] Silent refresh failed, manual re-connect may be needed"),this.accessToken=null,new Error("Sesión de Drive expirada. Por favor reconecta en Configuración.")}}return this.accessToken}static async getOrCreateFolderPath(e){var n;await this.ensureValidToken(),(n=gapi.client)!=null&&n.drive||await this.init();const a=e.split("/").filter(i=>i);let t="root";for(const i of a)try{const o=`name = '${i}' and mimeType = 'application/vnd.google-apps.folder' and '${t}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)"})).result.files;if(l&&l.length>0)t=l[0].id;else{const u={name:i,mimeType:"application/vnd.google-apps.folder",parents:[t]};t=(await gapi.client.drive.files.create({resource:u,fields:"id"})).result.id}}catch(o){throw o.status===401?(this.accessToken=null,new Error("Sesión de Google expirada. Por favor reconecta.")):o}return t}static async pushData(e,a){var t,n,i;try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");(t=gapi.client)!=null&&t.drive||await this.init(),gapi.client.setToken({access_token:this.accessToken}),console.log("[Drive] Pushing full encrypted data...");const o=await this.getOrCreateFolderPath("/backup/life-dashboard/"),r=await P.encrypt(e,a),l="dashboard_vault_v5.bin",u=`name = '${l}' and '${o}' in parents and trashed = false`,d=(await gapi.client.drive.files.list({q:u,fields:"files(id)"})).result.files,m=new Blob([JSON.stringify(r)],{type:"application/json"});if(d&&d.length>0){const h=d[0].id,f=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${h}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:m});if(!f.ok)throw new Error(`Error al actualizar backup: ${f.status}`)}else{const h={name:l,parents:[o]},f=new FormData;f.append("metadata",new Blob([JSON.stringify(h)],{type:"application/json"})),f.append("file",m);const E=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:f});if(!E.ok)throw new Error(`Error al crear backup: ${E.status}`)}return!0}catch(o){throw console.error("[Drive] Push failed:",o),new Error(((i=(n=o.result)==null?void 0:n.error)==null?void 0:i.message)||o.message||"Fallo al subir datos a Drive")}}static async pullData(e){var a,t,n;try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");(a=gapi.client)!=null&&a.drive||await this.init(),gapi.client.setToken({access_token:this.accessToken}),console.log("[Drive] Pulling data...");const r=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,u=(await gapi.client.drive.files.list({q:r,fields:"files(id, name)"})).result.files;if(!u||u.length===0)return null;const c=u[0].id,d=await fetch(`https://www.googleapis.com/drive/v3/files/${c}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(!d.ok)throw new Error(`Error al descargar backup: ${d.status}`);const m=await d.json();return await P.decrypt(m,e)}catch(i){throw console.error("[Drive] Pull failed:",i),new Error(((n=(t=i.result)==null?void 0:t.error)==null?void 0:n.message)||i.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){var e,a,t;try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");(e=gapi.client)!=null&&e.drive||await this.init(),gapi.client.setToken({access_token:this.accessToken});const o=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:o,fields:"files(id)"})).result.files;if(l&&l.length>0){const u=l[0].id;return await gapi.client.drive.files.delete({fileId:u}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(n){throw console.error("[Drive] Deletion failed:",n),new Error(((t=(a=n.result)==null?void 0:a.error)==null?void 0:t.message)||n.message||"Fallo al borrar backup en Drive")}}}J(T,"tokenClient",null),J(T,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null);const ie={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',chevronUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>',chevronDown:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>'};function g(s,e=""){return(ie[s]||ie.package).replace("<svg",`<svg class="${e}"`)}class Me{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,a="success",t=3e3){const n=document.createElement("div");n.className=`toast toast-${a} stagger-in`;const i=a==="success"?"check":a==="error"?"alertCircle":"info";n.innerHTML=`
        ...
        `,this.toastContainer.appendChild(n),setTimeout(()=>{n.classList.add("fade-out"),setTimeout(()=>n.remove(),500)},t)}alert(e,a){return new Promise(t=>{this._showModal({title:e,message:a,centered:!0,buttons:[{text:"Entendido",type:"primary",onClick:()=>t(!0)}]})})}confirm(e,a,t="Confirmar",n="Cancelar"){return new Promise(i=>{this._showModal({title:e,message:a,centered:!0,buttons:[{text:n,type:"secondary",onClick:()=>i(!1)},{text:t,type:"danger",onClick:()=>i(!0)}]})})}prompt(e,a,t="",n="text"){return new Promise(i=>{const o=`prompt-input-${Date.now()}`;this._showModal({title:e,message:a,centered:!0,content:`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>i(null)}]});const r=document.querySelector(".modal-overlay.active");r&&r.querySelectorAll(".select-option-btn").forEach(l=>{l.addEventListener("click",()=>{i(l.dataset.value),this._closeModal(r)})})})}hardConfirm(e,a,t="BORRAR"){return new Promise(n=>{const i=`hard-confirm-input-${Date.now()}`,o=`hard-confirm-btn-${Date.now()}`;this._showModal({title:e,message:`<div style="color: var(--accent-danger); font-weight: 600; margin-bottom: 8px;">ACCIÓN IRREVERSIBLE</div>${a}<br><br>Escribe <strong>${t}</strong> para confirmar:`,centered:!0,content:`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>n(!1)},{text:"Borrar Todo",type:"danger",id:o,disabled:!0,onClick:()=>n(!0)}]});const r=document.getElementById(i),l=document.getElementById(o);r.addEventListener("input",()=>{const u=r.value.trim().toUpperCase()===t.toUpperCase();l.disabled=!u,l.style.opacity=u?"1":"0.3",l.style.pointerEvents=u?"auto":"none"})})}stars(e,a){return new Promise(t=>{let n=5;this._showModal({title:e,message:a,centered:!0,content:`
                    <div class="star-rating-container" style="display: flex; justify-content: center; gap: 12px; margin-top: 20px; font-size: 32px;">
                        ${[1,2,3,4,5].map(o=>`
                            <span class="star-btn" data-value="${o}" style="cursor: pointer; color: ${o<=5?"var(--accent-tertiary)":"var(--text-muted)"}; transition: transform 0.2s ease;">★</span>
                        `).join("")}
                    </div>
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>t(null)},{text:"Guardar Calificación",type:"primary",onClick:()=>t(n)}]});const i=document.querySelector(".modal-overlay.active");if(i){const o=i.querySelectorAll(".star-btn");o.forEach(r=>{r.addEventListener("click",()=>{n=parseInt(r.dataset.value),o.forEach((l,u)=>{l.style.color=u<n?"var(--accent-tertiary)":"var(--text-muted)",l.style.transform=u<n?"scale(1.2)":"scale(1)"})})})}})}_showModal({title:e,message:a,content:t="",buttons:n=[],centered:i=!1}){const o=document.createElement("div");o.className=`modal-overlay ${i?"overlay-centered":""}`,o.style.zIndex="9999";const r=`modal-${Date.now()}-${Math.floor(Math.random()*1e3)}`;o.id=r;const l=`
      ...
      <div class="form-row">
          <div class="form-group" style="flex: 1.5;">
              ...
              <select class="form-input form-select" id="edit-type">
                  ${t.map(i=>`<option value="${i.value}" ${i.value===s.type?"selected":""}>${i.label}</option>`).join("")}
              </select>
          </div>
          <div class="form-group" style="flex: 1;">
              ...
              <select class="form-input form-select" id="edit-currency">
                  <optgroup label="Divisas">
                      ${Ge.map(i=>`<option value="${i.value}" ${i.value===s.currency?"selected":""}>${i.label}</option>`).join("")}
                  </optgroup>
                  ${a?`
                  <optgroup label="Mercados Reales">
                      ${_.map(i=>`<option value="${i.symbol}" ${i.symbol===s.currency?"selected":""}>${i.name} (${i.symbol})</option>`).join("")}
                  </optgroup>
                  `:""}
              </select>
          </div>
  ...
  `}function Ke(s){const e=document.getElementById("edit-modal"),a=document.getElementById("edit-modal-close"),t=document.getElementById("btn-update"),n=document.getElementById("btn-delete");e.addEventListener("click",i=>{i.target===e&&X()}),a.addEventListener("click",X),t.addEventListener("click",()=>qe(s)),n.addEventListener("click",()=>ze(s))}function qe(s){var u,c,d,m,h,f,E,k,w;const e=(c=(u=document.getElementById("edit-name"))==null?void 0:u.value)==null?void 0:c.trim(),a=(d=document.getElementById("edit-type"))==null?void 0:d.value,t=(m=document.getElementById("edit-currency"))==null?void 0:m.value,n=(f=(h=document.getElementById("edit-details"))==null?void 0:h.value)==null?void 0:f.trim(),i=parseFloat((E=document.getElementById("edit-value"))==null?void 0:E.value)||0,o=parseFloat((k=document.getElementById("edit-amount"))==null?void 0:k.value)||0,r=parseFloat((w=document.getElementById("edit-monthly"))==null?void 0:w.value)||0;if(!e){v.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:a,currency:t,details:n};s.fields.includes("value")&&(l.value=i),s.fields.includes("amount")&&(l.amount=o),s.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),s.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),p[s.updateMethod](z.id,l),X()}function ze(s){v.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${z.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(p[s.deleteMethod](z.id),v.toast("Eliminado correctamente","info"),X())})}function X(){const s=document.getElementById("edit-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300)),z=null,j=null}function de(){const s=p.getState(),e=s.currencySymbol,a=p.getPassiveIncome(),t=p.getLivingExpenses(),n=p.getNetPassiveIncome(),i=p.getInvestmentAssetsValue(),o=p.getTotalLiabilities(),r=p.getNetWorth(),l=p.getAllIncomes(),u=p.getAllExpenses(),c=p.getNetIncome();return`
  ...
  `}function Ye(s){const e=[...s.passiveAssets,...s.investmentAssets],a=s.liabilities;if(e.length===0)return"";const t={Bitcoin:{value:0,color:"#f59e0b"},Altcoins:{value:0,color:"#6366f1"},Inmuebles:{value:0,color:"#a855f7"},Bolsa:{value:0,color:"#00d4aa"},Oro:{value:0,color:"#fbbf24"},"Otros/Efe.":{value:0,color:"#94a3b8"}};e.forEach(c=>{const d=p.convertValue(c.value||0,c.currency||"EUR");c.currency==="BTC"?t.Bitcoin.value+=d:c.currency==="ETH"||c.currency==="XRP"||c.type==="crypto"?t.Altcoins.value+=d:c.type==="property"||c.type==="rental"?t.Inmuebles.value+=d:c.type==="stocks"||c.type==="etf"||c.currency==="SP500"?t.Bolsa.value+=d:c.currency==="GOLD"?t.Oro.value+=d:t["Otros/Efe."].value+=d});const n=a.filter(c=>c.type==="mortgage").reduce((c,d)=>c+p.convertValue(d.amount||0,d.currency||"EUR"),0);t.Inmuebles.value=Math.max(0,t.Inmuebles.value-n),s.hideRealEstate&&(t.Inmuebles.value=0);const i=Object.entries(t).filter(([c,d])=>d.value>0).sort((c,d)=>d[1].value-c[1].value),o=i.reduce((c,[d,m])=>c+m.value,0);if(o===0)return`
    ...
    `;let r=0;const l=i.map(([c,d])=>{const m=d.value/o*100,h=r;return r+=m,{name:c,percentage:m,color:d.color,start:h}}),u=l.map(c=>`${c.color} ${c.start}% ${c.start+c.percentage}%`).join(", ");return`
  ...
  `}function We(s){const e=[...s.passiveAssets.map(t=>({...t,category:"passive"})),...s.investmentAssets.map(t=>({...t,category:"investment"})),...s.liabilities.map(t=>({...t,category:"liability"}))];if(e.length===0)return`
    ...
    <div class="asset-list">
      ${e.map(t=>{const n=Xe(t.currency||t.type),i=Je(t.currency||t.type),o=t.category==="liability",r=t.value||t.amount||0,l=p.convertValue(r,t.currency||"EUR");let u="";if(t.currency!==s.currency){const d={EUR:"€",USD:"$",BTC:"₿",ETH:"Ξ",XRP:"✕",GOLD:"oz",SP500:"pts",CHF:"Fr",GBP:"£",AUD:"A$",ARS:"$"}[t.currency]||t.currency;u=`<div class="asset-original-value">${r} ${d}</div>`}return`
          <div class="asset-item" data-id="${t.id}" data-category="${t.category}">
            ...
            <div>
              ...
              ${t.monthlyIncome?`<div class="asset-yield">+${b(p.convertValue(t.monthlyIncome,t.currency),a)}/mes</div>`:""}
              ${t.monthlyPayment?`<div class="asset-yield text-negative">-${b(p.convertValue(t.monthlyPayment,t.currency),a)}/mes</div>`:""}
            </div>
          </div>
        `}).join("")}
    </div>
  `}function Xe(s){return{property:"property",rental:"property",stocks:"stocks",etf:"stocks",SP500:"stocks",crypto:"crypto",BTC:"crypto",ETH:"crypto",XRP:"crypto",GOLD:"investment",cash:"cash",USD:"cash",EUR:"cash",savings:"cash",vehicle:"vehicle",debt:"debt",loan:"debt",mortgage:"debt",creditcard:"debt"}[s]||"cash"}function Je(s){return{property:"building",rental:"building",stocks:"trendingUp",etf:"trendingUp",SP500:"trendingUp",crypto:"bitcoin",BTC:"bitcoin",ETH:"bitcoin",XRP:"bitcoin",GOLD:"package",cash:"dollarSign",USD:"dollarSign",EUR:"dollarSign",savings:"piggyBank",vehicle:"car",debt:"creditCard",loan:"landmark",mortgage:"home",creditcard:"creditCard"}[s]||"dollarSign"}function ue(){document.querySelectorAll(".asset-item").forEach(t=>{t.addEventListener("click",()=>{const n=t.dataset.id,i=t.dataset.category;Ee(n,i)})});const e=document.getElementById("toggle-real-estate");e&&e.addEventListener("change",()=>{p.toggleRealEstate()});const a=document.getElementById("display-currency-select");a&&a.addEventListener("change",t=>{p.setCurrency(t.target.value)})}let M=10,U=7,O=null,N=null;function Ze(){const e=p.getState().currencySymbol,a=p.getNetWorth(),n=p.getNetIncome()*12,i=O!==null?O:a,o=N!==null?N:n,r=ke(i,o,U,M);return`
      ...
      <div class="card">
        ...
        <div class="compound-input-group">
          ...
          <div class="slider-container">
            <input type="range" class="compound-slider" id="rate-slider" min="1" max="20" value="${U}" step="0.5">
            <span class="slider-value" id="rate-value">${U}%</span>
          </div>
        </div>
  ...
  `}function Se(s,e){const a=[];for(let t=0;t<s.length;t++){const n=s[t];(t<5||(t+1)%5===0||t===s.length-1)&&a.push(n)}return`
  ...
  `}function Qe(s){const e=document.getElementById("back-to-finance"),a=document.getElementById("rate-slider"),t=document.getElementById("years-slider"),n=document.getElementById("principal-input"),i=document.getElementById("contribution-input"),o=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",s),n&&n.addEventListener("input",l=>{O=parseFloat(l.target.value)||0,F()}),i&&i.addEventListener("input",l=>{N=parseFloat(l.target.value)||0,F()}),o&&o.addEventListener("click",()=>{O=null;const l=p.getNetWorth();n.value=l,F()}),r&&r.addEventListener("click",()=>{N=null;const l=p.getNetIncome()*12;i.value=l,F()}),a&&a.addEventListener("input",l=>{U=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${U}%`,F()}),t&&t.addEventListener("input",l=>{M=parseInt(l.target.value),document.getElementById("years-value").textContent=`${M} años`,F()})}function F(){const e=p.getState().currencySymbol,a=O!==null?O:p.getNetWorth(),t=N!==null?N:p.getNetIncome()*12,n=ke(a,t,U,M),i=document.getElementById("future-value"),o=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),u=document.getElementById("total-contributed"),c=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),m=document.getElementById("projection-chart"),h=document.getElementById("projection-table");i&&(i.textContent=b(n.finalValue,e)),o&&(o.textContent=`Valor Futuro en ${M} años`),r&&(r.innerHTML=`${n.totalGrowth>=0?"📈":"📉"} ${n.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=b(a,e)),u&&(u.textContent=b(n.totalContributions,e),u.className=`stat-value ${n.totalContributions>=0?"positive":"negative"}`),c&&(c.textContent=b(n.totalInterest,e)),d&&(d.textContent=b(n.finalValue,e)),m&&(m.innerHTML=xe(n.yearlyBreakdown)),h&&(h.innerHTML=Se(n.yearlyBreakdown,e))}function et(){M=10,U=7,O=null,N=null}let Y=p.getState().lastMarketData||[],K=Y.length===0,S={key:"price",direction:"desc"};function tt(){const s=p.getState(),e=s.currency||"EUR",a=s.currencySymbol||"€";if(Y.length===0){if(K)return ee(),`
            ...
            `}else K||ee();const t=Object.values(y);return`
        <div class="market-page stagger-children" style="padding-bottom: 80px;">
            ...
            ${t.map(n=>{const i=Y.filter(o=>o.category===n);return i.length===0?"":at(n,i,a)}).join("")}
        </div>
    `}function at(s,e,a){const t=[...e].sort((n,i)=>{let o=n[S.key],r=i[S.key];return typeof o=="string"&&(o=o.toLowerCase()),typeof r=="string"&&(r=r.toLowerCase()),o<r?S.direction==="asc"?-1:1:o>r?S.direction==="asc"?1:-1:0});return`
    ...
    <div class="health-page stagger-children" style="padding-bottom: 80px;">
          ...
          <div class="card routine-card">
            <div class="routine-header">
                <div class="routine-info">
                    <div class="routine-name clickable rename-routine" data-id="${a.id}" data-current="${a.name}">${a.name}</div>
                    <div class="routine-meta">
                        ${a.exercises.length} ejercicios
                        <div class="routine-reorder-btns">
                            <button class="reorder-routine-btn" data-index="${t}" data-dir="up" title="Subir">${g("chevronUp")}</button>
                            <button class="reorder-routine-btn" data-index="${t}" data-dir="down" title="Bajar">${g("chevronDown")}</button>
                        </div>
                    </div>
                </div>
                <div style="display: flex; gap: 4px;">
                    <button class="icon-btn add-exercise-btn" data-id="${a.id}" title="Agregar ejercicio">
                        ${g("plus")}
                    </button>
                    <button class="icon-btn delete-routine" data-id="${a.id}" style="color: var(--accent-danger);" title="Eliminar rutina">
                        ${g("trash")}
                    </button>
                </div>
            </div>
            <div class="exercise-list">
                ${a.exercises.map((n,i)=>{const o=p.getExerciseStatus(a.id,i);let r="var(--text-muted)";o.color==="red"&&(r="var(--accent-danger)"),o.color==="orange"&&(r="var(--accent-warning)"),o.color==="green"&&(r="var(--accent-success)");const l=o.status==="done_today";let u="";return l&&o.lastLog&&(u=`<span style="font-size: 10px; color: var(--accent-tertiary);">★ ${o.lastLog.rating}</span>`),`
                    <div class="exercise-item-health ${l?"exercise-done":""}">
                        <div class="ex-health-main">
                            ...
                            <div class="ex-health-info">
                                <div class="ex-health-name-row">
                                    <span class="ex-health-name clickable rename-exercise" data-routine="${a.id}" data-index="${i}" data-current="${n.name}">${n.name}</span>
                                    <div class="ex-reorder-btns">
                                        <button class="reorder-ex-btn" data-routine="${a.id}" data-index="${i}" data-dir="up">${g("chevronUp")}</button>
                                        <button class="reorder-ex-btn" data-routine="${a.id}" data-index="${i}" data-dir="down">${g("chevronDown")}</button>
                                    </div>
                                </div>
                                <div class="ex-health-stats">
                                    <span class="ex-clickable-val update-weight" data-routine="${a.id}" data-index="${i}">${n.weight||50}kg</span>
                                    <span style="opacity: 0.3;">•</span>
                                    <span class="ex-clickable-val update-reps" data-routine="${a.id}" data-index="${i}">${n.reps||10} reps</span>
                                    <span style="opacity: 0.3;">•</span>
                                    <span style="font-size: 11px; font-weight: 500;">4 series</span>
                                    ${u?`<span style="opacity: 0.3;">•</span> ${u}`:""}
                                </div>
                            </div>
                        </div>
                        <div class="ex-health-actions">
                            ...
                            `:`
                                <button class="delete-exercise-btn" data-routine="${a.id}" data-index="${i}" title="Eliminar ejercicio">
                                    ${g("x")}
                                </button>
      ...
      <div class="summary-grid" style="margin-bottom: var(--spacing-2xl);">
        ...
        <div class="summary-item card">
          <div class="summary-value">${me(e)}</div>
      ...
      <div class="health-top-layout">
        ...
        <div class="card health-goal-card">
          ...
          <div class="goal-stats" style="margin-top: var(--spacing-md); border-top: 1px solid rgba(255,255,255,0.05); padding-top: var(--spacing-sm);">
              <div class="goal-stat">
                  ...
                  <span class="goal-value" style="color: var(--accent-primary); font-weight: 700;">${rt(e)} kg</span>
              </div>
          </div>
        </div>
        ...
        <div class="card ai-calorie-card">
          ...
          <div class="calorie-brief" style="text-align: center; font-size: 13px; color: var(--text-muted);">
              Consumo de hoy: <span style="color: var(--text-primary); font-weight: 600;">${me(e)} kcal</span>
          </div>
        </div>
      </div>
    </div>
  `}function it(s){const e=s.weightLogs;return e.length<2?'<div class="empty-chart-msg">Registra al menos 2 pesos para ver el gráfico.</div>':`
        <div class="simple-chart-placeholder">
            <svg viewBox="0 0 100 40" class="burndown-line" preserveAspectRatio="none">
                ...
                <path d="${ot(e,s.weightGoal)}" fill="none" stroke="var(--accent-primary)" stroke-width="2" vector-effect="non-scaling-stroke" />
            </svg>
        </div>
    `}function ot(s,e){if(s.length<2)return"";const a=s.map(c=>c.weight),t=Math.min(...a,e)-1,i=Math.max(...a,e)+1-t,o=s[0].date,l=s[s.length-1].date-o||1;return`M${s.map((c,d)=>{const m=d===0?0:(c.date-o)/l*100,h=40-(c.weight-t)/i*40;return`${m},${h}`}).join(" L")}`}function rt(s){if(s.weightLogs.length===0)return"--";const a=s.weightLogs[s.weightLogs.length-1].weight-s.weightGoal;return a>0?a.toFixed(1):"¡Logrado!"}function me(s){const e=new Date().setHours(0,0,0,0);return s.calorieLogs.filter(a=>new Date(a.date).setHours(0,0,0,0)===e).reduce((a,t)=>a+t.calories,0)}function lt(){var e,a,t,n;(e=document.getElementById("log-weight-btn"))==null||e.addEventListener("click",async()=>{const i=await v.prompt("Registrar Peso","Ingresa tu peso actual en kg:","Ej: 75.5","number");i&&!isNaN(i)&&(p.addWeightLog(i),v.toast("Peso registrado"))}),(a=document.getElementById("log-fat-btn"))==null||a.addEventListener("click",async()=>{const i=await v.prompt("Grasa Corporal","Ingresa tu % de grasa (deja en blanco si no lo sabes):","Ej: 18.2","number");if(i!==null){const o=parseFloat(i);isNaN(o)||(p.addFatLog(o),v.toast("Grasa registrada"))}}),document.querySelectorAll(".rename-routine").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.id,r=i.dataset.current,l=await v.prompt("Renombrar Rutina","Nuevo nombre:",r);l&&l!==r&&(p.renameRoutine(o,l),v.toast("Rutina renombrada"))})}),document.querySelectorAll(".add-exercise-btn").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.id,r=await v.prompt("Agregar Ejercicio","Nombre del ejercicio:","Ej: Press Militar");r&&(p.addExerciseToRoutine(o,{name:r}),v.toast("Ejercicio añadido"))})}),document.querySelectorAll(".delete-routine").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.id;await v.confirm("Borrar Rutina","¿Estás seguro de eliminar esta rutina?","BORRAR","CANCELAR")&&(p.deleteRoutine(o),v.toast("Rutina eliminada"))})}),document.querySelectorAll(".rename-exercise").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.routine,r=parseInt(i.dataset.index),l=i.dataset.current,u=await v.prompt("Renombrar Ejercicio","Nuevo nombre:",l);u&&u!==l&&(p.updateExercise(o,r,{name:u}),v.toast("Ejercicio renombrado"))})}),document.querySelectorAll(".delete-exercise-btn").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.routine,r=parseInt(i.dataset.index);await v.confirm("Eliminar Ejercicio","¿Quitar este ejercicio de la rutina?","Eliminar","Cancelar")&&(p.deleteExerciseFromRoutine(o,r),v.toast("Ejercicio eliminado"))})}),document.querySelectorAll(".reorder-routine-btn").forEach(i=>{i.addEventListener("click",o=>{o.stopPropagation();const r=parseInt(i.dataset.index),l=i.dataset.dir;p.reorderRoutine(r,l)})}),document.querySelectorAll(".reorder-ex-btn").forEach(i=>{i.addEventListener("click",o=>{o.stopPropagation();const r=i.dataset.routine,l=parseInt(i.dataset.index),u=i.dataset.dir;p.reorderExercise(r,l,u)})}),document.querySelectorAll(".update-weight").forEach(i=>{i.addEventListener("click",async o=>{o.stopPropagation();const r=i.dataset.routine,l=parseInt(i.dataset.index),u=[];for(let d=10;d<=150;d+=2.5)u.push(`${d}kg`);const c=await v.select("Seleccionar Peso","Elige el peso para este ejercicio:",u,4);if(c){const d=parseFloat(c.replace("kg",""));p.updateExercise(r,l,{weight:d}),v.toast("Peso actualizado")}})}),document.querySelectorAll(".update-reps").forEach(i=>{i.addEventListener("click",async o=>{o.stopPropagation();const r=i.dataset.routine,l=parseInt(i.dataset.index),u=[];for(let d=7;d<=20;d++)u.push(`${d} reps`);const c=await v.select("Seleccionar Reps","Elige las repeticiones objetivo:",u,4);if(c){const d=parseInt(c.replace(" reps",""));p.updateExercise(r,l,{reps:d}),v.toast("Reps actualizadas")}})}),document.querySelectorAll(".trigger-exercise-log").forEach(i=>{i.addEventListener("click",async o=>{o.stopPropagation();const r=i.dataset.routine,l=parseInt(i.dataset.index),u=i.dataset.name,c=await v.stars("Monitor de Gym",`¿Cómo fue tu desempeño en "${u}"?`);c&&(p.logExercise(r,l,c),v.toast("¡Entrenamiento guardado!","success"))})}),(t=document.getElementById("ai-scan-photo"))==null||t.addEventListener("click",()=>{const i=document.createElement("input");i.type="file",i.accept="image/*",i.onchange=async r=>{var u;const l=r.target.files[0];if(l){if(!pe.hasKey()){if(await v.confirm("IA no configurada","Añade tu Gemini API Key en Ajustes.","Configurar","Simulación")){(u=document.querySelector('[data-nav="settings"]'))==null||u.click();return}v.toast("Usando simulación...","info"),o();return}try{v.toast("Analizando con Gemini...","info");const c=await pe.analyzeFood(l);await v.confirm("IA Detectada",`Identificado: "${c.name}" (${c.calories} kcal). ¿Registrar?`)&&(p.addCalorieLog(c.calories,`${c.name} (AI)`),v.toast("Calorías registradas"))}catch(c){v.alert("Error IA",c.message)}}};function o(){setTimeout(async()=>{const r={name:"Bowl Saludable",cals:450};await v.confirm("IA Simulada",`Detectado "${r.name}" con ${r.cals} kcal. ¿Registrar?`)&&(p.addCalorieLog(r.cals,r.name),v.toast("Registrado"))},1e3)}i.click()}),(n=document.getElementById("add-routine-btn"))==null||n.addEventListener("click",async()=>{const i=await v.prompt("Nueva Rutina","Nombre (ej: Pecho y Triceps):","Día X");i&&(p.saveRoutine({name:i,exercises:[]}),v.toast("Rutina creada"))})}function ct(){const s=p.getState(),{goals:e}=s;return`
    <div class="goals-page stagger-children" style="padding-bottom: 80px;">
      ...
      <div class="goals-grid-layout">
        ${[{id:"day",label:"Hoy",icon:"zap",color:"#FFD700"},{id:"week",label:"Semana",icon:"calendar",color:"#00D4AA"},{id:"year",label:"Año 2026",icon:"target",color:"#7C3AED"},{id:"long",label:"Visión",icon:"trendingUp",color:"#EF4444"}].map(t=>{const n=e.filter(l=>l.timeframe===t.id),i=n.filter(l=>l.completed).length,o=n.length,r=o>0?i/o*100:0;return`
            ...
            <div class="goals-column-header-premium" style="--tf-color: ${t.color}">
                <div class="column-header-main">
                    ...
                    <div class="column-info">
                        ...
                        <span class="column-stats">${i}/${o} completado</span>
                    </div>
                </div>
  ...
  `}function dt(s,e){return s.length===0?`
            <div class="empty-column-state">
                <div class="empty-column-icon">${g("package")}</div>
                <p>Sin metas pendientes</p>
            </div>
        `:[...s].sort((t,n)=>t.completed===n.completed?(n.createdAt||0)-(t.createdAt||0):t.completed?1:-1).map(t=>{const n=t.subGoals&&t.subGoals.length>0,i=n?t.subGoals.filter(o=>o.completed).length/t.subGoals.length*100:0;return`
        <div class="goal-card-premium ${t.completed?"is-completed":""}" data-id="${t.id}">
            <div class="goal-card-body">
                <div class="goal-checkbox-premium toggle-goal" data-id="${t.id}">
                    ${t.completed?g("check","check-icon"):""}
                </div>
                <div class="goal-main-content">
                    <div class="goal-header-row">
                        <span class="goal-category-badge">${t.category||"General"}</span>
                        <div class="goal-actions-mini">
                            <button class="action-btn-mini add-subgoal" data-id="${t.id}" title="Añadir hito">${g("plus")}</button>
                            <button class="action-btn-mini delete-goal" data-id="${t.id}" title="Eliminar">${g("trash")}</button>
                        </div>
                    </div>
                    <div class="goal-title-premium clickable-edit-goal" data-id="${t.id}">${t.title}</div>
                    
                    ${n?`
                        <div class="subgoals-list-premium">
                            ${t.subGoals.map((o,r)=>`
                                <div class="subgoal-item-premium ${o.completed?"sub-done":""} toggle-subgoal" data-id="${t.id}" data-idx="${r}">
                                    <div class="sub-check">${g(o.completed?"check":"plus","sub-check-svg")}</div>
                                    <span class="sub-title">${o.title}</span>
                                </div>
                            `).join("")}
                            <div class="sub-progress-mini">
                                <div class="sub-progress-fill" style="width: ${i}%"></div>
                            </div>
                        </div>
                    `:""}
                </div>
    ...
    `}).join("")}function ut(){var s;document.querySelectorAll(".toggle-goal").forEach(e=>{e.addEventListener("click",a=>{a.stopPropagation();const t=e.dataset.id;p.toggleGoal(t)})}),document.querySelectorAll(".toggle-subgoal").forEach(e=>{e.addEventListener("click",a=>{a.stopPropagation();const t=e.dataset.id,n=parseInt(e.dataset.idx);p.toggleSubGoal(t,n)})}),document.querySelectorAll(".delete-goal").forEach(e=>{e.addEventListener("click",async a=>{a.stopPropagation(),await v.confirm("Eliminar Meta","Esta acción es permanente.","ELIMINAR")&&(p.deleteGoal(e.dataset.id),v.toast("Meta eliminada"))})}),document.querySelectorAll(".add-subgoal").forEach(e=>{e.addEventListener("click",async a=>{a.stopPropagation();const t=e.dataset.id,n=await v.prompt("Sub-meta","¿Qué paso necesitas completar?");if(n){const o=[...p.getState().goals.find(r=>r.id===t).subGoals||[],{title:n,completed:!1}];p.updateGoal(t,{subGoals:o}),v.toast("Hito añadido")}})}),document.querySelectorAll(".clickable-edit-goal").forEach(e=>{e.addEventListener("click",async()=>{const a=e.dataset.id,t=e.textContent,n=await v.prompt("Editar Meta","Título de la meta:",t);n&&n!==t&&p.updateGoal(a,{title:n})})}),document.querySelectorAll(".quick-add-input-premium").forEach(e=>{e.addEventListener("keypress",a=>{if(a.key==="Enter"&&e.value.trim()){const t=e.dataset.timeframe;p.addGoal({title:e.value.trim(),timeframe:t,category:"Foco"}),e.value="",v.toast("Meta fijada")}})}),(s=document.getElementById("add-goal-primary"))==null||s.addEventListener("click",async()=>{const e=await v.prompt("Nueva Estrategia","Describe tu meta estratégica:");if(e){const a=[{value:"day",label:"Hoy"},{value:"week",label:"Esta Semana"},{value:"year",label:"Año 2026"},{value:"long",label:"Visión / Largo Plazo"}],t=await v.select("Plazo","¿Cuándo quieres lograr esto?",a,2);if(t){const n=["Vida","Finanzas","Salud","Proyectos","Mental"],i=await v.select("Categoría","¿A qué área pertenece?",n,3);p.addGoal({title:e,timeframe:t,category:i||"General"}),v.toast("Meta estratégica guardada","success")}}}),document.querySelectorAll(".quick-add-plus-btn").forEach(e=>{e.addEventListener("click",()=>{const a=e.nextElementSibling;a&&a.focus()})})}function pt(){const s=p.getState(),{events:e}=s;return`
      ...
      <div class="calendar-top-layout">
        ...
        <div class="events-list-container">
            <div class="events-list">
                ...
                `:e.sort((a,t)=>new Date(a.date)-new Date(t.date)).map(a=>`
                    <div class="card event-card">
                        <div class="event-icon-wrapper ${a.category||"event"}">
                            ${g(ht(a.category||"event"))}
                        </div>
  ...
  `}function mt(s){const e=new Date,a=e.getMonth(),t=e.getFullYear(),n=e.getDate(),i=new Date(t,a+1,0).getDate(),o=new Date(t,a,1).getDay(),r=["D","L","M","M","J","V","S"],l=new Set;s.forEach(c=>{const d=new Date(c.date);d.getMonth()===a&&d.getFullYear()===t&&l.add(d.getDate())});let u=r.map(c=>`<div class="calendar-day-label">${c}</div>`).join("");for(let c=0;c<o;c++)u+='<div class="calendar-day empty"></div>';for(let c=1;c<=i;c++){const d=c===n,m=l.has(c);u+=`
            <div class="calendar-day ${d?"today":""} ${m?"has-event":""}">
                ${c}
                ${m?'<span class="event-dot-indicator"></span>':""}
            </div>
        `}return u}function vt(){const s=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],e=new Date;return`${s[e.getMonth()]} ${e.getFullYear()}`}function gt(s){const e={day:"numeric",month:"short"};return new Date(s).toLocaleDateString("es-ES",e).toUpperCase()}function ht(s){switch(s){case"reminder":return"bell";case"meeting":return"users";default:return"calendar"}}function yt(s){return{daily:"Diario",weekly:"Semanal",monthly:"Mensual",yearly:"Anual"}[s]||""}function bt(){document.querySelectorAll(".event-delete-btn").forEach(s=>{s.addEventListener("click",async()=>{await v.confirm("¿Eliminar evento?","¿Estás seguro de que quieres borrar este evento de tu agenda?")&&(p.deleteEvent(s.dataset.id),v.toast("Evento eliminado","info"))})})}function ft(){const s=p.getState(),e=s.currencySymbol,a=s.livingExpenses,t=s.otherExpenses||[],n=s.liabilities,i=p.sumItems(a,"amount"),o=p.sumItems(t,"amount"),r=p.sumItems(n,"monthlyPayment"),l=i+o+r,u=[...(a||[]).map(c=>({...c,category:"livingExpense",typeLabel:"Gasto de Vida"})),...(t||[]).map(c=>({...c,category:"otherExpense",typeLabel:"Otro Gasto"})),...(n||[]).filter(c=>c.monthlyPayment>0).map(c=>({...c,amount:c.monthlyPayment,category:"liability",typeLabel:"Deuda / Hipoteca"}))].sort((c,d)=>d.amount-c.amount);return`
  ...
  `}function wt(s,e){if(s.length===0)return`
            <div class="empty-state">
        ...
        <div class="asset-list">
            ${s.map(t=>{const n=p.convertValue(t.amount,t.currency||"EUR"),i=Et(t.category);return`
  ...
  `}function Ie(){const s=ae[$],e=$==="investmentAsset"||$==="passiveAsset";if(e){const t=_.map(n=>({value:n.symbol,label:`${n.name} (${n.symbol})`}));[...ve,...t]}let a="";return $==="passiveAsset"||$==="investmentAsset"?a=`
    ...
    <div class="form-row">
        ...
        <div class="form-group" style="flex: 1.5;">
            ...
            <select class="form-input form-select" id="input-currency">
                <optgroup label="Divisas">
                    ${ve.map(t=>`<option value="${t.value}">${t.label}</option>`).join("")}
                </optgroup>
                ${e?`
                <optgroup label="Mercados Reales (Auto-Price)">
                    ${_.map(t=>`<option value="${t.symbol}">${t.name} (${t.symbol})</option>`).join("")}
                </optgroup>
                `:""}
            </select>
        </div>
  ...
  `}function St(){const s=document.getElementById("add-modal"),e=document.getElementById("modal-close");s.addEventListener("click",t=>{t.target===s&&te()}),e.addEventListener("click",te);const a=s.querySelectorAll(".category-selector .type-option");a.forEach(t=>{t.addEventListener("click",()=>{$=t.dataset.category,a.forEach(n=>n.classList.remove("active")),t.classList.add("active"),document.getElementById("form-container").innerHTML=Ie(),he()})}),he()}function he(){const s=document.getElementById("btn-save");s&&s.addEventListener("click",It);const e=document.getElementById("mode-qty"),a=document.getElementById("mode-total"),t=document.getElementById("input-qty"),n=document.getElementById("input-value"),i=document.getElementById("input-currency"),o=document.getElementById("input-name");if(e&&a){const l=u=>{u==="qty"?(e.style.background="var(--accent-primary)",e.style.color="var(--bg-primary)",a.style.background="transparent",a.style.color="var(--text-secondary)",t.focus()):(a.style.background="var(--accent-primary)",a.style.color="var(--bg-primary)",e.style.background="transparent",e.style.color="var(--text-secondary)",n.focus())};e.addEventListener("click",()=>l("qty")),a.addEventListener("click",()=>l("total"))}const r=l=>{const u=p.getState().rates,c=i==null?void 0:i.value,d=u[c]||1;if(l==="qty"){const m=parseFloat(t.value)||0;n.value=(m*d).toFixed(2)}else{const m=parseFloat(n.value)||0;t.value=(m/d).toFixed(6)}};t==null||t.addEventListener("input",()=>r("qty")),n==null||n.addEventListener("input",()=>r("total")),i&&i.addEventListener("change",()=>{if(o&&!o.value){const l=i.options[i.selectedIndex].text;o.value=l.split(" (")[0]}r("qty")})}function It(){var h,f,E,k,w,C,L,G,H,V,W,se;const s=(f=(h=document.getElementById("input-name"))==null?void 0:h.value)==null?void 0:f.trim(),e=(E=document.getElementById("input-type"))==null?void 0:E.value,a=(k=document.getElementById("input-currency"))==null?void 0:k.value,t=(C=(w=document.getElementById("input-details"))==null?void 0:w.value)==null?void 0:C.trim(),n=parseFloat((L=document.getElementById("input-value"))==null?void 0:L.value)||0,i=document.getElementById("input-qty"),o=i?parseFloat(i.value)||0:n,r=parseFloat((G=document.getElementById("input-amount"))==null?void 0:G.value)||0,l=parseFloat((H=document.getElementById("input-monthly"))==null?void 0:H.value)||0,u=(V=document.getElementById("input-date"))==null?void 0:V.value,c=(W=document.getElementById("input-time"))==null?void 0:W.value,d=(se=document.getElementById("input-repeat"))==null?void 0:se.value;if(!s){v.alert("Campo Obligatorio","Por favor ingresa un nombre para el elemento.");return}const m={name:s,type:e,currency:a,details:t};switch($){case"passiveAsset":p.addPassiveAsset({...m,value:o,monthlyIncome:l});break;case"activeIncome":p.addActiveIncome({...m,amount:r});break;case"livingExpense":p.addLivingExpense({...m,amount:r});break;case"investmentAsset":p.addInvestmentAsset({...m,value:o});break;case"liability":p.addLiability({...m,amount:r,monthlyPayment:l});break;case"event":p.addEvent({title:s,date:u,time:c,repeat:d,category:e});break}te()}function te(){const s=document.getElementById("add-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300))}function $t(){const s=x.isSetup(),e=x.isBioEnabled();return`
    ...
    `}function At(s){var i;const e=document.getElementById("auth-submit-btn"),a=document.getElementById("auth-bio-btn"),t=document.getElementById("auth-password"),n=async()=>{const o=t.value,r=document.getElementById("auth-confirm"),l=x.isSetup();try{let u;if(l)u=await x.unlock(o);else{if(!o||o.length<4)throw new Error("Contraseña demasiado corta");if(o!==r.value)throw new Error("Las contraseñas no coinciden");u=await x.setup(o)}await p.loadEncrypted(u),s()}catch(u){v.alert("Error",u.message)}};e==null||e.addEventListener("click",n),t==null||t.addEventListener("keypress",o=>{o.key==="Enter"&&n()}),(i=document.getElementById("auth-confirm"))==null||i.addEventListener("keypress",o=>{o.key==="Enter"&&n()}),a==null||a.addEventListener("click",async()=>{try{const o=await x.unlockWithBiometrics();await p.loadEncrypted(o),s()}catch(o){v.alert("Identificación",o.message)}}),x.isBioEnabled()&&setTimeout(async()=>{try{const o=await x.unlockWithBiometrics();await p.loadEncrypted(o),s()}catch{console.log("Auto-bio failed or cancelled")}},500)}const Ct="modulepreload",Lt=function(s){return"/life-dashboard/"+s},ye={},be=function(e,a,t){let n=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),r=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));n=Promise.allSettled(a.map(l=>{if(l=Lt(l),l in ye)return;ye[l]=!0;const u=l.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":Ct,u||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),u)return new Promise((m,h)=>{d.addEventListener("load",m),d.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(o){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=o,window.dispatchEvent(r),!r.defaultPrevented)throw o}return n.then(o=>{for(const r of o||[])r.status==="rejected"&&i(r.reason);return e().catch(i)})};function Tt(){const s=x.isBioEnabled(),e=T.hasToken();return`
    <div class="settings-page stagger-children">
        ...
        <footer class="settings-footer">
            <p>Life Dashboard Pro v1.0.59</p>
            <p>© 2026 Privacy First Zero-Knowledge System</p>
        </footer>
    </div>
    `}function Rt(){var t,n,i,o,r,l,u;(t=document.getElementById("toggle-bio"))==null||t.addEventListener("change",async c=>{if(c.target.checked){const m=await v.prompt("Activar Biometría","Introduce tu contraseña maestra para confirmar:","Tu contraseña","password");if(m)try{await x.registerBiometrics(m),v.toast("Biometría activada correctamente")}catch(h){await v.alert("Error",h.message),c.target.checked=!1}else c.target.checked=!1}else localStorage.setItem("life-dashboard/db_bio_enabled","false"),v.toast("Biometría desactivada","info")});const s=document.getElementById("btn-install-pwa");s&&setTimeout(()=>{if(window.deferredPrompt){const c=document.getElementById("install-pwa-card");c&&(c.style.display="block"),s.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:d}=await window.deferredPrompt.userChoice;if(d==="accepted"){v.toast("Instalando aplicación...");const m=document.getElementById("install-pwa-card");m&&(m.style.display="none")}window.deferredPrompt=null})}},1e3),(n=document.getElementById("sync-drive-btn"))==null||n.addEventListener("click",async()=>{const c=document.getElementById("sync-drive-btn"),d=T.hasToken(),m=c.innerHTML;try{if(c.innerHTML='<div class="loading-spinner-sm"></div>',c.style.pointerEvents="none",d){const h=x.getVaultKey();await T.pushData(p.getState(),h),v.toast("Bóveda actualizada en Drive")}else{await T.authenticate();const h=x.getVaultKey(),f=await T.pullData(h).catch(()=>null);if(f&&await v.confirm("Respaldo Encontrado","Hemos detectado una bóveda existente en Google Drive. ¿Qué deseas hacer con tus datos?","Recuperar de la Nube","Sobreescribir Nube")){p.setState(f),await p.saveState(),v.toast("Datos recuperados correctamente"),setTimeout(()=>window.location.reload(),800);return}await T.pushData(p.getState(),h),v.toast("Google Drive conectado y sincronizado")}typeof window.reRender=="function"&&window.reRender()}catch(h){if(console.error(h),h.message&&(h.message.includes("Contraseña incorrecta")||h.message.includes("corruptos"))){if(await v.confirm("Error de Decifrado","La contraseña actual no coincide con la del backup en la nube. ¿Deseas borrar los datos en Drive para empezar de cero?","Borrar Datos Nube","Cancelar"))try{await T.deleteBackup(),v.toast("Datos de Drive borrados");const E=x.getVaultKey();await T.pushData(p.getState(),E),v.toast("Google Drive sincronizado (Nueva Bóveda)")}catch{v.alert("Error","No se pudieron borrar los datos de Drive.")}}else v.alert("Error",h.message||(typeof h=="object"?JSON.stringify(h):"Error al conectar con Google"))}finally{c.innerHTML=m,c.style.pointerEvents="auto"}}),(i=document.getElementById("export-data-btn"))==null||i.addEventListener("click",async()=>{try{v.toast("Preparando archivo encriptado...","info");const c=p.getState(),d=x.getVaultKey(),{SecurityService:m}=await be(async()=>{const{SecurityService:C}=await Promise.resolve().then(()=>ne);return{SecurityService:C}},void 0),h=await m.encrypt(c,d),f=new Blob([JSON.stringify(h)],{type:"application/octet-stream"}),E=URL.createObjectURL(f),k=document.createElement("a"),w=new Date().toISOString().split("T")[0];k.href=E,k.download=`life_dashboard_backup_${w}.bin`,document.body.appendChild(k),k.click(),document.body.removeChild(k),URL.revokeObjectURL(E),v.toast("Backup exportado correctamente")}catch(c){console.error("Export error:",c),v.alert("Error de Exportación","No se pudieron encriptar o descargar los datos.")}});const e=document.getElementById("import-backup-btn"),a=document.getElementById("import-backup-input");e==null||e.addEventListener("click",()=>{a==null||a.click()}),a==null||a.addEventListener("change",async c=>{var h;const d=(h=c.target.files)==null?void 0:h[0];if(!d)return;if(!await v.confirm("¿Importar Backup?","Esto sobreescribirá todos tus datos locales con los del archivo. ¿Deseas continuar?")){a.value="";return}try{const f=await d.text(),E=JSON.parse(f),k=x.getVaultKey(),{SecurityService:w}=await be(async()=>{const{SecurityService:L}=await Promise.resolve().then(()=>ne);return{SecurityService:L}},void 0),C=await w.decrypt(E,k);if(C)p.setState(C),await p.saveState(),v.toast("Backup importado correctamente"),setTimeout(()=>window.location.reload(),1e3);else throw new Error("No se pudo descifrar el archivo")}catch(f){console.error("Import error:",f),v.alert("Error de Importación","El archivo no es válido o la contraseña no coincide con la usada para el backup.")}finally{a.value=""}}),(o=document.getElementById("btn-logout"))==null||o.addEventListener("click",async()=>{await v.confirm("¿Cerrar sesión?","El acceso quedará bloqueado hasta que introduzcas tu clave.")&&(x.logout(),window.location.reload())}),(r=document.getElementById("btn-force-update"))==null||r.addEventListener("click",async()=>{if(await v.confirm("¿Forzar Actualización?","Esto recargará la página y limpiará la caché para obtener la última versión.")){if(window.caches)try{const d=await caches.keys();for(let m of d)await caches.delete(m)}catch(d){console.error("Error clearing cache",d)}window.location.reload(!0)}}),(l=document.getElementById("btn-save-gemini"))==null||l.addEventListener("click",()=>{var d;const c=(d=document.getElementById("gemini-api-key"))==null?void 0:d.value;c!==void 0&&(localStorage.setItem("life-dashboard/db_gemini_api_key",c.trim()),v.toast("API Key de Gemini guardada"))}),(u=document.getElementById("btn-factory-reset"))==null||u.addEventListener("click",async()=>{if(await v.hardConfirm("Borrar todos los datos","Esta acción eliminará permanentemente todos tus activos, ingresos, agenda y configuraciones de este dispositivo.","BORRAR")){const d="life-dashboard/";if(Object.keys(localStorage).forEach(m=>{m.startsWith(d)&&localStorage.removeItem(m)}),Object.keys(sessionStorage).forEach(m=>{m.startsWith(d)&&sessionStorage.removeItem(m)}),window.indexedDB.databases&&(await window.indexedDB.databases()).forEach(h=>window.indexedDB.deleteDatabase(h.name)),navigator.serviceWorker){const m=await navigator.serviceWorker.getRegistrations();for(let h of m)h.unregister()}v.toast("Aplicación reseteada","info"),setTimeout(()=>{window.location.href=window.location.origin+"?reset="+Date.now()},1e3)}})}let D=localStorage.getItem("life-dashboard/app_current_page")||"finance",I=localStorage.getItem("life-dashboard/app_current_sub_page")||null;I==="null"&&(I=null);async function fe(){const s=x.getVaultKey();s?(await p.loadEncrypted(s),$e()):Bt()}function Bt(){const s=document.getElementById("app");s.innerHTML=$t(),At(()=>{$e()})}function $e(){const s=document.getElementById("app");s.innerHTML=`
        <main id="main-content"></main>
        <nav id="bottom-nav"></nav>
    `,Ae(),p.subscribe(()=>{R()}),window.reRender=()=>R(),Dt()}function Dt(){var t,n;const s=localStorage.getItem("life-dashboard/pwa_install_dismissed");if(s&&(Date.now()-parseInt(s))/864e5<7||window.matchMedia("(display-mode: standalone)").matches)return;const e=document.createElement("div");e.className="pwa-install-banner",e.id="pwa-install-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(e);const a=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};a(),window.addEventListener("beforeinstallprompt",a),(t=document.getElementById("pwa-banner-install"))==null||t.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:i}=await window.deferredPrompt.userChoice;i==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(n=document.getElementById("pwa-banner-close"))==null||n.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function Ae(){const s=document.getElementById("bottom-nav");s.innerHTML=re(D),le(e=>{D=e,I=null,localStorage.setItem("life-dashboard/app_current_page",D),localStorage.setItem("life-dashboard/app_current_sub_page",I),B(),R(),s.innerHTML=re(D),le(a=>{D=a,I=null,localStorage.setItem("life-dashboard/app_current_page",D),localStorage.setItem("life-dashboard/app_current_sub_page",I),B(),R(),Ae()})}),Pt(),R()}function R(){const s=document.getElementById("main-content");if(I==="compound"){s.innerHTML=Ze(),Qe(()=>{I=null,et(),B(),R()});return}if(I==="expenses"){s.innerHTML=ft(),kt(()=>{I=null,B(),R()});return}if(I==="market"){s.innerHTML=tt(),st(()=>{I=null,B(),R()});return}switch(D){case"finance":B(),s.innerHTML=de(),ue(),we();break;case"goals":B(),s.innerHTML=ct(),ut();break;case"calendar":B(),s.innerHTML=pt(),bt();break;case"health":s.innerHTML=nt(),lt(),q();break;case"settings":s.innerHTML=Tt(),Rt(),q();break;default:B(),s.innerHTML=de(),ue(),we()}}function we(){const s=document.getElementById("open-compound");s&&s.addEventListener("click",()=>{I="compound",localStorage.setItem("life-dashboard/app_current_sub_page",I),q(),R()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{I="market",localStorage.setItem("life-dashboard/app_current_sub_page",I),q(),R()});const a=document.getElementById("open-expenses");a&&a.addEventListener("click",()=>{I="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",I),q(),R()})}function Pt(){const s=document.querySelector(".fab");s&&s.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=g("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{if(D==="calendar")ge("event");else if(D==="health"){const a=await ns.confirm("Registrar Métrica","¿Qué deseas registrar hoy?","Peso","Grasa");if(a===!0){const t=await ns.prompt("Registrar Peso","Ingresa tu peso actual en kg:","","number");t&&p.addWeightLog(t)}else if(a===!1){const t=await ns.prompt("Grasa Corporal","Ingresa tu % de grasa:","","number");t&&p.addFatLog(t)}}else ge()}),document.body.appendChild(e)}function q(){const s=document.getElementById("main-fab");s&&(s.style.display="none")}function B(){const s=document.getElementById("main-fab");s&&(s.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",fe):fe();window.addEventListener("beforeinstallprompt",s=>{s.preventDefault(),window.deferredPrompt=s,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});
