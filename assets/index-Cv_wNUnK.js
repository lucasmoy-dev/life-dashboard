var Ze=Object.defineProperty;var Qe=(s,e,a)=>e in s?Ze(s,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[e]=a;var ce=(s,e,a)=>Qe(s,typeof e!="symbol"?e+"":e,a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const et="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",tt="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function at(){var e,a,t,n,o,i,r,l,m,u,d,g,f,h,b;const s={EUR:1};try{const w=await(await fetch(et)).json();s.BTC=((e=w.bitcoin)==null?void 0:e.eur)||4e4,s.ETH=((a=w.ethereum)==null?void 0:a.eur)||2200,s.XRP=((t=w.ripple)==null?void 0:t.eur)||.5,s.KAS=((n=w.kaspa)==null?void 0:n.eur)||.1,s.SOL=((o=w.solana)==null?void 0:o.eur)||90,s.XLM=((i=w.stellar)==null?void 0:i.eur)||.11,s.ALGO=((r=w.algorand)==null?void 0:r.eur)||.18,s.LTC=((l=w.litecoin)==null?void 0:l.eur)||65,s.SUI=((m=w.sui)==null?void 0:m.eur)||1.1,s.LINK=((u=w.chainlink)==null?void 0:u.eur)||14,s.RNDR=((d=w["render-token"])==null?void 0:d.eur)||4.5,s.ADA=((g=w.cardano)==null?void 0:g.eur)||.45,s.ONDO=((f=w["ondo-finance"])==null?void 0:f.eur)||.7,(h=w.bitcoin)!=null&&h.ars&&((b=w.bitcoin)!=null&&b.eur)&&(s.ARS=w.bitcoin.eur/w.bitcoin.ars);const S=await fetch(tt);if(S.ok){const $=await S.json();s.USD=1/$.rates.USD,s.CHF=1/$.rates.CHF,s.GBP=1/$.rates.GBP,s.AUD=1/$.rates.AUD}s.GOLD=2100,s.SP500=4700}catch(k){console.error("Failed to fetch some prices:",k),s.USD=s.USD||.92,s.CHF=s.CHF||1.05,s.GBP=s.GBP||1.15,s.AUD=s.AUD||.6,s.ARS=s.ARS||.001}return s}class G{static async hash(e,a="salt_life_dashboard_2026"){const n=new TextEncoder().encode(e+a),o=await crypto.subtle.digest("SHA-512",n);return Array.from(new Uint8Array(o)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,a){const t=new TextEncoder,n=await crypto.subtle.importKey("raw",t.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode(a),iterations:25e4,hash:"SHA-512"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,a){try{const t=crypto.getRandomValues(new Uint8Array(16)),n=crypto.getRandomValues(new Uint8Array(12)),o=await this.deriveKey(a,this.bufToBase64(t)),i=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(i),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},o,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(n),salt:this.bufToBase64(t),v:"5.0"}}catch(t){throw console.error("[Security] Encryption failed:",t),new Error("No se pudo encriptar la información")}}static async decrypt(e,a){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:t,iv:n,salt:o}=e,i=await this.deriveKey(a,o),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(n)},i,this.base64ToBuf(t)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(t){throw console.error("[Security] Decryption failed:",t),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(a=>a.charCodeAt(0)))}}const Ee=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:G},Symbol.toStringTag,{value:"Module"})),M={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class C{static isSetup(){return!!localStorage.getItem(M.MASTER_HASH)}static async setup(e){const a=await G.hash(e),t=await G.deriveVaultKey(e);return localStorage.setItem(M.MASTER_HASH,a),sessionStorage.setItem(M.VAULT_KEY,t),t}static async unlock(e){const a=await G.hash(e),t=localStorage.getItem(M.MASTER_HASH);if(a===t){const n=await G.deriveVaultKey(e);return sessionStorage.setItem(M.VAULT_KEY,n),n}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const a=sessionStorage.getItem(M.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const t=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:t,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(M.BIO_ENABLED,"true"),localStorage.setItem(M.VAULT_KEY,a),!0}catch(t){throw console.error("Biometric setup failed:",t),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(M.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const a=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:a,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const t=localStorage.getItem(M.VAULT_KEY);if(t)return sessionStorage.setItem(M.VAULT_KEY,t),t;throw new Error("Llave no encontrada. Usa contraseña.")}catch(a){throw console.error("Biometric auth failed:",a),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(M.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(M.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(M.BIO_ENABLED)==="true"}}const he="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",Se=[71,79,67,83,80,88,45,112,121,52,68,109,80,83,107,45,100,75,55,99,73,66,116,106,65,81,75,90,70,75,118,95,66,87,95].map(s=>String.fromCharCode(s)).join(""),st="https://www.googleapis.com/auth/drive.file";class q{static hasToken(){const e=!!this.accessToken;return localStorage.getItem("life-dashboard/drive_connected")==="true"&&e}static async init(){return this._initPromise?this._initPromise:(this._initPromise=new Promise((e,a)=>{const t=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.codeClient=google.accounts.oauth2.initCodeClient({client_id:he,scope:st,ux_mode:"popup",access_type:"offline",prompt:"consent",callback:async n=>{if(n.error){console.error("[Drive] Auth callback error:",n);return}if(n.code)try{const o=sessionStorage.getItem("life-dashboard/pkce_verifier"),i=localStorage.getItem("life-dashboard/drive_client_secret")||Se,r=await this.exchangeCodeForTokens(n.code,o,he,i);r.refresh_token&&await this.saveRefreshToken(r.refresh_token),this.saveSession(r),console.log("[Drive] Connected successfully via offline flow."),window.ns&&window.ns.toast("Google Drive vinculado"),typeof window.reRender=="function"&&window.reRender()}catch(o){console.error("[Drive] Token exchange error:",o),window.ns&&window.ns.alert("Error Auth","No se pudieron obtener tokens. Verifica el Client Secret.")}}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&this.ensureValidToken().catch(n=>{console.log("[Drive] Initial silent restoration skipped:",n.message)}),e(!0)}catch(n){console.error("[Drive] Init error:",n),a(n)}}):setTimeout(t,200)};t()}),this._initPromise)}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const a=e.expires_in||3600,t=Date.now()+a*1e3;localStorage.setItem("life-dashboard/drive_token_expiry",t.toString())}static async authenticate(){this.codeClient||await this.init();const{verifier:e}=await this.generatePKCE();sessionStorage.setItem("life-dashboard/pkce_verifier",e),this.codeClient.requestCode()}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(!(localStorage.getItem("life-dashboard/drive_connected")==="true"))return null;if(!this.accessToken||Date.now()>e-3e5){console.log("[Drive] Access token expired or near expiry, attempting refresh...");const n=await this.getRefreshToken();if(n)try{const o=localStorage.getItem("life-dashboard/drive_client_secret")||Se,i=await this.refreshAccessToken(n,he,o),r={access_token:i.access_token,expires_in:i.expires_in,refresh_token:i.refresh_token||n};return i.refresh_token&&await this.saveRefreshToken(i.refresh_token),this.saveSession(r),this.accessToken}catch(o){throw console.error("[Drive] Token refresh failed:",o),new Error("Sesión de Google Drive expirada. Por favor reconecta en Configuración.")}else throw console.warn("[Drive] No refresh token found."),new Error("Google Drive no está vinculado para acceso offline.")}return this.accessToken&&(!gapi.client.getToken()||gapi.client.getToken().access_token!==this.accessToken)&&gapi.client.setToken({access_token:this.accessToken}),this.accessToken}static async generatePKCE(){const e=Array.from(crypto.getRandomValues(new Uint8Array(32))).map(i=>("0"+i.toString(16)).slice(-2)).join(""),t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t),o=btoa(String.fromCharCode(...new Uint8Array(n))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return{verifier:e,challenge:o}}static async exchangeCodeForTokens(e,a,t,n=null){const o=new URLSearchParams({client_id:t,code:e,grant_type:"authorization_code",redirect_uri:"postmessage"});a&&!n&&o.append("code_verifier",a),n&&o.append("client_secret",n);const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:o});if(!i.ok){const r=await i.json();throw new Error(r.error_description||"Failed to exchange code")}return await i.json()}static async refreshAccessToken(e,a,t=null){const n=new URLSearchParams({client_id:a,refresh_token:e,grant_type:"refresh_token"});t&&n.append("client_secret",t);const o=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n});if(!o.ok){const i=await o.json();throw new Error(i.error_description||"Failed to refresh token")}return await o.json()}static async saveRefreshToken(e){return new Promise((a,t)=>{const n=indexedDB.open("LifeDashboardAuthDB",1);n.onupgradeneeded=o=>{const i=o.target.result;i.objectStoreNames.contains("tokens")||i.createObjectStore("tokens")},n.onsuccess=o=>{const r=o.target.result.transaction("tokens","readwrite");r.objectStore("tokens").put(e,"drive_refresh_token"),r.oncomplete=()=>a(),r.onerror=l=>t(l)},n.onerror=o=>t(o)})}static async getRefreshToken(){return new Promise((e,a)=>{const t=indexedDB.open("LifeDashboardAuthDB",1);t.onupgradeneeded=n=>{const o=n.target.result;o.objectStoreNames.contains("tokens")||o.createObjectStore("tokens")},t.onsuccess=n=>{const o=n.target.result;if(!o.objectStoreNames.contains("tokens")){e(null);return}const l=o.transaction("tokens","readonly").objectStore("tokens").get("drive_refresh_token");l.onsuccess=()=>e(l.result),l.onerror=m=>a(m)},t.onerror=n=>a(n)})}static async clearTokens(){return localStorage.removeItem("life-dashboard/drive_access_token"),localStorage.removeItem("life-dashboard/drive_connected"),localStorage.removeItem("life-dashboard/drive_token_expiry"),new Promise(e=>{const a=indexedDB.open("LifeDashboardAuthDB",1);a.onsuccess=t=>{const n=t.target.result;if(n.objectStoreNames.contains("tokens")){const o=n.transaction("tokens","readwrite");o.objectStore("tokens").clear(),o.oncomplete=()=>e()}else e()},a.onerror=()=>e()})}static async getOrCreateFolderPath(e){var n;await this.ensureValidToken(),(n=gapi.client)!=null&&n.drive||await this.init();const a=e.split("/").filter(o=>o);let t="root";for(const o of a){const i=`name = '${o}' and mimeType = 'application/vnd.google-apps.folder' and '${t}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:i,fields:"files(id, name)"})).result.files;if(l&&l.length>0)t=l[0].id;else{const m={name:o,mimeType:"application/vnd.google-apps.folder",parents:[t]};t=(await gapi.client.drive.files.create({resource:m,fields:"id"})).result.id}}return t}static async pushData(e,a,t=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pushing encrypted data...${t?" (Retry)":""}`);const n=await this.getOrCreateFolderPath("/backup/life-dashboard/"),o=await G.encrypt(e,a),i="dashboard_vault_v5.bin",r=`name = '${i}' and '${n}' in parents and trashed = false`,m=(await gapi.client.drive.files.list({q:r,fields:"files(id)"})).result.files,u=new Blob([JSON.stringify(o)],{type:"application/json"});if(m&&m.length>0){const d=m[0].id,g=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${d}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:u});if(g.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,a,!0);if(!g.ok)throw new Error(`Error al actualizar backup: ${g.status}`)}else{const d={name:i,parents:[n]},g=new FormData;g.append("metadata",new Blob([JSON.stringify(d)],{type:"application/json"})),g.append("file",u);const f=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:g});if(f.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,a,!0);if(!f.ok)throw new Error(`Error al crear backup: ${f.status}`)}return!0}catch(n){throw console.error("[Drive] Push failed:",n),new Error(n.message||"Fallo al subir datos a Drive")}}static async pullData(e,a=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pulling data...${a?" (Retry)":""}`);const o=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,r=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)"})).result.files;if(!r||r.length===0)return null;const l=r[0].id,m=await fetch(`https://www.googleapis.com/drive/v3/files/${l}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(m.status===401&&!a)return await this.ensureValidToken(),await this.pullData(e,!0);if(!m.ok)throw new Error(`Error al descargar backup: ${m.status}`);const u=await m.json();return await G.decrypt(u,e)}catch(t){throw console.error("[Drive] Pull failed:",t),new Error(t.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");const t=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,o=(await gapi.client.drive.files.list({q:t,fields:"files(id)"})).result.files;if(o&&o.length>0){const i=o[0].id;return await gapi.client.drive.files.delete({fileId:i}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(e){throw console.error("[Drive] Deletion failed:",e),new Error(e.message||"Fallo al borrar backup en Drive")}}}ce(q,"codeClient",null),ce(q,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null),ce(q,"_initPromise",null);const $e={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',chevronUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>',chevronDown:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',uploadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12V21"/><path d="m16 16-4-4-4 4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>',moreVertical:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>',check:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',menu:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>',users:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',messageSquare:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',phone:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',instagram:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>',facebook:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>',linkedin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>',alertCircle:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>',fingerprint:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 15.1a7 7 0 0 0 10.9 0"/><path d="M6 13.6a7 7 0 0 0 4.6 2.4"/><path d="M13.4 16a7 7 0 0 0 4.6-2.4"/><path d="M8 12.1a5 5 0 0 0 6.9 0"/><path d="M9.1 11a3 3 0 0 0 3.9 0"/><path d="M12 18.5V20"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',palette:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.555C21.965 6.012 17.461 2 12 2z"/></svg>',star:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',eye:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>',eyeOff:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.52 13.52 0 0 0 2 12c0 0 3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><line x1="2" x2="22" y1="2" y2="22"/></svg>',play:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg>',pause:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>',clock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',barChart2:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>',brain:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 4.44-2.54Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-4.44-2.54Z"/></svg>',rocket:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-5c1.62-2.2 5-3 5-3"/><path d="M12 15v5s3.03-.55 5-2c2.2-1.62 3-5 3-5"/></svg>',coffee:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>',bookOpen:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>'};function p(s,e=""){return($e[s]||$e.package).replace("<svg",`<svg class="${e}"`)}class nt{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,a="success",t=3e3){const n=document.createElement("div");n.className=`toast toast-${a} stagger-in`;const o=a==="success"?"check":a==="error"?"alertCircle":"info";n.innerHTML=`
    ...
    `:e.fields.includes("amount")&&(n=`
      <div class="form-group">
        <label class="form-label">${Z==="livingExpense"?"Gasto Mensual":"Ingreso Mensual"}</label>
        <input type="number" class="form-input" id="edit-amount" value="${s.amount||0}" inputmode="numeric">
      </div>
    `),`
    <div class="modal">
          ...
          <div class="form-group" style="flex: 1;">
              ...
              <select class="form-input form-select" id="edit-currency">
                  <optgroup label="Divisas">
                      ${ut.map(o=>`<option value="${o.value}" ${o.value===s.currency?"selected":""}>${o.label}</option>`).join("")}
                  </optgroup>
                  ${a?`
                  <optgroup label="Mercados Reales">
                      ${z.map(o=>`<option value="${o.symbol}" ${o.symbol===s.currency?"selected":""}>${o.name} (${o.symbol})</option>`).join("")}
                  </optgroup>
                  `:""}
              </select>
          </div>
  ...
  `}function vt(s){const e=document.getElementById("edit-modal"),a=document.getElementById("edit-modal-close"),t=document.getElementById("btn-update"),n=document.getElementById("btn-delete");e.addEventListener("click",o=>{o.target===e&&pe()}),a.addEventListener("click",pe),t.addEventListener("click",()=>gt(s)),n.addEventListener("click",()=>ht(s))}function gt(s){var m,u,d,g,f,h,b,k,w;const e=(u=(m=document.getElementById("edit-name"))==null?void 0:m.value)==null?void 0:u.trim(),a=(d=document.getElementById("edit-type"))==null?void 0:d.value,t=(g=document.getElementById("edit-currency"))==null?void 0:g.value,n=(h=(f=document.getElementById("edit-details"))==null?void 0:f.value)==null?void 0:h.trim(),o=parseFloat((b=document.getElementById("edit-value"))==null?void 0:b.value)||0,i=parseFloat((k=document.getElementById("edit-amount"))==null?void 0:k.value)||0,r=parseFloat((w=document.getElementById("edit-monthly"))==null?void 0:w.value)||0;if(!e){v.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:a,currency:t,details:n};s.fields.includes("value")&&(l.value=o),s.fields.includes("amount")&&(l.amount=i),s.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),s.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),c[s.updateMethod](le.id,l),pe()}function ht(s){v.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${le.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(c[s.deleteMethod](le.id),v.toast("Eliminado correctamente","info"),pe())})}function pe(){const s=document.getElementById("edit-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300)),le=null,Z=null}let Q=!1,ee=!1,E={key:"price",direction:"desc"},te="USD",U=null;function yt(){const s=c.getState(),e=s.lastMarketData||[],a=s.marketFavorites||[];U===null&&(U=a.length>0?"favorites":"all"),!ee&&!Q&&xt();const t=te==="EUR"?"€":"$";let n=e;U==="favorites"&&(n=e.filter(i=>a.includes(i.id)));const o=Object.values(y);return`
        <div class="market-view animate-fade-in" style="padding: 4px;">
            ...
            <div class="market-controls-row">
                ...
                <div class="market-status-badge ${Q?"market-status-fresh":"market-status-cached"}" title="Tasa de refresco: 5 min">
                    ${ee?'<div class="loading-spinner-sm" style="width:10px; height:10px;"></div>':p(Q?"check":"save","tiny-icon")}
                    <span>${ee?"Updating":Q?"Live":"Cached"}</span>
                </div>
            ...
            <!-- Content -->
            ${n.length===0&&U==="favorites"?wt():""}
            ${n.length===0&&U==="all"?kt():""}
            
            ${o.map(i=>{const r=n.filter(l=>l.category===i);return r.length===0?"":ft(i,r,t,a)}).join("")}
        </div>
    `}function ft(s,e,a,t){const n=[...e].sort((o,i)=>{let r=o[E.key],l=i[E.key];return typeof r=="string"&&(r=r.toLowerCase()),typeof l=="string"&&(l=l.toLowerCase()),r<l?E.direction==="asc"?-1:1:r>l?E.direction==="asc"?1:-1:0});return`
                    ...
                    <table class="market-table">
                        <thead>
                            <tr>
                                ...
                                <th data-sort="name" class="sortable ${E.key==="name"?E.direction:""}">Nombre</th>
                                <th data-sort="price" class="sortable text-right ${E.key==="price"?E.direction:""}">Precio</th>
                                <th data-sort="change24h" class="sortable text-right ${E.key==="change24h"?E.direction:""}">24h</th>
                                <th data-sort="change30d" class="sortable text-right ${E.key==="change30d"?E.direction:""}">30d</th>
                                <th data-sort="change1y" class="sortable text-right ${E.key==="change1y"?E.direction:""}">1y</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${n.map(o=>bt(o,a,t.includes(o.id))).join("")}
                        </tbody>
                    </table>
                </div>
            </div>
        </div>
    `}function bt(s,e,a){let t=s.price;if(s.price!==null&&te==="EUR"){const r=c.getState().rates.USD||.92;t=s.price*r}const n=fe(s.change24h),o=fe(s.change30d),i=fe(s.change1y);return`
        <tr class="market-row" data-id="${s.id}">
            ...
            <td class="text-right font-mono" style="font-weight: 700; color: var(--text-primary);">${t!==null?x(t,e):"-"}</td>
    ...
    `}function fe(s){return s==null?"":Q?s>=0?"text-positive":"text-negative":"text-accent-primary"}function wt(){return`
    ...
    `}async function xt(){var s,e;if(!ee){ee=!0,(s=window.reRender)==null||s.call(window);try{const a=await Ne();c.saveMarketData(a),Q=!0}catch(a){console.error("Market update failed",a)}finally{ee=!1,(e=window.reRender)==null||e.call(window)}}}function Et(){var s,e,a;document.querySelectorAll(".capsule-btn").forEach(t=>{t.addEventListener("click",()=>{var o;const n=t.dataset.curr;n!==te&&(te=n,(o=window.reRender)==null||o.call(window))})}),(s=document.getElementById("filter-all"))==null||s.addEventListener("click",()=>{var t;U="all",(t=window.reRender)==null||t.call(window)}),(e=document.getElementById("filter-favs"))==null||e.addEventListener("click",()=>{var t;U="favorites",(t=window.reRender)==null||t.call(window)}),(a=document.getElementById("btn-show-all"))==null||a.addEventListener("click",()=>{var t;U="all",(t=window.reRender)==null||t.call(window)}),document.querySelectorAll(".btn-favorite").forEach(t=>{t.addEventListener("click",n=>{var i;n.stopPropagation();const o=t.dataset.id;c.toggleMarketFavorite(o),(i=window.reRender)==null||i.call(window)})}),document.querySelectorAll(".market-table th.sortable").forEach(t=>{t.addEventListener("click",()=>{var o;const n=t.dataset.sort;E.key===n?E.direction=E.direction==="asc"?"desc":"asc":(E.key=n,E.direction="desc",n==="name"&&(E.direction="asc")),(o=window.reRender)==null||o.call(window)})})}function St(){const s=c.getState(),{wealthGoals:e=[],inflationRate:a=3,projectionYears:t=10,currencySymbol:n}=s,o=c.getAllExpenses();let i=0;e.forEach(d=>{const g=d.cost*(d.dividendYield/100)/12;i+=c.convertValue(g,d.currency||s.currency)});const r=i-o,l=o*Math.pow(1+a/100,t);let m=0;e.forEach(d=>{const f=d.cost*Math.pow(1+d.annualGrowth/100,t)*(d.dividendYield/100)/12;m+=c.convertValue(f,d.currency||s.currency)});const u=m-l;return`
            ...
            <div class="projection-grid">
                <div class="projection-col">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="positive">${x(i,n)}</span>
                    </div>
                    <div class="stat-row">
                        <span>Gastos Totales</span>
                        <span class="negative">${x(o,n)}</span>
                    </div>
                    <div class="stat-row divider">
                        <span>Neto</span>
                        <span class="${r>=0?"positive":"negative"}">${x(r,n)}</span>
                    </div>
                </div>
                ...
                <div class="projection-col">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="positive">${x(m,n)}</span>
                    </div>
                    <div class="stat-row">
                        <span>Gastos Est.</span>
                        <span class="negative">${x(l,n)}</span>
                    </div>
                    <div class="stat-row divider">
                        <span>Neto Proyectado</span>
                        <span class="${u>=0?"positive":"negative"}">${x(u,n)}</span>
                    </div>
                </div>
            </div>
    ...
    `}function $t(s,e){const a=e.currencySymbol,t=s.cost*(s.dividendYield/100)/12,n=c.convertValue(t,s.currency||e.currency);return`
    <div class="card wealth-goal-card" data-id="${s.id}">
        <div class="goal-card-main">
            <div class="goal-card-info">
                <div class="goal-name">${s.name}</div>
                <div class="goal-cost">${x(s.cost,s.currency||e.currency)} cost</div>
            </div>
            <div class="goal-card-yield">
                <div class="yield-value">+${x(n,a)}/mes</div>
    ...
    `}function It(){var a;(a=document.getElementById("btn-add-wealth-goal"))==null||a.addEventListener("click",async()=>{Le()}),document.querySelectorAll(".edit-wealth-goal").forEach(t=>{t.addEventListener("click",n=>{n.stopPropagation();const o=t.dataset.id,i=c.getState().wealthGoals.find(r=>r.id===o);i&&Le(i)})}),document.querySelectorAll(".delete-wealth-goal").forEach(t=>{t.addEventListener("click",async n=>{var r;n.stopPropagation();const o=t.dataset.id;await v.confirm("Eliminar objetivo","¿Estás seguro de que deseas eliminar este objetivo?")&&(c.deleteWealthGoal(o),(r=window.reRender)==null||r.call(window))})});const s=document.getElementById("inflation-slider");s&&s.addEventListener("change",t=>{var n;c.setInflationRate(t.target.value),(n=window.reRender)==null||n.call(window)});const e=document.getElementById("years-slider");e&&e.addEventListener("change",t=>{var n;c.setProjectionYears(t.target.value),(n=window.reRender)==null||n.call(window)})}async function Le(s=null){const e=!!s,a=e?"Editar Objetivo":"Nuevo Objetivo Patrimonial",t=document.createElement("div");t.className="modal-overlay active overlay-centered",t.innerHTML=`
    ...
    `,document.body.appendChild(t);const n=t.querySelector(".close-modal-btn"),o=t.querySelector("#save-goal-btn"),i=()=>{t.classList.remove("active"),setTimeout(()=>t.remove(),300)};n.addEventListener("click",i),t.addEventListener("click",r=>{r.target===t&&i()}),o.addEventListener("click",()=>{var f;const r=t.querySelector("#goal-name").value,l=parseFloat(t.querySelector("#goal-cost").value),m=parseFloat(t.querySelector("#goal-growth").value)||0,u=parseFloat(t.querySelector("#goal-dividend").value)||0,d=t.querySelector("#goal-currency").value;if(!r||isNaN(l)){v.toast("Completa nombre y coste","error");return}const g={name:r,cost:l,annualGrowth:m,dividendYield:u,currency:d};e?(c.updateWealthGoal(s.id,g),v.toast("Objetivo actualizado")):(c.addWealthGoal(g),v.toast("Objetivo creado")),i(),(f=window.reRender)==null||f.call(window)})}let P="summary";function Te(){const s=c.getState(),e=s.currencySymbol;return setTimeout(P==="markets"||P==="goals"?N:O,0),`
    <div class="finance-page stagger-children" style="padding-bottom: 80px;">
      ...
      ${P==="summary"?Ct(s,e):P==="goals"?St():yt()}
      
    </div>
  `}function Ct(s,e){const a=c.getPassiveIncome(),t=c.getLivingExpenses(),n=c.getNetPassiveIncome(),o=c.getInvestmentAssetsValue(),i=c.getTotalLiabilities(),r=c.getNetWorth(),l=c.getAllIncomes(),m=c.getAllExpenses(),u=c.getNetIncome();return`
      <div class="finance-top-grid animate-fade-in">
        ...
        <div class="card">
          ...
          <div class="stat-row">
            ...
            <span class="stat-value positive">${x(a,e)}</span>
          </div>
          <div class="stat-row">
            <span class="stat-label">
            ...
            <span class="stat-value negative">${x(t,e)}</span>
          </div>
        </div>
        ...
        <div class="card highlight-card ${n<0?"highlight-card-negative":""}">
          ...
          <div class="highlight-value ${n<0?"highlight-value-negative":""}">${x(n,e)}</div>
          <div class="highlight-label ${n<0?"highlight-label-negative":""}">
            ${n>=0?"🎉 ¡Libertad financiera alcanzada!":`Faltan ${x(Math.abs(n),e)}/mes`}
          </div>
        </div>
      </div>
      ...
      <div class="finance-balance-grid">
        <div class="summary-grid">
          <div class="summary-item">
            <div class="summary-value text-primary-accent">${x(o,e)}</div>
            <div class="summary-label">Activos</div>
          </div>
          <div class="summary-item">
            <div class="summary-value text-warning">${x(i,e)}</div>
      ...
      <div class="card">
        <div class="stat-row">
          ...
          <span class="stat-value positive">${x(l,e)}</span>
        </div>
        <div class="stat-row">
          <span class="stat-label">
            <span class="stat-dot expense"></span>
          ...
          <span class="stat-value negative">${x(m,e)}</span>
        </div>
  ...
  `}function At(s){const e=[...s.passiveAssets,...s.investmentAssets],a=s.liabilities;if(e.length===0)return"";const t={Bitcoin:{value:0,color:"#f59e0b"},Altcoins:{value:0,color:"#6366f1"},Inmuebles:{value:0,color:"#a855f7"},Bolsa:{value:0,color:"#00d4aa"},Oro:{value:0,color:"#fbbf24"},"Otros/Efe.":{value:0,color:"#94a3b8"}};e.forEach(u=>{const d=c.convertValue(u.value||0,u.currency||"EUR");u.currency==="BTC"?t.Bitcoin.value+=d:u.currency==="ETH"||u.currency==="XRP"||u.type==="crypto"?t.Altcoins.value+=d:u.type==="property"||u.type==="rental"?t.Inmuebles.value+=d:u.type==="stocks"||u.type==="etf"||u.currency==="SP500"?t.Bolsa.value+=d:u.currency==="GOLD"?t.Oro.value+=d:t["Otros/Efe."].value+=d});const n=a.filter(u=>u.type==="mortgage").reduce((u,d)=>u+c.convertValue(d.amount||0,d.currency||"EUR"),0);t.Inmuebles.value=Math.max(0,t.Inmuebles.value-n),s.hideRealEstate&&(t.Inmuebles.value=0);const o=Object.entries(t).filter(([u,d])=>d.value>0).sort((u,d)=>d[1].value-u[1].value),i=o.reduce((u,[d,g])=>u+g.value,0);if(i===0)return`
    ...
    `;let r=0;const l=o.map(([u,d])=>{const g=d.value/i*100,f=r;return r+=g,{name:u,percentage:g,color:d.color,start:f}}),m=l.map(u=>`${u.color} ${u.start}% ${u.start+u.percentage}%`).join(", ");return`
      ...
      <div class="allocation-container">
        <div class="pie-chart" style="background: conic-gradient(${m});">
          <div class="pie-center">
            <div class="pie-total">${x(i,s.currencySymbol)}</div>
  ...
  `}function Lt(s){const e=[...(s.activeIncomes||[]).map(t=>({...t,category:"activeIncome"})),...s.passiveAssets.map(t=>({...t,category:"passive"})),...s.investmentAssets.map(t=>({...t,category:"investment"})),...s.liabilities.map(t=>({...t,category:"liability"}))];if(e.length===0)return`
      <div class="empty-state">
    ...
    <div class="asset-list">
      ${e.map(t=>{const n=Tt(t.currency||t.type),o=Mt(t.currency||t.type),i=t.category==="liability",r=t.value||t.amount||0,l=c.convertValue(r,t.currency||"EUR");let m="";if(t.currency!==s.currency){const d={EUR:"€",USD:"$",BTC:"₿",ETH:"Ξ",XRP:"✕",GOLD:"oz",SP500:"pts",CHF:"Fr",GBP:"£",AUD:"A$",ARS:"$"}[t.currency]||t.currency;m=`<div class="asset-original-value">${r} ${d}</div>`}return`
          <div class="asset-item" data-id="${t.id}" data-category="${t.category}">
            ...
            <div>
              <div class="asset-value ${i?"text-warning":""}">
                ${t.category==="activeIncome"?"+":i?"-":""}${x(l,a)}
                ${t.category==="activeIncome"?'<span style="font-size: 10px; opacity: 0.7; font-weight: 400;">/mes</span>':""}
              </div>
              ${t.monthlyIncome?`<div class="asset-yield">+${x(c.convertValue(t.monthlyIncome,t.currency),a)}/mes</div>`:""}
              ${t.monthlyPayment?`<div class="asset-yield text-negative">-${x(c.convertValue(t.monthlyPayment,t.currency),a)}/mes</div>`:""}
            </div>
          </div>
        `}).join("")}
    </div>
  `}function Tt(s){return{property:"property",rental:"property",stocks:"stocks",etf:"stocks",SP500:"stocks",crypto:"crypto",BTC:"crypto",ETH:"crypto",XRP:"crypto",GOLD:"investment",cash:"cash",USD:"cash",EUR:"cash",savings:"cash",vehicle:"vehicle",debt:"debt",loan:"debt",mortgage:"debt",creditcard:"debt",salary:"cash",freelance:"cash",business:"property"}[s]||"cash"}function Mt(s){return{property:"building",rental:"building",stocks:"trendingUp",etf:"trendingUp",SP500:"trendingUp",crypto:"bitcoin",BTC:"bitcoin",ETH:"bitcoin",XRP:"bitcoin",GOLD:"package",cash:"dollarSign",USD:"dollarSign",EUR:"dollarSign",savings:"piggyBank",vehicle:"car",debt:"creditCard",loan:"landmark",mortgage:"home",creditcard:"creditCard",salary:"briefcase",freelance:"users",business:"building"}[s]||"dollarSign"}function Me(){const s=document.getElementById("tab-summary"),e=document.getElementById("tab-markets"),a=document.getElementById("tab-goals");if(s&&e&&a&&(s.addEventListener("click",()=>{var i;P="summary",(i=window.reRender)==null||i.call(window)}),e.addEventListener("click",()=>{var i;P="markets",(i=window.reRender)==null||i.call(window)}),a.addEventListener("click",()=>{var i;P="goals",(i=window.reRender)==null||i.call(window)})),P==="markets"){Et();return}if(P==="goals"){It();return}document.querySelectorAll(".asset-item").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.id,l=i.dataset.category;Fe(r,l)})});const n=document.getElementById("toggle-real-estate");n&&n.addEventListener("change",()=>{c.toggleRealEstate()});const o=document.getElementById("display-currency-select");o&&o.addEventListener("change",i=>{c.setCurrency(i.target.value)})}let H=10,K=7,W=null,X=null;function Dt(){const e=c.getState().currencySymbol,a=c.getNetWorth(),n=c.getNetIncome()*12,o=W!==null?W:a,i=X!==null?X:n,r=Ge(o,i,K,H);return`
    <div class="compound-page stagger-children" style="padding-bottom: 80px;">
      ...
      <div class="card">
        ...
        <div class="compound-input-group">
          ...
          <div class="compound-input-hint">Patrimonio actual: ${x(a,e)}</div>
        </div>
        ...
        <div class="compound-input-group">
          ...
          <div class="compound-input-hint">Ingreso neto anual: ${x(n,e)}</div>
        </div>
      ...
      <div class="card highlight-card">
        ...
        <div class="highlight-value" id="future-value">${x(r.finalValue,e)}</div>
      ...
      <div class="card">
        ...
        <div class="stat-row">
          ...
          <span class="stat-value neutral" id="initial-capital">${x(o,e)}</span>
        </div>
        ...
        <div class="stat-row">
          ...
          <span class="stat-value ${r.totalContributions>=0?"positive":"negative"}" id="total-contributed">${x(r.totalContributions,e)}</span>
        </div>
        ...
        <div class="stat-row">
          ...
          <span class="stat-value" style="color: var(--accent-secondary);" id="total-interest">${x(r.totalInterest,e)}</span>
        </div>
        ...
        <div class="stat-row" style="padding-top: var(--spacing-md); border-top: 1px solid rgba(255,255,255,0.1); margin-top: var(--spacing-sm);">
          ...
          <span class="stat-value positive" style="font-size: 20px;" id="final-value-breakdown">${x(r.finalValue,e)}</span>
        </div>
      </div>
      ...
      <div class="projection-table" id="projection-table">
        ${He(r.yearlyBreakdown,e)}
      </div>
    </div>
  `}function Ge(s,e,a,t){const n=a/100,o=[];let i=s,r=0,l=0;for(let m=1;m<=t;m++){const u=i,d=i*n;i+=d+e,r+=e,l+=d,o.push({year:m,startBalance:u,contribution:e,interest:d,endBalance:i,totalContributions:r,totalInterest:l})}return{finalValue:i,totalContributions:r,totalInterest:l,totalGrowth:i-s,growthMultiple:s>0?i/s:0,yearlyBreakdown:o}}function qe(s,e){if(s.length===0)return"";const a=Math.max(...s.map(n=>Math.abs(n.endBalance))),t=s.map((n,o)=>{const i=o/(s.length-1)*100,r=100-n.endBalance/a*100;return`${i},${r}`});return`
  ...
  `}function He(s,e){const a=[];for(let t=0;t<s.length;t++){const n=s[t];(t<5||(t+1)%5===0||t===s.length-1)&&a.push(n)}return`
    <div class="table-container">
      <table class="projection-data-table">
        ...
        <tbody>
          ${a.map(t=>`
            <tr>
              <td>${t.year}</td>
              <td class="${t.endBalance>=0?"positive":"negative"}">${x(t.endBalance,e)}</td>
              <td style="color: var(--accent-secondary);">+${x(t.interest,e)}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    </div>
  `}function Bt(s){const e=document.getElementById("back-to-finance"),a=document.getElementById("rate-slider"),t=document.getElementById("years-slider"),n=document.getElementById("principal-input"),o=document.getElementById("contribution-input"),i=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",s),n&&n.addEventListener("input",l=>{W=parseFloat(l.target.value)||0,J()}),o&&o.addEventListener("input",l=>{X=parseFloat(l.target.value)||0,J()}),i&&i.addEventListener("click",()=>{W=null;const l=c.getNetWorth();n.value=l,J()}),r&&r.addEventListener("click",()=>{X=null;const l=c.getNetIncome()*12;o.value=l,J()}),a&&a.addEventListener("input",l=>{K=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${K}%`,J()}),t&&t.addEventListener("input",l=>{H=parseInt(l.target.value),document.getElementById("years-value").textContent=`${H} años`,J()})}function J(){const e=c.getState().currencySymbol,a=W!==null?W:c.getNetWorth(),t=X!==null?X:c.getNetIncome()*12,n=Ge(a,t,K,H),o=document.getElementById("future-value"),i=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),m=document.getElementById("total-contributed"),u=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),g=document.getElementById("projection-chart"),f=document.getElementById("projection-table");o&&(o.textContent=x(n.finalValue,e)),i&&(i.textContent=`Valor Futuro en ${H} años`),r&&(r.innerHTML=`${n.totalGrowth>=0?"📈":"📉"} ${n.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=x(a,e)),m&&(m.textContent=x(n.totalContributions,e),m.className=`stat-value ${n.totalContributions>=0?"positive":"negative"}`),u&&(u.textContent=x(n.totalInterest,e)),d&&(d.textContent=x(n.finalValue,e)),g&&(g.innerHTML=qe(n.yearlyBreakdown)),f&&(f.innerHTML=He(n.yearlyBreakdown,e))}function Rt(){H=10,K=7,W=null,X=null}let oe=c.getState().lastMarketData||[],ie=!1,I={key:"price",direction:"desc"},Ve="";function Pt(){const s=c.getState(),e=s.currency||"EUR",a=s.currencySymbol||"€";if((oe.length===0||Ve!==e)&&(ie||ze(),oe.length===0))return`
        ...
        <div class="market-page stagger-children" style="padding-bottom: 80px;">
            ...
            ${t.map(n=>{const o=oe.filter(i=>i.category===n);return o.length===0?"":_t(n,o,a)}).join("")}
        </div>
    `}function _t(s,e,a){const t=[...e].sort((n,o)=>{let i=n[I.key],r=o[I.key];return typeof i=="string"&&(i=i.toLowerCase()),typeof r=="string"&&(r=r.toLowerCase()),i<r?I.direction==="asc"?-1:1:i>r?I.direction==="asc"?1:-1:0});return`
                        ...
                        <tbody>
                            ${t.map(n=>`
                                <tr>
                                    ...
                                    <td style="font-weight: 600; font-variant-numeric: tabular-nums;">${n.price!==null?x(n.price,a):"-"}</td>
                        ...
                        <div class="ex-health-main">
                            ...
                            <div class="ex-health-info">
                                ...
                                <div class="ex-health-stats">
                                    ...
                                    ${o.lastLog?`
                                        <span style="opacity: 0.3;">•</span>
                                        <span class="last-effort-badge-emoji" title="Último esfuerzo">${Ft(o.lastLog.rating)}</span>
                                    `:""}
                                </div>
                            </div>
                        </div>
    ...
    `}function Nt(s){return`
      ...
      <div class="card ai-calorie-card" style="margin-bottom: var(--spacing-2xl); display: flex; flex-direction: column; align-items: center;">
          <div class="summary-value" style="font-size: 28px;">${Gt(s)} kcal</div>
      ...
      <div class="calendar-top-layout">
        ...
        <div class="card calendar-view-card">
            <div class="calendar-mini-header">
                ...
                <span class="current-month">${Jt()}</span>
                    ...
                    <div class="card event-card">
                        ...
                        <div class="event-main-col" style="flex: 1;">
                            ...
                            <div class="event-details-row">
                                ...
                                ${a.repeat!=="none"?`<span class="event-repeat-tag">${ea(a.repeat)}</span>`:""}
                            </div>
                        </div>
      ...
      <div class="card">
        ...
        <div class="expense-breakdown-row">
            <div class="breakdown-item">
                <div class="breakdown-val">${x(o,e)}</div>
                <div class="breakdown-lbl">Vida</div>
            </div>
            <div class="breakdown-item">
                <div class="breakdown-val">${x(r,e)}</div>
                <div class="breakdown-lbl">Deuda</div>
            </div>
            <div class="breakdown-item">
                <div class="breakdown-val">${x(i,e)}</div>
  ...
  `}function sa(s,e){if(s.length===0)return`
            <div class="empty-state">
        ...
        <div class="asset-list">
            ${s.map(t=>{const n=c.convertValue(t.amount,t.currency||"EUR"),o=na(t.category);return`
    ...
    `}function na(s){switch(s){case"liability":return"landmark";case"livingExpense":return"shoppingCart";default:return"creditCard"}}function oa(s){const e=document.getElementById("back-to-finance");e&&e.addEventListener("click",s),document.querySelectorAll(".expense-item").forEach(t=>{t.addEventListener("click",()=>{const n=t.dataset.id,o=t.dataset.category;Fe(n,o)})})}const ia="modulepreload",ra=function(s){return"/life-dashboard/"+s},Be={},me=function(e,a,t){let n=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),r=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));n=Promise.allSettled(a.map(l=>{if(l=ra(l),l in Be)return;Be[l]=!0;const m=l.endsWith(".css"),u=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const d=document.createElement("link");if(d.rel=m?"stylesheet":ia,m||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),m)return new Promise((g,f)=>{d.addEventListener("load",g),d.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return n.then(i=>{for(const r of i||[])r.status==="rejected"&&o(r.reason);return e().catch(o)})};function la(){const s=C.isBioEnabled(),e=q.hasToken();return`
    ...
    `}function ca(){var t,n,o,i,r,l,m,u,d,g,f;(t=document.getElementById("toggle-bio"))==null||t.addEventListener("change",async h=>{if(h.target.checked){const k=await v.prompt("Activar Biometría","Introduce tu contraseña maestra para confirmar:","Tu contraseña","password");if(k)try{await C.registerBiometrics(k),v.toast("Biometría activada correctamente")}catch(w){await v.alert("Error",w.message),h.target.checked=!1}else h.target.checked=!1}else localStorage.setItem("life-dashboard/db_bio_enabled","false"),v.toast("Biometría desactivada","info")});const s=document.getElementById("btn-install-pwa");s&&setTimeout(()=>{if(window.deferredPrompt){const h=document.getElementById("install-pwa-card");h&&(h.style.display="block"),s.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:b}=await window.deferredPrompt.userChoice;if(b==="accepted"){v.toast("Instalando aplicación...");const k=document.getElementById("install-pwa-card");k&&(k.style.display="none")}window.deferredPrompt=null})}},1e3),(n=document.getElementById("connect-drive-btn"))==null||n.addEventListener("click",async()=>{try{await q.authenticate(),v.toast("Google Drive conectado"),typeof window.reRender=="function"&&window.reRender()}catch(h){v.alert("Error",h.message||"Error al conectar")}}),(o=document.getElementById("upload-drive-btn"))==null||o.addEventListener("click",async()=>{const h=document.getElementById("upload-drive-btn"),b=h.innerHTML;try{if(!await v.confirm("Subir a la Nube","Esto reemplazará TODO lo que tengas en Google Drive con tus datos locales. ¿Continuar?"))return;h.innerHTML='<div class="loading-spinner-sm"></div>',h.style.pointerEvents="none";const w=C.getVaultKey();await q.pushData(c.getState(),w),v.toast("Bóveda subida correctamente")}catch(k){console.error(k),v.alert("Error al subir",k.message)}finally{h.innerHTML=b,h.style.pointerEvents="auto"}}),(i=document.getElementById("download-drive-btn"))==null||i.addEventListener("click",async()=>{const h=document.getElementById("download-drive-btn"),b=h.innerHTML;try{if(!await v.confirm("Descargar de la Nube","Esto reemplazará TODOS tus datos locales con los que hay en la nube. Esta acción no se puede deshacer. ¿Continuar?"))return;h.innerHTML='<div class="loading-spinner-sm"></div>',h.style.pointerEvents="none";const w=C.getVaultKey(),S=await q.pullData(w);S?(c.resetState(S),await c.saveState(),v.toast("Datos descargados correctamente","success"),setTimeout(()=>window.location.reload(),1e3)):v.alert("Error","No se encontró una bóveda válida en Drive o el descifrado falló (¿Contraseña incorrecta?)")}catch(k){console.error("[Settings] Download failed:",k),v.alert("Error de Descarga",k.message||"Error desconocido al bajar datos")}finally{h.innerHTML=b,h.style.pointerEvents="auto"}}),(r=document.getElementById("export-data-btn"))==null||r.addEventListener("click",async()=>{try{v.toast("Preparando archivo encriptado...","info");const h=c.getState(),b=C.getVaultKey(),{SecurityService:k}=await me(async()=>{const{SecurityService:B}=await Promise.resolve().then(()=>Ee);return{SecurityService:B}},void 0),w=await k.encrypt(h,b),S=new Blob([JSON.stringify(w)],{type:"application/octet-stream"}),$=URL.createObjectURL(S),T=document.createElement("a"),R=new Date().toISOString().split("T")[0];T.href=$,T.download=`life_dashboard_backup_${R}.bin`,document.body.appendChild(T),T.click(),document.body.removeChild(T),URL.revokeObjectURL($),v.toast("Backup exportado correctamente")}catch(h){console.error("Export error:",h),v.alert("Error de Exportación","No se pudieron encriptar o descargar los datos.")}});const e=document.getElementById("import-backup-btn"),a=document.getElementById("import-backup-input");e==null||e.addEventListener("click",()=>{a==null||a.click()}),a==null||a.addEventListener("change",async h=>{var w;const b=(w=h.target.files)==null?void 0:w[0];if(!b)return;if(!await v.confirm("¿Importar Backup?","Esto sobreescribirá todos tus datos locales con los del archivo. ¿Deseas continuar?")){a.value="";return}try{const S=await b.text(),$=JSON.parse(S),T=C.getVaultKey(),{SecurityService:R}=await me(async()=>{const{SecurityService:V}=await Promise.resolve().then(()=>Ee);return{SecurityService:V}},void 0),B=await R.decrypt($,T);if(B)c.setState(B),await c.saveState(),v.toast("Backup importado correctamente"),setTimeout(()=>window.location.reload(),1e3);else throw new Error("No se pudo descifrar el archivo")}catch(S){console.error("Import error:",S),v.alert("Error de Importación","El archivo no es válido o la contraseña no coincide con la usada para el backup.")}finally{a.value=""}}),(l=document.getElementById("btn-logout"))==null||l.addEventListener("click",async()=>{await v.confirm("¿Cerrar sesión?","El acceso quedará bloqueado hasta que introduzcas tu clave.")&&(C.logout(),window.location.reload())}),(m=document.getElementById("btn-force-update"))==null||m.addEventListener("click",async()=>{if(await v.confirm("¿Forzar Actualización?","Esto recargará la página y limpiará la caché para obtener la última versión.")){if(window.caches)try{const b=await caches.keys();for(let k of b)await caches.delete(k)}catch(b){console.error("Error clearing cache",b)}window.location.reload(!0)}}),(u=document.getElementById("btn-save-gemini"))==null||u.addEventListener("click",()=>{var b;const h=(b=document.getElementById("gemini-api-key"))==null?void 0:b.value;h!==void 0&&(localStorage.setItem("life-dashboard/db_gemini_api_key",h.trim()),v.toast("API Key de Gemini guardada"))}),(d=document.getElementById("btn-save-drive-secret"))==null||d.addEventListener("click",()=>{const b=document.getElementById("drive-client-secret").value.trim();b?(localStorage.setItem("life-dashboard/drive_client_secret",b),v.toast("Secreto guardado correctamente")):(localStorage.removeItem("life-dashboard/drive_client_secret"),v.toast("Secreto eliminado, usando valor por defecto","info")),q.init().catch(console.error)}),(g=document.getElementById("toggle-drive-secret"))==null||g.addEventListener("click",h=>{const b=document.getElementById("drive-client-secret"),k=h.currentTarget,w=b.type==="password";b.type=w?"text":"password",k.innerHTML=p(w?"eyeOff":"eye")}),(f=document.getElementById("btn-factory-reset"))==null||f.addEventListener("click",async()=>{if(await v.hardConfirm("Borrar todos los datos","Esta acción eliminará permanentemente todos tus activos, ingresos, agenda y configuraciones de este dispositivo.","BORRAR")){const b="life-dashboard/";if(Object.keys(localStorage).forEach(k=>{k.startsWith(b)&&localStorage.removeItem(k)}),Object.keys(sessionStorage).forEach(k=>{k.startsWith(b)&&sessionStorage.removeItem(k)}),window.indexedDB.databases&&(await window.indexedDB.databases()).forEach(w=>window.indexedDB.deleteDatabase(w.name)),navigator.serviceWorker){const k=await navigator.serviceWorker.getRegistrations();for(let w of k)w.unregister()}v.toast("Aplicación reseteada","info"),setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now()},1e3)}})}function da(){return`
    ...
    `}function ua(s){var e,a;(e=document.getElementById("open-calendar"))==null||e.addEventListener("click",()=>{s("calendar")}),(a=document.getElementById("open-settings"))==null||a.addEventListener("click",()=>{s("settings")})}function pa(){const{social:s}=c.getState(),{people:e,columns:a}=s;return`
    ...
    `}function ma(s){const e=s.lastContact?Math.floor((Date.now()-new Date(s.lastContact).getTime())/864e5):null,a=s.color||"#3b82f6";return`
    ...
    `}function va(){window.socialListenersAttached||(window.socialListenersAttached=!0,document.addEventListener("click",s=>{const e=s.target.closest(".col-opts-btn");if(e){s.preventDefault(),s.stopPropagation(),ba(e.dataset.id,e);return}if(s.target.closest("#add-social-col-btn")){ga();return}if(s.target.closest("#add-person-btn")){window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person"}}));return}if(s.target.closest("#ideal-lead-btn")){ha();return}if(s.target.closest("#communications-mgr-btn")){me(()=>import("./CommunicationsModal-BP6uTfb6.js"),[]).then(n=>n.openCommunicationsModal());return}if(s.target.closest("#contact-sources-btn")){ka();return}const a=s.target.closest(".person-chat-btn");if(a){s.preventDefault(),s.stopPropagation(),me(()=>import("./CommunicationsModal-BP6uTfb6.js"),[]).then(n=>n.openCommunicationsModal(a.dataset.id));return}const t=s.target.closest(".person-card");if(t){ya(t.dataset.id);return}}),document.addEventListener("dragstart",s=>{const e=s.target.closest(".person-card");e&&(s.dataTransfer.setData("text/plain",e.dataset.id),e.classList.add("dragging"))}),document.addEventListener("dragend",s=>{const e=s.target.closest(".person-card");e&&e.classList.remove("dragging")}),document.addEventListener("dragover",s=>{const e=s.target.closest(".kanban-cards");e&&(s.preventDefault(),e.classList.add("drag-over"))}),document.addEventListener("dragleave",s=>{const e=s.target.closest(".kanban-cards");e&&e.classList.remove("drag-over")}),document.addEventListener("drop",s=>{const e=s.target.closest(".kanban-cards");if(e){s.preventDefault(),e.classList.remove("drag-over");const a=s.dataTransfer.getData("text/plain"),t=e.dataset.colId;a&&t&&c.movePerson(a,t)}}))}async function ga(){const s=await v.prompt("Etapa","Nombre de la etapa:");s&&(c.addSocialColumn({name:s,color:"#94a3b8"}),v.toast("Etapa agregada correctamente","success"))}async function ha(){const s=c.getState().social.idealLeadProfile||"",e=await fa(s);e!==null&&(c.updateIdealLeadProfile(e),v.toast("Perfil Ideal actualizado"))}function ya(s){const e=c.getState().social.people.find(a=>a.id===s);e&&window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person",person:e}}))}function fa(s){return new Promise(e=>{const a=document.createElement("div");a.className="modal-overlay active",a.style.zIndex="9999",a.innerHTML=`
            <div class="modal">
                <div class="modal-header">
        ...
        `,document.body.appendChild(a);const t=()=>{a.remove(),e(null)};a.querySelector(".modal-close").addEventListener("click",t),a.querySelector("#save-ideal-lead").addEventListener("click",()=>{const n=a.querySelector("#ideal-lead-text").value;a.remove(),e(n)}),a.addEventListener("click",n=>{n.target===a&&t()})})}function ba(s,e){document.querySelectorAll(".column-options-menu").forEach(i=>i.remove());const a=c.getState().social.columns.find(i=>i.id===s);if(!a)return;const t=document.createElement("div");t.className="column-options-menu",t.innerHTML=`
    ...
    `;const n=e.getBoundingClientRect();t.style.position="fixed",t.style.top=`${n.bottom+8}px`,t.style.right=`${window.innerWidth-n.right}px`,t.style.zIndex="9999",document.body.appendChild(t),t.querySelectorAll(".menu-item").forEach(i=>{i.addEventListener("click",async()=>{const r=i.dataset.action;if(t.remove(),r==="edit"){const l=await v.prompt("Nombre de Columna","Nuevo nombre:",a.name);l!=null&&l.trim()&&c.updateSocialColumn(s,{name:l.trim()})}else if(r==="color"){const l=await wa(a.color);l&&c.updateSocialColumn(s,{color:l})}else if(r==="delete")await v.confirm("Eliminar Etapa",`¿Eliminar "${a.name}"?`)&&c.deleteSocialColumn(s);else if(r==="move_up"||r==="move_down"){const l=[...c.getState().social.columns].sort((d,g)=>d.order-g.order),m=l.findIndex(d=>d.id===s);if(m===-1)return;const u=r==="move_up"?m-1:m+1;u>=0&&u<l.length&&([l[m].order,l[u].order]=[l[u].order,l[m].order],c.reorderSocialColumns(l))}})});const o=i=>{!t.contains(i.target)&&i.target!==e&&(t.remove(),document.removeEventListener("click",o))};setTimeout(()=>document.addEventListener("click",o),10)}function wa(s){return new Promise(e=>{const a=document.createElement("div");a.className="modal-overlay active",a.style.zIndex="99999",a.innerHTML=`
        ...
        `,document.body.appendChild(a);const t=()=>{a.remove(),e(null)};a.querySelector(".modal-close").addEventListener("click",t),a.querySelectorAll(".color-swatch").forEach(n=>n.addEventListener("click",()=>{a.querySelector("#stage-color-input").value=n.dataset.color,a.querySelectorAll(".color-swatch").forEach(o=>o.style.borderColor="transparent"),n.style.borderColor="white"})),a.querySelector("#save-stage-color").addEventListener("click",()=>{const n=a.querySelector("#stage-color-input").value;a.remove(),e(n)}),a.addEventListener("click",n=>{n.target===a&&t()})})}async function ka(){const{contactSources:s}=c.getState().social,e=await xa(s);e&&(c.updateContactSources(e),v.toast("Fuentes de contacto actualizadas"))}function xa(s){return new Promise(e=>{const a=document.createElement("div");a.className="modal-overlay active",a.style.zIndex="9999",a.innerHTML=`
        ...
        `,document.body.appendChild(a);const t=()=>{a.remove(),e(null)};a.querySelector(".modal-close").addEventListener("click",t),a.querySelector("#save-contact-sources").addEventListener("click",()=>{const o=a.querySelector("#contact-sources-text").value.split(",").map(i=>i.trim()).filter(i=>i.length>0);a.remove(),e(o)}),a.addEventListener("click",n=>{n.target===a&&t()})})}let re="tracker",D=null,ge=!1;function Ea(){const s=c.getState(),{activities:e=[],logs:a=[]}=s.timeInvest||{};return`
    <div class="time-invest-page stagger-children">
        ...
        ${re==="tracker"?Sa(e):$a(e,a)}

        ${D?Ia(e):""}
    </div>
    `}function Sa(s){return`
    <div class="tracker-view animate-fade-in">
        ...
        <div class="card" style="margin-top: var(--spacing-xl);">
            <div class="toggle-row">
                ...
                <input type="checkbox" id="pomodoro-toggle" class="apple-switch" ${ge?"checked":""}>
            </div>
        </div>
    </div>
    `}function $a(s,e){const a=new Date,t=new Date(a.getTime()-7*24*60*60*1e3),n=s.map(i=>{const l=e.filter(u=>u.activityId===i.id&&new Date(u.date)>=t).reduce((u,d)=>u+(d.durationMinutes||0),0),m=l/7;return{name:i.name,totalMinutes:l,dailyAverage:m,color:i.color}}),o=Math.max(...n.map(i=>i.totalMinutes),60);return`
    ...
    `}function Ia(s){const e=s.find(t=>t.id===D.activityId),a=Ke(D.elapsedSeconds);return`
    <div class="timer-overlay animate-fade-in">
        ...
        ${ge?`<p style="margin-top: 40px; color: var(--text-muted); font-size: 14px;">Pomodoro activo (${c.getState().timeInvest.pomodoroTime} min)</p>`:""}
    </div>
    `}function Ke(s){const e=Math.floor(s/3600),a=Math.floor(s%3600/60),t=s%60;return`${e>0?e+":":""}${String(a).padStart(2,"0")}:${String(t).padStart(2,"0")}`}function Ca(){var s,e,a,t,n,o;(s=document.getElementById("tab-tracker"))==null||s.addEventListener("click",()=>{var i;re="tracker",(i=window.reRender)==null||i.call(window)}),(e=document.getElementById("tab-stats"))==null||e.addEventListener("click",()=>{var i;re="stats",(i=window.reRender)==null||i.call(window)}),document.querySelectorAll(".activity-btn").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.id;Aa(r)})}),(a=document.getElementById("pomodoro-toggle"))==null||a.addEventListener("change",i=>{ge=i.target.checked}),(t=document.getElementById("btn-stop-timer"))==null||t.addEventListener("click",()=>{confirm("¿Deseas cancelar esta sesión? No se guardarán los datos.")&&Re(!1)}),(n=document.getElementById("btn-complete-timer"))==null||n.addEventListener("click",()=>{Re(!0)}),(o=document.getElementById("btn-add-activity"))==null||o.addEventListener("click",()=>{v.toast("Función de personalización próximamente...","info")})}function Aa(s){var e;D||(D={activityId:s,startTime:Date.now(),elapsedSeconds:0,interval:setInterval(()=>{D.elapsedSeconds=Math.floor((Date.now()-D.startTime)/1e3);const a=document.querySelector(".timer-display");if(a&&(a.textContent=Ke(D.elapsedSeconds)),ge){const t=c.getState().timeInvest.pomodoroTime||25;D.elapsedSeconds===t*60&&(La(),v.toast("¡Tiempo Pomodoro cumplido!","success"))}},1e3)},(e=window.reRender)==null||e.call(window))}function Re(s=!1){var e;if(D){if(clearInterval(D.interval),s){const a=Math.floor(D.elapsedSeconds/60);a>=1?(c.addTimeLog({activityId:D.activityId,date:new Date().toISOString(),durationMinutes:a}),v.toast(`¡Excelente! Has invertido ${a} min.`,"success")):v.toast("Sesión muy corta para ser registrada.","info")}D=null,(e=window.reRender)==null||e.call(window)}}function La(){try{const s=new(window.AudioContext||window.webkitAudioContext),e=s.createOscillator(),a=s.createGain();e.connect(a),a.connect(s.destination),e.type="sine",e.frequency.setValueAtTime(880,s.currentTime),a.gain.setValueAtTime(0,s.currentTime),a.gain.linearRampToValueAtTime(.5,s.currentTime+.1),a.gain.exponentialRampToValueAtTime(.01,s.currentTime+1),e.start(s.currentTime),e.stop(s.currentTime+1)}catch(s){console.error("Audio error:",s)}}const xe={passiveAsset:{label:"Ingresos Pasivos",icon:"building",types:[{value:"rental",label:"Inmueble en Renta"},{value:"stocks",label:"Acciones/Dividendos"},{value:"etf",label:"ETF/Fondos"},{value:"bonds",label:"Bonos"},{value:"crypto",label:"Crypto Staking"},{value:"business",label:"Negocio Pasivo"},{value:"royalties",label:"Regalías"},{value:"other",label:"Otro"}]},activeIncome:{label:"Ingreso Activo",icon:"briefcase",types:[{value:"salary",label:"Salario"},{value:"freelance",label:"Freelance"},{value:"business",label:"Negocio Activo"},{value:"other",label:"Otro"}]},livingExpense:{label:"Gasto de Vida",icon:"receipt",types:[{value:"rent",label:"Alquiler/Hipoteca"},{value:"utilities",label:"Servicios"},{value:"food",label:"Alimentación"},{value:"transport",label:"Transporte"},{value:"insurance",label:"Seguros"},{value:"health",label:"Salud"},{value:"other",label:"Otro"}]},investmentAsset:{label:"Activo de Inversión",icon:"trendingUp",types:[{value:"property",label:"Inmueble"},{value:"stocks",label:"Acciones"},{value:"etf",label:"ETF/Fondos"},{value:"crypto",label:"Criptomoneda"},{value:"cash",label:"Efectivo/Ahorro"},{value:"vehicle",label:"Vehículo"},{value:"collectibles",label:"Coleccionables"},{value:"other",label:"Otro"}]},liability:{label:"Pasivo/Deuda",icon:"creditCard",types:[{value:"mortgage",label:"Hipoteca"},{value:"loan",label:"Préstamo Personal"},{value:"carloan",label:"Préstamo Auto"},{value:"creditcard",label:"Tarjeta de Crédito"},{value:"studentloan",label:"Préstamo Estudiantil"},{value:"other",label:"Otra Deuda"}]},event:{label:"Evento/Cita",icon:"calendar",types:[{value:"event",label:"Evento Puntual"},{value:"reminder",label:"Recordatorio"},{value:"meeting",label:"Reunión"},{value:"other",label:"Otro"}]}},Pe=[{value:"EUR",label:"Euro (€)"},{value:"USD",label:"Dólar ($)"},{value:"CHF",label:"Franco Suizo (Fr)"},{value:"GBP",label:"Libra (£)"},{value:"AUD",label:"Dólar Aus. (A$)"},{value:"ARS",label:"Peso Arg. ($)"}];let L="passiveAsset";function we(s="passiveAsset"){var a,t;L=s,(t=(a=xe[L])==null?void 0:a.types[0])!=null&&t.value;const e=document.createElement("div");e.className="modal-overlay",e.id="add-modal",e.innerHTML=Ta(),document.body.appendChild(e),requestAnimationFrame(()=>{e.classList.add("active")}),Ma()}function Ta(){return`
    <div class="modal">
      <div class="modal-handle"></div>
      <div class="modal-header">
  ...
  `}function Ye(){const s=xe[L],e=L==="investmentAsset"||L==="passiveAsset";if(e){const t=z.map(n=>({value:n.symbol,label:`${n.name} (${n.symbol})`}));[...Pe,...t]}let a="";return L==="passiveAsset"||L==="investmentAsset"?a=`
    ...
    <div class="form-row">
        ...
        <div class="form-group" style="flex: 1.5;">
            ...
            <select class="form-input form-select" id="input-currency">
                <optgroup label="Divisas">
                    ${Pe.map(t=>`<option value="${t.value}">${t.label}</option>`).join("")}
                </optgroup>
                ${e?`
                <optgroup label="Mercados Reales (Auto-Price)">
                    ${z.map(t=>`<option value="${t.symbol}">${t.name} (${t.symbol})</option>`).join("")}
                </optgroup>
                `:""}
            </select>
        </div>
  ...
  `}function Ma(){const s=document.getElementById("add-modal"),e=document.getElementById("modal-close");s.addEventListener("click",t=>{t.target===s&&ke()}),e.addEventListener("click",ke);const a=s.querySelectorAll(".category-selector .type-option");a.forEach(t=>{t.addEventListener("click",()=>{L=t.dataset.category,a.forEach(n=>n.classList.remove("active")),t.classList.add("active"),document.getElementById("form-container").innerHTML=Ye(),_e()})}),_e()}function _e(){const s=document.getElementById("btn-save");s&&s.addEventListener("click",Da);const e=document.getElementById("mode-qty"),a=document.getElementById("mode-total"),t=document.getElementById("input-qty"),n=document.getElementById("input-value"),o=document.getElementById("input-currency"),i=document.getElementById("input-name");if(e&&a){const l=m=>{m==="qty"?(e.style.background="var(--accent-primary)",e.style.color="var(--bg-primary)",a.style.background="transparent",a.style.color="var(--text-secondary)",t.focus()):(a.style.background="var(--accent-primary)",a.style.color="var(--bg-primary)",e.style.background="transparent",e.style.color="var(--text-secondary)",n.focus())};e.addEventListener("click",()=>l("qty")),a.addEventListener("click",()=>l("total"))}const r=l=>{const m=c.getState().rates,u=o==null?void 0:o.value,d=m[u]||1;if(l==="qty"){const g=parseFloat(t.value)||0;n.value=(g*d).toFixed(2)}else{const g=parseFloat(n.value)||0;t.value=(g/d).toFixed(6)}};t==null||t.addEventListener("input",()=>r("qty")),n==null||n.addEventListener("input",()=>r("total")),o&&o.addEventListener("change",()=>{if(i&&!i.value){const l=o.options[o.selectedIndex].text;i.value=l.split(" (")[0]}r("qty")})}function Da(){var f,h,b,k,w,S,$,T,R,B,V,se;const s=(h=(f=document.getElementById("input-name"))==null?void 0:f.value)==null?void 0:h.trim(),e=(b=document.getElementById("input-type"))==null?void 0:b.value,a=(k=document.getElementById("input-currency"))==null?void 0:k.value,t=(S=(w=document.getElementById("input-details"))==null?void 0:w.value)==null?void 0:S.trim(),n=parseFloat(($=document.getElementById("input-value"))==null?void 0:$.value)||0,o=document.getElementById("input-qty"),i=o?parseFloat(o.value)||0:n,r=parseFloat((T=document.getElementById("input-amount"))==null?void 0:T.value)||0,l=parseFloat((R=document.getElementById("input-monthly"))==null?void 0:R.value)||0,m=(B=document.getElementById("input-date"))==null?void 0:B.value,u=(V=document.getElementById("input-time"))==null?void 0:V.value,d=(se=document.getElementById("input-repeat"))==null?void 0:se.value;if(!s){v.alert("Campo Obligatorio","Por favor ingresa un nombre para el elemento.");return}const g={name:s,type:e,currency:a,details:t};switch(L){case"passiveAsset":c.addPassiveAsset({...g,value:i,monthlyIncome:l});break;case"activeIncome":c.addActiveIncome({...g,amount:r});break;case"livingExpense":c.addLivingExpense({...g,amount:r});break;case"investmentAsset":c.addInvestmentAsset({...g,value:i});break;case"liability":c.addLiability({...g,amount:r,monthlyPayment:l});break;case"event":c.addEvent({title:s,date:m,time:u,repeat:d,category:e});break}ke()}function ke(){const s=document.getElementById("add-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300))}let Y=null;function We(s=null){console.log("[LeadModal] Opening modal",{personToEdit:s});const e=document.getElementById("add-person-modal");e&&(console.log("[LeadModal] Removing existing modal"),e.remove()),Y=s?s.id:null;const a=document.createElement("div");a.className="modal-overlay",a.id="add-person-modal",a.setAttribute("role","dialog"),a.innerHTML=Ba(s),document.body.appendChild(a),setTimeout(()=>{var t;a.classList.add("active"),(t=a.querySelector("#person-name"))==null||t.focus()},50),Ra(a)}function Ba(s=null){const e=s?"Editar Lead":"Lead",a=s?"Guardar Cambios":"Lead";return`
    <div class="modal">
      <div class="modal-handle"></div>
      <div class="modal-header">
  ...
  `}function Ra(s){const e=s.querySelector("#person-modal-close"),a=s.querySelector("#btn-save-person-lead"),t=s.querySelector("#btn-delete-person"),n=s.querySelector("#person-rating-slider"),o=s.querySelector("#rating-value");if(s.addEventListener("click",l=>{l.target===s&&(console.log("[LeadModal] Overlay clicked, closing"),ve(s))}),e==null||e.addEventListener("click",()=>{console.log("[LeadModal] Close button clicked"),ve(s)}),n&&o){const l=()=>{console.log("[LeadModal] Slider updated:",n.value),o.textContent=n.value};n.oninput=l,n.onchange=l}a&&(a.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Save button clicked"),_a(s)}),t&&(t.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Delete button clicked"),Pa(s)});const i=s.querySelectorAll(".goal-color-dot"),r=s.querySelector("#person-color-value");i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(m=>m.classList.remove("active")),l.classList.add("active"),r&&(r.value=l.dataset.color),console.log("[LeadModal] Color selected:",l.dataset.color)})})}async function Pa(s){Y&&await v.confirm("Eliminar Lead","¿Estás seguro de eliminar este lead?")&&(c.deletePerson(Y),v.toast("Lead eliminado","success"),ve(s))}function _a(s){var a,t,n,o,i,r,l,m,u,d,g,f,h;const e=s.querySelector("#btn-save-person-lead");if(e.disabled){console.log("[LeadModal] Save ignored, already processing");return}try{const b=(t=(a=s.querySelector("#person-name"))==null?void 0:a.value)==null?void 0:t.trim(),k=(o=(n=s.querySelector("#person-phone"))==null?void 0:n.value)==null?void 0:o.trim(),w=(r=(i=s.querySelector("#person-city"))==null?void 0:i.value)==null?void 0:r.trim(),S=(l=s.querySelector("#person-source"))==null?void 0:l.value,$=(m=s.querySelector("#person-rating-slider"))==null?void 0:m.value,T=(d=(u=s.querySelector("#person-desc"))==null?void 0:u.value)==null?void 0:d.trim(),R=(g=s.querySelector("#person-column"))==null?void 0:g.value,B=(f=s.querySelector("#person-color-value"))==null?void 0:f.value,V=(h=s.querySelector("#person-last-contact"))==null?void 0:h.value;if(console.log("[LeadModal] Attempting to save",{name:b,rating:$,columnId:R,color:B,lastContact:V}),!b){console.warn("[LeadModal] Save failed: Missing name"),v.toast("El nombre es obligatorio","error");return}e.disabled=!0,e.innerHTML='<span class="loading-spinner-sm"></span> Guardando...';const se={name:b,phone:k,city:w,source:S,rating:parseInt($)||5,description:T,columnId:R,color:B,lastContact:V};Y?(console.log("[LeadModal] Updating person",Y),c.updatePerson(Y,se),v.toast("Lead actualizado correctamente","success")):(console.log("[LeadModal] Adding new person"),c.addPerson(se),v.toast("Lead guardado correctamente","success")),console.log("[LeadModal] Save successful, closing modal"),ve(s)}catch(b){console.error("[LeadModal] Error saving lead:",b),v.toast("Error al guardar el lead","error"),e.disabled=!1,e.innerHTML=`${p("plus")} Lead`}}function ve(s){s&&(console.log("[LeadModal] Closing modal"),s.classList.remove("active"),setTimeout(()=>{s.parentNode&&(console.log("[LeadModal] Removing modal from DOM"),s.remove())},400))}function ja(){const s=C.isSetup(),e=C.isBioEnabled();return`
    ...
    `}function Ua(s){var o;const e=document.getElementById("auth-submit-btn"),a=document.getElementById("auth-bio-btn"),t=document.getElementById("auth-password"),n=async()=>{const i=t.value,r=document.getElementById("auth-confirm"),l=C.isSetup();try{let m;if(l)m=await C.unlock(i);else{if(!i||i.length<4)throw new Error("Contraseña demasiado corta");if(i!==r.value)throw new Error("Las contraseñas no coinciden");m=await C.setup(i)}await c.loadEncrypted(m),s()}catch(m){v.alert("Error",m.message)}};e==null||e.addEventListener("click",n),t==null||t.addEventListener("keydown",i=>{i.key==="Enter"&&(i.preventDefault(),n())}),(o=document.getElementById("auth-confirm"))==null||o.addEventListener("keydown",i=>{i.key==="Enter"&&(i.preventDefault(),n())}),a==null||a.addEventListener("click",async()=>{try{const i=await C.unlockWithBiometrics();await c.loadEncrypted(i),s()}catch(i){v.alert("Identificación",i.message)}}),C.isBioEnabled()&&setTimeout(async()=>{try{const i=await C.unlockWithBiometrics();await c.loadEncrypted(i),s()}catch{console.log("Auto-bio failed or cancelled")}},500)}let _=localStorage.getItem("life-dashboard/app_current_page")||"finance",A=localStorage.getItem("life-dashboard/app_current_sub_page")||null;A==="null"&&(A=null);async function je(){window.addEventListener("open-add-modal",e=>{var t,n;const a=(t=e.detail)==null?void 0:t.type;a==="person"?We((n=e.detail)==null?void 0:n.person):we(a)}),q.init().catch(e=>console.warn("[Drive] Pre-init failed:",e));const s=C.getVaultKey();s?await c.loadEncrypted(s)?Xe():(console.error("[Boot] Decryption failed, invalid vault key in session?"),C.logout(),Ue()):Ue()}function Ue(){const s=document.getElementById("app");s.innerHTML=ja(),Ua(()=>{Xe()})}function Xe(){const s=document.getElementById("app");s.innerHTML=`
        <main id="main-content"></main>
        <nav id="bottom-nav"></nav>
    `,Je(),c.subscribe(()=>{j()}),window.reRender=()=>j(),Oa()}function Oa(){var t,n;const s=localStorage.getItem("life-dashboard/pwa_install_dismissed");if(s&&(Date.now()-parseInt(s))/864e5<7||window.matchMedia("(display-mode: standalone)").matches)return;const e=document.createElement("div");e.className="pwa-install-banner",e.id="pwa-install-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(e);const a=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};a(),window.addEventListener("beforeinstallprompt",a),(t=document.getElementById("pwa-banner-install"))==null||t.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:o}=await window.deferredPrompt.userChoice;o==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(n=document.getElementById("pwa-banner-close"))==null||n.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function Je(){const s=document.getElementById("bottom-nav");s.innerHTML=Ce(_),Ae(e=>{_=e,A=null,localStorage.setItem("life-dashboard/app_current_page",_),localStorage.setItem("life-dashboard/app_current_sub_page",A),O(),j(),s.innerHTML=Ce(_),Ae(a=>{_=a,A=null,localStorage.setItem("life-dashboard/app_current_page",_),localStorage.setItem("life-dashboard/app_current_sub_page",A),O(),j(),Je()})}),Na(),j()}function j(){const s=document.getElementById("main-content");if(!s)return;const e=s.scrollTop;if(A==="compound"){s.innerHTML=Dt(),Bt(()=>{A=null,Rt(),O(),j()}),s.scrollTop=e;return}if(A==="expenses"){s.innerHTML=aa(),oa(()=>{A=null,O(),j()}),s.scrollTop=e;return}if(A==="market"){s.innerHTML=Pt(),jt(()=>{A=null,O(),j()}),s.scrollTop=e;return}switch(s.classList.toggle("no-padding-mobile",_==="health"),_){case"finance":O(),s.innerHTML=Te(),Me(),Oe();break;case"goals":N(),s.innerHTML=zt(),Yt();break;case"time-invest":N(),s.innerHTML=Ea(),Ca();break;case"social":N(),s.innerHTML=pa(),va();break;case"health":s.innerHTML=Ut(),qt(),N();break;case"menu":s.innerHTML=da(),ua(a=>{_=a,O(),j()}),N();break;case"calendar":s.innerHTML=Wt(),ta(),O();break;case"settings":s.innerHTML=la(),ca(),N();break;default:O(),s.innerHTML=Te(),Me(),Oe()}requestAnimationFrame(()=>{s.scrollTop=e})}function Oe(){const s=document.getElementById("open-compound");s&&s.addEventListener("click",()=>{A="compound",localStorage.setItem("life-dashboard/app_current_sub_page",A),N(),j()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{A="market",localStorage.setItem("life-dashboard/app_current_sub_page",A),N(),j()});const a=document.getElementById("open-expenses");a&&a.addEventListener("click",()=>{A="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",A),N(),j()})}function Na(){const s=document.querySelector(".fab");s&&s.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=p("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{if(_==="calendar")we("event");else if(_==="health"){const a=await ns.confirm("Log Metric","What do you want to record today?","Weight","Body Fat");if(a===!0){const t=await ns.prompt("Log Weight","Enter your current weight in kg:","","number");t&&c.addWeightLog(t)}else if(a===!1){const t=await ns.prompt("Body Fat","Enter your body fat %:","","number");t&&c.addFatLog(t)}}else _==="social"?We():we()}),document.body.appendChild(e)}function N(){const s=document.getElementById("main-fab");s&&(s.style.display="none")}function O(){const s=document.getElementById("main-fab");s&&(s.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",je):je();window.addEventListener("beforeinstallprompt",s=>{s.preventDefault(),window.deferredPrompt=s,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});export{p as g,v as n,c as s};
