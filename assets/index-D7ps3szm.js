var Ke=Object.defineProperty;var Ye=(s,e,a)=>e in s?Ke(s,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[e]=a;var re=(s,e,a)=>Ye(s,typeof e!="symbol"?e+"":e,a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const We="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",Xe="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function Je(){var e,a,t,n,o,i,r,l,p,u,d,h,g,b,f;const s={EUR:1};try{const E=await(await fetch(We)).json();s.BTC=((e=E.bitcoin)==null?void 0:e.eur)||4e4,s.ETH=((a=E.ethereum)==null?void 0:a.eur)||2200,s.XRP=((t=E.ripple)==null?void 0:t.eur)||.5,s.KAS=((n=E.kaspa)==null?void 0:n.eur)||.1,s.SOL=((o=E.solana)==null?void 0:o.eur)||90,s.XLM=((i=E.stellar)==null?void 0:i.eur)||.11,s.ALGO=((r=E.algorand)==null?void 0:r.eur)||.18,s.LTC=((l=E.litecoin)==null?void 0:l.eur)||65,s.SUI=((p=E.sui)==null?void 0:p.eur)||1.1,s.LINK=((u=E.chainlink)==null?void 0:u.eur)||14,s.RNDR=((d=E["render-token"])==null?void 0:d.eur)||4.5,s.ADA=((h=E.cardano)==null?void 0:h.eur)||.45,s.ONDO=((g=E["ondo-finance"])==null?void 0:g.eur)||.7,(b=E.bitcoin)!=null&&b.ars&&((f=E.bitcoin)!=null&&f.eur)&&(s.ARS=E.bitcoin.eur/E.bitcoin.ars);const L=await fetch(Xe);if(L.ok){const k=await L.json();s.USD=1/k.rates.USD,s.CHF=1/k.rates.CHF,s.GBP=1/k.rates.GBP,s.AUD=1/k.rates.AUD}s.GOLD=2100,s.SP500=4700}catch(x){console.error("Failed to fetch some prices:",x),s.USD=s.USD||.92,s.CHF=s.CHF||1.05,s.GBP=s.GBP||1.15,s.AUD=s.AUD||.6,s.ARS=s.ARS||.001}return s}class G{static async hash(e,a="salt_life_dashboard_2026"){const n=new TextEncoder().encode(e+a),o=await crypto.subtle.digest("SHA-512",n);return Array.from(new Uint8Array(o)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,a){const t=new TextEncoder,n=await crypto.subtle.importKey("raw",t.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode(a),iterations:25e4,hash:"SHA-512"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,a){try{const t=crypto.getRandomValues(new Uint8Array(16)),n=crypto.getRandomValues(new Uint8Array(12)),o=await this.deriveKey(a,this.bufToBase64(t)),i=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(i),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},o,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(n),salt:this.bufToBase64(t),v:"5.0"}}catch(t){throw console.error("[Security] Encryption failed:",t),new Error("No se pudo encriptar la información")}}static async decrypt(e,a){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:t,iv:n,salt:o}=e,i=await this.deriveKey(a,o),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(n)},i,this.base64ToBuf(t)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(t){throw console.error("[Security] Decryption failed:",t),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(a=>a.charCodeAt(0)))}}const we=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:G},Symbol.toStringTag,{value:"Module"})),T={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class I{static isSetup(){return!!localStorage.getItem(T.MASTER_HASH)}static async setup(e){const a=await G.hash(e),t=await G.deriveVaultKey(e);return localStorage.setItem(T.MASTER_HASH,a),sessionStorage.setItem(T.VAULT_KEY,t),t}static async unlock(e){const a=await G.hash(e),t=localStorage.getItem(T.MASTER_HASH);if(a===t){const n=await G.deriveVaultKey(e);return sessionStorage.setItem(T.VAULT_KEY,n),n}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const a=sessionStorage.getItem(T.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const t=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:t,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(T.BIO_ENABLED,"true"),localStorage.setItem(T.VAULT_KEY,a),!0}catch(t){throw console.error("Biometric setup failed:",t),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(T.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const a=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:a,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const t=localStorage.getItem(T.VAULT_KEY);if(t)return sessionStorage.setItem(T.VAULT_KEY,t),t;throw new Error("Llave no encontrada. Usa contraseña.")}catch(a){throw console.error("Biometric auth failed:",a),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(T.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(T.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(T.BIO_ENABLED)==="true"}}const me="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",Ee=[71,79,67,83,80,88,45,112,121,52,68,109,80,83,107,45,100,75,55,99,73,66,116,106,65,81,75,90,70,75,118,95,66,87,95].map(s=>String.fromCharCode(s)).join(""),Ze="https://www.googleapis.com/auth/drive.file";class O{static hasToken(){const e=!!this.accessToken;return localStorage.getItem("life-dashboard/drive_connected")==="true"&&e}static async init(){return this._initPromise?this._initPromise:(this._initPromise=new Promise((e,a)=>{const t=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.codeClient=google.accounts.oauth2.initCodeClient({client_id:me,scope:Ze,ux_mode:"popup",access_type:"offline",prompt:"consent",callback:async n=>{if(n.error){console.error("[Drive] Auth callback error:",n);return}if(n.code)try{const o=sessionStorage.getItem("life-dashboard/pkce_verifier"),i=localStorage.getItem("life-dashboard/drive_client_secret")||Ee,r=await this.exchangeCodeForTokens(n.code,o,me,i);r.refresh_token&&await this.saveRefreshToken(r.refresh_token),this.saveSession(r),console.log("[Drive] Connected successfully via offline flow."),window.ns&&window.ns.toast("Google Drive vinculado"),typeof window.reRender=="function"&&window.reRender()}catch(o){console.error("[Drive] Token exchange error:",o),window.ns&&window.ns.alert("Error Auth","No se pudieron obtener tokens. Verifica el Client Secret.")}}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&this.ensureValidToken().catch(n=>{console.log("[Drive] Initial silent restoration skipped:",n.message)}),e(!0)}catch(n){console.error("[Drive] Init error:",n),a(n)}}):setTimeout(t,200)};t()}),this._initPromise)}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const a=e.expires_in||3600,t=Date.now()+a*1e3;localStorage.setItem("life-dashboard/drive_token_expiry",t.toString())}static async authenticate(){this.codeClient||await this.init();const{verifier:e}=await this.generatePKCE();sessionStorage.setItem("life-dashboard/pkce_verifier",e),this.codeClient.requestCode()}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(!(localStorage.getItem("life-dashboard/drive_connected")==="true"))return null;if(!this.accessToken||Date.now()>e-3e5){console.log("[Drive] Access token expired or near expiry, attempting refresh...");const n=await this.getRefreshToken();if(n)try{const o=localStorage.getItem("life-dashboard/drive_client_secret")||Ee,i=await this.refreshAccessToken(n,me,o),r={access_token:i.access_token,expires_in:i.expires_in,refresh_token:i.refresh_token||n};return i.refresh_token&&await this.saveRefreshToken(i.refresh_token),this.saveSession(r),this.accessToken}catch(o){throw console.error("[Drive] Token refresh failed:",o),new Error("Sesión de Google Drive expirada. Por favor reconecta en Configuración.")}else throw console.warn("[Drive] No refresh token found."),new Error("Google Drive no está vinculado para acceso offline.")}return this.accessToken&&(!gapi.client.getToken()||gapi.client.getToken().access_token!==this.accessToken)&&gapi.client.setToken({access_token:this.accessToken}),this.accessToken}static async generatePKCE(){const e=Array.from(crypto.getRandomValues(new Uint8Array(32))).map(i=>("0"+i.toString(16)).slice(-2)).join(""),t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t),o=btoa(String.fromCharCode(...new Uint8Array(n))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return{verifier:e,challenge:o}}static async exchangeCodeForTokens(e,a,t,n=null){const o=new URLSearchParams({client_id:t,code:e,grant_type:"authorization_code",redirect_uri:"postmessage"});a&&!n&&o.append("code_verifier",a),n&&o.append("client_secret",n);const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:o});if(!i.ok){const r=await i.json();throw new Error(r.error_description||"Failed to exchange code")}return await i.json()}static async refreshAccessToken(e,a,t=null){const n=new URLSearchParams({client_id:a,refresh_token:e,grant_type:"refresh_token"});t&&n.append("client_secret",t);const o=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n});if(!o.ok){const i=await o.json();throw new Error(i.error_description||"Failed to refresh token")}return await o.json()}static async saveRefreshToken(e){return new Promise((a,t)=>{const n=indexedDB.open("LifeDashboardAuthDB",1);n.onupgradeneeded=o=>{const i=o.target.result;i.objectStoreNames.contains("tokens")||i.createObjectStore("tokens")},n.onsuccess=o=>{const r=o.target.result.transaction("tokens","readwrite");r.objectStore("tokens").put(e,"drive_refresh_token"),r.oncomplete=()=>a(),r.onerror=l=>t(l)},n.onerror=o=>t(o)})}static async getRefreshToken(){return new Promise((e,a)=>{const t=indexedDB.open("LifeDashboardAuthDB",1);t.onupgradeneeded=n=>{const o=n.target.result;o.objectStoreNames.contains("tokens")||o.createObjectStore("tokens")},t.onsuccess=n=>{const o=n.target.result;if(!o.objectStoreNames.contains("tokens")){e(null);return}const l=o.transaction("tokens","readonly").objectStore("tokens").get("drive_refresh_token");l.onsuccess=()=>e(l.result),l.onerror=p=>a(p)},t.onerror=n=>a(n)})}static async clearTokens(){return localStorage.removeItem("life-dashboard/drive_access_token"),localStorage.removeItem("life-dashboard/drive_connected"),localStorage.removeItem("life-dashboard/drive_token_expiry"),new Promise(e=>{const a=indexedDB.open("LifeDashboardAuthDB",1);a.onsuccess=t=>{const n=t.target.result;if(n.objectStoreNames.contains("tokens")){const o=n.transaction("tokens","readwrite");o.objectStore("tokens").clear(),o.oncomplete=()=>e()}else e()},a.onerror=()=>e()})}static async getOrCreateFolderPath(e){var n;await this.ensureValidToken(),(n=gapi.client)!=null&&n.drive||await this.init();const a=e.split("/").filter(o=>o);let t="root";for(const o of a){const i=`name = '${o}' and mimeType = 'application/vnd.google-apps.folder' and '${t}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:i,fields:"files(id, name)"})).result.files;if(l&&l.length>0)t=l[0].id;else{const p={name:o,mimeType:"application/vnd.google-apps.folder",parents:[t]};t=(await gapi.client.drive.files.create({resource:p,fields:"id"})).result.id}}return t}static async pushData(e,a,t=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pushing encrypted data...${t?" (Retry)":""}`);const n=await this.getOrCreateFolderPath("/backup/life-dashboard/"),o=await G.encrypt(e,a),i="dashboard_vault_v5.bin",r=`name = '${i}' and '${n}' in parents and trashed = false`,p=(await gapi.client.drive.files.list({q:r,fields:"files(id)"})).result.files,u=new Blob([JSON.stringify(o)],{type:"application/json"});if(p&&p.length>0){const d=p[0].id,h=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${d}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:u});if(h.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,a,!0);if(!h.ok)throw new Error(`Error al actualizar backup: ${h.status}`)}else{const d={name:i,parents:[n]},h=new FormData;h.append("metadata",new Blob([JSON.stringify(d)],{type:"application/json"})),h.append("file",u);const g=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:h});if(g.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,a,!0);if(!g.ok)throw new Error(`Error al crear backup: ${g.status}`)}return!0}catch(n){throw console.error("[Drive] Push failed:",n),new Error(n.message||"Fallo al subir datos a Drive")}}static async pullData(e,a=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pulling data...${a?" (Retry)":""}`);const o=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,r=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)"})).result.files;if(!r||r.length===0)return null;const l=r[0].id,p=await fetch(`https://www.googleapis.com/drive/v3/files/${l}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(p.status===401&&!a)return await this.ensureValidToken(),await this.pullData(e,!0);if(!p.ok)throw new Error(`Error al descargar backup: ${p.status}`);const u=await p.json();return await G.decrypt(u,e)}catch(t){throw console.error("[Drive] Pull failed:",t),new Error(t.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");const t=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,o=(await gapi.client.drive.files.list({q:t,fields:"files(id)"})).result.files;if(o&&o.length>0){const i=o[0].id;return await gapi.client.drive.files.delete({fileId:i}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(e){throw console.error("[Drive] Deletion failed:",e),new Error(e.message||"Fallo al borrar backup en Drive")}}}re(O,"codeClient",null),re(O,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null),re(O,"_initPromise",null);const xe={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',chevronUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>',chevronDown:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',uploadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12V21"/><path d="m16 16-4-4-4 4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>',moreVertical:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>',check:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',menu:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>',users:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',messageSquare:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',phone:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',instagram:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>',facebook:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>',linkedin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>',alertCircle:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>',fingerprint:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 15.1a7 7 0 0 0 10.9 0"/><path d="M6 13.6a7 7 0 0 0 4.6 2.4"/><path d="M13.4 16a7 7 0 0 0 4.6-2.4"/><path d="M8 12.1a5 5 0 0 0 6.9 0"/><path d="M9.1 11a3 3 0 0 0 3.9 0"/><path d="M12 18.5V20"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',palette:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.555C21.965 6.012 17.461 2 12 2z"/></svg>',star:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>'};function m(s,e=""){return(xe[s]||xe.package).replace("<svg",`<svg class="${e}"`)}class Qe{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,a="success",t=3e3){const n=document.createElement("div");n.className=`toast toast-${a} stagger-in`;const o=a==="success"?"check":a==="error"?"alertCircle":"info";n.innerHTML=`
          ...
          <div class="form-group" style="flex: 1;">
              ...
              <select class="form-input form-select" id="edit-currency">
                  ...
                  <optgroup label="Mercados Reales">
                      ${H.map(o=>`<option value="${o.symbol}" ${o.symbol===s.currency?"selected":""}>${o.name} (${o.symbol})</option>`).join("")}
                  </optgroup>
                  `:""}
              </select>
          </div>
  ...
  `}function ct(s){const e=document.getElementById("edit-modal"),a=document.getElementById("edit-modal-close"),t=document.getElementById("btn-update"),n=document.getElementById("btn-delete");e.addEventListener("click",o=>{o.target===e&&de()}),a.addEventListener("click",de),t.addEventListener("click",()=>dt(s)),n.addEventListener("click",()=>ut(s))}function dt(s){var p,u,d,h,g,b,f,x,E;const e=(u=(p=document.getElementById("edit-name"))==null?void 0:p.value)==null?void 0:u.trim(),a=(d=document.getElementById("edit-type"))==null?void 0:d.value,t=(h=document.getElementById("edit-currency"))==null?void 0:h.value,n=(b=(g=document.getElementById("edit-details"))==null?void 0:g.value)==null?void 0:b.trim(),o=parseFloat((f=document.getElementById("edit-value"))==null?void 0:f.value)||0,i=parseFloat((x=document.getElementById("edit-amount"))==null?void 0:x.value)||0,r=parseFloat((E=document.getElementById("edit-monthly"))==null?void 0:E.value)||0;if(!e){v.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:a,currency:t,details:n};s.fields.includes("value")&&(l.value=o),s.fields.includes("amount")&&(l.amount=i),s.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),s.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),c[s.updateMethod](ie.id,l),de()}function ut(s){v.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${ie.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(c[s.deleteMethod](ie.id),v.toast("Eliminado correctamente","info"),de())})}function de(){const s=document.getElementById("edit-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300)),ie=null,X=null}let J=!1,Z=!1,S={key:"price",direction:"desc"},Q="USD",U=null;function pt(){const s=c.getState(),e=s.lastMarketData||[],a=s.marketFavorites||[];U===null&&(U=a.length>0?"favorites":"all"),!Z&&!J&&yt();const t=Q==="EUR"?"€":"$";let n=e;U==="favorites"&&(n=e.filter(i=>a.includes(i.id)));const o=Object.values(y);return`
        <div class="market-view animate-fade-in" style="padding: 4px;">
            ...
            <div class="market-controls-row">
                ...
                <div class="market-status-badge ${J?"market-status-fresh":"market-status-cached"}" title="Tasa de refresco: 5 min">
                    ${Z?'<div class="loading-spinner-sm" style="width:10px; height:10px;"></div>':m(J?"check":"save","tiny-icon")}
    ...
    `}function mt(s,e,a,t){const n=[...e].sort((o,i)=>{let r=o[S.key],l=i[S.key];return typeof r=="string"&&(r=r.toLowerCase()),typeof l=="string"&&(l=l.toLowerCase()),r<l?S.direction==="asc"?-1:1:r>l?S.direction==="asc"?1:-1:0});return`
    ...
    `}function vt(s,e,a){let t=s.price;if(s.price!==null&&Q==="EUR"){const r=c.getState().rates.USD||.92;t=s.price*r}const n=ge(s.change24h),o=ge(s.change30d),i=ge(s.change1y);return`
    ...
    `}function ge(s){return s==null?"":J?s>=0?"text-positive":"text-negative":"text-accent-primary"}function gt(){return`
    ...
    `}async function yt(){var s,e;if(!Z){Z=!0,(s=window.reRender)==null||s.call(window);try{const a=await _e();c.saveMarketData(a),J=!0}catch(a){console.error("Market update failed",a)}finally{Z=!1,(e=window.reRender)==null||e.call(window)}}}function ft(){var s,e,a;document.querySelectorAll(".capsule-btn").forEach(t=>{t.addEventListener("click",()=>{var o;const n=t.dataset.curr;n!==Q&&(Q=n,(o=window.reRender)==null||o.call(window))})}),(s=document.getElementById("filter-all"))==null||s.addEventListener("click",()=>{var t;U="all",(t=window.reRender)==null||t.call(window)}),(e=document.getElementById("filter-favs"))==null||e.addEventListener("click",()=>{var t;U="favorites",(t=window.reRender)==null||t.call(window)}),(a=document.getElementById("btn-show-all"))==null||a.addEventListener("click",()=>{var t;U="all",(t=window.reRender)==null||t.call(window)}),document.querySelectorAll(".btn-favorite").forEach(t=>{t.addEventListener("click",n=>{var i;n.stopPropagation();const o=t.dataset.id;c.toggleMarketFavorite(o),(i=window.reRender)==null||i.call(window)})}),document.querySelectorAll(".market-table th.sortable").forEach(t=>{t.addEventListener("click",()=>{var o;const n=t.dataset.sort;S.key===n?S.direction=S.direction==="asc"?"desc":"asc":(S.key=n,S.direction="desc",n==="name"&&(S.direction="asc")),(o=window.reRender)==null||o.call(window)})})}function bt(){const s=c.getState(),{wealthGoals:e=[],inflationRate:a=3,projectionYears:t=10,currencySymbol:n}=s,o=c.getAllExpenses();let i=0;e.forEach(d=>{const h=d.cost*(d.dividendYield/100)/12;i+=c.convertValue(h,d.currency||s.currency)});const r=i-o,l=o*Math.pow(1+a/100,t);let p=0;e.forEach(d=>{const g=d.cost*Math.pow(1+d.annualGrowth/100,t)*(d.dividendYield/100)/12;p+=c.convertValue(g,d.currency||s.currency)});const u=p-l;return`
            ...
            <div class="projection-grid">
                ...
                <div class="projection-col">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="positive">${w(p,n)}</span>
                    </div>
                    <div class="stat-row">
                    ...
                    <div class="stat-row divider">
                        ...
                        <span class="${u>=0?"positive":"negative"}">${w(u,n)}</span>
                    </div>
                </div>
            </div>
    ...
    `,document.body.appendChild(t);const n=t.querySelector(".close-modal-btn"),o=t.querySelector("#save-goal-btn"),i=()=>{t.classList.remove("active"),setTimeout(()=>t.remove(),300)};n.addEventListener("click",i),t.addEventListener("click",r=>{r.target===t&&i()}),o.addEventListener("click",()=>{var g;const r=t.querySelector("#goal-name").value,l=parseFloat(t.querySelector("#goal-cost").value),p=parseFloat(t.querySelector("#goal-growth").value)||0,u=parseFloat(t.querySelector("#goal-dividend").value)||0,d=t.querySelector("#goal-currency").value;if(!r||isNaN(l)){v.toast("Completa nombre y coste","error");return}const h={name:r,cost:l,annualGrowth:p,dividendYield:u,currency:d};e?(c.updateWealthGoal(s.id,h),v.toast("Objetivo actualizado")):(c.addWealthGoal(h),v.toast("Objetivo creado")),i(),(g=window.reRender)==null||g.call(window)})}let M="summary";function Ce(){const s=c.getState(),e=s.currencySymbol;return setTimeout(M==="markets"||M==="goals"?F:j,0),`
    <div class="finance-page stagger-children" style="padding-bottom: 80px;">
      ...
      <div class="segmented-control">
        <button class="segment-btn ${M==="summary"?"active":""}" id="tab-summary">
            Summary
        </button>
        <button class="segment-btn ${M==="markets"?"active":""}" id="tab-markets">
            Markets
        </button>
        <button class="segment-btn ${M==="goals"?"active":""}" id="tab-goals">
            Goals
        </button>
      </div>
      
      ${M==="summary"?xt(s,e):M==="markets"?pt():bt()}
      
    </div>
  `}function xt(s,e){const a=c.getPassiveIncome(),t=c.getLivingExpenses(),n=c.getNetPassiveIncome(),o=c.getInvestmentAssetsValue(),i=c.getTotalLiabilities(),r=c.getNetWorth(),l=c.getAllIncomes(),p=c.getAllExpenses(),u=c.getNetIncome();return`
      ...
      <div class="card">
        ...
        <div class="stat-row">
          ...
          <span class="stat-value negative">${w(p,e)}</span>
        </div>
  ...
  `}function kt(s){const e=[...s.passiveAssets,...s.investmentAssets],a=s.liabilities;if(e.length===0)return"";const t={Bitcoin:{value:0,color:"#f59e0b"},Altcoins:{value:0,color:"#6366f1"},Inmuebles:{value:0,color:"#a855f7"},Bolsa:{value:0,color:"#00d4aa"},Oro:{value:0,color:"#fbbf24"},"Otros/Efe.":{value:0,color:"#94a3b8"}};e.forEach(u=>{const d=c.convertValue(u.value||0,u.currency||"EUR");u.currency==="BTC"?t.Bitcoin.value+=d:u.currency==="ETH"||u.currency==="XRP"||u.type==="crypto"?t.Altcoins.value+=d:u.type==="property"||u.type==="rental"?t.Inmuebles.value+=d:u.type==="stocks"||u.type==="etf"||u.currency==="SP500"?t.Bolsa.value+=d:u.currency==="GOLD"?t.Oro.value+=d:t["Otros/Efe."].value+=d});const n=a.filter(u=>u.type==="mortgage").reduce((u,d)=>u+c.convertValue(d.amount||0,d.currency||"EUR"),0);t.Inmuebles.value=Math.max(0,t.Inmuebles.value-n),s.hideRealEstate&&(t.Inmuebles.value=0);const o=Object.entries(t).filter(([u,d])=>d.value>0).sort((u,d)=>d[1].value-u[1].value),i=o.reduce((u,[d,h])=>u+h.value,0);if(i===0)return`
    ...
    `;let r=0;const l=o.map(([u,d])=>{const h=d.value/i*100,g=r;return r+=h,{name:u,percentage:h,color:d.color,start:g}}),p=l.map(u=>`${u.color} ${u.start}% ${u.start+u.percentage}%`).join(", ");return`
      ...
      <div class="allocation-container">
        <div class="pie-chart" style="background: conic-gradient(${p});">
          <div class="pie-center">
            <div class="pie-total">${w(i,s.currencySymbol)}</div>
      ...
      ${e.map(t=>{const n=$t(t.currency||t.type),o=It(t.currency||t.type),i=t.category==="liability",r=t.value||t.amount||0,l=c.convertValue(r,t.currency||"EUR");let p="";if(t.currency!==s.currency){const d={EUR:"€",USD:"$",BTC:"₿",ETH:"Ξ",XRP:"✕",GOLD:"oz",SP500:"pts",CHF:"Fr",GBP:"£",AUD:"A$",ARS:"$"}[t.currency]||t.currency;p=`<div class="asset-original-value">${r} ${d}</div>`}return`
          <div class="asset-item" data-id="${t.id}" data-category="${t.category}">
            ...
            <div>
              ...
              ${t.monthlyIncome?`<div class="asset-yield">+${w(c.convertValue(t.monthlyIncome,t.currency),a)}/mes</div>`:""}
              ${t.monthlyPayment?`<div class="asset-yield text-negative">-${w(c.convertValue(t.monthlyPayment,t.currency),a)}/mes</div>`:""}
            </div>
          </div>
        `}).join("")}
    </div>
  `}function $t(s){return{property:"property",rental:"property",stocks:"stocks",etf:"stocks",SP500:"stocks",crypto:"crypto",BTC:"crypto",ETH:"crypto",XRP:"crypto",GOLD:"investment",cash:"cash",USD:"cash",EUR:"cash",savings:"cash",vehicle:"vehicle",debt:"debt",loan:"debt",mortgage:"debt",creditcard:"debt"}[s]||"cash"}function It(s){return{property:"building",rental:"building",stocks:"trendingUp",etf:"trendingUp",SP500:"trendingUp",crypto:"bitcoin",BTC:"bitcoin",ETH:"bitcoin",XRP:"bitcoin",GOLD:"package",cash:"dollarSign",USD:"dollarSign",EUR:"dollarSign",savings:"piggyBank",vehicle:"car",debt:"creditCard",loan:"landmark",mortgage:"home",creditcard:"creditCard"}[s]||"dollarSign"}function Ae(){const s=document.getElementById("tab-summary"),e=document.getElementById("tab-markets"),a=document.getElementById("tab-goals");if(s&&e&&a&&(s.addEventListener("click",()=>{var i;M="summary",(i=window.reRender)==null||i.call(window)}),e.addEventListener("click",()=>{var i;M="markets",(i=window.reRender)==null||i.call(window)}),a.addEventListener("click",()=>{var i;M="goals",(i=window.reRender)==null||i.call(window)})),M==="markets"){ft();return}if(M==="goals"){Et();return}document.querySelectorAll(".asset-item").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.id,l=i.dataset.category;Ue(r,l)})});const n=document.getElementById("toggle-real-estate");n&&n.addEventListener("change",()=>{c.toggleRealEstate()});const o=document.getElementById("display-currency-select");o&&o.addEventListener("change",i=>{c.setCurrency(i.target.value)})}let q=10,V=7,K=null,Y=null;function Ct(){const e=c.getState().currencySymbol,a=c.getNetWorth(),n=c.getNetIncome()*12,o=K!==null?K:a,i=Y!==null?Y:n,r=je(o,i,V,q);return`
  ...
  `}function At(s){const e=document.getElementById("back-to-finance"),a=document.getElementById("rate-slider"),t=document.getElementById("years-slider"),n=document.getElementById("principal-input"),o=document.getElementById("contribution-input"),i=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",s),n&&n.addEventListener("input",l=>{K=parseFloat(l.target.value)||0,W()}),o&&o.addEventListener("input",l=>{Y=parseFloat(l.target.value)||0,W()}),i&&i.addEventListener("click",()=>{K=null;const l=c.getNetWorth();n.value=l,W()}),r&&r.addEventListener("click",()=>{Y=null;const l=c.getNetIncome()*12;o.value=l,W()}),a&&a.addEventListener("input",l=>{V=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${V}%`,W()}),t&&t.addEventListener("input",l=>{q=parseInt(l.target.value),document.getElementById("years-value").textContent=`${q} años`,W()})}function W(){const e=c.getState().currencySymbol,a=K!==null?K:c.getNetWorth(),t=Y!==null?Y:c.getNetIncome()*12,n=je(a,t,V,q),o=document.getElementById("future-value"),i=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),p=document.getElementById("total-contributed"),u=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),h=document.getElementById("projection-chart"),g=document.getElementById("projection-table");o&&(o.textContent=w(n.finalValue,e)),i&&(i.textContent=`Valor Futuro en ${q} años`),r&&(r.innerHTML=`${n.totalGrowth>=0?"📈":"📉"} ${n.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=w(a,e)),p&&(p.textContent=w(n.totalContributions,e),p.className=`stat-value ${n.totalContributions>=0?"positive":"negative"}`),u&&(u.textContent=w(n.totalInterest,e)),d&&(d.textContent=w(n.finalValue,e)),h&&(h.innerHTML=Oe(n.yearlyBreakdown)),g&&(g.innerHTML=Ne(n.yearlyBreakdown,e))}function Lt(){q=10,V=7,K=null,Y=null}let ne=c.getState().lastMarketData||[],oe=!1,$={key:"price",direction:"desc"},Fe="";function Tt(){const s=c.getState(),e=s.currency||"EUR",a=s.currencySymbol||"€";if((ne.length===0||Fe!==e)&&(oe||Ge(),ne.length===0))return`
    ...
    `}function Dt(s,e,a){const t=[...e].sort((n,o)=>{let i=n[$.key],r=o[$.key];return typeof i=="string"&&(i=i.toLowerCase()),typeof r=="string"&&(r=r.toLowerCase()),i<r?$.direction==="asc"?-1:1:i>r?$.direction==="asc"?1:-1:0});return`
      ...
      <div class="calendar-top-layout">
        ...
        <div class="events-list-container" style="margin-top: var(--spacing-xl);">
            ...
            <div class="events-list">
                ...
                `:e.filter(a=>{const t=new Date(a.date);return t.getMonth()===N.getMonth()&&t.getFullYear()===N.getFullYear()}).sort((a,t)=>new Date(a.date)-new Date(t.date)).map(a=>`
  ...
  `}function Zt(s,e){if(s.length===0)return`
            ...
            <div class="card premium-settings-card">
                <div class="settings-item-row" id="drive-sync-row">
                    <div class="settings-item-info">
                        ...
                        <div class="settings-item-desc">${e?'<span class="status-badge connected">Conectado</span>':'<span class="status-badge disconnected">No conectado</span>'}</div>
                    </div>
                    ${e?`
    ...
    `}function na(){var t,n,o,i,r,l,p,u,d,h;(t=document.getElementById("toggle-bio"))==null||t.addEventListener("change",async g=>{if(g.target.checked){const f=await v.prompt("Activar Biometría","Introduce tu contraseña maestra para confirmar:","Tu contraseña","password");if(f)try{await I.registerBiometrics(f),v.toast("Biometría activada correctamente")}catch(x){await v.alert("Error",x.message),g.target.checked=!1}else g.target.checked=!1}else localStorage.setItem("life-dashboard/db_bio_enabled","false"),v.toast("Biometría desactivada","info")});const s=document.getElementById("btn-install-pwa");s&&setTimeout(()=>{if(window.deferredPrompt){const g=document.getElementById("install-pwa-card");g&&(g.style.display="block"),s.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:b}=await window.deferredPrompt.userChoice;if(b==="accepted"){v.toast("Instalando aplicación...");const f=document.getElementById("install-pwa-card");f&&(f.style.display="none")}window.deferredPrompt=null})}},1e3),(n=document.getElementById("connect-drive-btn"))==null||n.addEventListener("click",async()=>{try{await O.authenticate(),v.toast("Google Drive conectado"),typeof window.reRender=="function"&&window.reRender()}catch(g){v.alert("Error",g.message||"Error al conectar")}}),(o=document.getElementById("upload-drive-btn"))==null||o.addEventListener("click",async()=>{const g=document.getElementById("upload-drive-btn"),b=g.innerHTML;try{if(!await v.confirm("Subir a la Nube","Esto reemplazará TODO lo que tengas en Google Drive con tus datos locales. ¿Continuar?"))return;g.innerHTML='<div class="loading-spinner-sm"></div>',g.style.pointerEvents="none";const x=I.getVaultKey();await O.pushData(c.getState(),x),v.toast("Bóveda subida correctamente")}catch(f){console.error(f),v.alert("Error al subir",f.message)}finally{g.innerHTML=b,g.style.pointerEvents="auto"}}),(i=document.getElementById("download-drive-btn"))==null||i.addEventListener("click",async()=>{const g=document.getElementById("download-drive-btn"),b=g.innerHTML;try{if(!await v.confirm("Descargar de la Nube","Esto reemplazará TODOS tus datos locales con los que hay en la nube. Esta acción no se puede deshacer. ¿Continuar?"))return;g.innerHTML='<div class="loading-spinner-sm"></div>',g.style.pointerEvents="none";const x=I.getVaultKey(),E=await O.pullData(x);E?(c.resetState(E),await c.saveState(),v.toast("Datos descargados correctamente","success"),setTimeout(()=>window.location.reload(),1e3)):v.alert("Error","No se encontró una bóveda válida en Drive o el descifrado falló (¿Contraseña incorrecta?)")}catch(f){console.error("[Settings] Download failed:",f),v.alert("Error de Descarga",f.message||"Error desconocido al bajar datos")}finally{g.innerHTML=b,g.style.pointerEvents="auto"}}),(r=document.getElementById("export-data-btn"))==null||r.addEventListener("click",async()=>{try{v.toast("Preparando archivo encriptado...","info");const g=c.getState(),b=I.getVaultKey(),{SecurityService:f}=await ue(async()=>{const{SecurityService:D}=await Promise.resolve().then(()=>we);return{SecurityService:D}},void 0),x=await f.encrypt(g,b),E=new Blob([JSON.stringify(x)],{type:"application/octet-stream"}),L=URL.createObjectURL(E),k=document.createElement("a"),P=new Date().toISOString().split("T")[0];k.href=L,k.download=`life_dashboard_backup_${P}.bin`,document.body.appendChild(k),k.click(),document.body.removeChild(k),URL.revokeObjectURL(L),v.toast("Backup exportado correctamente")}catch(g){console.error("Export error:",g),v.alert("Error de Exportación","No se pudieron encriptar o descargar los datos.")}});const e=document.getElementById("import-backup-btn"),a=document.getElementById("import-backup-input");e==null||e.addEventListener("click",()=>{a==null||a.click()}),a==null||a.addEventListener("change",async g=>{var x;const b=(x=g.target.files)==null?void 0:x[0];if(!b)return;if(!await v.confirm("¿Importar Backup?","Esto sobreescribirá todos tus datos locales con los del archivo. ¿Deseas continuar?")){a.value="";return}try{const E=await b.text(),L=JSON.parse(E),k=I.getVaultKey(),{SecurityService:P}=await ue(async()=>{const{SecurityService:_}=await Promise.resolve().then(()=>we);return{SecurityService:_}},void 0),D=await P.decrypt(L,k);if(D)c.setState(D),await c.saveState(),v.toast("Backup importado correctamente"),setTimeout(()=>window.location.reload(),1e3);else throw new Error("No se pudo descifrar el archivo")}catch(E){console.error("Import error:",E),v.alert("Error de Importación","El archivo no es válido o la contraseña no coincide con la usada para el backup.")}finally{a.value=""}}),(l=document.getElementById("btn-logout"))==null||l.addEventListener("click",async()=>{await v.confirm("¿Cerrar sesión?","El acceso quedará bloqueado hasta que introduzcas tu clave.")&&(I.logout(),window.location.reload())}),(p=document.getElementById("btn-force-update"))==null||p.addEventListener("click",async()=>{if(await v.confirm("¿Forzar Actualización?","Esto recargará la página y limpiará la caché para obtener la última versión.")){if(window.caches)try{const b=await caches.keys();for(let f of b)await caches.delete(f)}catch(b){console.error("Error clearing cache",b)}window.location.reload(!0)}}),(u=document.getElementById("btn-save-gemini"))==null||u.addEventListener("click",()=>{var b;const g=(b=document.getElementById("gemini-api-key"))==null?void 0:b.value;g!==void 0&&(localStorage.setItem("life-dashboard/db_gemini_api_key",g.trim()),v.toast("API Key de Gemini guardada"))}),(d=document.getElementById("btn-save-drive-secret"))==null||d.addEventListener("click",()=>{var b;const g=(b=document.getElementById("drive-client-secret"))==null?void 0:b.value;g!==void 0&&(localStorage.setItem("life-dashboard/drive_client_secret",g.trim()),v.toast("Client Secret de Drive guardado"),O.hasToken()&&O.init().catch(console.error))}),(h=document.getElementById("btn-factory-reset"))==null||h.addEventListener("click",async()=>{if(await v.hardConfirm("Borrar todos los datos","Esta acción eliminará permanentemente todos tus activos, ingresos, agenda y configuraciones de este dispositivo.","BORRAR")){const b="life-dashboard/";if(Object.keys(localStorage).forEach(f=>{f.startsWith(b)&&localStorage.removeItem(f)}),Object.keys(sessionStorage).forEach(f=>{f.startsWith(b)&&sessionStorage.removeItem(f)}),window.indexedDB.databases&&(await window.indexedDB.databases()).forEach(x=>window.indexedDB.deleteDatabase(x.name)),navigator.serviceWorker){const f=await navigator.serviceWorker.getRegistrations();for(let x of f)x.unregister()}v.toast("Aplicación reseteada","info"),setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now()},1e3)}})}function oa(){return`
  ...
  `}function qe(){const s=be[A],e=A==="investmentAsset"||A==="passiveAsset";if(e){const t=H.map(n=>({value:n.symbol,label:`${n.name} (${n.symbol})`}));[...De,...t]}let a="";return A==="passiveAsset"||A==="investmentAsset"?a=`
        ...
        <div class="form-group" style="flex: 1.5;">
            ...
            <select class="form-input form-select" id="input-currency">
                ...
                <optgroup label="Mercados Reales (Auto-Price)">
                    ${H.map(t=>`<option value="${t.symbol}">${t.name} (${t.symbol})</option>`).join("")}
                </optgroup>
                `:""}
            </select>
        </div>
  ...
  `}function ba(){const s=document.getElementById("add-modal"),e=document.getElementById("modal-close");s.addEventListener("click",t=>{t.target===s&&fe()}),e.addEventListener("click",fe);const a=s.querySelectorAll(".category-selector .type-option");a.forEach(t=>{t.addEventListener("click",()=>{A=t.dataset.category,a.forEach(n=>n.classList.remove("active")),t.classList.add("active"),document.getElementById("form-container").innerHTML=qe(),Me()})}),Me()}function Me(){const s=document.getElementById("btn-save");s&&s.addEventListener("click",wa);const e=document.getElementById("mode-qty"),a=document.getElementById("mode-total"),t=document.getElementById("input-qty"),n=document.getElementById("input-value"),o=document.getElementById("input-currency"),i=document.getElementById("input-name");if(e&&a){const l=p=>{p==="qty"?(e.style.background="var(--accent-primary)",e.style.color="var(--bg-primary)",a.style.background="transparent",a.style.color="var(--text-secondary)",t.focus()):(a.style.background="var(--accent-primary)",a.style.color="var(--bg-primary)",e.style.background="transparent",e.style.color="var(--text-secondary)",n.focus())};e.addEventListener("click",()=>l("qty")),a.addEventListener("click",()=>l("total"))}const r=l=>{const p=c.getState().rates,u=o==null?void 0:o.value,d=p[u]||1;if(l==="qty"){const h=parseFloat(t.value)||0;n.value=(h*d).toFixed(2)}else{const h=parseFloat(n.value)||0;t.value=(h/d).toFixed(6)}};t==null||t.addEventListener("input",()=>r("qty")),n==null||n.addEventListener("input",()=>r("total")),o&&o.addEventListener("change",()=>{if(i&&!i.value){const l=o.options[o.selectedIndex].text;i.value=l.split(" (")[0]}r("qty")})}function wa(){var g,b,f,x,E,L,k,P,D,_,te,ae;const s=(b=(g=document.getElementById("input-name"))==null?void 0:g.value)==null?void 0:b.trim(),e=(f=document.getElementById("input-type"))==null?void 0:f.value,a=(x=document.getElementById("input-currency"))==null?void 0:x.value,t=(L=(E=document.getElementById("input-details"))==null?void 0:E.value)==null?void 0:L.trim(),n=parseFloat((k=document.getElementById("input-value"))==null?void 0:k.value)||0,o=document.getElementById("input-qty"),i=o?parseFloat(o.value)||0:n,r=parseFloat((P=document.getElementById("input-amount"))==null?void 0:P.value)||0,l=parseFloat((D=document.getElementById("input-monthly"))==null?void 0:D.value)||0,p=(_=document.getElementById("input-date"))==null?void 0:_.value,u=(te=document.getElementById("input-time"))==null?void 0:te.value,d=(ae=document.getElementById("input-repeat"))==null?void 0:ae.value;if(!s){v.alert("Campo Obligatorio","Por favor ingresa un nombre para el elemento.");return}const h={name:s,type:e,currency:a,details:t};switch(A){case"passiveAsset":c.addPassiveAsset({...h,value:i,monthlyIncome:l});break;case"activeIncome":c.addActiveIncome({...h,amount:r});break;case"livingExpense":c.addLivingExpense({...h,amount:r});break;case"investmentAsset":c.addInvestmentAsset({...h,value:i});break;case"liability":c.addLiability({...h,amount:r,monthlyPayment:l});break;case"event":c.addEvent({title:s,date:p,time:u,repeat:d,category:e});break}fe()}function fe(){const s=document.getElementById("add-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300))}let z=null;function He(s=null){console.log("[LeadModal] Opening modal",{personToEdit:s});const e=document.getElementById("add-person-modal");e&&(console.log("[LeadModal] Removing existing modal"),e.remove()),z=s?s.id:null;const a=document.createElement("div");a.className="modal-overlay",a.id="add-person-modal",a.setAttribute("role","dialog"),a.innerHTML=Ea(s),document.body.appendChild(a),setTimeout(()=>{var t;a.classList.add("active"),(t=a.querySelector("#person-name"))==null||t.focus()},50),xa(a)}function Ea(s=null){const e=s?"Editar Lead":"Lead",a=s?"Guardar Cambios":"Lead";return`
    <div class="modal">
      <div class="modal-handle"></div>
      <div class="modal-header">
  ...
  `}function xa(s){const e=s.querySelector("#person-modal-close"),a=s.querySelector("#btn-save-person-lead"),t=s.querySelector("#btn-delete-person"),n=s.querySelector("#person-rating-slider"),o=s.querySelector("#rating-value");if(s.addEventListener("click",l=>{l.target===s&&(console.log("[LeadModal] Overlay clicked, closing"),pe(s))}),e==null||e.addEventListener("click",()=>{console.log("[LeadModal] Close button clicked"),pe(s)}),n&&o){const l=()=>{console.log("[LeadModal] Slider updated:",n.value),o.textContent=n.value};n.oninput=l,n.onchange=l}a&&(a.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Save button clicked"),Sa(s)}),t&&(t.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Delete button clicked"),ka(s)});const i=s.querySelectorAll(".goal-color-dot"),r=s.querySelector("#person-color-value");i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(p=>p.classList.remove("active")),l.classList.add("active"),r&&(r.value=l.dataset.color),console.log("[LeadModal] Color selected:",l.dataset.color)})})}async function ka(s){z&&await v.confirm("Eliminar Lead","¿Estás seguro de eliminar este lead?")&&(c.deletePerson(z),v.toast("Lead eliminado","success"),pe(s))}function Sa(s){var a,t,n,o,i,r,l,p,u,d,h,g,b;const e=s.querySelector("#btn-save-person-lead");if(e.disabled){console.log("[LeadModal] Save ignored, already processing");return}try{const f=(t=(a=s.querySelector("#person-name"))==null?void 0:a.value)==null?void 0:t.trim(),x=(o=(n=s.querySelector("#person-phone"))==null?void 0:n.value)==null?void 0:o.trim(),E=(r=(i=s.querySelector("#person-city"))==null?void 0:i.value)==null?void 0:r.trim(),L=(l=s.querySelector("#person-source"))==null?void 0:l.value,k=(p=s.querySelector("#person-rating-slider"))==null?void 0:p.value,P=(d=(u=s.querySelector("#person-desc"))==null?void 0:u.value)==null?void 0:d.trim(),D=(h=s.querySelector("#person-column"))==null?void 0:h.value,_=(g=s.querySelector("#person-color-value"))==null?void 0:g.value,te=(b=s.querySelector("#person-last-contact"))==null?void 0:b.value;if(console.log("[LeadModal] Attempting to save",{name:f,rating:k,columnId:D,color:_,lastContact:te}),!f){console.warn("[LeadModal] Save failed: Missing name"),v.toast("El nombre es obligatorio","error");return}e.disabled=!0,e.innerHTML='<span class="loading-spinner-sm"></span> Guardando...';const ae={name:f,phone:x,city:E,source:L,rating:parseInt(k)||5,description:P,columnId:D,color:_,lastContact:te};z?(console.log("[LeadModal] Updating person",z),c.updatePerson(z,ae),v.toast("Lead actualizado correctamente","success")):(console.log("[LeadModal] Adding new person"),c.addPerson(ae),v.toast("Lead guardado correctamente","success")),console.log("[LeadModal] Save successful, closing modal"),pe(s)}catch(f){console.error("[LeadModal] Error saving lead:",f),v.toast("Error al guardar el lead","error"),e.disabled=!1,e.innerHTML=`${m("plus")} Lead`}}function pe(s){s&&(console.log("[LeadModal] Closing modal"),s.classList.remove("active"),setTimeout(()=>{s.parentNode&&(console.log("[LeadModal] Removing modal from DOM"),s.remove())},400))}function $a(){const s=I.isSetup(),e=I.isBioEnabled();return`
    ...
    `}function Ia(s){var o;const e=document.getElementById("auth-submit-btn"),a=document.getElementById("auth-bio-btn"),t=document.getElementById("auth-password"),n=async()=>{const i=t.value,r=document.getElementById("auth-confirm"),l=I.isSetup();try{let p;if(l)p=await I.unlock(i);else{if(!i||i.length<4)throw new Error("Contraseña demasiado corta");if(i!==r.value)throw new Error("Las contraseñas no coinciden");p=await I.setup(i)}await c.loadEncrypted(p),s()}catch(p){v.alert("Error",p.message)}};e==null||e.addEventListener("click",n),t==null||t.addEventListener("keydown",i=>{i.key==="Enter"&&(i.preventDefault(),n())}),(o=document.getElementById("auth-confirm"))==null||o.addEventListener("keydown",i=>{i.key==="Enter"&&(i.preventDefault(),n())}),a==null||a.addEventListener("click",async()=>{try{const i=await I.unlockWithBiometrics();await c.loadEncrypted(i),s()}catch(i){v.alert("Identificación",i.message)}}),I.isBioEnabled()&&setTimeout(async()=>{try{const i=await I.unlockWithBiometrics();await c.loadEncrypted(i),s()}catch{console.log("Auto-bio failed or cancelled")}},500)}let B=localStorage.getItem("life-dashboard/app_current_page")||"finance",C=localStorage.getItem("life-dashboard/app_current_sub_page")||null;C==="null"&&(C=null);async function Be(){window.addEventListener("open-add-modal",e=>{var t,n;const a=(t=e.detail)==null?void 0:t.type;a==="person"?He((n=e.detail)==null?void 0:n.person):ye(a)}),O.init().catch(e=>console.warn("[Drive] Pre-init failed:",e));const s=I.getVaultKey();s?await c.loadEncrypted(s)?Ve():(console.error("[Boot] Decryption failed, invalid vault key in session?"),I.logout(),Re()):Re()}function Re(){const s=document.getElementById("app");s.innerHTML=$a(),Ia(()=>{Ve()})}function Ve(){const s=document.getElementById("app");s.innerHTML=`
        <main id="main-content"></main>
        <nav id="bottom-nav"></nav>
    `,ze(),c.subscribe(()=>{R()}),window.reRender=()=>R(),Ca()}function Ca(){var t,n;const s=localStorage.getItem("life-dashboard/pwa_install_dismissed");if(s&&(Date.now()-parseInt(s))/864e5<7||window.matchMedia("(display-mode: standalone)").matches)return;const e=document.createElement("div");e.className="pwa-install-banner",e.id="pwa-install-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(e);const a=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};a(),window.addEventListener("beforeinstallprompt",a),(t=document.getElementById("pwa-banner-install"))==null||t.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:o}=await window.deferredPrompt.userChoice;o==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(n=document.getElementById("pwa-banner-close"))==null||n.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function ze(){const s=document.getElementById("bottom-nav");s.innerHTML=Se(B),$e(e=>{B=e,C=null,localStorage.setItem("life-dashboard/app_current_page",B),localStorage.setItem("life-dashboard/app_current_sub_page",C),j(),R(),s.innerHTML=Se(B),$e(a=>{B=a,C=null,localStorage.setItem("life-dashboard/app_current_page",B),localStorage.setItem("life-dashboard/app_current_sub_page",C),j(),R(),ze()})}),Aa(),R()}function R(){const s=document.getElementById("main-content");if(!s)return;const e=s.scrollTop;if(C==="compound"){s.innerHTML=Ct(),At(()=>{C=null,Lt(),j(),R()}),s.scrollTop=e;return}if(C==="expenses"){s.innerHTML=Jt(),ea(()=>{C=null,j(),R()}),s.scrollTop=e;return}if(C==="market"){s.innerHTML=Tt(),Mt(()=>{C=null,j(),R()}),s.scrollTop=e;return}switch(s.classList.toggle("no-padding-mobile",B==="health"),B){case"finance":j(),s.innerHTML=Ce(),Ae(),Pe();break;case"goals":F(),s.innerHTML=Ft(),qt();break;case"social":F(),s.innerHTML=ra(),ca();break;case"health":s.innerHTML=Bt(),jt(),F();break;case"menu":s.innerHTML=oa(),ia(a=>{B=a,j(),R()}),F();break;case"calendar":s.innerHTML=Ht(),Xt(),j();break;case"settings":s.innerHTML=sa(),na(),F();break;default:j(),s.innerHTML=Ce(),Ae(),Pe()}requestAnimationFrame(()=>{s.scrollTop=e})}function Pe(){const s=document.getElementById("open-compound");s&&s.addEventListener("click",()=>{C="compound",localStorage.setItem("life-dashboard/app_current_sub_page",C),F(),R()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{C="market",localStorage.setItem("life-dashboard/app_current_sub_page",C),F(),R()});const a=document.getElementById("open-expenses");a&&a.addEventListener("click",()=>{C="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",C),F(),R()})}function Aa(){const s=document.querySelector(".fab");s&&s.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=m("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{if(B==="calendar")ye("event");else if(B==="health"){const a=await ns.confirm("Log Metric","What do you want to record today?","Weight","Body Fat");if(a===!0){const t=await ns.prompt("Log Weight","Enter your current weight in kg:","","number");t&&c.addWeightLog(t)}else if(a===!1){const t=await ns.prompt("Body Fat","Enter your body fat %:","","number");t&&c.addFatLog(t)}}else B==="social"?He():ye()}),document.body.appendChild(e)}function F(){const s=document.getElementById("main-fab");s&&(s.style.display="none")}function j(){const s=document.getElementById("main-fab");s&&(s.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Be):Be();window.addEventListener("beforeinstallprompt",s=>{s.preventDefault(),window.deferredPrompt=s,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});export{m as g,v as n,c as s};
