var at=Object.defineProperty;var st=(a,e,s)=>e in a?at(a,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[e]=s;var de=(a,e,s)=>st(a,typeof e!="symbol"?e+"":e,s);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();const nt="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",ot="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function it(){var e,s,t,n,o,i,r,l,m,c,d,g,h,b,y;const a={EUR:1};try{const x=await(await fetch(nt)).json();a.BTC=((e=x.bitcoin)==null?void 0:e.eur)||4e4,a.ETH=((s=x.ethereum)==null?void 0:s.eur)||2200,a.XRP=((t=x.ripple)==null?void 0:t.eur)||.5,a.KAS=((n=x.kaspa)==null?void 0:n.eur)||.1,a.SOL=((o=x.solana)==null?void 0:o.eur)||90,a.XLM=((i=x.stellar)==null?void 0:i.eur)||.11,a.ALGO=((r=x.algorand)==null?void 0:r.eur)||.18,a.LTC=((l=x.litecoin)==null?void 0:l.eur)||65,a.SUI=((m=x.sui)==null?void 0:m.eur)||1.1,a.LINK=((c=x.chainlink)==null?void 0:c.eur)||14,a.RNDR=((d=x["render-token"])==null?void 0:d.eur)||4.5,a.ADA=((g=x.cardano)==null?void 0:g.eur)||.45,a.ONDO=((h=x["ondo-finance"])==null?void 0:h.eur)||.7,(b=x.bitcoin)!=null&&b.ars&&((y=x.bitcoin)!=null&&y.eur)&&(a.ARS=x.bitcoin.eur/x.bitcoin.ars);const T=await fetch(ot);if(T.ok){const E=await T.json();a.USD=1/E.rates.USD,a.CHF=1/E.rates.CHF,a.GBP=1/E.rates.GBP,a.AUD=1/E.rates.AUD}a.GOLD=2100,a.SP500=4700}catch(k){console.error("Failed to fetch some prices:",k),a.USD=a.USD||.92,a.CHF=a.CHF||1.05,a.GBP=a.GBP||1.15,a.AUD=a.AUD||.6,a.ARS=a.ARS||.001}return a}class G{static async hash(e,s="salt_life_dashboard_2026"){const n=new TextEncoder().encode(e+s),o=await crypto.subtle.digest("SHA-512",n);return Array.from(new Uint8Array(o)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,s){const t=new TextEncoder,n=await crypto.subtle.importKey("raw",t.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode(s),iterations:25e4,hash:"SHA-512"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,s){try{const t=crypto.getRandomValues(new Uint8Array(16)),n=crypto.getRandomValues(new Uint8Array(12)),o=await this.deriveKey(s,this.bufToBase64(t)),i=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(i),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},o,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(n),salt:this.bufToBase64(t),v:"5.0"}}catch(t){throw console.error("[Security] Encryption failed:",t),new Error("No se pudo encriptar la información")}}static async decrypt(e,s){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:t,iv:n,salt:o}=e,i=await this.deriveKey(s,o),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(n)},i,this.base64ToBuf(t)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(t){throw console.error("[Security] Decryption failed:",t),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(s=>s.charCodeAt(0)))}}const $e=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:G},Symbol.toStringTag,{value:"Module"})),M={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class I{static isSetup(){return!!localStorage.getItem(M.MASTER_HASH)}static async setup(e){const s=await G.hash(e),t=await G.deriveVaultKey(e);return localStorage.setItem(M.MASTER_HASH,s),sessionStorage.setItem(M.VAULT_KEY,t),t}static async unlock(e){const s=await G.hash(e),t=localStorage.getItem(M.MASTER_HASH);if(s===t){const n=await G.deriveVaultKey(e);return sessionStorage.setItem(M.VAULT_KEY,n),n}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const s=sessionStorage.getItem(M.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const t=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:t,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(M.BIO_ENABLED,"true"),localStorage.setItem(M.VAULT_KEY,s),!0}catch(t){throw console.error("Biometric setup failed:",t),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(M.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const s=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:s,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const t=localStorage.getItem(M.VAULT_KEY);if(t)return sessionStorage.setItem(M.VAULT_KEY,t),t;throw new Error("Llave no encontrada. Usa contraseña.")}catch(s){throw console.error("Biometric auth failed:",s),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(M.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(M.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(M.BIO_ENABLED)==="true"}}const fe="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",Ie=[71,79,67,83,80,88,45,112,121,52,68,109,80,83,107,45,100,75,55,99,73,66,116,106,65,81,75,90,70,75,118,95,66,87,95].map(a=>String.fromCharCode(a)).join(""),rt="https://www.googleapis.com/auth/drive.file";class q{static hasToken(){const e=!!this.accessToken;return localStorage.getItem("life-dashboard/drive_connected")==="true"&&e}static async init(){return this._initPromise?this._initPromise:(this._initPromise=new Promise((e,s)=>{const t=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.codeClient=google.accounts.oauth2.initCodeClient({client_id:fe,scope:rt,ux_mode:"popup",access_type:"offline",prompt:"consent",callback:async n=>{if(n.error){console.error("[Drive] Auth callback error:",n);return}if(n.code)try{const o=sessionStorage.getItem("life-dashboard/pkce_verifier"),i=localStorage.getItem("life-dashboard/drive_client_secret")||Ie,r=await this.exchangeCodeForTokens(n.code,o,fe,i);r.refresh_token&&await this.saveRefreshToken(r.refresh_token),this.saveSession(r),console.log("[Drive] Connected successfully via offline flow."),window.ns&&window.ns.toast("Google Drive vinculado"),typeof window.reRender=="function"&&window.reRender()}catch(o){console.error("[Drive] Token exchange error:",o),window.ns&&window.ns.alert("Error Auth","No se pudieron obtener tokens. Verifica el Client Secret.")}}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&this.ensureValidToken().catch(n=>{console.log("[Drive] Initial silent restoration skipped:",n.message)}),e(!0)}catch(n){console.error("[Drive] Init error:",n),s(n)}}):setTimeout(t,200)};t()}),this._initPromise)}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const s=e.expires_in||3600,t=Date.now()+s*1e3;localStorage.setItem("life-dashboard/drive_token_expiry",t.toString())}static async authenticate(){this.codeClient||await this.init();const{verifier:e}=await this.generatePKCE();sessionStorage.setItem("life-dashboard/pkce_verifier",e),this.codeClient.requestCode()}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(!(localStorage.getItem("life-dashboard/drive_connected")==="true"))return null;if(!this.accessToken||Date.now()>e-3e5){console.log("[Drive] Access token expired or near expiry, attempting refresh...");const n=await this.getRefreshToken();if(n)try{const o=localStorage.getItem("life-dashboard/drive_client_secret")||Ie,i=await this.refreshAccessToken(n,fe,o),r={access_token:i.access_token,expires_in:i.expires_in,refresh_token:i.refresh_token||n};return i.refresh_token&&await this.saveRefreshToken(i.refresh_token),this.saveSession(r),this.accessToken}catch(o){throw console.error("[Drive] Token refresh failed:",o),new Error("Sesión de Google Drive expirada. Por favor reconecta en Configuración.")}else throw console.warn("[Drive] No refresh token found."),new Error("Google Drive no está vinculado para acceso offline.")}return this.accessToken&&(!gapi.client.getToken()||gapi.client.getToken().access_token!==this.accessToken)&&gapi.client.setToken({access_token:this.accessToken}),this.accessToken}static async generatePKCE(){const e=Array.from(crypto.getRandomValues(new Uint8Array(32))).map(i=>("0"+i.toString(16)).slice(-2)).join(""),t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t),o=btoa(String.fromCharCode(...new Uint8Array(n))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return{verifier:e,challenge:o}}static async exchangeCodeForTokens(e,s,t,n=null){const o=new URLSearchParams({client_id:t,code:e,grant_type:"authorization_code",redirect_uri:"postmessage"});s&&!n&&o.append("code_verifier",s),n&&o.append("client_secret",n);const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:o});if(!i.ok){const r=await i.json();throw new Error(r.error_description||"Failed to exchange code")}return await i.json()}static async refreshAccessToken(e,s,t=null){const n=new URLSearchParams({client_id:s,refresh_token:e,grant_type:"refresh_token"});t&&n.append("client_secret",t);const o=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n});if(!o.ok){const i=await o.json();throw new Error(i.error_description||"Failed to refresh token")}return await o.json()}static async saveRefreshToken(e){return new Promise((s,t)=>{const n=indexedDB.open("LifeDashboardAuthDB",1);n.onupgradeneeded=o=>{const i=o.target.result;i.objectStoreNames.contains("tokens")||i.createObjectStore("tokens")},n.onsuccess=o=>{const r=o.target.result.transaction("tokens","readwrite");r.objectStore("tokens").put(e,"drive_refresh_token"),r.oncomplete=()=>s(),r.onerror=l=>t(l)},n.onerror=o=>t(o)})}static async getRefreshToken(){return new Promise((e,s)=>{const t=indexedDB.open("LifeDashboardAuthDB",1);t.onupgradeneeded=n=>{const o=n.target.result;o.objectStoreNames.contains("tokens")||o.createObjectStore("tokens")},t.onsuccess=n=>{const o=n.target.result;if(!o.objectStoreNames.contains("tokens")){e(null);return}const l=o.transaction("tokens","readonly").objectStore("tokens").get("drive_refresh_token");l.onsuccess=()=>e(l.result),l.onerror=m=>s(m)},t.onerror=n=>s(n)})}static async clearTokens(){return localStorage.removeItem("life-dashboard/drive_access_token"),localStorage.removeItem("life-dashboard/drive_connected"),localStorage.removeItem("life-dashboard/drive_token_expiry"),new Promise(e=>{const s=indexedDB.open("LifeDashboardAuthDB",1);s.onsuccess=t=>{const n=t.target.result;if(n.objectStoreNames.contains("tokens")){const o=n.transaction("tokens","readwrite");o.objectStore("tokens").clear(),o.oncomplete=()=>e()}else e()},s.onerror=()=>e()})}static async getOrCreateFolderPath(e){var n;await this.ensureValidToken(),(n=gapi.client)!=null&&n.drive||await this.init();const s=e.split("/").filter(o=>o);let t="root";for(const o of s){const i=`name = '${o}' and mimeType = 'application/vnd.google-apps.folder' and '${t}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:i,fields:"files(id, name)"})).result.files;if(l&&l.length>0)t=l[0].id;else{const m={name:o,mimeType:"application/vnd.google-apps.folder",parents:[t]};t=(await gapi.client.drive.files.create({resource:m,fields:"id"})).result.id}}return t}static async pushData(e,s,t=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pushing encrypted data...${t?" (Retry)":""}`);const n=await this.getOrCreateFolderPath("/backup/life-dashboard/"),o=await G.encrypt(e,s),i="dashboard_vault_v5.bin",r=`name = '${i}' and '${n}' in parents and trashed = false`,m=(await gapi.client.drive.files.list({q:r,fields:"files(id)"})).result.files,c=new Blob([JSON.stringify(o)],{type:"application/json"});if(m&&m.length>0){const d=m[0].id,g=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${d}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:c});if(g.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,s,!0);if(!g.ok)throw new Error(`Error al actualizar backup: ${g.status}`)}else{const d={name:i,parents:[n]},g=new FormData;g.append("metadata",new Blob([JSON.stringify(d)],{type:"application/json"})),g.append("file",c);const h=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:g});if(h.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,s,!0);if(!h.ok)throw new Error(`Error al crear backup: ${h.status}`)}return!0}catch(n){throw console.error("[Drive] Push failed:",n),new Error(n.message||"Fallo al subir datos a Drive")}}static async pullData(e,s=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pulling data...${s?" (Retry)":""}`);const o=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,r=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)"})).result.files;if(!r||r.length===0)return null;const l=r[0].id,m=await fetch(`https://www.googleapis.com/drive/v3/files/${l}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(m.status===401&&!s)return await this.ensureValidToken(),await this.pullData(e,!0);if(!m.ok)throw new Error(`Error al descargar backup: ${m.status}`);const c=await m.json();return await G.decrypt(c,e)}catch(t){throw console.error("[Drive] Pull failed:",t),new Error(t.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");const t=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,o=(await gapi.client.drive.files.list({q:t,fields:"files(id)"})).result.files;if(o&&o.length>0){const i=o[0].id;return await gapi.client.drive.files.delete({fileId:i}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(e){throw console.error("[Drive] Deletion failed:",e),new Error(e.message||"Fallo al borrar backup en Drive")}}}de(q,"codeClient",null),de(q,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null),de(q,"_initPromise",null);const Ae={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',chevronUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>',chevronDown:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',uploadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12V21"/><path d="m16 16-4-4-4 4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>',moreVertical:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>',check:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',menu:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>',users:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',messageSquare:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',phone:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',instagram:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>',facebook:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>',linkedin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>',alertCircle:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>',fingerprint:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 15.1a7 7 0 0 0 10.9 0"/><path d="M6 13.6a7 7 0 0 0 4.6 2.4"/><path d="M13.4 16a7 7 0 0 0 4.6-2.4"/><path d="M8 12.1a5 5 0 0 0 6.9 0"/><path d="M9.1 11a3 3 0 0 0 3.9 0"/><path d="M12 18.5V20"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',palette:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.555C21.965 6.012 17.461 2 12 2z"/></svg>',star:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',eye:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>',eyeOff:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.52 13.52 0 0 0 2 12c0 0 3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><line x1="2" x2="22" y1="2" y2="22"/></svg>',play:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg>',pause:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>',clock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',barChart2:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>',brain:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 4.44-2.54Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-4.44-2.54Z"/></svg>',rocket:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-5c1.62-2.2 5-3 5-3"/><path d="M12 15v5s3.03-.55 5-2c2.2-1.62 3-5 3-5"/></svg>',coffee:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>',bookOpen:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>',dumbbell:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6.5 6.5 11 11"/><path d="m21 21-1-1"/><path d="m3 3 1 1"/><path d="m18 22 4-4"/><path d="m2 6 4-4"/><path d="m3 10 7-7"/><path d="m14 21 7-7"/></svg>',code:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',music:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>',monitor:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" x2="16" y1="21" y2="21"/><line x1="12" x2="12" y1="17" y2="21"/></svg>'};function p(a,e=""){return(Ae[a]||Ae.package).replace("<svg",`<svg class="${e}"`)}class lt{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,s="success",t=3e3){const n=document.createElement("div");n.className=`toast toast-${s} stagger-in`;const o=s==="success"?"check":s==="error"?"alertCircle":"info";n.innerHTML=`
    ...
    `).join("");return e+s}function Te(a){const e=document.querySelectorAll(".nav-item");e.forEach(s=>{s.addEventListener("click",()=>{const t=s.dataset.nav;e.forEach(n=>n.classList.remove("active")),s.classList.add("active"),a&&a(t)})})}function w(a,e="$"){const s=Math.abs(a);let t=0,n=0;e==="₿"?(t=4,n=6):(e==="$"||e==="€"||e==="£"||e==="Fr")&&(t=0,n=2);const o=new Intl.NumberFormat("en-US",{minimumFractionDigits:t,maximumFractionDigits:n}).format(s);return`${a<0?"-":""}${e}${o}`}function oe(a){return a==null?"0.0%":`${a>=0?"+":""}${a.toFixed(1)}%`}const ut="https://api.coingecko.com/api/v3",f={STOCKS:"Stocks & Índices",CURRENCIES:"Divisas (Forex)",CRYPTO_MAJORS:"Cripto (Principales)",CRYPTO_ALTS:"Cripto (Altcoins)",COMMODITIES:"Materias Primas"},pt=5*60*1e3;let pe={data:null,timestamp:0,currency:"USD"};const V=[{id:"sp500",name:"S&P 500",symbol:"SPX",category:f.STOCKS,yahooId:"%5EGSPC",icon:"trendingUp"},{id:"nasdaq100",name:"Nasdaq 100",symbol:"NDX",category:f.STOCKS,yahooId:"%5ENDX",icon:"trendingUp"},{id:"msciworld",name:"MSCI World ETF",symbol:"URTH",category:f.STOCKS,yahooId:"URTH",icon:"trendingUp"},{id:"microsoft",name:"Microsoft",symbol:"MSFT",category:f.STOCKS,yahooId:"MSFT",icon:"trendingUp"},{id:"tesla",name:"Tesla",symbol:"TSLA",category:f.STOCKS,yahooId:"TSLA",icon:"trendingUp"},{id:"apple",name:"Apple",symbol:"AAPL",category:f.STOCKS,yahooId:"AAPL",icon:"trendingUp"},{id:"amazon",name:"Amazon",symbol:"AMZN",category:f.STOCKS,yahooId:"AMZN",icon:"trendingUp"},{id:"nvidia",name:"Nvidia",symbol:"NVDA",category:f.STOCKS,yahooId:"NVDA",icon:"trendingUp"},{id:"google",name:"Google",symbol:"GOOGL",category:f.STOCKS,yahooId:"GOOGL",icon:"trendingUp"},{id:"meta",name:"Meta",symbol:"META",category:f.STOCKS,yahooId:"META",icon:"trendingUp"},{id:"oracle",name:"Oracle",symbol:"ORCL",category:f.STOCKS,yahooId:"ORCL",icon:"trendingUp"},{id:"netflix",name:"Netflix",symbol:"NFLX",category:f.STOCKS,yahooId:"NFLX",icon:"trendingUp"},{id:"ypf",name:"YPF",symbol:"YPF",category:f.STOCKS,yahooId:"YPF",icon:"trendingUp"},{id:"ibex35",name:"IBEX 35",symbol:"IBEX",category:f.STOCKS,yahooId:"%5EIBEX",icon:"trendingUp"},{id:"eurusd",name:"Euro / Dólar",symbol:"EUR/USD",category:f.CURRENCIES,yahooId:"EURUSD=X",icon:"dollarSign"},{id:"usdars",name:"Dólar / Peso Arg",symbol:"USD/ARS",category:f.CURRENCIES,yahooId:"USDARS=X",icon:"dollarSign"},{id:"usdchf",name:"Dólar / Franco Suizo",symbol:"USD/CHF",category:f.CURRENCIES,yahooId:"USDCHF=X",icon:"dollarSign"},{id:"gbpusd",name:"Libra / Dólar",symbol:"GBP/USD",category:f.CURRENCIES,yahooId:"GBPUSD=X",icon:"dollarSign"},{id:"audusd",name:"Aus Dólar / USD",symbol:"AUD/USD",category:f.CURRENCIES,yahooId:"AUDUSD=X",icon:"dollarSign"},{id:"usdbrl",name:"Dólar / Real Bra",symbol:"USD/BRL",category:f.CURRENCIES,yahooId:"USDBRL=X",icon:"dollarSign"},{id:"gold",name:"Oro",symbol:"XAU",category:f.COMMODITIES,cgId:"pax-gold",icon:"package"},{id:"silver",name:"Plata",symbol:"XAG",category:f.COMMODITIES,cgId:"tether-gold",icon:"package"},{id:"copper",name:"Cobre",symbol:"HG",category:f.COMMODITIES,yahooId:"HG=F",icon:"package"},{id:"bitcoin",name:"Bitcoin",symbol:"BTC",cgId:"bitcoin",category:f.CRYPTO_MAJORS,icon:"bitcoin"},{id:"ethereum",name:"Ethereum",symbol:"ETH",cgId:"ethereum",category:f.CRYPTO_MAJORS,icon:"bitcoin"},{id:"ripple",name:"XRP",symbol:"XRP",cgId:"ripple",category:f.CRYPTO_MAJORS,icon:"bitcoin"},{id:"solana",name:"Solana",symbol:"SOL",cgId:"solana",category:f.CRYPTO_MAJORS,icon:"bitcoin"},{id:"cardano",name:"Cardano",symbol:"ADA",cgId:"cardano",category:f.CRYPTO_MAJORS,icon:"bitcoin"},{id:"dogecoin",name:"Dogecoin",symbol:"DOGE",cgId:"dogecoin",category:f.CRYPTO_MAJORS,icon:"bitcoin"},{id:"kaspa",name:"Kaspa",symbol:"KAS",cgId:"kaspa",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"litecoin",name:"Litecoin",symbol:"LTC",cgId:"litecoin",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"bitcoin-cash",name:"Bitcoin Cash",symbol:"BCH",cgId:"bitcoin-cash",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"monero",name:"Monero",symbol:"XMR",cgId:"monero",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"chainlink",name:"Chainlink",symbol:"LINK",cgId:"chainlink",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"stellar",name:"Stellar",symbol:"XLM",cgId:"stellar",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"sui",name:"Sui",symbol:"SUI",cgId:"sui",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"hbar",name:"Hedera",symbol:"HBAR",cgId:"hedera-hashgraph",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"aave",name:"Aave",symbol:"AAVE",cgId:"aave",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"bittensor",name:"Bittensor",symbol:"TAO",cgId:"bittensor",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"worldcoin",name:"Worldcoin",symbol:"WLD",cgId:"worldcoin-org",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"arbitrum",name:"Arbitrum",symbol:"ARB",cgId:"arbitrum",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"polygon",name:"Polygon",symbol:"POL",cgId:"polygon-ecosystem-token",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"optimism",name:"Optimism",symbol:"OP",cgId:"optimism",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"stacks",name:"Stacks",symbol:"STX",cgId:"blockstack",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"ondo",name:"Ondo",symbol:"ONDO",cgId:"ondo-finance",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"zcash",name:"Zcash",symbol:"ZEC",cgId:"zcash",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"dash",name:"Dash",symbol:"DASH",cgId:"dash",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"filecoin",name:"Filecoin",symbol:"FIL",cgId:"filecoin",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"algorand",name:"Algorand",symbol:"ALGO",cgId:"algorand",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"render",name:"Render",symbol:"RNDR",cgId:"render-token",category:f.CRYPTO_ALTS,icon:"bitcoin"},{id:"fetch-ai",name:"Fetch.ai",symbol:"FET",cgId:"fetch-ai",category:f.CRYPTO_ALTS,icon:"bitcoin"}];async function He(){const a="usd";if(pe.data&&Date.now()-pe.timestamp<pt)return pe.data;const e=V.map(t=>t.cgId).filter(Boolean).join(","),s=`${ut}/coins/markets?vs_currency=${a}&ids=${e}&order=market_cap_desc&per_page=100&page=1&sparkline=false&price_change_percentage=24h,7d,30d,1y`;try{const t=await fetch(s),n=t.ok?await t.json():[],o=V.filter(l=>l.yahooId),i=await mt(o),r=V.map(l=>{if(l.cgId){const m=n.find(c=>c.id===l.cgId);if(m)return{...l,price:m.current_price,image:m.image,change24h:m.price_change_percentage_24h_in_currency||m.price_change_percentage_24h||0,change7d:m.price_change_percentage_7d_in_currency||0,change30d:m.price_change_percentage_30d_in_currency||0,change1y:m.price_change_percentage_1y_in_currency||0}}if(l.yahooId&&i[l.yahooId]){const m=i[l.yahooId];return{...l,price:m.price,change24h:m.change24h,change7d:m.change7d,change30d:m.change30d,change1y:m.change1y}}return{...l,price:null,change24h:null,change7d:null,change30d:null,change1y:null}});return pe={data:r,timestamp:Date.now(),currency:"USD"},r}catch(t){return console.error("Market fetch failed",t),V.map(n=>({...n,price:null,change24h:null,change7d:null,change30d:null,change1y:null}))}}async function mt(a){const e={};return await Promise.all(a.map(async s=>{try{const t=`https://query1.finance.yahoo.com/v8/finance/chart/${s.yahooId}?interval=1d&range=2y`,n=`https://api.allorigins.win/get?url=${encodeURIComponent(t)}`,i=await(await fetch(n)).json(),r=JSON.parse(i.contents);if(!r.chart||!r.chart.result||!r.chart.result[0])throw new Error("Invalid data");const l=r.chart.result[0],m=l.meta,d=l.indicators.quote[0].close.filter(j=>j!==null&&j>0);if(d.length===0)throw new Error("No valid price data");const g=m.regularMarketPrice||d[d.length-1],h=d.length-1,b=d[Math.max(0,h-1)],y=(g-b)/b*100,k=d[Math.max(0,h-5)],x=(g-k)/k*100,T=d[Math.max(0,h-21)],E=(g-T)/T*100,_=d[Math.max(0,h-252)],D=(g-_)/_*100;e[s.yahooId]={price:g,change24h:isNaN(y)?0:y,change7d:isNaN(x)?0:x,change30d:isNaN(E)?0:E,change1y:isNaN(D)?0:D}}catch(t){console.warn(`Failed to fetch ${s.symbol} from Yahoo`,t),e[s.yahooId]=null}})),e}const vt={passive:{label:"Ingresos Pasivos",storeKey:"passiveAssets",updateMethod:"updatePassiveAsset",deleteMethod:"deletePassiveAsset",fields:["value","monthlyIncome"]},investment:{label:"Activo de Inversión",storeKey:"investmentAssets",updateMethod:"updateInvestmentAsset",deleteMethod:"deleteInvestmentAsset",fields:["value"]},liability:{label:"Pasivo/Deuda",storeKey:"liabilities",updateMethod:"updateLiability",deleteMethod:"deleteLiability",fields:["amount","monthlyPayment"]},activeIncome:{label:"Ingreso Activo",storeKey:"activeIncomes",updateMethod:"updateActiveIncome",deleteMethod:"deleteActiveIncome",fields:["amount"]},livingExpense:{label:"Gasto de Vida",storeKey:"livingExpenses",updateMethod:"updateLivingExpense",deleteMethod:"deleteLivingExpense",fields:["amount"]}};let le=null,J=null;function Ve(a,e){const s=vt[e];if(!s){console.error("Unknown category:",e);return}const o=u.getState()[s.storeKey].find(r=>r.id===a);if(!o){console.error("Item not found:",a);return}le=o,J=e;const i=document.createElement("div");i.className="modal-overlay",i.id="edit-modal",i.innerHTML=yt(o,s),document.body.appendChild(i),requestAnimationFrame(()=>{i.classList.add("active")}),ft(s)}const gt=[{value:"EUR",label:"Euro (€)"},{value:"USD",label:"Dólar ($)"},{value:"CHF",label:"Franco Suizo (Fr)"},{value:"GBP",label:"Libra (£)"},{value:"AUD",label:"Dólar Aus. (A$)"},{value:"ARS",label:"Peso Arg. ($)"}],ht={passive:[{value:"rental",label:"Inmueble en Renta"},{value:"stocks",label:"Acciones/Dividendos"},{value:"etf",label:"ETF/Fondos"},{value:"bonds",label:"Bonos"},{value:"crypto",label:"Crypto Staking"},{value:"business",label:"Negocio Pasivo"},{value:"royalties",label:"Regalías"},{value:"other",label:"Otro"}],investment:[{value:"property",label:"Inmueble"},{value:"stocks",label:"Acciones"},{value:"etf",label:"ETF/Fondos"},{value:"crypto",label:"Criptomoneda"},{value:"cash",label:"Efectivo/Ahorro"},{value:"vehicle",label:"Vehículo"},{value:"collectibles",label:"Coleccionables"},{value:"other",label:"Otro"}],liability:[{value:"mortgage",label:"Hipoteca"},{value:"loan",label:"Préstamo Personal"},{value:"carloan",label:"Préstamo Auto"},{value:"creditcard",label:"Tarjeta de Crédito"},{value:"studentloan",label:"Préstamo Estudiantil"},{value:"other",label:"Otra Deuda"}],activeIncome:[{value:"salary",label:"Salario"},{value:"freelance",label:"Freelance"},{value:"business",label:"Negocio Activo"},{value:"other",label:"Otro"}],livingExpense:[{value:"rent",label:"Alquiler/Hipoteca"},{value:"utilities",label:"Servicios"},{value:"food",label:"Alimentación"},{value:"transport",label:"Transporte"},{value:"insurance",label:"Seguros"},{value:"health",label:"Salud"},{value:"other",label:"Otro"}]};function yt(a,e){const s=J==="investment"||J==="passive",t=ht[J]||[];let n="";return e.fields.includes("value")&&e.fields.includes("monthlyIncome")?n=`
      <div class="form-row">
          ...
          <div class="form-group" style="flex: 1;">
              ...
              <select class="form-input form-select" id="edit-currency">
                  <optgroup label="Divisas">
                      ${gt.map(o=>`<option value="${o.value}" ${o.value===a.currency?"selected":""}>${o.label}</option>`).join("")}
                  </optgroup>
                  ${s?`
                  <optgroup label="Mercados Reales">
                      ${V.map(o=>`<option value="${o.symbol}" ${o.symbol===a.currency?"selected":""}>${o.name} (${o.symbol})</option>`).join("")}
                  </optgroup>
                  `:""}
              </select>
          </div>
  ...
  `}function ft(a){const e=document.getElementById("edit-modal"),s=document.getElementById("edit-modal-close"),t=document.getElementById("btn-update"),n=document.getElementById("btn-delete");e.addEventListener("click",o=>{o.target===e&&me()}),s.addEventListener("click",me),t.addEventListener("click",()=>bt(a)),n.addEventListener("click",()=>wt(a))}function bt(a){var m,c,d,g,h,b,y,k,x;const e=(c=(m=document.getElementById("edit-name"))==null?void 0:m.value)==null?void 0:c.trim(),s=(d=document.getElementById("edit-type"))==null?void 0:d.value,t=(g=document.getElementById("edit-currency"))==null?void 0:g.value,n=(b=(h=document.getElementById("edit-details"))==null?void 0:h.value)==null?void 0:b.trim(),o=parseFloat((y=document.getElementById("edit-value"))==null?void 0:y.value)||0,i=parseFloat((k=document.getElementById("edit-amount"))==null?void 0:k.value)||0,r=parseFloat((x=document.getElementById("edit-monthly"))==null?void 0:x.value)||0;if(!e){v.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:s,currency:t,details:n};a.fields.includes("value")&&(l.value=o),a.fields.includes("amount")&&(l.amount=i),a.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),a.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),u[a.updateMethod](le.id,l),me()}function wt(a){v.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${le.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(u[a.deleteMethod](le.id),v.toast("Eliminado correctamente","info"),me())})}function me(){const a=document.getElementById("edit-modal");a&&(a.classList.remove("active"),setTimeout(()=>a.remove(),300)),le=null,J=null}let Z=!1,ee=!1,S={key:"price",direction:"desc"},te="USD",U=null;function xt(){const a=u.getState(),e=a.lastMarketData||[],s=a.marketFavorites||[];U===null&&(U=s.length>0?"favorites":"all"),!ee&&!Z&&It();const t=te==="EUR"?"€":"$";let n=e;U==="favorites"&&(n=e.filter(i=>s.includes(i.id)));const o=Object.values(f);return`
        <div class="market-view animate-fade-in" style="padding: 4px;">
            ...
            <div class="market-controls-row">
                ...
                <div class="market-status-badge ${Z?"market-status-fresh":"market-status-cached"}" title="Tasa de refresco: 5 min">
                    ${ee?'<div class="loading-spinner-sm" style="width:10px; height:10px;"></div>':p(Z?"check":"save","tiny-icon")}
                    <span>${ee?"Updating":Z?"Live":"Cached"}</span>
                </div>

                <div class="capsule-toggle">
                    <button class="capsule-btn ${te==="USD"?"active":""}" data-curr="USD">USD</button>
                    <button class="capsule-btn ${te==="EUR"?"active":""}" data-curr="EUR">EUR</button>
                </div>
            </div>

            <!-- Content -->
            ${n.length===0&&U==="favorites"?St():""}
            ${n.length===0&&U==="all"?$t():""}
            
            ${o.map(i=>{const r=n.filter(l=>l.category===i);return r.length===0?"":kt(i,r,t,s)}).join("")}
        </div>
    `}function kt(a,e,s,t){const n=[...e].sort((o,i)=>{let r=o[S.key],l=i[S.key];return typeof r=="string"&&(r=r.toLowerCase()),typeof l=="string"&&(l=l.toLowerCase()),r<l?S.direction==="asc"?-1:1:r>l?S.direction==="asc"?1:-1:0});return`
            ...
            <div class="card market-table-card" style="padding: 0 !important; overflow: hidden; background: rgba(10, 15, 30, 0.4); border: 1px solid rgba(255,255,255,0.05); box-shadow: 0 4px 20px rgba(0,0,0,0.2);">
                <div class="table-container">
                    <table class="market-table">
                        ...
                        <tbody>
                            ${n.map(o=>Et(o,s,t.includes(o.id))).join("")}
                        </tbody>
                    </table>
                </div>
            </div>
        </div>
    `}function Et(a,e,s){let t=a.price;if(a.price!==null&&te==="EUR"){const r=u.getState().rates.USD||.92;t=a.price*r}const n=we(a.change24h),o=we(a.change30d),i=we(a.change1y);return`
    ...
    `}function we(a){return a==null?"":Z?a>=0?"text-positive":"text-negative":"text-accent-primary"}function St(){return`
    ...
    `}async function It(){var a,e;if(!ee){ee=!0,(a=window.reRender)==null||a.call(window);try{const s=await He();u.saveMarketData(s),Z=!0}catch(s){console.error("Market update failed",s)}finally{ee=!1,(e=window.reRender)==null||e.call(window)}}}function At(){var a,e,s;document.querySelectorAll(".capsule-btn").forEach(t=>{t.addEventListener("click",()=>{var o;const n=t.dataset.curr;n!==te&&(te=n,(o=window.reRender)==null||o.call(window))})}),(a=document.getElementById("filter-all"))==null||a.addEventListener("click",()=>{var t;U="all",(t=window.reRender)==null||t.call(window)}),(e=document.getElementById("filter-favs"))==null||e.addEventListener("click",()=>{var t;U="favorites",(t=window.reRender)==null||t.call(window)}),(s=document.getElementById("btn-show-all"))==null||s.addEventListener("click",()=>{var t;U="all",(t=window.reRender)==null||t.call(window)}),document.querySelectorAll(".btn-favorite").forEach(t=>{t.addEventListener("click",n=>{var i;n.stopPropagation();const o=t.dataset.id;u.toggleMarketFavorite(o),(i=window.reRender)==null||i.call(window)})}),document.querySelectorAll(".market-table th.sortable").forEach(t=>{t.addEventListener("click",()=>{var o;const n=t.dataset.sort;S.key===n?S.direction=S.direction==="asc"?"desc":"asc":(S.key=n,S.direction="desc",n==="name"&&(S.direction="asc")),(o=window.reRender)==null||o.call(window)})})}function Ct(){const a=u.getState(),{wealthGoals:e=[],inflationRate:s=3,projectionYears:t=10,currencySymbol:n}=a,o=u.getAllExpenses();let i=0;e.forEach(d=>{const g=d.cost*(d.dividendYield/100)/12;i+=u.convertValue(g,d.currency||a.currency)});const r=i-o,l=o*Math.pow(1+s/100,t);let m=0;e.forEach(d=>{const h=d.cost*Math.pow(1+d.annualGrowth/100,t)*(d.dividendYield/100)/12;m+=u.convertValue(h,d.currency||a.currency)});const c=m-l;return`
    ...
    `}function Lt(a,e){const s=e.currencySymbol,t=a.cost*(a.dividendYield/100)/12,n=u.convertValue(t,a.currency||e.currency);return`
    ...
    `}function Tt(){var s;(s=document.getElementById("btn-add-wealth-goal"))==null||s.addEventListener("click",async()=>{Me()}),document.querySelectorAll(".edit-wealth-goal").forEach(t=>{t.addEventListener("click",n=>{n.stopPropagation();const o=t.dataset.id,i=u.getState().wealthGoals.find(r=>r.id===o);i&&Me(i)})}),document.querySelectorAll(".delete-wealth-goal").forEach(t=>{t.addEventListener("click",async n=>{var r;n.stopPropagation();const o=t.dataset.id;await v.confirm("Eliminar objetivo","¿Estás seguro de que deseas eliminar este objetivo?")&&(u.deleteWealthGoal(o),(r=window.reRender)==null||r.call(window))})});const a=document.getElementById("inflation-slider");a&&a.addEventListener("change",t=>{var n;u.setInflationRate(t.target.value),(n=window.reRender)==null||n.call(window)});const e=document.getElementById("years-slider");e&&e.addEventListener("change",t=>{var n;u.setProjectionYears(t.target.value),(n=window.reRender)==null||n.call(window)})}async function Me(a=null){const e=!!a,s=e?"Editar Objetivo":"Nuevo Objetivo Patrimonial",t=document.createElement("div");t.className="modal-overlay active overlay-centered",t.innerHTML=`
    ...
    <div class="finance-page stagger-children" style="padding-bottom: 80px;">
      ...
      ${B==="summary"?Mt(a,e):B==="goals"?Ct():xt()}
      
    </div>
  `}function Mt(a,e){const s=u.getPassiveIncome(),t=u.getLivingExpenses(),n=u.getNetPassiveIncome(),o=u.getInvestmentAssetsValue(),i=u.getTotalLiabilities(),r=u.getNetWorth(),l=u.getAllIncomes(),m=u.getAllExpenses(),c=u.getNetIncome();return`
  ...
  `}function Bt(a){const e=[...(a.activeIncomes||[]).map(t=>({...t,category:"activeIncome"})),...a.passiveAssets.map(t=>({...t,category:"passive"})),...a.investmentAssets.map(t=>({...t,category:"investment"})),...a.liabilities.map(t=>({...t,category:"liability"}))];if(e.length===0)return`
      <div class="empty-state">
    ...
    <div class="asset-list">
      ${e.map(t=>{const n=Rt(t.currency||t.type),o=Pt(t.currency||t.type),i=t.category==="liability",r=t.value||t.amount||0,l=u.convertValue(r,t.currency||"EUR");let m="";if(t.currency!==a.currency){const d={EUR:"€",USD:"$",BTC:"₿",ETH:"Ξ",XRP:"✕",GOLD:"oz",SP500:"pts",CHF:"Fr",GBP:"£",AUD:"A$",ARS:"$"}[t.currency]||t.currency;m=`<div class="asset-original-value">${r} ${d}</div>`}return`
  ...
  `}function Rt(a){return{property:"property",rental:"property",stocks:"stocks",etf:"stocks",SP500:"stocks",crypto:"crypto",BTC:"crypto",ETH:"crypto",XRP:"crypto",GOLD:"investment",cash:"cash",USD:"cash",EUR:"cash",savings:"cash",vehicle:"vehicle",debt:"debt",loan:"debt",mortgage:"debt",creditcard:"debt",salary:"cash",freelance:"cash",business:"property"}[a]||"cash"}function Pt(a){return{property:"building",rental:"building",stocks:"trendingUp",etf:"trendingUp",SP500:"trendingUp",crypto:"bitcoin",BTC:"bitcoin",ETH:"bitcoin",XRP:"bitcoin",GOLD:"package",cash:"dollarSign",USD:"dollarSign",EUR:"dollarSign",savings:"piggyBank",vehicle:"car",debt:"creditCard",loan:"landmark",mortgage:"home",creditcard:"creditCard",salary:"briefcase",freelance:"users",business:"building"}[a]||"dollarSign"}function Be(){const a=document.getElementById("tab-summary"),e=document.getElementById("tab-markets"),s=document.getElementById("tab-goals");if(a&&e&&s&&(a.addEventListener("click",()=>{var i;B="summary",(i=window.reRender)==null||i.call(window)}),e.addEventListener("click",()=>{var i;B="markets",(i=window.reRender)==null||i.call(window)}),s.addEventListener("click",()=>{var i;B="goals",(i=window.reRender)==null||i.call(window)})),B==="markets"){At();return}if(B==="goals"){Tt();return}document.querySelectorAll(".asset-item").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.id,l=i.dataset.category;Ve(r,l)})});const n=document.getElementById("toggle-real-estate");n&&n.addEventListener("change",()=>{u.toggleRealEstate()});const o=document.getElementById("display-currency-select");o&&o.addEventListener("change",i=>{u.setCurrency(i.target.value)})}let H=10,z=7,Y=null,W=null;function _t(){const e=u.getState().currencySymbol,s=u.getNetWorth(),n=u.getNetIncome()*12,o=Y!==null?Y:s,i=W!==null?W:n,r=ze(o,i,z,H);return`
  ...
  `}function Ye(a,e){const s=[];for(let t=0;t<a.length;t++){const n=a[t];(t<5||(t+1)%5===0||t===a.length-1)&&s.push(n)}return`
    <div class="table-container">
  ...
  `}function jt(a){const e=document.getElementById("back-to-finance"),s=document.getElementById("rate-slider"),t=document.getElementById("years-slider"),n=document.getElementById("principal-input"),o=document.getElementById("contribution-input"),i=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",a),n&&n.addEventListener("input",l=>{Y=parseFloat(l.target.value)||0,X()}),o&&o.addEventListener("input",l=>{W=parseFloat(l.target.value)||0,X()}),i&&i.addEventListener("click",()=>{Y=null;const l=u.getNetWorth();n.value=l,X()}),r&&r.addEventListener("click",()=>{W=null;const l=u.getNetIncome()*12;o.value=l,X()}),s&&s.addEventListener("input",l=>{z=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${z}%`,X()}),t&&t.addEventListener("input",l=>{H=parseInt(l.target.value),document.getElementById("years-value").textContent=`${H} años`,X()})}function X(){const e=u.getState().currencySymbol,s=Y!==null?Y:u.getNetWorth(),t=W!==null?W:u.getNetIncome()*12,n=ze(s,t,z,H),o=document.getElementById("future-value"),i=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),m=document.getElementById("total-contributed"),c=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),g=document.getElementById("projection-chart"),h=document.getElementById("projection-table");o&&(o.textContent=w(n.finalValue,e)),i&&(i.textContent=`Valor Futuro en ${H} años`),r&&(r.innerHTML=`${n.totalGrowth>=0?"📈":"📉"} ${n.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=w(s,e)),m&&(m.textContent=w(n.totalContributions,e),m.className=`stat-value ${n.totalContributions>=0?"positive":"negative"}`),c&&(c.textContent=w(n.totalInterest,e)),d&&(d.textContent=w(n.finalValue,e)),g&&(g.innerHTML=Ke(n.yearlyBreakdown)),h&&(h.innerHTML=Ye(n.yearlyBreakdown,e))}function Ut(){H=10,z=7,Y=null,W=null}let ie=u.getState().lastMarketData||[],re=!1,$={key:"price",direction:"desc"},We="";function Ot(){const a=u.getState(),e=a.currency||"EUR",s=a.currencySymbol||"€";if((ie.length===0||We!==e)&&(re||Xe(),ie.length===0))return`
            ...
            `;const t=Object.values(f);return`
        <div class="market-page stagger-children" style="padding-bottom: 80px;">
            ...
            ${t.map(n=>{const o=ie.filter(i=>i.category===n);return o.length===0?"":Nt(n,o,s)}).join("")}
        </div>
    `}function Nt(a,e,s){const t=[...e].sort((n,o)=>{let i=n[$.key],r=o[$.key];return typeof i=="string"&&(i=i.toLowerCase()),typeof r=="string"&&(r=r.toLowerCase()),i<r?$.direction==="asc"?-1:1:i>r?$.direction==="asc"?1:-1:0});return`
    ...
    <div class="health-page stagger-children" style="padding-bottom: 120px;">
      ...
      <div class="health-tabs">
        <button class="health-tab-btn ${ae==="exercise"?"active":""}" data-tab="exercise">
            ${p("zap")} Ejercicio
        </button>
        <button class="health-tab-btn ${ae==="diet"?"active":""}" data-tab="diet">
            ${p("apple")} Dieta
        </button>
      </div>

      <div id="health-tab-content">
        ${ae==="exercise"?qt(e):Ht(e)}
      </div>

    </div>
    `}function qt(a){return`
      <!-- FITNESS ROUTINES -->
      <div class="section-divider">
                        ...
                        <div class="ex-health-main">
                            ...
                            <div class="ex-health-info">
                                ...
                                <div class="ex-health-stats">
                                    ...
                                    ${o.lastLog?`
                                        <span style="opacity: 0.3;">•</span>
                                        <span class="last-effort-badge-emoji" title="Último esfuerzo">${Vt(o.lastLog.rating)}</span>
                                    `:""}
                                </div>
                            </div>
                        </div>
    ...
    `}function Ht(a){return`
      ...
      <div class="summary-grid" style="margin-bottom: var(--spacing-2xl);">
        ...
        <div class="summary-item card clickable" id="log-fat-btn">
          <div class="summary-value">${a.fatLogs.length>0&&a.fatLogs[a.fatLogs.length-1].fat||"--"} %</div>
      ...
      <div class="card ai-calorie-card" style="margin-bottom: var(--spacing-2xl); display: flex; flex-direction: column; align-items: center;">
          <div class="summary-value" style="font-size: 28px;">${zt(a)} kcal</div>
  ...
  `}function Jt(a,e){return a.length===0?`
      ...
      <div class="calendar-top-layout">
        ...
        <div class="card calendar-view-card">
            <div class="calendar-mini-header">
                ...
                <span class="current-month">${ta()}</span>
        ...
        <div class="events-list-container" style="margin-top: var(--spacing-xl);">
            ...
            <div class="events-list">
                ...
                `:e.filter(s=>{const t=new Date(s.date);return t.getMonth()===F.getMonth()&&t.getFullYear()===F.getFullYear()}).sort((s,t)=>new Date(s.date)-new Date(t.date)).map(s=>`
                    <div class="card event-card">
                        <div class="event-icon-wrapper ${s.category||"event"}">
                            ${p(sa(s.category||"event"))}
                        </div>
                        <div class="event-main-col" style="flex: 1;">
                            <div class="event-title" style="font-weight: 700;">${s.title}</div>
                            <div class="event-details-row">
                                <span class="event-date-text">${aa(s.date)}</span>
                                <span class="event-dot-separator"></span>
                                <span class="event-time-text">${s.time}</span>
                                ${s.repeat!=="none"?`<span class="event-repeat-tag">${na(s.repeat)}</span>`:""}
                            </div>
                        </div>
  ...
  `}function ra(a,e){if(a.length===0)return`
            <div class="empty-state">
        ...
        <div class="asset-list">
            ${a.map(t=>{const n=u.convertValue(t.amount,t.currency||"EUR"),o=la(t.category);return`
    ...
    `}function la(a){switch(a){case"liability":return"landmark";case"livingExpense":return"shoppingCart";default:return"creditCard"}}function ca(a){const e=document.getElementById("back-to-finance");e&&e.addEventListener("click",a),document.querySelectorAll(".expense-item").forEach(t=>{t.addEventListener("click",()=>{const n=t.dataset.id,o=t.dataset.category;Ve(n,o)})})}const da="modulepreload",ua=function(a){return"/life-dashboard/"+a},Pe={},ve=function(e,s,t){let n=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),r=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));n=Promise.allSettled(s.map(l=>{if(l=ua(l),l in Pe)return;Pe[l]=!0;const m=l.endsWith(".css"),c=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const d=document.createElement("link");if(d.rel=m?"stylesheet":da,m||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),m)return new Promise((g,h)=>{d.addEventListener("load",g),d.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return n.then(i=>{for(const r of i||[])r.status==="rejected"&&o(r.reason);return e().catch(o)})};function pa(){const a=I.isBioEnabled(),e=q.hasToken();return`
    <div class="settings-page stagger-children">
        ...
        <footer class="settings-footer">
            <p>Life Dashboard Pro v1.0.87</p>
            <p>© 2026 Privacy First Zero-Knowledge System</p>
        </footer>
    </div>
    `}function ma(){var t,n,o,i,r,l,m,c,d,g;(t=document.getElementById("toggle-bio"))==null||t.addEventListener("change",async h=>{if(h.target.checked){const y=await v.prompt("Activar Biometría","Introduce tu contraseña maestra para confirmar:","Tu contraseña","password");if(y)try{await I.registerBiometrics(y),v.toast("Biometría activada correctamente")}catch(k){await v.alert("Error",k.message),h.target.checked=!1}else h.target.checked=!1}else localStorage.setItem("life-dashboard/db_bio_enabled","false"),v.toast("Biometría desactivada","info")});const a=document.getElementById("btn-install-pwa");a&&setTimeout(()=>{if(window.deferredPrompt){const h=document.getElementById("install-pwa-card");h&&(h.style.display="block"),a.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:b}=await window.deferredPrompt.userChoice;if(b==="accepted"){v.toast("Instalando aplicación...");const y=document.getElementById("install-pwa-card");y&&(y.style.display="none")}window.deferredPrompt=null})}},1e3),(n=document.getElementById("connect-drive-btn"))==null||n.addEventListener("click",async()=>{try{await q.authenticate(),v.toast("Google Drive conectado"),typeof window.reRender=="function"&&window.reRender()}catch(h){v.alert("Error",h.message||"Error al conectar")}}),(o=document.getElementById("upload-drive-btn"))==null||o.addEventListener("click",async()=>{const h=document.getElementById("upload-drive-btn"),b=h.innerHTML;try{if(!await v.confirm("Subir a la Nube","Esto reemplazará TODO lo que tengas en Google Drive con tus datos locales. ¿Continuar?"))return;h.innerHTML='<div class="loading-spinner-sm"></div>',h.style.pointerEvents="none";const k=I.getVaultKey();await q.pushData(u.getState(),k),v.toast("Bóveda subida correctamente")}catch(y){console.error(y),v.alert("Error al subir",y.message)}finally{h.innerHTML=b,h.style.pointerEvents="auto"}}),(i=document.getElementById("download-drive-btn"))==null||i.addEventListener("click",async()=>{const h=document.getElementById("download-drive-btn"),b=h.innerHTML;try{if(!await v.confirm("Descargar de la Nube","Esto reemplazará TODOS tus datos locales con los que hay en la nube. Esta acción no se puede deshacer. ¿Continuar?"))return;h.innerHTML='<div class="loading-spinner-sm"></div>',h.style.pointerEvents="none";const k=I.getVaultKey(),x=await q.pullData(k);x?(u.resetState(x),await u.saveState(),v.toast("Datos descargados correctamente","success"),setTimeout(()=>window.location.reload(),1e3)):v.alert("Error","No se encontró una bóveda válida en Drive o el descifrado falló (¿Contraseña incorrecta?)")}catch(y){console.error("[Settings] Download failed:",y),v.alert("Error de Descarga",y.message||"Error desconocido al bajar datos")}finally{h.innerHTML=b,h.style.pointerEvents="auto"}}),(r=document.getElementById("export-data-btn"))==null||r.addEventListener("click",async()=>{try{v.toast("Preparando archivo encriptado...","info");const h=u.getState(),b=I.getVaultKey(),{SecurityService:y}=await ve(async()=>{const{SecurityService:D}=await Promise.resolve().then(()=>$e);return{SecurityService:D}},void 0),k=await y.encrypt(h,b),x=new Blob([JSON.stringify(k)],{type:"application/octet-stream"}),T=URL.createObjectURL(x),E=document.createElement("a"),_=new Date().toISOString().split("T")[0];E.href=T,E.download=`life_dashboard_backup_${_}.bin`,document.body.appendChild(E),E.click(),document.body.removeChild(E),URL.revokeObjectURL(T),v.toast("Backup exportado correctamente")}catch(h){console.error("Export error:",h),v.alert("Error de Exportación","No se pudieron encriptar o descargar los datos.")}});const e=document.getElementById("import-backup-btn"),s=document.getElementById("import-backup-input");e==null||e.addEventListener("click",()=>{s==null||s.click()}),s==null||s.addEventListener("change",async h=>{var k;const b=(k=h.target.files)==null?void 0:k[0];if(!b)return;if(!await v.confirm("¿Importar Backup?","Esto sobreescribirá todos tus datos locales con los del archivo. ¿Deseas continuar?")){s.value="";return}try{const x=await b.text(),T=JSON.parse(x),E=I.getVaultKey(),{SecurityService:_}=await ve(async()=>{const{SecurityService:j}=await Promise.resolve().then(()=>$e);return{SecurityService:j}},void 0),D=await _.decrypt(T,E);if(D)u.setState(D),await u.saveState(),v.toast("Backup importado correctamente"),setTimeout(()=>window.location.reload(),1e3);else throw new Error("No se pudo descifrar el archivo")}catch(x){console.error("Import error:",x),v.alert("Error de Importación","El archivo no es válido o la contraseña no coincide con la usada para el backup.")}finally{s.value=""}}),(l=document.getElementById("btn-logout"))==null||l.addEventListener("click",async()=>{await v.confirm("¿Cerrar sesión?","El acceso quedará bloqueado hasta que introduzcas tu clave.")&&(I.logout(),window.location.reload())}),(m=document.getElementById("btn-save-gemini"))==null||m.addEventListener("click",()=>{var b;const h=(b=document.getElementById("gemini-api-key"))==null?void 0:b.value;h!==void 0&&(localStorage.setItem("life-dashboard/db_gemini_api_key",h.trim()),v.toast("API Key de Gemini guardada"))}),(c=document.getElementById("btn-save-drive-secret"))==null||c.addEventListener("click",()=>{const b=document.getElementById("drive-client-secret").value.trim();b?(localStorage.setItem("life-dashboard/drive_client_secret",b),v.toast("Secreto guardado correctamente")):(localStorage.removeItem("life-dashboard/drive_client_secret"),v.toast("Secreto eliminado, usando valor por defecto","info")),q.init().catch(console.error)}),(d=document.getElementById("toggle-drive-secret"))==null||d.addEventListener("click",h=>{const b=document.getElementById("drive-client-secret"),y=h.currentTarget,k=b.type==="password";b.type=k?"text":"password",y.innerHTML=p(k?"eyeOff":"eye")}),(g=document.getElementById("btn-factory-reset"))==null||g.addEventListener("click",async()=>{if(await v.hardConfirm("Borrar todos los datos","Esta acción eliminará permanentemente todos tus activos, ingresos, agenda y configuraciones de este dispositivo.","BORRAR")){const b="life-dashboard/";if(Object.keys(localStorage).forEach(y=>{y.startsWith(b)&&localStorage.removeItem(y)}),Object.keys(sessionStorage).forEach(y=>{y.startsWith(b)&&sessionStorage.removeItem(y)}),window.indexedDB.databases&&(await window.indexedDB.databases()).forEach(k=>window.indexedDB.deleteDatabase(k.name)),navigator.serviceWorker){const y=await navigator.serviceWorker.getRegistrations();for(let k of y)k.unregister()}v.toast("Aplicación reseteada","info"),setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now()},1e3)}})}function va(){return`
    ...
    `}function ga(a){var e,s,t;(e=document.getElementById("open-calendar"))==null||e.addEventListener("click",()=>{a("calendar")}),(s=document.getElementById("open-settings"))==null||s.addEventListener("click",()=>{a("settings")}),(t=document.getElementById("btn-force-update"))==null||t.addEventListener("click",async()=>{if(await v.confirm("¿Forzar Actualización?","Esto recargará la página y limpiará la caché para obtener la última versión.")){if(window.caches)try{const o=await caches.keys();for(let i of o)await caches.delete(i)}catch(o){console.error("Error clearing cache",o)}window.location.reload(!0)}})}function ha(){const{social:a}=u.getState(),{people:e,columns:s}=a;return`
    <div class="social-page stagger-children">
        ...
        <div class="kanban-container">
            ${s.sort((t,n)=>t.order-n.order).map(t=>{const n=e.filter(o=>o.columnId===t.id);return`
    ...
    `}function ya(a){const e=a.lastContact?Math.floor((Date.now()-new Date(a.lastContact).getTime())/864e5):null,s=a.color||"#3b82f6";return`
    ...
    `}function fa(){window.socialListenersAttached||(window.socialListenersAttached=!0,document.addEventListener("click",a=>{const e=a.target.closest(".col-opts-btn");if(e){a.preventDefault(),a.stopPropagation(),Ea(e.dataset.id,e);return}if(a.target.closest("#add-social-col-btn")){ba();return}if(a.target.closest("#add-person-btn")){window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person"}}));return}if(a.target.closest("#ideal-lead-btn")){wa();return}if(a.target.closest("#communications-mgr-btn")){ve(()=>import("./CommunicationsModal-CFW3rYcO.js"),[]).then(n=>n.openCommunicationsModal());return}if(a.target.closest("#contact-sources-btn")){$a();return}const s=a.target.closest(".person-chat-btn");if(s){a.preventDefault(),a.stopPropagation(),ve(()=>import("./CommunicationsModal-CFW3rYcO.js"),[]).then(n=>n.openCommunicationsModal(s.dataset.id));return}const t=a.target.closest(".person-card");if(t){xa(t.dataset.id);return}}),document.addEventListener("dragstart",a=>{const e=a.target.closest(".person-card");e&&(a.dataTransfer.setData("text/plain",e.dataset.id),e.classList.add("dragging"))}),document.addEventListener("dragend",a=>{const e=a.target.closest(".person-card");e&&e.classList.remove("dragging")}),document.addEventListener("dragover",a=>{const e=a.target.closest(".kanban-cards");e&&(a.preventDefault(),e.classList.add("drag-over"))}),document.addEventListener("dragleave",a=>{const e=a.target.closest(".kanban-cards");e&&e.classList.remove("drag-over")}),document.addEventListener("drop",a=>{const e=a.target.closest(".kanban-cards");if(e){a.preventDefault(),e.classList.remove("drag-over");const s=a.dataTransfer.getData("text/plain"),t=e.dataset.colId;s&&t&&u.movePerson(s,t)}}))}async function ba(){const a=await v.prompt("Etapa","Nombre de la etapa:");a&&(u.addSocialColumn({name:a,color:"#94a3b8"}),v.toast("Etapa agregada correctamente","success"))}async function wa(){const a=u.getState().social.idealLeadProfile||"",e=await ka(a);e!==null&&(u.updateIdealLeadProfile(e),v.toast("Perfil Ideal actualizado"))}function xa(a){const e=u.getState().social.people.find(s=>s.id===a);e&&window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person",person:e}}))}function ka(a){return new Promise(e=>{const s=document.createElement("div");s.className="modal-overlay active",s.style.zIndex="9999",s.innerHTML=`
            <div class="modal">
                <div class="modal-header">
        ...
        `,document.body.appendChild(s);const t=()=>{s.remove(),e(null)};s.querySelector(".modal-close").addEventListener("click",t),s.querySelector("#save-ideal-lead").addEventListener("click",()=>{const n=s.querySelector("#ideal-lead-text").value;s.remove(),e(n)}),s.addEventListener("click",n=>{n.target===s&&t()})})}function Ea(a,e){document.querySelectorAll(".column-options-menu").forEach(i=>i.remove());const s=u.getState().social.columns.find(i=>i.id===a);if(!s)return;const t=document.createElement("div");t.className="column-options-menu",t.innerHTML=`
    ...
    `;const n=e.getBoundingClientRect();t.style.position="fixed",t.style.top=`${n.bottom+8}px`,t.style.right=`${window.innerWidth-n.right}px`,t.style.zIndex="9999",document.body.appendChild(t),t.querySelectorAll(".menu-item").forEach(i=>{i.addEventListener("click",async()=>{const r=i.dataset.action;if(t.remove(),r==="edit"){const l=await v.prompt("Nombre de Columna","Nuevo nombre:",s.name);l!=null&&l.trim()&&u.updateSocialColumn(a,{name:l.trim()})}else if(r==="color"){const l=await Sa(s.color);l&&u.updateSocialColumn(a,{color:l})}else if(r==="delete")await v.confirm("Eliminar Etapa",`¿Eliminar "${s.name}"?`)&&u.deleteSocialColumn(a);else if(r==="move_up"||r==="move_down"){const l=[...u.getState().social.columns].sort((d,g)=>d.order-g.order),m=l.findIndex(d=>d.id===a);if(m===-1)return;const c=r==="move_up"?m-1:m+1;c>=0&&c<l.length&&([l[m].order,l[c].order]=[l[c].order,l[m].order],u.reorderSocialColumns(l))}})});const o=i=>{!t.contains(i.target)&&i.target!==e&&(t.remove(),document.removeEventListener("click",o))};setTimeout(()=>document.addEventListener("click",o),10)}function Sa(a){return new Promise(e=>{const s=document.createElement("div");s.className="modal-overlay active",s.style.zIndex="99999",s.innerHTML=`
        ...
        `,document.body.appendChild(s);const t=()=>{s.remove(),e(null)};s.querySelector(".modal-close").addEventListener("click",t),s.querySelectorAll(".color-swatch").forEach(n=>n.addEventListener("click",()=>{s.querySelector("#stage-color-input").value=n.dataset.color,s.querySelectorAll(".color-swatch").forEach(o=>o.style.borderColor="transparent"),n.style.borderColor="white"})),s.querySelector("#save-stage-color").addEventListener("click",()=>{const n=s.querySelector("#stage-color-input").value;s.remove(),e(n)}),s.addEventListener("click",n=>{n.target===s&&t()})})}async function $a(){const{contactSources:a}=u.getState().social,e=await Ia(a);e&&(u.updateContactSources(e),v.toast("Fuentes de contacto actualizadas"))}function Ia(a){return new Promise(e=>{const s=document.createElement("div");s.className="modal-overlay active",s.style.zIndex="9999",s.innerHTML=`
        ...
        `,document.body.appendChild(s);const t=()=>{s.remove(),e(null)};s.querySelector(".modal-close").addEventListener("click",t),s.querySelector("#save-contact-sources").addEventListener("click",()=>{const o=s.querySelector("#contact-sources-text").value.split(",").map(i=>i.trim()).filter(i=>i.length>0);s.remove(),e(o)}),s.addEventListener("click",n=>{n.target===s&&t()})})}let ce="tracker",L=null,ye=!1,Q=null;function Aa(){const a=u.getState(),{activities:e=[],logs:s=[]}=a.timeInvest||{};return`
    <div class="time-invest-page stagger-children">
        ...
        <div class="segmented-control">
            <button class="segment-btn ${ce==="tracker"?"active":""}" id="tab-tracker">
                Tracker
            </button>
            <button class="segment-btn ${ce==="stats"?"active":""}" id="tab-stats">
                Stats
            </button>
        </div>
    ...
    `}function Ca(a,e){var s;if(Q){const t=a.find(n=>n.id===Q);if(t&&((s=t.subActivities)==null?void 0:s.length)>0)return La(t)}return ce==="tracker"?Ta(a):Ma(a,e)}function La(a){return`
    ...
    <div class="tracker-view animate-fade-in">
        ...
        <div class="card" style="margin-top: var(--spacing-xl);">
            <div class="toggle-row">
                ...
                <input type="checkbox" id="pomodoro-toggle" class="apple-switch" ${ye?"checked":""}>
            </div>
        </div>
    </div>
    `}function Ma(a,e){const s=[];for(let c=6;c>=0;c--){const d=new Date;d.setDate(d.getDate()-c),s.push(d.toISOString().split("T")[0])}const t=["Dom","Lun","Mar","Mié","Jue","Vie","Sáb"],n=s.map(c=>{const d=e.filter(h=>h.date.startsWith(c)),g={};return d.forEach(h=>{g[h.activityId]=(g[h.activityId]||0)+(h.durationMinutes||0)}),g}),o=Math.max(...n.flatMap(c=>Object.values(c)),60),i=150,r=300,l=r/6,m=c=>n.map((d,g)=>{const h=d[c]||0,b=g*l,y=i-h/o*i;return`${g===0?"M":"L"} ${b} ${y}`}).join(" ");return`
            ...
            <div class="line-chart-container" style="height: ${i}px; width: 100%; position: relative; margin-top: 20px;">
                <svg viewBox="0 0 ${r} ${i}" preserveAspectRatio="none" style="width: 100%; height: 100%; overflow: visible;">
                    ...
                    ${a.map(c=>`
                        ...
                        ${n.map((d,g)=>{const h=d[c.id]||0;if(h===0)return"";const b=g*l,y=i-h/o*i;return`<circle cx="${b}" cy="${y}" r="4" fill="${c.color}" />`}).join("")}
                    `).join("")}
                </svg>
    ...
    `}function Da(a){var n;const e=a.find(o=>o.id===L.activityId),s=(n=e==null?void 0:e.subActivities)==null?void 0:n.find(o=>o.id===L.subActivityId),t=Je(L.elapsedSeconds);return`
    <div class="timer-overlay animate-fade-in">
        ...
        ${ye?`<p style="margin-top: 40px; color: var(--text-muted); font-size: 14px;">Pomodoro activo (${u.getState().timeInvest.pomodoroTime} min)</p>`:""}
    </div>
    `}function Je(a){const e=Math.floor(a/3600),s=Math.floor(a%3600/60),t=a%60;return`${e>0?e+":":""}${String(s).padStart(2,"0")}:${String(t).padStart(2,"0")}`}function Ba(){var a,e,s,t,n,o,i;(a=document.getElementById("tab-tracker"))==null||a.addEventListener("click",()=>{var r;ce="tracker",(r=window.reRender)==null||r.call(window)}),(e=document.getElementById("tab-stats"))==null||e.addEventListener("click",()=>{var r;ce="stats",(r=window.reRender)==null||r.call(window)}),document.querySelectorAll(".activity-btn").forEach(r=>{r.classList.contains("sub-opt")||r.addEventListener("click",()=>{var c,d;const l=r.dataset.id;((c=u.getState().timeInvest.activities.find(g=>g.id===l).subActivities)==null?void 0:c.length)>0?(Q=l,(d=window.reRender)==null||d.call(window)):je(l)})}),document.querySelectorAll(".sub-opt").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.subId==="none"?null:r.dataset.subId;je(Q,l),Q=null})}),(s=document.getElementById("btn-back-to-activities"))==null||s.addEventListener("click",()=>{var r;Q=null,(r=window.reRender)==null||r.call(window)}),(t=document.getElementById("pomodoro-toggle"))==null||t.addEventListener("change",r=>{ye=r.target.checked}),(n=document.getElementById("btn-stop-timer"))==null||n.addEventListener("click",()=>{confirm("¿Deseas cancelar esta sesión? No se guardarán los datos.")&&Ue(!1)}),(o=document.getElementById("btn-complete-timer"))==null||o.addEventListener("click",()=>{Ue(!0)}),(i=document.getElementById("btn-add-activity"))==null||i.addEventListener("click",()=>{ge()})}function ge(){var r,l,m;const a=u.getState().timeInvest,{activities:e=[],pomodoroTime:s=25}=a,t=document.createElement("div");t.className="modal-overlay active",t.id="time-invest-config-modal",t.innerHTML=`
  ...
  `}function Ze(){const a=Se[C],e=C==="investmentAsset"||C==="passiveAsset";if(e){const t=V.map(n=>({value:n.symbol,label:`${n.name} (${n.symbol})`}));[...Oe,...t]}let s="";return C==="passiveAsset"||C==="investmentAsset"?s=`
    ...
    <div class="form-row">
        ...
        <div class="form-group" style="flex: 1.5;">
            ...
            <select class="form-input form-select" id="input-currency">
                <optgroup label="Divisas">
                    ${Oe.map(t=>`<option value="${t.value}">${t.label}</option>`).join("")}
                </optgroup>
                ${e?`
  ...
  `}function _a(){const a=document.getElementById("add-modal"),e=document.getElementById("modal-close");a.addEventListener("click",t=>{t.target===a&&Ee()}),e.addEventListener("click",Ee);const s=a.querySelectorAll(".category-selector .type-option");s.forEach(t=>{t.addEventListener("click",()=>{C=t.dataset.category,s.forEach(n=>n.classList.remove("active")),t.classList.add("active"),document.getElementById("form-container").innerHTML=Ze(),Ne()})}),Ne()}function Ne(){const a=document.getElementById("btn-save");a&&a.addEventListener("click",ja);const e=document.getElementById("mode-qty"),s=document.getElementById("mode-total"),t=document.getElementById("input-qty"),n=document.getElementById("input-value"),o=document.getElementById("input-currency"),i=document.getElementById("input-name");if(e&&s){const l=m=>{m==="qty"?(e.style.background="var(--accent-primary)",e.style.color="var(--bg-primary)",s.style.background="transparent",s.style.color="var(--text-secondary)",t.focus()):(s.style.background="var(--accent-primary)",s.style.color="var(--bg-primary)",e.style.background="transparent",e.style.color="var(--text-secondary)",n.focus())};e.addEventListener("click",()=>l("qty")),s.addEventListener("click",()=>l("total"))}const r=l=>{const m=u.getState().rates,c=o==null?void 0:o.value,d=m[c]||1;if(l==="qty"){const g=parseFloat(t.value)||0;n.value=(g*d).toFixed(2)}else{const g=parseFloat(n.value)||0;t.value=(g/d).toFixed(6)}};t==null||t.addEventListener("input",()=>r("qty")),n==null||n.addEventListener("input",()=>r("total")),o&&o.addEventListener("change",()=>{if(i&&!i.value){const l=o.options[o.selectedIndex].text;i.value=l.split(" (")[0]}r("qty")})}function ja(){var h,b,y,k,x,T,E,_,D,j,se,ne;const a=(b=(h=document.getElementById("input-name"))==null?void 0:h.value)==null?void 0:b.trim(),e=(y=document.getElementById("input-type"))==null?void 0:y.value,s=(k=document.getElementById("input-currency"))==null?void 0:k.value,t=(T=(x=document.getElementById("input-details"))==null?void 0:x.value)==null?void 0:T.trim(),n=parseFloat((E=document.getElementById("input-value"))==null?void 0:E.value)||0,o=document.getElementById("input-qty"),i=o?parseFloat(o.value)||0:n,r=parseFloat((_=document.getElementById("input-amount"))==null?void 0:_.value)||0,l=parseFloat((D=document.getElementById("input-monthly"))==null?void 0:D.value)||0,m=(j=document.getElementById("input-date"))==null?void 0:j.value,c=(se=document.getElementById("input-time"))==null?void 0:se.value,d=(ne=document.getElementById("input-repeat"))==null?void 0:ne.value;if(!a){v.alert("Campo Obligatorio","Por favor ingresa un nombre para el elemento.");return}const g={name:a,type:e,currency:s,details:t};switch(C){case"passiveAsset":u.addPassiveAsset({...g,value:i,monthlyIncome:l});break;case"activeIncome":u.addActiveIncome({...g,amount:r});break;case"livingExpense":u.addLivingExpense({...g,amount:r});break;case"investmentAsset":u.addInvestmentAsset({...g,value:i});break;case"liability":u.addLiability({...g,amount:r,monthlyPayment:l});break;case"event":u.addEvent({title:a,date:m,time:c,repeat:d,category:e});break}Ee()}function Ee(){const a=document.getElementById("add-modal");a&&(a.classList.remove("active"),setTimeout(()=>a.remove(),300))}let K=null;function Qe(a=null){console.log("[LeadModal] Opening modal",{personToEdit:a});const e=document.getElementById("add-person-modal");e&&(console.log("[LeadModal] Removing existing modal"),e.remove()),K=a?a.id:null;const s=document.createElement("div");s.className="modal-overlay",s.id="add-person-modal",s.setAttribute("role","dialog"),s.innerHTML=Ua(a),document.body.appendChild(s),setTimeout(()=>{var t;s.classList.add("active"),(t=s.querySelector("#person-name"))==null||t.focus()},50),Oa(s)}function Ua(a=null){const e=a?"Editar Lead":"Lead",s=a?"Guardar Cambios":"Lead";return`
    <div class="modal">
      <div class="modal-handle"></div>
      <div class="modal-header">
  ...
  `}function Oa(a){const e=a.querySelector("#person-modal-close"),s=a.querySelector("#btn-save-person-lead"),t=a.querySelector("#btn-delete-person"),n=a.querySelector("#person-rating-slider"),o=a.querySelector("#rating-value");if(a.addEventListener("click",l=>{l.target===a&&(console.log("[LeadModal] Overlay clicked, closing"),he(a))}),e==null||e.addEventListener("click",()=>{console.log("[LeadModal] Close button clicked"),he(a)}),n&&o){const l=()=>{console.log("[LeadModal] Slider updated:",n.value),o.textContent=n.value};n.oninput=l,n.onchange=l}s&&(s.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Save button clicked"),Fa(a)}),t&&(t.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Delete button clicked"),Na(a)});const i=a.querySelectorAll(".goal-color-dot"),r=a.querySelector("#person-color-value");i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(m=>m.classList.remove("active")),l.classList.add("active"),r&&(r.value=l.dataset.color),console.log("[LeadModal] Color selected:",l.dataset.color)})})}async function Na(a){K&&await v.confirm("Eliminar Lead","¿Estás seguro de eliminar este lead?")&&(u.deletePerson(K),v.toast("Lead eliminado","success"),he(a))}function Fa(a){var s,t,n,o,i,r,l,m,c,d,g,h,b;const e=a.querySelector("#btn-save-person-lead");if(e.disabled){console.log("[LeadModal] Save ignored, already processing");return}try{const y=(t=(s=a.querySelector("#person-name"))==null?void 0:s.value)==null?void 0:t.trim(),k=(o=(n=a.querySelector("#person-phone"))==null?void 0:n.value)==null?void 0:o.trim(),x=(r=(i=a.querySelector("#person-city"))==null?void 0:i.value)==null?void 0:r.trim(),T=(l=a.querySelector("#person-source"))==null?void 0:l.value,E=(m=a.querySelector("#person-rating-slider"))==null?void 0:m.value,_=(d=(c=a.querySelector("#person-desc"))==null?void 0:c.value)==null?void 0:d.trim(),D=(g=a.querySelector("#person-column"))==null?void 0:g.value,j=(h=a.querySelector("#person-color-value"))==null?void 0:h.value,se=(b=a.querySelector("#person-last-contact"))==null?void 0:b.value;if(console.log("[LeadModal] Attempting to save",{name:y,rating:E,columnId:D,color:j,lastContact:se}),!y){console.warn("[LeadModal] Save failed: Missing name"),v.toast("El nombre es obligatorio","error");return}e.disabled=!0,e.innerHTML='<span class="loading-spinner-sm"></span> Guardando...';const ne={name:y,phone:k,city:x,source:T,rating:parseInt(E)||5,description:_,columnId:D,color:j,lastContact:se};K?(console.log("[LeadModal] Updating person",K),u.updatePerson(K,ne),v.toast("Lead actualizado correctamente","success")):(console.log("[LeadModal] Adding new person"),u.addPerson(ne),v.toast("Lead guardado correctamente","success")),console.log("[LeadModal] Save successful, closing modal"),he(a)}catch(y){console.error("[LeadModal] Error saving lead:",y),v.toast("Error al guardar el lead","error"),e.disabled=!1,e.innerHTML=`${p("plus")} Lead`}}function he(a){a&&(console.log("[LeadModal] Closing modal"),a.classList.remove("active"),setTimeout(()=>{a.parentNode&&(console.log("[LeadModal] Removing modal from DOM"),a.remove())},400))}function Ga(){const a=I.isSetup(),e=I.isBioEnabled();return`
    ...
    `}function qa(a){var o;const e=document.getElementById("auth-submit-btn"),s=document.getElementById("auth-bio-btn"),t=document.getElementById("auth-password"),n=async()=>{const i=t.value,r=document.getElementById("auth-confirm"),l=I.isSetup();try{let m;if(l)m=await I.unlock(i);else{if(!i||i.length<4)throw new Error("Contraseña demasiado corta");if(i!==r.value)throw new Error("Las contraseñas no coinciden");m=await I.setup(i)}await u.loadEncrypted(m),a()}catch(m){v.alert("Error",m.message)}};e==null||e.addEventListener("click",n),t==null||t.addEventListener("keydown",i=>{i.key==="Enter"&&(i.preventDefault(),n())}),(o=document.getElementById("auth-confirm"))==null||o.addEventListener("keydown",i=>{i.key==="Enter"&&(i.preventDefault(),n())}),s==null||s.addEventListener("click",async()=>{try{const i=await I.unlockWithBiometrics();await u.loadEncrypted(i),a()}catch(i){v.alert("Identificación",i.message)}}),I.isBioEnabled()&&setTimeout(async()=>{try{const i=await I.unlockWithBiometrics();await u.loadEncrypted(i),a()}catch{console.log("Auto-bio failed or cancelled")}},500)}let R=localStorage.getItem("life-dashboard/app_current_page")||"finance",A=localStorage.getItem("life-dashboard/app_current_sub_page")||null;A==="null"&&(A=null);async function Fe(){window.addEventListener("open-add-modal",e=>{var t,n;const s=(t=e.detail)==null?void 0:t.type;s==="person"?Qe((n=e.detail)==null?void 0:n.person):ke(s)}),q.init().catch(e=>console.warn("[Drive] Pre-init failed:",e));const a=I.getVaultKey();a?await u.loadEncrypted(a)?et():(console.error("[Boot] Decryption failed, invalid vault key in session?"),I.logout(),Ge()):Ge()}function Ge(){const a=document.getElementById("app");a.innerHTML=Ga(),qa(()=>{et()})}function et(){const a=document.getElementById("app");a.innerHTML=`
        <main id="main-content"></main>
        <nav id="bottom-nav"></nav>
    `,tt(),u.subscribe(()=>{P()}),window.reRender=()=>P(),Ha()}function Ha(){var t,n;const a=localStorage.getItem("life-dashboard/pwa_install_dismissed");if(a&&(Date.now()-parseInt(a))/864e5<7||window.matchMedia("(display-mode: standalone)").matches)return;const e=document.createElement("div");e.className="pwa-install-banner",e.id="pwa-install-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(e);const s=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};s(),window.addEventListener("beforeinstallprompt",s),(t=document.getElementById("pwa-banner-install"))==null||t.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:o}=await window.deferredPrompt.userChoice;o==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(n=document.getElementById("pwa-banner-close"))==null||n.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function tt(){const a=document.getElementById("bottom-nav");a.innerHTML=Le(R),Te(e=>{R=e,A=null,localStorage.setItem("life-dashboard/app_current_page",R),localStorage.setItem("life-dashboard/app_current_sub_page",A),O(),P(),a.innerHTML=Le(R),Te(s=>{R=s,A=null,localStorage.setItem("life-dashboard/app_current_page",R),localStorage.setItem("life-dashboard/app_current_sub_page",A),O(),P(),tt()})}),Va(),P()}function P(){const a=document.getElementById("main-content");if(!a)return;const e=a.scrollTop;if(A==="compound"){a.innerHTML=_t(),jt(()=>{A=null,Ut(),O(),P()}),a.scrollTop=e;return}if(A==="expenses"){a.innerHTML=ia(),ca(()=>{A=null,O(),P()}),a.scrollTop=e;return}if(A==="market"){a.innerHTML=Ot(),Ft(()=>{A=null,O(),P()}),a.scrollTop=e;return}switch(a.classList.toggle("no-padding-mobile",R==="health"),R){case"finance":O(),a.innerHTML=De(),Be(),qe();break;case"goals":N(),a.innerHTML=Xt(),Zt();break;case"time-invest":N(),a.innerHTML=Aa(),Ba();break;case"social":N(),a.innerHTML=ha(),fa();break;case"health":a.innerHTML=Gt(),Kt(),N();break;case"menu":a.innerHTML=va(),ga(s=>{R=s,O(),P()}),N();break;case"calendar":a.innerHTML=Qt(),oa(),O();break;case"settings":a.innerHTML=pa(),ma(),N();break;default:O(),a.innerHTML=De(),Be(),qe()}requestAnimationFrame(()=>{a.scrollTop=e})}function qe(){const a=document.getElementById("open-compound");a&&a.addEventListener("click",()=>{A="compound",localStorage.setItem("life-dashboard/app_current_sub_page",A),N(),P()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{A="market",localStorage.setItem("life-dashboard/app_current_sub_page",A),N(),P()});const s=document.getElementById("open-expenses");s&&s.addEventListener("click",()=>{A="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",A),N(),P()})}function Va(){const a=document.querySelector(".fab");a&&a.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=p("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{if(R==="calendar")ke("event");else if(R==="health"){const s=await ns.confirm("Log Metric","What do you want to record today?","Weight","Body Fat");if(s===!0){const t=await ns.prompt("Log Weight","Enter your current weight in kg:","","number");t&&u.addWeightLog(t)}else if(s===!1){const t=await ns.prompt("Body Fat","Enter your body fat %:","","number");t&&u.addFatLog(t)}}else R==="social"?Qe():ke()}),document.body.appendChild(e)}function N(){const a=document.getElementById("main-fab");a&&(a.style.display="none")}function O(){const a=document.getElementById("main-fab");a&&(a.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Fe):Fe();window.addEventListener("beforeinstallprompt",a=>{a.preventDefault(),window.deferredPrompt=a,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});export{p as g,v as n,u as s};
