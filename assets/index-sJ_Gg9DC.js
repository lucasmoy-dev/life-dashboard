var gt=Object.defineProperty;var ht=(a,e,t)=>e in a?gt(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var pe=(a,e,t)=>ht(a,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const yt="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",ft="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function bt(){var e,t,s,n,i,o,r,l,u,c,d,g,h,f,y;const a={EUR:1};try{const k=await(await fetch(yt)).json();a.BTC=((e=k.bitcoin)==null?void 0:e.eur)||4e4,a.ETH=((t=k.ethereum)==null?void 0:t.eur)||2200,a.XRP=((s=k.ripple)==null?void 0:s.eur)||.5,a.KAS=((n=k.kaspa)==null?void 0:n.eur)||.1,a.SOL=((i=k.solana)==null?void 0:i.eur)||90,a.XLM=((o=k.stellar)==null?void 0:o.eur)||.11,a.ALGO=((r=k.algorand)==null?void 0:r.eur)||.18,a.LTC=((l=k.litecoin)==null?void 0:l.eur)||65,a.SUI=((u=k.sui)==null?void 0:u.eur)||1.1,a.LINK=((c=k.chainlink)==null?void 0:c.eur)||14,a.RNDR=((d=k["render-token"])==null?void 0:d.eur)||4.5,a.ADA=((g=k.cardano)==null?void 0:g.eur)||.45,a.ONDO=((h=k["ondo-finance"])==null?void 0:h.eur)||.7,(f=k.bitcoin)!=null&&f.ars&&((y=k.bitcoin)!=null&&y.eur)&&(a.ARS=k.bitcoin.eur/k.bitcoin.ars);const L=await fetch(ft);if(L.ok){const E=await L.json();a.USD=1/E.rates.USD,a.CHF=1/E.rates.CHF,a.GBP=1/E.rates.GBP,a.AUD=1/E.rates.AUD}a.GOLD=2100,a.SP500=4700}catch(x){console.error("Failed to fetch some prices:",x),a.USD=a.USD||.92,a.CHF=a.CHF||1.05,a.GBP=a.GBP||1.15,a.AUD=a.AUD||.6,a.ARS=a.ARS||.001}return a}class H{static async hash(e,t="salt_life_dashboard_2026"){const n=new TextEncoder().encode(e+t),i=await crypto.subtle.digest("SHA-512",n);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,t){const s=new TextEncoder,n=await crypto.subtle.importKey("raw",s.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:s.encode(t),iterations:25e4,hash:"SHA-512"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,t){try{const s=crypto.getRandomValues(new Uint8Array(16)),n=crypto.getRandomValues(new Uint8Array(12)),i=await this.deriveKey(t,this.bufToBase64(s)),o=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(o),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},i,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(n),salt:this.bufToBase64(s),v:"5.0"}}catch(s){throw console.error("[Security] Encryption failed:",s),new Error("No se pudo encriptar la información")}}static async decrypt(e,t){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:s,iv:n,salt:i}=e,o=await this.deriveKey(t,i),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(n)},o,this.base64ToBuf(s)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(s){throw console.error("[Security] Decryption failed:",s),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(t=>t.charCodeAt(0)))}}const Me=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:H},Symbol.toStringTag,{value:"Module"})),M={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class ${static isSetup(){return!!localStorage.getItem(M.MASTER_HASH)}static async setup(e){const t=await H.hash(e),s=await H.deriveVaultKey(e);return localStorage.setItem(M.MASTER_HASH,t),sessionStorage.setItem(M.VAULT_KEY,s),s}static async unlock(e){const t=await H.hash(e),s=localStorage.getItem(M.MASTER_HASH);if(t===s){const n=await H.deriveVaultKey(e);return sessionStorage.setItem(M.VAULT_KEY,n),n}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const t=sessionStorage.getItem(M.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const s=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:s,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(M.BIO_ENABLED,"true"),localStorage.setItem(M.VAULT_KEY,t),!0}catch(s){throw console.error("Biometric setup failed:",s),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(M.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const t=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:t,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const s=localStorage.getItem(M.VAULT_KEY);if(s)return sessionStorage.setItem(M.VAULT_KEY,s),s;throw new Error("Llave no encontrada. Usa contraseña.")}catch(t){throw console.error("Biometric auth failed:",t),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(M.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(M.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(M.BIO_ENABLED)==="true"}}const Ee="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",Be=[71,79,67,83,80,88,45,112,121,52,68,109,80,83,107,45,100,75,55,99,73,66,116,106,65,81,75,90,70,75,118,95,66,87,95].map(a=>String.fromCharCode(a)).join(""),wt="https://www.googleapis.com/auth/drive.file";class U{static hasToken(){const e=!!this.accessToken;return localStorage.getItem("life-dashboard/drive_connected")==="true"&&e}static async init(){return this._initPromise?this._initPromise:(this._initPromise=new Promise((e,t)=>{const s=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.codeClient=google.accounts.oauth2.initCodeClient({client_id:Ee,scope:wt,ux_mode:"popup",access_type:"offline",prompt:"consent",callback:async n=>{if(n.error){console.error("[Drive] Auth callback error:",n);return}if(n.code)try{const i=sessionStorage.getItem("life-dashboard/pkce_verifier"),o=localStorage.getItem("life-dashboard/drive_client_secret")||Be,r=await this.exchangeCodeForTokens(n.code,i,Ee,o);r.refresh_token&&await this.saveRefreshToken(r.refresh_token),this.saveSession(r),console.log("[Drive] Connected successfully via offline flow."),window.ns&&window.ns.toast("Google Drive vinculado"),typeof window.reRender=="function"&&window.reRender()}catch(i){console.error("[Drive] Token exchange error:",i),window.ns&&window.ns.alert("Error Auth","No se pudieron obtener tokens. Verifica el Client Secret.")}}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&this.ensureValidToken().catch(n=>{console.log("[Drive] Initial silent restoration skipped:",n.message)}),e(!0)}catch(n){console.error("[Drive] Init error:",n),t(n)}}):setTimeout(s,200)};s()}),this._initPromise)}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const t=e.expires_in||3600,s=Date.now()+t*1e3;localStorage.setItem("life-dashboard/drive_token_expiry",s.toString())}static async authenticate(){this.codeClient||await this.init();const{verifier:e}=await this.generatePKCE();sessionStorage.setItem("life-dashboard/pkce_verifier",e),this.codeClient.requestCode()}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(!(localStorage.getItem("life-dashboard/drive_connected")==="true"))return null;if(!this.accessToken||Date.now()>e-3e5){console.log("[Drive] Access token expired or near expiry, attempting refresh...");const n=await this.getRefreshToken();if(n)try{const i=localStorage.getItem("life-dashboard/drive_client_secret")||Be,o=await this.refreshAccessToken(n,Ee,i),r={access_token:o.access_token,expires_in:o.expires_in,refresh_token:o.refresh_token||n};return o.refresh_token&&await this.saveRefreshToken(o.refresh_token),this.saveSession(r),this.accessToken}catch(i){throw console.error("[Drive] Token refresh failed:",i),new Error("Sesión de Google Drive expirada. Por favor reconecta en Configuración.")}else throw console.warn("[Drive] No refresh token found."),new Error("Google Drive no está vinculado para acceso offline.")}return this.accessToken&&(!gapi.client.getToken()||gapi.client.getToken().access_token!==this.accessToken)&&gapi.client.setToken({access_token:this.accessToken}),this.accessToken}static async generatePKCE(){const e=Array.from(crypto.getRandomValues(new Uint8Array(32))).map(o=>("0"+o.toString(16)).slice(-2)).join(""),s=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",s),i=btoa(String.fromCharCode(...new Uint8Array(n))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return{verifier:e,challenge:i}}static async exchangeCodeForTokens(e,t,s,n=null){const i=new URLSearchParams({client_id:s,code:e,grant_type:"authorization_code",redirect_uri:"postmessage"});t&&!n&&i.append("code_verifier",t),n&&i.append("client_secret",n);const o=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:i});if(!o.ok){const r=await o.json();throw new Error(r.error_description||"Failed to exchange code")}return await o.json()}static async refreshAccessToken(e,t,s=null){const n=new URLSearchParams({client_id:t,refresh_token:e,grant_type:"refresh_token"});s&&n.append("client_secret",s);const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n});if(!i.ok){const o=await i.json();throw new Error(o.error_description||"Failed to refresh token")}return await i.json()}static async saveRefreshToken(e){return new Promise((t,s)=>{const n=indexedDB.open("LifeDashboardAuthDB",1);n.onupgradeneeded=i=>{const o=i.target.result;o.objectStoreNames.contains("tokens")||o.createObjectStore("tokens")},n.onsuccess=i=>{const r=i.target.result.transaction("tokens","readwrite");r.objectStore("tokens").put(e,"drive_refresh_token"),r.oncomplete=()=>t(),r.onerror=l=>s(l)},n.onerror=i=>s(i)})}static async getRefreshToken(){return new Promise((e,t)=>{const s=indexedDB.open("LifeDashboardAuthDB",1);s.onupgradeneeded=n=>{const i=n.target.result;i.objectStoreNames.contains("tokens")||i.createObjectStore("tokens")},s.onsuccess=n=>{const i=n.target.result;if(!i.objectStoreNames.contains("tokens")){e(null);return}const l=i.transaction("tokens","readonly").objectStore("tokens").get("drive_refresh_token");l.onsuccess=()=>e(l.result),l.onerror=u=>t(u)},s.onerror=n=>t(n)})}static async clearTokens(){return localStorage.removeItem("life-dashboard/drive_access_token"),localStorage.removeItem("life-dashboard/drive_connected"),localStorage.removeItem("life-dashboard/drive_token_expiry"),new Promise(e=>{const t=indexedDB.open("LifeDashboardAuthDB",1);t.onsuccess=s=>{const n=s.target.result;if(n.objectStoreNames.contains("tokens")){const i=n.transaction("tokens","readwrite");i.objectStore("tokens").clear(),i.oncomplete=()=>e()}else e()},t.onerror=()=>e()})}static async getOrCreateFolderPath(e){var n;await this.ensureValidToken(),(n=gapi.client)!=null&&n.drive||await this.init();const t=e.split("/").filter(i=>i);let s="root";for(const i of t){const o=`name = '${i}' and mimeType = 'application/vnd.google-apps.folder' and '${s}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)"})).result.files;if(l&&l.length>0)s=l[0].id;else{const u={name:i,mimeType:"application/vnd.google-apps.folder",parents:[s]};s=(await gapi.client.drive.files.create({resource:u,fields:"id"})).result.id}}return s}static async pushData(e,t,s=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pushing encrypted data...${s?" (Retry)":""}`);const n=await this.getOrCreateFolderPath("/backup/life-dashboard/"),i=await H.encrypt(e,t),o="dashboard_vault_v5.bin",r=`name = '${o}' and '${n}' in parents and trashed = false`,u=(await gapi.client.drive.files.list({q:r,fields:"files(id)"})).result.files,c=new Blob([JSON.stringify(i)],{type:"application/json"});if(u&&u.length>0){const d=u[0].id,g=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${d}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:c});if(g.status===401&&!s)return await this.ensureValidToken(),await this.pushData(e,t,!0);if(!g.ok)throw new Error(`Error al actualizar backup: ${g.status}`)}else{const d={name:o,parents:[n]},g=new FormData;g.append("metadata",new Blob([JSON.stringify(d)],{type:"application/json"})),g.append("file",c);const h=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:g});if(h.status===401&&!s)return await this.ensureValidToken(),await this.pushData(e,t,!0);if(!h.ok)throw new Error(`Error al crear backup: ${h.status}`)}return!0}catch(n){throw console.error("[Drive] Push failed:",n),new Error(n.message||"Fallo al subir datos a Drive")}}static async pullData(e,t=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pulling data...${t?" (Retry)":""}`);const i=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,r=(await gapi.client.drive.files.list({q:i,fields:"files(id, name)"})).result.files;if(!r||r.length===0)return null;const l=r[0].id,u=await fetch(`https://www.googleapis.com/drive/v3/files/${l}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(u.status===401&&!t)return await this.ensureValidToken(),await this.pullData(e,!0);if(!u.ok)throw new Error(`Error al descargar backup: ${u.status}`);const c=await u.json();return await H.decrypt(c,e)}catch(s){throw console.error("[Drive] Pull failed:",s),new Error(s.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");const s=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,i=(await gapi.client.drive.files.list({q:s,fields:"files(id)"})).result.files;if(i&&i.length>0){const o=i[0].id;return await gapi.client.drive.files.delete({fileId:o}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(e){throw console.error("[Drive] Deletion failed:",e),new Error(e.message||"Fallo al borrar backup en Drive")}}}pe(U,"codeClient",null),pe(U,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null),pe(U,"_initPromise",null);const Pe={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',chevronUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>',chevronDown:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',uploadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12V21"/><path d="m16 16-4-4-4 4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>',moreVertical:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>',check:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',menu:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>',users:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',messageSquare:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',phone:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',instagram:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>',facebook:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>',linkedin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>',alertCircle:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>',fingerprint:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 15.1a7 7 0 0 0 10.9 0"/><path d="M6 13.6a7 7 0 0 0 4.6 2.4"/><path d="M13.4 16a7 7 0 0 0 4.6-2.4"/><path d="M8 12.1a5 5 0 0 0 6.9 0"/><path d="M9.1 11a3 3 0 0 0 3.9 0"/><path d="M12 18.5V20"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',palette:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.555C21.965 6.012 17.461 2 12 2z"/></svg>',star:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',eye:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>',eyeOff:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.52 13.52 0 0 0 2 12c0 0 3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><line x1="2" x2="22" y1="2" y2="22"/></svg>',play:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg>',pause:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>',clock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',barChart2:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>',brain:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 4.44-2.54Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-4.44-2.54Z"/></svg>',rocket:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-5c1.62-2.2 5-3 5-3"/><path d="M12 15v5s3.03-.55 5-2c2.2-1.62 3-5 3-5"/></svg>',coffee:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>',bookOpen:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>',dumbbell:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6.5 6.5 11 11"/><path d="m21 21-1-1"/><path d="m3 3 1 1"/><path d="m18 22 4-4"/><path d="m2 6 4-4"/><path d="m3 10 7-7"/><path d="m14 21 7-7"/></svg>',code:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',music:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>',monitor:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" x2="16" y1="21" y2="21"/><line x1="12" x2="12" y1="17" y2="21"/></svg>'};function m(a,e=""){return(Pe[a]||Pe.package).replace("<svg",`<svg class="${e}"`)}class xt{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,t="success",s=3e3){const n=document.createElement("div");n.className=`toast toast-${t} stagger-in`;const i=t==="success"?"check":t==="error"?"alertCircle":"info";n.innerHTML=`
  ...
  `}function Dt(a){const e=document.getElementById("edit-modal"),t=document.getElementById("edit-modal-close"),s=document.getElementById("btn-update"),n=document.getElementById("btn-delete");e.addEventListener("click",i=>{i.target===e&&he()}),t.addEventListener("click",he),s.addEventListener("click",()=>Mt(a)),n.addEventListener("click",()=>Bt(a))}function Mt(a){var u,c,d,g,h,f,y,x,k;const e=(c=(u=document.getElementById("edit-name"))==null?void 0:u.value)==null?void 0:c.trim(),t=(d=document.getElementById("edit-type"))==null?void 0:d.value,s=(g=document.getElementById("edit-currency"))==null?void 0:g.value,n=(f=(h=document.getElementById("edit-details"))==null?void 0:h.value)==null?void 0:f.trim(),i=parseFloat((y=document.getElementById("edit-value"))==null?void 0:y.value)||0,o=parseFloat((x=document.getElementById("edit-amount"))==null?void 0:x.value)||0,r=parseFloat((k=document.getElementById("edit-monthly"))==null?void 0:k.value)||0;if(!e){v.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:t,currency:s,details:n};a.fields.includes("value")&&(l.value=i),a.fields.includes("amount")&&(l.amount=o),a.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),a.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),p[a.updateMethod](de.id,l),he()}function Bt(a){v.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${de.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(p[a.deleteMethod](de.id),v.toast("Eliminado correctamente","info"),he())})}function he(){const a=document.getElementById("edit-modal");a&&(a.classList.remove("active"),setTimeout(()=>a.remove(),300)),de=null,ee=null}let te=!1,se=!1,S={key:"price",direction:"desc"},ne="USD",F=null;function Pt(){const a=p.getState(),e=a.lastMarketData||[],t=a.marketFavorites||[];F===null&&(F=t.length>0?"favorites":"all"),!se&&!te&&Ot();const s=ne==="EUR"?"€":"$";let n=e;F==="favorites"&&(n=e.filter(o=>t.includes(o.id)));const i=Object.values(b);return`
        <div class="market-view animate-fade-in" style="padding: 4px;">
            ...
            ${i.map(o=>{const r=n.filter(l=>l.category===o);return r.length===0?"":Rt(o,r,s,t)}).join("")}
        </div>
    `}function Rt(a,e,t,s){const n=[...e].sort((i,o)=>{let r=i[S.key],l=o[S.key];return typeof r=="string"&&(r=r.toLowerCase()),typeof l=="string"&&(l=l.toLowerCase()),r<l?S.direction==="asc"?-1:1:r>l?S.direction==="asc"?1:-1:0});return`
    ...
    `}function _t(a,e,t){let s=a.price;if(a.price!==null&&ne==="EUR"){const r=p.getState().rates.USD||.92;s=a.price*r}const n=$e(a.change24h),i=$e(a.change30d),o=$e(a.change1y);return`
    ...
    `}function $e(a){return a==null?"":te?a>=0?"text-positive":"text-negative":"text-accent-primary"}function jt(){return`
    ...
    `}async function Ot(){var a,e;if(!se){se=!0,(a=window.reRender)==null||a.call(window);try{const t=await Qe();p.saveMarketData(t),te=!0}catch(t){console.error("Market update failed",t)}finally{se=!1,(e=window.reRender)==null||e.call(window)}}}function Nt(){var a,e,t;document.querySelectorAll(".capsule-btn").forEach(s=>{s.addEventListener("click",()=>{var i;const n=s.dataset.curr;n!==ne&&(ne=n,(i=window.reRender)==null||i.call(window))})}),(a=document.getElementById("filter-all"))==null||a.addEventListener("click",()=>{var s;F="all",(s=window.reRender)==null||s.call(window)}),(e=document.getElementById("filter-favs"))==null||e.addEventListener("click",()=>{var s;F="favorites",(s=window.reRender)==null||s.call(window)}),(t=document.getElementById("btn-show-all"))==null||t.addEventListener("click",()=>{var s;F="all",(s=window.reRender)==null||s.call(window)}),document.querySelectorAll(".btn-favorite").forEach(s=>{s.addEventListener("click",n=>{var o;n.stopPropagation();const i=s.dataset.id;p.toggleMarketFavorite(i),(o=window.reRender)==null||o.call(window)})}),document.querySelectorAll(".market-table th.sortable").forEach(s=>{s.addEventListener("click",()=>{var i;const n=s.dataset.sort;S.key===n?S.direction=S.direction==="asc"?"desc":"asc":(S.key=n,S.direction="desc",n==="name"&&(S.direction="asc")),(i=window.reRender)==null||i.call(window)})})}function Gt(){const a=p.getState(),{wealthGoals:e=[],inflationRate:t=3,projectionYears:s=10,currencySymbol:n}=a,i=p.getAllExpenses();let o=0;e.forEach(d=>{const g=d.cost*(d.dividendYield/100)/12;o+=p.convertValue(g,d.currency||a.currency)});const r=o-i,l=i*Math.pow(1+t/100,s);let u=0;e.forEach(d=>{const h=d.cost*Math.pow(1+d.annualGrowth/100,s)*(d.dividendYield/100)/12;u+=p.convertValue(h,d.currency||a.currency)});const c=u-l;return`
    ...
    <div class="finance-page stagger-children" style="padding-bottom: 80px;">
      ...
      ${j==="summary"?Ht(a,e):j==="goals"?Gt():Pt()}
  ...
  `}function Xt(a){const e=document.getElementById("back-to-finance"),t=document.getElementById("rate-slider"),s=document.getElementById("years-slider"),n=document.getElementById("principal-input"),i=document.getElementById("contribution-input"),o=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",a),n&&n.addEventListener("input",l=>{J=parseFloat(l.target.value)||0,Q()}),i&&i.addEventListener("input",l=>{Z=parseFloat(l.target.value)||0,Q()}),o&&o.addEventListener("click",()=>{J=null;const l=p.getNetWorth();n.value=l,Q()}),r&&r.addEventListener("click",()=>{Z=null;const l=p.getNetIncome()*12;i.value=l,Q()}),t&&t.addEventListener("input",l=>{W=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${W}%`,Q()}),s&&s.addEventListener("input",l=>{z=parseInt(l.target.value),document.getElementById("years-value").textContent=`${z} años`,Q()})}function Q(){const e=p.getState().currencySymbol,t=J!==null?J:p.getNetWorth(),s=Z!==null?Z:p.getNetIncome()*12,n=tt(t,s,W,z),i=document.getElementById("future-value"),o=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),u=document.getElementById("total-contributed"),c=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),g=document.getElementById("projection-chart"),h=document.getElementById("projection-table");i&&(i.textContent=w(n.finalValue,e)),o&&(o.textContent=`Valor Futuro en ${z} años`),r&&(r.innerHTML=`${n.totalGrowth>=0?"📈":"📉"} ${n.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=w(t,e)),u&&(u.textContent=w(n.totalContributions,e),u.className=`stat-value ${n.totalContributions>=0?"positive":"negative"}`),c&&(c.textContent=w(n.totalInterest,e)),d&&(d.textContent=w(n.finalValue,e)),g&&(g.innerHTML=at(n.yearlyBreakdown)),h&&(h.innerHTML=st(n.yearlyBreakdown,e))}function Jt(){z=10,W=7,J=null,Z=null}let le=p.getState().lastMarketData||[],ce=!1,A={key:"price",direction:"desc"},nt="";function Zt(){const a=p.getState(),e=a.currency||"EUR",t=a.currencySymbol||"€";if((le.length===0||nt!==e)&&(ce||it(),le.length===0))return`
      ...
      <div class="card highlight-card" style="margin-bottom: var(--spacing-xl); background: ${n}; border-color: ${s}; padding: 24px !important; transition: all 0.3s ease;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; align-items: center;">
              ...
              <div class="clickable" id="log-weight-btn" style="text-align: center; border-right: 1px solid rgba(255,255,255,0.1);">
                  <div class="highlight-value" style="color: ${i}; font-size: 32px; margin: 0; line-height: 1;">${e} <span style="font-size: 14px; opacity: 0.6;">kg</span></div>
              ...
              <div class="clickable" id="log-fat-btn" style="text-align: center;">
                  <div class="highlight-value" style="color: ${i}; font-size: 32px; margin: 0; line-height: 1;">${t!==null?t+"%":"--"}</div>
    ...
    `}function na(a){const e=[...a.weightLogs||[]].sort((G,ke)=>G.date-ke.date);if(e.length<1||!a.weightGoalDate)return`
        ...
        `;const t=e[0],s=e[e.length-1],n=t.date,i=new Date(a.weightGoalDate).getTime(),o=Date.now(),l=Math.max(i,o)-n,u=e.map(G=>G.weight),c=Math.min(...u,a.weightGoal)-2,g=Math.max(...u,t.weight)+2-c,h=300,f=150,y=G=>(G-n)/l*h,x=G=>f-(G-c)/g*f,k=y(i),L=x(a.weightGoal),E=y(n),B=x(t.weight),D=e.map((G,ke)=>`${ke===0?"M":"L"} ${y(G.date)} ${x(G.weight)}`).join(" "),P=y(o),V=i-n,K=o-n,pt=Math.min(1,K/V),mt=t.weight-(t.weight-a.weightGoal)*pt,xe=s.weight-mt,Te=a.weightGoal<t.weight?xe<0:xe>0,De=V/(1e3*60*60*24*7),vt=De>0?(t.weight-a.weightGoal)/De:0;return`
  ...
  `}function Sa(a,e){if(a.length===0)return`
            <div class="empty-state">
        ...
        <div class="asset-list">
            ${a.map(s=>{const n=p.convertValue(s.amount,s.currency||"EUR"),i=$a(s.category);return`
            ...
            <div class="header-content">
                ...
                <div class="finance-top-grid" style="margin-top: 20px; margin-bottom: 20px;">
                    <div class="card highlight-card" style="background: ${l}; border-color: ${r}; transition: all 0.3s ease;">
                        <div class="card-header">
                            <span class="card-title" style="color: ${r};">Índice de Éxito</span>
                            <div style="color: ${r}">${m("target","card-icon")}</div>
                        </div>
                        <div class="highlight-value" style="color: ${r};">${o}%</div>
                        <div class="highlight-label" style="color: ${r}; opacity: 0.9;">
    ...
    `}function Pa(a){const e=a.lastContact?Math.floor((Date.now()-new Date(a.lastContact).getTime())/864e5):null,t=a.color||"#3b82f6";return`
  ...
  `}function rs(a){const e=a.querySelector("#person-modal-close"),t=a.querySelector("#btn-save-person-lead"),s=a.querySelector("#btn-delete-person"),n=a.querySelector("#person-rating-slider"),i=a.querySelector("#rating-value");if(a.addEventListener("click",l=>{l.target===a&&(console.log("[LeadModal] Overlay clicked, closing"),be(a))}),e==null||e.addEventListener("click",()=>{console.log("[LeadModal] Close button clicked"),be(a)}),n&&i){const l=()=>{console.log("[LeadModal] Slider updated:",n.value),i.textContent=n.value};n.oninput=l,n.onchange=l}t&&(t.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Save button clicked"),cs(a)}),s&&(s.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Delete button clicked"),ls(a)});const o=a.querySelectorAll(".goal-color-dot"),r=a.querySelector("#person-color-value");o.forEach(l=>{l.addEventListener("click",()=>{o.forEach(u=>u.classList.remove("active")),l.classList.add("active"),r&&(r.value=l.dataset.color),console.log("[LeadModal] Color selected:",l.dataset.color)})})}async function ls(a){X&&await v.confirm("Eliminar Lead","¿Estás seguro de eliminar este lead?")&&(p.deletePerson(X),v.toast("Lead eliminado","success"),be(a))}function cs(a){var t,s,n,i,o,r,l,u,c,d,g,h,f;const e=a.querySelector("#btn-save-person-lead");if(e.disabled){console.log("[LeadModal] Save ignored, already processing");return}try{const y=(s=(t=a.querySelector("#person-name"))==null?void 0:t.value)==null?void 0:s.trim(),x=(i=(n=a.querySelector("#person-phone"))==null?void 0:n.value)==null?void 0:i.trim(),k=(r=(o=a.querySelector("#person-city"))==null?void 0:o.value)==null?void 0:r.trim(),L=(l=a.querySelector("#person-source"))==null?void 0:l.value,E=(u=a.querySelector("#person-rating-slider"))==null?void 0:u.value,B=(d=(c=a.querySelector("#person-desc"))==null?void 0:c.value)==null?void 0:d.trim(),D=(g=a.querySelector("#person-column"))==null?void 0:g.value,P=(h=a.querySelector("#person-color-value"))==null?void 0:h.value,V=(f=a.querySelector("#person-last-contact"))==null?void 0:f.value;if(console.log("[LeadModal] Attempting to save",{name:y,rating:E,columnId:D,color:P,lastContact:V}),!y){console.warn("[LeadModal] Save failed: Missing name"),v.toast("El nombre es obligatorio","error");return}e.disabled=!0,e.innerHTML='<span class="loading-spinner-sm"></span> Guardando...';const K={name:y,phone:x,city:k,source:L,rating:parseInt(E)||5,description:B,columnId:D,color:P,lastContact:V};X?(console.log("[LeadModal] Updating person",X),p.updatePerson(X,K),v.toast("Lead actualizado correctamente","success")):(console.log("[LeadModal] Adding new person"),p.addPerson(K),v.toast("Lead guardado correctamente","success")),console.log("[LeadModal] Save successful, closing modal"),be(a)}catch(y){console.error("[LeadModal] Error saving lead:",y),v.toast("Error al guardar el lead","error"),e.disabled=!1,e.innerHTML=`${m("plus")} Lead`}}function be(a){a&&(console.log("[LeadModal] Closing modal"),a.classList.remove("active"),setTimeout(()=>{a.parentNode&&(console.log("[LeadModal] Removing modal from DOM"),a.remove())},400))}function ds(){const a=$.isSetup(),e=$.isBioEnabled();return`
    ...
    `}function us(a){var i;const e=document.getElementById("auth-submit-btn"),t=document.getElementById("auth-bio-btn"),s=document.getElementById("auth-password"),n=async()=>{const o=s.value,r=document.getElementById("auth-confirm"),l=$.isSetup();try{let u;if(l)u=await $.unlock(o);else{if(!o||o.length<4)throw new Error("Contraseña demasiado corta");if(o!==r.value)throw new Error("Las contraseñas no coinciden");u=await $.setup(o)}await p.loadEncrypted(u),a()}catch(u){v.alert("Error",u.message)}};e==null||e.addEventListener("click",n),s==null||s.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),n())}),(i=document.getElementById("auth-confirm"))==null||i.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),n())}),t==null||t.addEventListener("click",async()=>{try{const o=await $.unlockWithBiometrics();await p.loadEncrypted(o),a()}catch(o){v.alert("Identificación",o.message)}}),$.isBioEnabled()&&setTimeout(async()=>{try{const o=await $.unlockWithBiometrics();await p.loadEncrypted(o),a()}catch{console.log("Auto-bio failed or cancelled")}},500)}let R=localStorage.getItem("life-dashboard/app_current_page")||"finance",I=localStorage.getItem("life-dashboard/app_current_sub_page")||null;I==="null"&&(I=null);async function Xe(){window.addEventListener("open-add-modal",e=>{var s,n;const t=(s=e.detail)==null?void 0:s.type;t==="person"?ct((n=e.detail)==null?void 0:n.person):ge(t)}),U.init().catch(e=>console.warn("[Drive] Pre-init failed:",e)),window.addEventListener("nav-change",e=>{var s;const t=(s=e.detail)==null?void 0:s.page;if(t){R=t,I=null,localStorage.setItem("life-dashboard/app_current_page",R),_();const n=document.getElementById("bottom-nav");n&&(n.innerHTML=Ie(R))}});const a=$.getVaultKey();a?await p.loadEncrypted(a)?dt():(console.error("[Boot] Decryption failed, invalid vault key in session?"),$.logout(),Je()):Je()}function Je(){const a=document.getElementById("app");a.innerHTML=ds(),us(()=>{dt()})}function dt(){const a=document.getElementById("app");a.innerHTML=`
        <main id="main-content"></main>
        <nav id="bottom-nav"></nav>
    `,ut(),p.subscribe(()=>{_()}),window.reRender=()=>_(),ps()}function ps(){var s,n;const a=localStorage.getItem("life-dashboard/pwa_install_dismissed");if(a&&(Date.now()-parseInt(a))/864e5<7||window.matchMedia("(display-mode: standalone)").matches)return;const e=document.createElement("div");e.className="pwa-install-banner",e.id="pwa-install-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(e);const t=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};t(),window.addEventListener("beforeinstallprompt",t),(s=document.getElementById("pwa-banner-install"))==null||s.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:i}=await window.deferredPrompt.userChoice;i==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(n=document.getElementById("pwa-banner-close"))==null||n.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function ut(){const a=document.getElementById("bottom-nav");a.innerHTML=Ie(R),_e(e=>{R=e,I=null,localStorage.setItem("life-dashboard/app_current_page",R),localStorage.setItem("life-dashboard/app_current_sub_page",I),O(),_(),a.innerHTML=Ie(R),_e(t=>{R=t,I=null,localStorage.setItem("life-dashboard/app_current_page",R),localStorage.setItem("life-dashboard/app_current_sub_page",I),O(),_(),ut()})}),ms(),_()}function _(){const a=document.getElementById("main-content");if(!a)return;const e=a.scrollTop;if(I==="compound"){a.innerHTML=Wt(),Xt(()=>{I=null,Jt(),O(),_()}),a.scrollTop=e;return}if(I==="expenses"){a.innerHTML=Ea(),Ia(()=>{I=null,O(),_()}),a.scrollTop=e;return}if(I==="market"){a.innerHTML=Zt(),ea(()=>{I=null,O(),_()}),a.scrollTop=e;return}switch(a.classList.toggle("no-padding-mobile",R==="health"),R){case"finance":O(),a.innerHTML=Ue(),Oe(),Ze();break;case"goals":N(),a.innerHTML=Ge(),Fe();break;case"time-invest":N(),a.innerHTML=Ha(),Xa();break;case"social":N(),a.innerHTML=Ba(),Ra();break;case"health":a.innerHTML=ta(),ra(),N();break;case"menu":a.innerHTML=Da(),Ma(t=>{R=t,O(),_()}),N();break;case"calendar":a.innerHTML=ha(),ka(),O();break;case"goals":N(),a.innerHTML=Ge(),Fe();break;case"skills":a.innerHTML=Za(),ts(),O();break;case"settings":a.innerHTML=Ca(),Ta(),N();break;default:O(),a.innerHTML=Ue(),Oe(),Ze()}requestAnimationFrame(()=>{a.scrollTop=e})}function Ze(){const a=document.getElementById("open-compound");a&&a.addEventListener("click",()=>{I="compound",localStorage.setItem("life-dashboard/app_current_sub_page",I),N(),_()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{I="market",localStorage.setItem("life-dashboard/app_current_sub_page",I),N(),_()});const t=document.getElementById("open-expenses");t&&t.addEventListener("click",()=>{I="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",I),N(),_()})}function ms(){const a=document.querySelector(".fab");a&&a.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=m("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{const t=localStorage.getItem("life-dashboard/app_current_page")||R;if(t==="calendar")ge("event");else if(t==="health"){const s=await ns.confirm("Log Metric","What do you want to record today?","Weight","Body Fat");if(s===!0){const n=await ns.prompt("Log Weight","Enter your current weight in kg:","","number");n&&p.addWeightLog(n)}else if(s===!1){const n=await ns.prompt("Body Fat","Enter your body fat %:","","number");n&&p.addFatLog(n)}}else if(t==="social")ct();else if(t==="skills"){const s=await ns.confirm("Nueva Skill","¿Qué tipo de skill quieres añadir?","Expertise (Actual)","A aprender (Próxima)");if(s!==null){const n=s===!0?"current":"next",i=await ns.prompt("Nueva Skill",`¿Qué skill quieres ${n==="current"?"registrar":"aprender"}?`);if(i){let o=0;if(n==="current"){const r=await ns.prompt("Nivel de Dominio","Del 1 al 100:","50","number");o=parseInt(r)||0}p.addSkill({name:i,level:o,category:n}),ns.toast("Skill añadida")}}}else t==="finance"||t==="goals"||!t?ge("passiveAsset",["event"]):ge()}),document.body.appendChild(e)}function N(){const a=document.getElementById("main-fab");a&&(a.style.display="none")}function O(){const a=document.getElementById("main-fab");a&&(a.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Xe):Xe();window.addEventListener("beforeinstallprompt",a=>{a.preventDefault(),window.deferredPrompt=a,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});export{m as g,v as n,p as s};
