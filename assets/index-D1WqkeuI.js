var De=Object.defineProperty;var Be=(n,e,a)=>e in n?De(n,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):n[e]=a;var Q=(n,e,a)=>Be(n,typeof e!="symbol"?e+"":e,a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const Pe="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",Me="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function _e(){var e,a,t,s,o,i,r,l,u,c,d,m,h,w,E;const n={EUR:1};try{const b=await(await fetch(Pe)).json();n.BTC=((e=b.bitcoin)==null?void 0:e.eur)||4e4,n.ETH=((a=b.ethereum)==null?void 0:a.eur)||2200,n.XRP=((t=b.ripple)==null?void 0:t.eur)||.5,n.KAS=((s=b.kaspa)==null?void 0:s.eur)||.1,n.SOL=((o=b.solana)==null?void 0:o.eur)||90,n.XLM=((i=b.stellar)==null?void 0:i.eur)||.11,n.ALGO=((r=b.algorand)==null?void 0:r.eur)||.18,n.LTC=((l=b.litecoin)==null?void 0:l.eur)||65,n.SUI=((u=b.sui)==null?void 0:u.eur)||1.1,n.LINK=((c=b.chainlink)==null?void 0:c.eur)||14,n.RNDR=((d=b["render-token"])==null?void 0:d.eur)||4.5,n.ADA=((m=b.cardano)==null?void 0:m.eur)||.45,n.ONDO=((h=b["ondo-finance"])==null?void 0:h.eur)||.7,(w=b.bitcoin)!=null&&w.ars&&((E=b.bitcoin)!=null&&E.eur)&&(n.ARS=b.bitcoin.eur/b.bitcoin.ars);const L=await fetch(Me);if(L.ok){const T=await L.json();n.USD=1/T.rates.USD,n.CHF=1/T.rates.CHF,n.GBP=1/T.rates.GBP,n.AUD=1/T.rates.AUD}n.GOLD=2100,n.SP500=4700}catch(k){console.error("Failed to fetch some prices:",k),n.USD=n.USD||.92,n.CHF=n.CHF||1.05,n.GBP=n.GBP||1.15,n.AUD=n.AUD||.6,n.ARS=n.ARS||.001}return n}class P{static async hash(e,a="salt_life_dashboard_2026"){const s=new TextEncoder().encode(e+a),o=await crypto.subtle.digest("SHA-512",s);return Array.from(new Uint8Array(o)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,a){const t=new TextEncoder,s=await crypto.subtle.importKey("raw",t.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode(a),iterations:25e4,hash:"SHA-512"},s,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,a){try{const t=crypto.getRandomValues(new Uint8Array(16)),s=crypto.getRandomValues(new Uint8Array(12)),o=await this.deriveKey(a,this.bufToBase64(t)),i=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(i),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:s},o,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(s),salt:this.bufToBase64(t),v:"5.0"}}catch(t){throw console.error("[Security] Encryption failed:",t),new Error("No se pudo encriptar la información")}}static async decrypt(e,a){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:t,iv:s,salt:o}=e,i=await this.deriveKey(a,o),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(s)},i,this.base64ToBuf(t)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(t){throw console.error("[Security] Decryption failed:",t),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(a=>a.charCodeAt(0)))}}const oe=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:P},Symbol.toStringTag,{value:"Module"})),A={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class x{static isSetup(){return!!localStorage.getItem(A.MASTER_HASH)}static async setup(e){const a=await P.hash(e),t=await P.deriveVaultKey(e);return localStorage.setItem(A.MASTER_HASH,a),sessionStorage.setItem(A.VAULT_KEY,t),t}static async unlock(e){const a=await P.hash(e),t=localStorage.getItem(A.MASTER_HASH);if(a===t){const s=await P.deriveVaultKey(e);return sessionStorage.setItem(A.VAULT_KEY,s),s}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const a=sessionStorage.getItem(A.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const t=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:t,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(A.BIO_ENABLED,"true"),localStorage.setItem(A.VAULT_KEY,a),!0}catch(t){throw console.error("Biometric setup failed:",t),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(A.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const a=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:a,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const t=localStorage.getItem(A.VAULT_KEY);if(t)return sessionStorage.setItem(A.VAULT_KEY,t),t;throw new Error("Llave no encontrada. Usa contraseña.")}catch(a){throw console.error("Biometric auth failed:",a),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(A.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(A.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(A.BIO_ENABLED)==="true"}}const Ue="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",Oe="https://www.googleapis.com/auth/drive.file";class C{static hasToken(){return!!this.accessToken&&localStorage.getItem("life-dashboard/drive_connected")==="true"}static async init(){return this._initPromise?this._initPromise:(this._initPromise=new Promise((e,a)=>{const t=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.tokenClient=google.accounts.oauth2.initTokenClient({client_id:Ue,scope:Oe,callback:s=>{if(s.error){console.error("[Drive] Auth callback error:",s);return}this.saveSession(s)}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&(console.log("[Drive] Initial check: Attempting silent token restoration..."),this.authenticate(!0).catch(()=>{console.log("[Drive] Initial silent restoration skipped (expired or no session)")})),e(!0)}catch(s){console.error("[Drive] Init error:",s),a(s)}}):setTimeout(t,200)};t()}),this._initPromise)}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const a=Date.now()+(e.expires_in?e.expires_in*1e3:36e5);localStorage.setItem("life-dashboard/drive_token_expiry",a.toString())}static async authenticate(e=!1){return this.tokenClient||await this.init(),new Promise((a,t)=>{this.tokenClient.callback=s=>{if(s.error){e?(console.warn("[Drive] Silent auth failed, but keeping connection intent"),t(new Error("Silent auth failed"))):t(new Error(s.error_description||"Fallo en la autenticación"));return}this.saveSession(s),a(s.access_token)},e?this.tokenClient.requestAccessToken({prompt:"none"}):this.tokenClient.requestAccessToken({prompt:"consent"})})}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(!(localStorage.getItem("life-dashboard/drive_connected")==="true"))return null;if(this.tokenClient||await this.init(),!this.accessToken||Date.now()>e-3e5){console.log("[Drive] Refreshing token silently...");try{return await this.authenticate(!0)}catch(s){throw console.warn("[Drive] Silent refresh failed:",s.message),new Error('Google Drive session expired. Click "Sync" in settings to reconnect.')}}return this.accessToken}static async getOrCreateFolderPath(e){var s;await this.ensureValidToken(),(s=gapi.client)!=null&&s.drive||await this.init();const a=e.split("/").filter(o=>o);let t="root";for(const o of a)try{const i=`name = '${o}' and mimeType = 'application/vnd.google-apps.folder' and '${t}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:i,fields:"files(id, name)"})).result.files;if(l&&l.length>0)t=l[0].id;else{const u={name:o,mimeType:"application/vnd.google-apps.folder",parents:[t]};t=(await gapi.client.drive.files.create({resource:u,fields:"id"})).result.id}}catch(i){if(i.status===401){console.log("[Drive] 401 error, attempting auto-reconnect...");try{throw await this.authenticate(!0),new Error("RETRY")}catch{throw this.accessToken=null,new Error("Sesión de Google expirada. Por favor reconecta.")}}throw i}return t}static async pushData(e,a,t=!1){var s,o,i;try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");(s=gapi.client)!=null&&s.drive||await this.init(),gapi.client.setToken({access_token:this.accessToken}),console.log(`[Drive] Pushing encrypted data...${t?" (Retry)":""}`);const r=await this.getOrCreateFolderPath("/backup/life-dashboard/"),l=await P.encrypt(e,a),u="dashboard_vault_v5.bin",c=`name = '${u}' and '${r}' in parents and trashed = false`,m=(await gapi.client.drive.files.list({q:c,fields:"files(id)"})).result.files,h=new Blob([JSON.stringify(l)],{type:"application/json"});if(m&&m.length>0){const w=m[0].id,E=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${w}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:h});if(E.status===401&&!t)return await this.authenticate(!0),await this.pushData(e,a,!0);if(!E.ok)throw new Error(`Error al actualizar backup: ${E.status}`)}else{const w={name:u,parents:[r]},E=new FormData;E.append("metadata",new Blob([JSON.stringify(w)],{type:"application/json"})),E.append("file",h);const k=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:E});if(k.status===401&&!t)return await this.authenticate(!0),await this.pushData(e,a,!0);if(!k.ok)throw new Error(`Error al crear backup: ${k.status}`)}return!0}catch(r){if(r.message==="RETRY"&&!t)return await this.pushData(e,a,!0);throw console.error("[Drive] Push failed:",r),new Error(((i=(o=r.result)==null?void 0:o.error)==null?void 0:i.message)||r.message||"Fallo al subir datos a Drive")}}static async pullData(e,a=!1){var t,s,o;try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");(t=gapi.client)!=null&&t.drive||await this.init(),gapi.client.setToken({access_token:this.accessToken}),console.log(`[Drive] Pulling data...${a?" (Retry)":""}`);const l=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,c=(await gapi.client.drive.files.list({q:l,fields:"files(id, name)"})).result.files;if(!c||c.length===0)return null;const d=c[0].id,m=await fetch(`https://www.googleapis.com/drive/v3/files/${d}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(m.status===401&&!a)return await this.authenticate(!0),await this.pullData(e,!0);if(!m.ok)throw new Error(`Error al descargar backup: ${m.status}`);const h=await m.json();return await P.decrypt(h,e)}catch(i){if(i.message==="RETRY"&&!a)return await this.pullData(e,!0);throw console.error("[Drive] Pull failed:",i),new Error(((o=(s=i.result)==null?void 0:s.error)==null?void 0:o.message)||i.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){var e,a,t;try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");(e=gapi.client)!=null&&e.drive||await this.init(),gapi.client.setToken({access_token:this.accessToken});const i=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:i,fields:"files(id)"})).result.files;if(l&&l.length>0){const u=l[0].id;return await gapi.client.drive.files.delete({fileId:u}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(s){throw console.error("[Drive] Deletion failed:",s),new Error(((t=(a=s.result)==null?void 0:a.error)==null?void 0:t.message)||s.message||"Fallo al borrar backup en Drive")}}}Q(C,"tokenClient",null),Q(C,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null);const re={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',chevronUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>',chevronDown:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>',moreVertical:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>',check:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>'};function g(n,e=""){return(re[n]||re.package).replace("<svg",`<svg class="${e}"`)}class Ne{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,a="success",t=3e3){const s=document.createElement("div");s.className=`toast toast-${a} stagger-in`;const o=a==="success"?"check":a==="error"?"alertCircle":"info";s.innerHTML=`
        ...
        `,this.toastContainer.appendChild(s),setTimeout(()=>{s.classList.add("fade-out"),setTimeout(()=>s.remove(),500)},t)}alert(e,a){return new Promise(t=>{this._showModal({title:e,message:a,centered:!0,buttons:[{text:"Entendido",type:"primary",onClick:()=>t(!0)}]})})}confirm(e,a,t="Confirmar",s="Cancelar"){return new Promise(o=>{this._showModal({title:e,message:a,centered:!0,buttons:[{text:s,type:"secondary",onClick:()=>o(!1)},{text:t,type:"danger",onClick:()=>o(!0)}]})})}prompt(e,a,t="",s="text"){return new Promise(o=>{const i=`prompt-input-${Date.now()}`;this._showModal({title:e,message:a,centered:!0,content:`
                    <div class="form-group" style="margin-top: var(--spacing-md);">
                        <input type="${s}" id="${i}" class="form-input" value="${t}" autofocus>
                    </div>
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>o(null)},{text:"Aceptar",type:"primary",onClick:()=>{const r=document.getElementById(i).value;o(r)}}]}),setTimeout(()=>{const r=document.getElementById(i);r&&(r.focus(),r.select&&r.select())},100)})}select(e,a,t=[],s=4){return new Promise(o=>{const i=`display: grid; grid-template-columns: repeat(${s}, 1fr); gap: 8px; margin-top: 16px;`;this._showModal({title:e,message:a,centered:!0,content:`
                    <div style="${i}">
                        ${t.map((l,u)=>`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>s(!1)},{text:"Borrar Todo",type:"danger",id:i,disabled:!0,onClick:()=>s(!0)}]});const r=document.getElementById(o),l=document.getElementById(i);r.addEventListener("input",()=>{const u=r.value.trim().toUpperCase()===t.toUpperCase();l.disabled=!u,l.style.opacity=u?"1":"0.3",l.style.pointerEvents=u?"auto":"none"})})}performance(e,a){const t=[{rating:1,emoji:"😰",label:"Duro"},{rating:3,emoji:"😐",label:"Bien"},{rating:5,emoji:"😄",label:"Fácil"}];return new Promise(s=>{this._showModal({title:e,message:a,centered:!0,content:`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>s(null)}]});const o=document.querySelector(".modal-overlay.active");o&&o.querySelectorAll(".perf-emoji-btn").forEach(i=>{i.addEventListener("click",()=>{s(parseInt(i.dataset.value)),this._closeModal(o)})})})}_showModal({title:e,message:a,content:t="",buttons:s=[],centered:o=!1}){const i=document.createElement("div");i.className=`modal-overlay ${o?"overlay-centered":""}`,i.style.zIndex="9999";const r=`modal-${Date.now()}-${Math.floor(Math.random()*1e3)}`;i.id=r;const l=`
          ...
          <div class="form-group" style="flex: 1;">
              ...
              <select class="form-input form-select" id="edit-currency">
                  <optgroup label="Divisas">
                      ${ze.map(o=>`<option value="${o.value}" ${o.value===n.currency?"selected":""}>${o.label}</option>`).join("")}
                  </optgroup>
                  ${a?`
  ...
  `}function Xe(n){const e=document.getElementById("edit-modal"),a=document.getElementById("edit-modal-close"),t=document.getElementById("btn-update"),s=document.getElementById("btn-delete");e.addEventListener("click",o=>{o.target===e&&Z()}),a.addEventListener("click",Z),t.addEventListener("click",()=>Je(n)),s.addEventListener("click",()=>Ze(n))}function Je(n){var u,c,d,m,h,w,E,k,b;const e=(c=(u=document.getElementById("edit-name"))==null?void 0:u.value)==null?void 0:c.trim(),a=(d=document.getElementById("edit-type"))==null?void 0:d.value,t=(m=document.getElementById("edit-currency"))==null?void 0:m.value,s=(w=(h=document.getElementById("edit-details"))==null?void 0:h.value)==null?void 0:w.trim(),o=parseFloat((E=document.getElementById("edit-value"))==null?void 0:E.value)||0,i=parseFloat((k=document.getElementById("edit-amount"))==null?void 0:k.value)||0,r=parseFloat((b=document.getElementById("edit-monthly"))==null?void 0:b.value)||0;if(!e){v.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:a,currency:t,details:s};n.fields.includes("value")&&(l.value=o),n.fields.includes("amount")&&(l.amount=i),n.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),n.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),p[n.updateMethod](X.id,l),Z()}function Ze(n){v.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${X.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(p[n.deleteMethod](X.id),v.toast("Eliminado correctamente","info"),Z())})}function Z(){const n=document.getElementById("edit-modal");n&&(n.classList.remove("active"),setTimeout(()=>n.remove(),300)),X=null,H=null}function pe(){const n=p.getState(),e=n.currencySymbol,a=p.getPassiveIncome(),t=p.getLivingExpenses(),s=p.getNetPassiveIncome(),o=p.getInvestmentAssetsValue(),i=p.getTotalLiabilities(),r=p.getNetWorth(),l=p.getAllIncomes(),u=p.getAllExpenses(),c=p.getNetIncome();return`
  ...
  `}function Qe(n){const e=[...n.passiveAssets,...n.investmentAssets],a=n.liabilities;if(e.length===0)return"";const t={Bitcoin:{value:0,color:"#f59e0b"},Altcoins:{value:0,color:"#6366f1"},Inmuebles:{value:0,color:"#a855f7"},Bolsa:{value:0,color:"#00d4aa"},Oro:{value:0,color:"#fbbf24"},"Otros/Efe.":{value:0,color:"#94a3b8"}};e.forEach(c=>{const d=p.convertValue(c.value||0,c.currency||"EUR");c.currency==="BTC"?t.Bitcoin.value+=d:c.currency==="ETH"||c.currency==="XRP"||c.type==="crypto"?t.Altcoins.value+=d:c.type==="property"||c.type==="rental"?t.Inmuebles.value+=d:c.type==="stocks"||c.type==="etf"||c.currency==="SP500"?t.Bolsa.value+=d:c.currency==="GOLD"?t.Oro.value+=d:t["Otros/Efe."].value+=d});const s=a.filter(c=>c.type==="mortgage").reduce((c,d)=>c+p.convertValue(d.amount||0,d.currency||"EUR"),0);t.Inmuebles.value=Math.max(0,t.Inmuebles.value-s),n.hideRealEstate&&(t.Inmuebles.value=0);const o=Object.entries(t).filter(([c,d])=>d.value>0).sort((c,d)=>d[1].value-c[1].value),i=o.reduce((c,[d,m])=>c+m.value,0);if(i===0)return`
    ...
    `;let r=0;const l=o.map(([c,d])=>{const m=d.value/i*100,h=r;return r+=m,{name:c,percentage:m,color:d.color,start:h}}),u=l.map(c=>`${c.color} ${c.start}% ${c.start+c.percentage}%`).join(", ");return`
      ...
      <div class="allocation-container">
        <div class="pie-chart" style="background: conic-gradient(${u});">
          <div class="pie-center">
            <div class="pie-total">${f(i,n.currencySymbol)}</div>
  ...
  `}function et(n){const e=[...n.passiveAssets.map(t=>({...t,category:"passive"})),...n.investmentAssets.map(t=>({...t,category:"investment"})),...n.liabilities.map(t=>({...t,category:"liability"}))];if(e.length===0)return`
    ...
    <div class="asset-list">
      ${e.map(t=>{const s=tt(t.currency||t.type),o=at(t.currency||t.type),i=t.category==="liability",r=t.value||t.amount||0,l=p.convertValue(r,t.currency||"EUR");let u="";if(t.currency!==n.currency){const d={EUR:"€",USD:"$",BTC:"₿",ETH:"Ξ",XRP:"✕",GOLD:"oz",SP500:"pts",CHF:"Fr",GBP:"£",AUD:"A$",ARS:"$"}[t.currency]||t.currency;u=`<div class="asset-original-value">${r} ${d}</div>`}return`
  ...
  `}function tt(n){return{property:"property",rental:"property",stocks:"stocks",etf:"stocks",SP500:"stocks",crypto:"crypto",BTC:"crypto",ETH:"crypto",XRP:"crypto",GOLD:"investment",cash:"cash",USD:"cash",EUR:"cash",savings:"cash",vehicle:"vehicle",debt:"debt",loan:"debt",mortgage:"debt",creditcard:"debt"}[n]||"cash"}function at(n){return{property:"building",rental:"building",stocks:"trendingUp",etf:"trendingUp",SP500:"trendingUp",crypto:"bitcoin",BTC:"bitcoin",ETH:"bitcoin",XRP:"bitcoin",GOLD:"package",cash:"dollarSign",USD:"dollarSign",EUR:"dollarSign",savings:"piggyBank",vehicle:"car",debt:"creditCard",loan:"landmark",mortgage:"home",creditcard:"creditCard"}[n]||"dollarSign"}function me(){document.querySelectorAll(".asset-item").forEach(t=>{t.addEventListener("click",()=>{const s=t.dataset.id,o=t.dataset.category;xe(s,o)})});const e=document.getElementById("toggle-real-estate");e&&e.addEventListener("change",()=>{p.toggleRealEstate()});const a=document.getElementById("display-currency-select");a&&a.addEventListener("change",t=>{p.setCurrency(t.target.value)})}let M=10,N=7,F=null,j=null;function st(){const e=p.getState().currencySymbol,a=p.getNetWorth(),s=p.getNetIncome()*12,o=F!==null?F:a,i=j!==null?j:s,r=Se(o,i,N,M);return`
  ...
  `}function Se(n,e,a,t){const s=a/100,o=[];let i=n,r=0,l=0;for(let u=1;u<=t;u++){const c=i,d=i*s;i+=d+e,r+=e,l+=d,o.push({year:u,startBalance:c,contribution:e,interest:d,endBalance:i,totalContributions:r,totalInterest:l})}return{finalValue:i,totalContributions:r,totalInterest:l,totalGrowth:i-n,growthMultiple:n>0?i/n:0,yearlyBreakdown:o}}function Ie(n,e){if(n.length===0)return"";const a=Math.max(...n.map(s=>Math.abs(s.endBalance))),t=n.map((s,o)=>{const i=o/(n.length-1)*100,r=100-s.endBalance/a*100;return`${i},${r}`});return`
  ...
  `}function nt(n){const e=document.getElementById("back-to-finance"),a=document.getElementById("rate-slider"),t=document.getElementById("years-slider"),s=document.getElementById("principal-input"),o=document.getElementById("contribution-input"),i=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",n),s&&s.addEventListener("input",l=>{F=parseFloat(l.target.value)||0,G()}),o&&o.addEventListener("input",l=>{j=parseFloat(l.target.value)||0,G()}),i&&i.addEventListener("click",()=>{F=null;const l=p.getNetWorth();s.value=l,G()}),r&&r.addEventListener("click",()=>{j=null;const l=p.getNetIncome()*12;o.value=l,G()}),a&&a.addEventListener("input",l=>{N=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${N}%`,G()}),t&&t.addEventListener("input",l=>{M=parseInt(l.target.value),document.getElementById("years-value").textContent=`${M} años`,G()})}function G(){const e=p.getState().currencySymbol,a=F!==null?F:p.getNetWorth(),t=j!==null?j:p.getNetIncome()*12,s=Se(a,t,N,M),o=document.getElementById("future-value"),i=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),u=document.getElementById("total-contributed"),c=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),m=document.getElementById("projection-chart"),h=document.getElementById("projection-table");o&&(o.textContent=f(s.finalValue,e)),i&&(i.textContent=`Valor Futuro en ${M} años`),r&&(r.innerHTML=`${s.totalGrowth>=0?"📈":"📉"} ${s.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=f(a,e)),u&&(u.textContent=f(s.totalContributions,e),u.className=`stat-value ${s.totalContributions>=0?"positive":"negative"}`),c&&(c.textContent=f(s.totalInterest,e)),d&&(d.textContent=f(s.finalValue,e)),m&&(m.innerHTML=Ie(s.yearlyBreakdown)),h&&(h.innerHTML=$e(s.yearlyBreakdown,e))}function it(){M=10,N=7,F=null,j=null}let Y=p.getState().lastMarketData||[],W=!1,S={key:"price",direction:"desc"},Ae="";function ot(){const n=p.getState(),e=n.currency||"EUR",a=n.currencySymbol||"€";if((Y.length===0||Ae!==e)&&(W||Ce(),Y.length===0))return`
        ...
        <div class="market-page stagger-children" style="padding-bottom: 80px;">
            ...
            ${t.map(s=>{const o=Y.filter(i=>i.category===s);return o.length===0?"":rt(s,o,a)}).join("")}
        </div>
    `}function rt(n,e,a){const t=[...e].sort((s,o)=>{let i=s[S.key],r=o[S.key];return typeof i=="string"&&(i=i.toLowerCase()),typeof r=="string"&&(r=r.toLowerCase()),i<r?S.direction==="asc"?-1:1:i>r?S.direction==="asc"?1:-1:0});return`
                        ...
                        <tbody>
                            ${t.map(s=>`
                                <tr>
                                    ...
                                    <td class="${s.change24h>=0?"text-positive":"text-negative"}" style="font-variant-numeric: tabular-nums;">${s.change24h!==null?ue(s.change24h):"-"}</td>
                                    <td class="${s.change30d>=0?"text-positive":"text-negative"}" style="font-variant-numeric: tabular-nums; padding-right: var(--spacing-md);">${s.change30d!==null?ue(s.change30d):"-"}</td>
                                </tr>
                            `).join("")}
                        </tbody>
                    </table>
    ...
    `}async function Ce(){const e=p.getState().currency||"EUR";W||(W=!0,Ae=e,Y=await Ve(e),p.saveMarketData(Y),W=!1,window.dispatchEvent(new CustomEvent("market-ready")))}function lt(n){const e=document.getElementById("market-back");e&&e.addEventListener("click",n),document.querySelectorAll(".market-table th[data-sort]").forEach(s=>{s.addEventListener("click",()=>{const o=s.dataset.sort;S.key===o?S.direction=S.direction==="asc"?"desc":"asc":(S.key=o,S.direction="desc",o==="name"&&(S.direction="asc")),typeof window.reRender=="function"&&window.reRender()})}),document.querySelectorAll(".market-currency-toggle .btn-toggle").forEach(s=>{s.addEventListener("click",()=>{const o=s.dataset.curr;p.setCurrency(o),Ce()})}),window.addEventListener("market-ready",()=>{typeof window.reRender=="function"&&window.reRender()})}class ve{static getApiKey(){return localStorage.getItem("life-dashboard/db_gemini_api_key")}static setApiKey(e){localStorage.setItem("life-dashboard/db_gemini_api_key",e)}static hasKey(){return!!this.getApiKey()}static async analyzeFood(e){var r;const a=this.getApiKey();if(!a)throw new Error("Se requiere una API Key de Gemini en Configuración.");const s=(await this.fileToBase64(e)).split(",")[1],o=e.type,i=`Identify the food in this image. 
        Provide the name of the dish and the approximate total calories for a standard portion.
        Return ONLY a JSON object like this: {"name": "Dish Name", "calories": 500}`;try{const l=await fetch(`https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=${a}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:i},{inline_data:{mime_type:o,data:s}}]}],generationConfig:{response_mime_type:"application/json"}})});if(!l.ok){const d=await l.json();throw new Error(((r=d.error)==null?void 0:r.message)||"Error al conectar con Gemini AI")}const c=(await l.json()).candidates[0].content.parts[0].text;return JSON.parse(c)}catch(l){throw console.error("[Gemini] Analysis failed:",l),l}}static fileToBase64(e){return new Promise((a,t)=>{const s=new FileReader;s.readAsDataURL(e),s.onload=()=>a(s.result),s.onerror=o=>t(o)})}}function ct(){const n=p.getState(),{health:e}=n;return`
    <div class="health-page stagger-children" style="padding-bottom: 100px;">
        ...
        ${e.routines.map((a,t)=>`
          <div class="card health-routine-card" style="margin-bottom: var(--spacing-lg);">
            <header class="routine-card-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--spacing-md);">
                ...
                <button class="icon-btn mobile-only routine-more-btn" data-id="${a.id}" data-index="${t}" data-name="${a.name}">
                    ${g("moreVertical")}
                </button>
            </header>

            <div class="exercise-list-health">
                ${a.exercises.map((s,o)=>{const i=p.getExerciseStatus(a.id,o),r=`var(--accent-${i.color})`,l=i.status==="done_today";return`
                    <div class="exercise-item-health ${l?"exercise-done":""}">
                        <div class="ex-health-main">
                            <div class="exercise-status-dot-wear" style="background-color: ${r}; box-shadow: 0 0 10px ${r};"></div>
                            <div class="ex-health-info">
                                ...
                                <div class="ex-health-stats">
                                    ...
                                    ${i.lastLog?`
                                        <span style="opacity: 0.3;">•</span>
                                        <span class="last-effort-badge-emoji" title="Último esfuerzo">${dt(i.lastLog.rating)}</span>
                                    `:""}
                                </div>
                            </div>
                        </div>
                        <div class="ex-health-actions">
                            ...
                            `:`
                                <button class="btn btn-secondary btn-icon-only log-stars-btn" data-rid="${a.id}" data-idx="${o}" style="width: 42px; height: 42px; border-radius: 12px;">
                                    ${g("check")}
                                </button>
                            `}
                            <button class="icon-btn mobile-only ex-more-btn" data-routine="${a.id}" data-index="${o}" data-name="${s.name}">
                                ${g("moreVertical")}
                            </button>
                            <button class="delete-exercise-btn ex-delete-mini desktop-only" data-routine="${a.id}" data-index="${o}" title="Eliminar">${g("trash")}</button>
                        </div>
                    </div>
                    `}).join("")}
            </div>
            <div class="add-ex-row" style="margin-top: var(--spacing-md);">
                <button class="btn btn-secondary add-ex-btn w-full" data-id="${a.id}">
      ...
      <div class="card ai-calorie-card" style="margin-bottom: var(--spacing-2xl); display: flex; flex-direction: column; align-items: center;">
          <div class="summary-value" style="font-size: 28px;">${ut(e)} kcal</div>
    ...
    `}function dt(n){return n<=2?"😰":n<=4?"😐":"😄"}function ut(n){const e=new Date().toDateString();return(n.calorieLogs||[]).filter(a=>new Date(a.date).toDateString()===e).reduce((a,t)=>a+(t.calories||0),0)}function pt(){var n,e,a,t,s,o;document.querySelectorAll(".add-ex-btn").forEach(i=>{i.addEventListener("click",async()=>{const r=i.dataset.id,l=await v.prompt("Nuevo Ejercicio","Nombre del ejercicio:");l&&(p.addExerciseToRoutine(r,{name:l}),v.toast("Ejercicio añadido"))})}),document.querySelectorAll(".rename-routine").forEach(i=>{i.addEventListener("click",async()=>{const r=i.dataset.id,l=i.dataset.current,u=await v.prompt("Editar Rutina","Nombre de la rutina:",l);u&&u!==l&&(p.renameRoutine(r,u),v.toast("Rutina renombrada"))})}),document.querySelectorAll(".delete-routine-btn").forEach(i=>{i.addEventListener("click",async()=>{const r=i.dataset.id;await v.confirm("¿Borrar Rutina?","Esta acción no se puede deshacer.","Eliminar","Cancelar")&&(p.deleteRoutine(r),v.toast("Rutina eliminada"))})}),document.querySelectorAll(".routine-more-btn").forEach(i=>{i.addEventListener("click",async r=>{r.stopPropagation();const l=i.dataset.id,u=parseInt(i.dataset.index),c=i.dataset.name,d=[{value:"rename",label:"✏️ Renombrar"},{value:"up",label:"⬆️ Mover Arriba"},{value:"down",label:"⬇️ Mover Abajo"},{value:"delete",label:"🗑️ Eliminar Rutina"}],m=await v.select(`Menú: ${c}`,"Elige una acción:",d,1);if(m==="rename"){const h=await v.prompt("Editar Rutina","Nuevo nombre:",c);h&&h!==c&&(p.renameRoutine(l,h),v.toast("Rutina renombrada"))}else m==="up"?p.reorderRoutine(u,"up"):m==="down"?p.reorderRoutine(u,"down"):m==="delete"&&await v.confirm("¿Borrar Rutina?","No se puede deshacer.","Eliminar","Cancelar")&&(p.deleteRoutine(l),v.toast("Rutina eliminada"))})}),document.querySelectorAll(".rename-exercise").forEach(i=>{i.addEventListener("click",async()=>{const r=i.dataset.routine,l=parseInt(i.dataset.index),u=i.dataset.current,c=await v.prompt("Renombrar Ejercicio","Nuevo nombre:",u);c&&c!==u&&(p.updateExercise(r,l,{name:c}),v.toast("Ejercicio renombrado"))})}),document.querySelectorAll(".delete-exercise-btn").forEach(i=>{i.addEventListener("click",async()=>{const r=i.dataset.routine,l=parseInt(i.dataset.index);await v.confirm("Eliminar Ejercicio","¿Quitar este ejercicio de la rutina?","Eliminar","Cancelar")&&(p.deleteExerciseFromRoutine(r,l),v.toast("Ejercicio eliminado"))})}),document.querySelectorAll(".ex-more-btn").forEach(i=>{i.addEventListener("click",async r=>{r.stopPropagation();const l=i.dataset.routine,u=parseInt(i.dataset.index),c=i.dataset.name,d=[{value:"rename",label:"✏️ Renombrar"},{value:"up",label:"⬆️ Mover Arriba"},{value:"down",label:"⬇️ Mover Abajo"},{value:"delete",label:"🗑️ Eliminar Ejercicio"}],m=await v.select(`Ejercicio: ${c}`,"Elige una acción:",d,1);if(m==="rename"){const h=await v.prompt("Renombrar Ejercicio","Nuevo nombre:",c);h&&h!==c&&(p.updateExercise(l,u,{name:h}),v.toast("Ejercicio renombrado"))}else m==="up"?p.reorderExercise(l,u,"up"):m==="down"?p.reorderExercise(l,u,"down"):m==="delete"&&await v.confirm("Eliminar Ejercicio","¿Quitar de la rutina?","Eliminar","Cancelar")&&(p.deleteExerciseFromRoutine(l,u),v.toast("Ejercicio eliminado"))})}),document.querySelectorAll(".reorder-routine-btn").forEach(i=>{i.addEventListener("click",r=>{r.stopPropagation();const l=parseInt(i.dataset.index),u=i.dataset.dir;p.reorderRoutine(l,u)})}),document.querySelectorAll(".reorder-ex-btn").forEach(i=>{i.addEventListener("click",r=>{r.stopPropagation();const l=i.dataset.routine,u=parseInt(i.dataset.index),c=i.dataset.dir;p.reorderExercise(l,u,c)})}),document.querySelectorAll(".update-weight").forEach(i=>{i.addEventListener("click",async r=>{r.stopPropagation();const l=i.dataset.routine,u=parseInt(i.dataset.index),c=[];for(let m=10;m<=150;m+=2.5)c.push(`${m}kg`);const d=await v.select("Seleccionar Peso","Elige el peso para este ejercicio:",c,4);if(d){const m=parseFloat(d.replace("kg",""));p.updateExercise(l,u,{weight:m}),v.toast("Peso actualizado")}})}),document.querySelectorAll(".update-reps").forEach(i=>{i.addEventListener("click",async r=>{r.stopPropagation();const l=i.dataset.routine,u=parseInt(i.dataset.index),c=[];for(let m=7;m<=20;m++)c.push(`${m} reps`);const d=await v.select("Seleccionar Reps","Elige las repeticiones objetivo:",c,4);if(d){const m=parseInt(d.replace(" reps",""));p.updateExercise(l,u,{reps:m}),v.toast("Reps actualizadas")}})}),document.querySelectorAll(".log-stars-btn").forEach(i=>{i.addEventListener("click",async r=>{r.stopPropagation();const l=i.dataset.rid,u=parseInt(i.dataset.idx),c=await v.performance("Finalizar Ejercicio","¿Qué tan intenso te ha parecido?");c&&(p.logExercise(l,u,c),v.toast("Ejercicio registrado","success"))})}),(n=document.getElementById("log-weight-btn"))==null||n.addEventListener("click",async()=>{const i=await v.prompt("Registrar Peso","Peso actual (kg):");i&&p.addWeightLog(i)}),(e=document.getElementById("log-fat-btn"))==null||e.addEventListener("click",async()=>{const i=await v.prompt("Registrar Grasa","Porcentaje de grasa (%):");i&&p.addFatLog(i)}),(a=document.getElementById("set-weight-goal-btn"))==null||a.addEventListener("click",async()=>{const i=p.getState().health.weightGoal,r=await v.prompt("Objetivo de Peso","Introduce tu peso ideal (kg):",i);r&&p.updateHealthGoal("weightGoal",parseFloat(r))}),(t=document.getElementById("set-fat-goal-btn"))==null||t.addEventListener("click",async()=>{const i=p.getState().health.fatGoal,r=await v.prompt("Objetivo de Grasa","Introduce tu porcentaje ideal (%):",i);r&&p.updateHealthGoal("fatGoal",parseFloat(r))}),(s=document.getElementById("ai-scan-photo"))==null||s.addEventListener("click",()=>{const i=document.createElement("input");i.type="file",i.accept="image/*",i.onchange=async l=>{var c;const u=l.target.files[0];if(u){if(!ve.hasKey()){if(await v.confirm("IA no configurada","Añade tu Gemini API Key en Ajustes.","Configurar","Simulación")){(c=document.querySelector('[data-nav="settings"]'))==null||c.click();return}v.toast("Usando simulación...","info"),r();return}try{v.toast("Analizando con Gemini...","info");const d=await ve.analyzeFood(u);await v.confirm("IA Detectada",`Identificado: "${d.name}" (${d.calories} kcal). ¿Registrar?`)&&(p.addCalorieLog(d.calories,`${d.name} (AI)`),v.toast("Calorías registradas"))}catch(d){v.alert("Error IA",d.message)}}};function r(){setTimeout(async()=>{const l={name:"Bowl Saludable",cals:450};await v.confirm("IA Simulada",`Detectado "${l.name}" con ${l.cals} kcal. ¿Registrar?`)&&(p.addCalorieLog(l.cals,l.name),v.toast("Registrado"))},1e3)}i.click()}),(o=document.getElementById("add-routine-btn"))==null||o.addEventListener("click",async()=>{const i=await v.prompt("Nueva Rutina","Nombre (ej: Pecho y Triceps):","Día X");i&&(p.saveRoutine({name:i,exercises:[]}),v.toast("Rutina creada"))})}const ae=["#ffffff","#00D4AA","#7C3AED","#F59E0B","#EF4444","#3B82F6","#EC4899","#10B981","#A855F7","#64748B"];function mt(){const n=p.getState(),{goals:e}=n;return`
    <div class="goals-page stagger-children" style="padding-bottom: 80px;">
      ...
      <div class="goals-grid-layout">
        ${[{id:"day",label:"Hoy",icon:"zap",color:"#FFD700"},{id:"week",label:"Semana",icon:"calendar",color:"#00D4AA"},{id:"year",label:"Año 2026",icon:"target",color:"#7C3AED"},{id:"long",label:"Largo Plazo",icon:"trendingUp",color:"#EF4444"}].map(t=>{const s=e.filter(l=>l.timeframe===t.id),o=s.filter(l=>l.completed).length,i=s.length,r=i>0?o/i*100:0;return`
  ...
  `}function vt(n,e){return n.length===0?`
    ...
    `}).join("")}function gt(){document.querySelectorAll(".btn-clear-completed").forEach(t=>{t.addEventListener("click",async s=>{s.stopPropagation();const o=t.dataset.tf;await v.confirm("Limpiar completadas","¿Borrar todas las metas ya terminadas de esta columna?")&&(p.deleteCompletedGoals(o),v.toast("Metas limpiadas"))})}),document.querySelectorAll(".toggle-goal").forEach(t=>{t.addEventListener("click",s=>{s.stopPropagation();const o=t.dataset.id;p.toggleGoal(o)})}),document.querySelectorAll(".open-color-picker").forEach(t=>{t.addEventListener("click",s=>{s.stopPropagation();const o=t.dataset.id,i=document.getElementById(`colors-${o}`);document.querySelectorAll(".color-selector-overlay").forEach(r=>{r.id!==`colors-${o}`&&r.classList.add("hidden")}),i==null||i.classList.toggle("hidden")})}),document.querySelectorAll(".set-goal-color").forEach(t=>{t.addEventListener("click",s=>{s.stopPropagation();const o=t.dataset.id,i=t.dataset.color;p.updateGoalColor(o,i),v.toast("Color aplicado")})}),document.querySelectorAll(".toggle-subgoal").forEach(t=>{t.addEventListener("click",s=>{s.stopPropagation();const o=t.dataset.id,i=parseInt(t.dataset.idx);p.toggleSubGoal(o,i)})}),document.querySelectorAll(".delete-goal").forEach(t=>{t.addEventListener("click",async s=>{s.stopPropagation(),await v.confirm("Eliminar Meta","¿Estás seguro?","BORRAR")&&(p.deleteGoal(t.dataset.id),v.toast("Meta eliminada"))})}),document.querySelectorAll(".add-subgoal").forEach(t=>{t.addEventListener("click",async s=>{s.stopPropagation();const o=t.dataset.id,i=await v.prompt("Nuevo Hito","¿Qué paso necesitas completar?");if(i){const l=[...p.getState().goals.find(u=>u.id===o).subGoals||[],{title:i,completed:!1}];p.updateGoal(o,{subGoals:l}),v.toast("Paso añadido")}})}),document.querySelectorAll(".clickable-edit-goal").forEach(t=>{t.addEventListener("click",async()=>{const s=t.dataset.id,o=t.textContent,i=await v.prompt("Editar Meta","Actualiza el texto:",o);i&&i!==o&&p.updateGoal(s,{title:i})})}),document.querySelectorAll(".quick-add-input-premium").forEach(t=>{t.addEventListener("keypress",s=>{if(s.key==="Enter"&&t.value.trim()){const o=t.dataset.timeframe;p.addGoal({title:t.value.trim(),timeframe:o,color:ae[0]}),t.value="",v.toast("Creada")}})}),document.querySelectorAll(".btn-quick-add-submit").forEach(t=>{t.addEventListener("click",()=>{const s=t.dataset.timeframe,o=t.previousElementSibling;o&&o.value.trim()?(p.addGoal({title:o.value.trim(),timeframe:s,color:ae[0]}),o.value="",v.toast("Creada")):o&&o.focus()})});const n=document.querySelectorAll(".goals-list-premium");let e=null;document.querySelectorAll(".goal-card-premium").forEach(t=>{t.addEventListener("dragstart",s=>{e=t.dataset.id,t.classList.add("dragging"),s.dataTransfer.effectAllowed="move"}),t.addEventListener("dragend",()=>{t.classList.remove("dragging"),document.querySelectorAll(".goals-list-premium").forEach(s=>s.classList.remove("drag-over"))})}),n.forEach(t=>{t.addEventListener("dragover",s=>{s.preventDefault(),t.classList.add("drag-over"),s.dataTransfer.dropEffect="move"}),t.addEventListener("dragleave",()=>{t.classList.remove("drag-over")}),t.addEventListener("drop",s=>{s.preventDefault(),t.classList.remove("drag-over");const o=t.dataset.timeframe,i=[...p.getState().goals],r=i.findIndex(d=>d.id===e);if(r===-1)return;const l={...i[r]};l.timeframe!==o&&(l.timeframe=o),i.splice(r,1);const u=a(t,s.clientY);if(u==null)i.push(l);else{const d=u.dataset.id,m=i.findIndex(h=>h.id===d);i.splice(m,0,l)}const c=i.map((d,m)=>({...d,order:m}));p.reorderGoals(c),v.toast("Orden actualizado")})});function a(t,s){return[...t.querySelectorAll(".goal-card-premium:not(.dragging)")].reduce((i,r)=>{const l=r.getBoundingClientRect(),u=s-l.top-l.height/2;return u<0&&u>i.offset?{offset:u,element:r}:i},{offset:Number.NEGATIVE_INFINITY}).element}}let B=new Date;function ht(){const n=p.getState(),{events:e}=n;return`
  ...
  `}function yt(n){const e=B.getMonth(),a=B.getFullYear(),t=new Date().getDate(),s=new Date().getMonth()===e&&new Date().getFullYear()===a,o=new Date(a,e+1,0).getDate(),i=new Date(a,e,1).getDay(),r=["D","L","M","M","J","V","S"],l=new Set;n.forEach(c=>{const d=new Date(c.date);d.getMonth()===e&&d.getFullYear()===a&&l.add(d.getDate())});let u=r.map(c=>`<div class="calendar-day-label">${c}</div>`).join("");for(let c=0;c<i;c++)u+='<div class="calendar-day empty"></div>';for(let c=1;c<=o;c++){const d=s&&c===t,m=l.has(c);u+=`
            <div class="calendar-day ${d?"today":""} ${m?"has-event":""}">
                ${c}
                ${m?'<span class="event-dot-indicator"></span>':""}
            </div>
        `}return u}function ft(){return`${["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"][B.getMonth()]} ${B.getFullYear()}`}function bt(n){const e={day:"numeric",month:"short"};return new Date(n).toLocaleDateString("es-ES",e).toUpperCase()}function wt(n){switch(n){case"reminder":return"bell";case"meeting":return"users";default:return"calendar"}}function Et(n){return{daily:"Diario",weekly:"Semanal",monthly:"Mensual",yearly:"Anual"}[n]||""}function kt(){var n,e,a;(n=document.querySelector(".prev-month"))==null||n.addEventListener("click",()=>{B.setMonth(B.getMonth()-1),typeof window.reRender=="function"&&window.reRender()}),(e=document.querySelector(".next-month"))==null||e.addEventListener("click",()=>{B.setMonth(B.getMonth()+1),typeof window.reRender=="function"&&window.reRender()}),document.querySelectorAll(".event-delete-btn").forEach(t=>{t.addEventListener("click",async()=>{await v.confirm("¿Eliminar evento?","¿Borrar este evento de tu agenda?")&&(p.deleteEvent(t.dataset.id),v.toast("Evento eliminado"))})}),(a=document.getElementById("add-event-manual-btn"))==null||a.addEventListener("click",async()=>{const t=await v.prompt("Nuevo Evento","Título del evento:");if(!t)return;const s=await v.prompt("Fecha","Formato YYYY-MM-DD:",new Date().toISOString().split("T")[0]);if(!s)return;const o=await v.prompt("Hora","Formato HH:MM:","10:00");if(!o)return;const i=[{value:"event",label:"Evento"},{value:"reminder",label:"Recordatorio"},{value:"meeting",label:"Reunión"}],r=await v.select("Categoría","Tipo de evento:",i,0);p.addEvent({title:t,date:s,time:o,category:r||"event",repeat:"none"}),v.toast("Evento agendado","success")})}function xt(){const n=p.getState(),e=n.currencySymbol,a=n.livingExpenses,t=n.otherExpenses||[],s=n.liabilities,o=p.sumItems(a,"amount"),i=p.sumItems(t,"amount"),r=p.sumItems(s,"monthlyPayment"),l=o+i+r,u=[...(a||[]).map(c=>({...c,category:"livingExpense",typeLabel:"Gasto de Vida"})),...(t||[]).map(c=>({...c,category:"otherExpense",typeLabel:"Otro Gasto"})),...(s||[]).filter(c=>c.monthlyPayment>0).map(c=>({...c,amount:c.monthlyPayment,category:"liability",typeLabel:"Deuda / Hipoteca"}))].sort((c,d)=>d.amount-c.amount);return`
  ...
  `}function St(n,e){if(n.length===0)return`
            <div class="empty-state">
        ...
        <div class="asset-list">
            ${n.map(t=>{const s=p.convertValue(t.amount,t.currency||"EUR"),o=It(t.category);return`
  ...
  `}function Le(){const n=ne[$],e=$==="investmentAsset"||$==="passiveAsset";if(e){const t=U.map(s=>({value:s.symbol,label:`${s.name} (${s.symbol})`}));[...ge,...t]}let a="";return $==="passiveAsset"||$==="investmentAsset"?a=`
  ...
  `}function Ct(){const n=document.getElementById("add-modal"),e=document.getElementById("modal-close");n.addEventListener("click",t=>{t.target===n&&se()}),e.addEventListener("click",se);const a=n.querySelectorAll(".category-selector .type-option");a.forEach(t=>{t.addEventListener("click",()=>{$=t.dataset.category,a.forEach(s=>s.classList.remove("active")),t.classList.add("active"),document.getElementById("form-container").innerHTML=Le(),ye()})}),ye()}function ye(){const n=document.getElementById("btn-save");n&&n.addEventListener("click",Lt);const e=document.getElementById("mode-qty"),a=document.getElementById("mode-total"),t=document.getElementById("input-qty"),s=document.getElementById("input-value"),o=document.getElementById("input-currency"),i=document.getElementById("input-name");if(e&&a){const l=u=>{u==="qty"?(e.style.background="var(--accent-primary)",e.style.color="var(--bg-primary)",a.style.background="transparent",a.style.color="var(--text-secondary)",t.focus()):(a.style.background="var(--accent-primary)",a.style.color="var(--bg-primary)",e.style.background="transparent",e.style.color="var(--text-secondary)",s.focus())};e.addEventListener("click",()=>l("qty")),a.addEventListener("click",()=>l("total"))}const r=l=>{const u=p.getState().rates,c=o==null?void 0:o.value,d=u[c]||1;if(l==="qty"){const m=parseFloat(t.value)||0;s.value=(m*d).toFixed(2)}else{const m=parseFloat(s.value)||0;t.value=(m/d).toFixed(6)}};t==null||t.addEventListener("input",()=>r("qty")),s==null||s.addEventListener("input",()=>r("total")),o&&o.addEventListener("change",()=>{if(i&&!i.value){const l=o.options[o.selectedIndex].text;i.value=l.split(" (")[0]}r("qty")})}function Lt(){var h,w,E,k,b,L,T,V,q,K,J,ie;const n=(w=(h=document.getElementById("input-name"))==null?void 0:h.value)==null?void 0:w.trim(),e=(E=document.getElementById("input-type"))==null?void 0:E.value,a=(k=document.getElementById("input-currency"))==null?void 0:k.value,t=(L=(b=document.getElementById("input-details"))==null?void 0:b.value)==null?void 0:L.trim(),s=parseFloat((T=document.getElementById("input-value"))==null?void 0:T.value)||0,o=document.getElementById("input-qty"),i=o?parseFloat(o.value)||0:s,r=parseFloat((V=document.getElementById("input-amount"))==null?void 0:V.value)||0,l=parseFloat((q=document.getElementById("input-monthly"))==null?void 0:q.value)||0,u=(K=document.getElementById("input-date"))==null?void 0:K.value,c=(J=document.getElementById("input-time"))==null?void 0:J.value,d=(ie=document.getElementById("input-repeat"))==null?void 0:ie.value;if(!n){v.alert("Campo Obligatorio","Por favor ingresa un nombre para el elemento.");return}const m={name:n,type:e,currency:a,details:t};switch($){case"passiveAsset":p.addPassiveAsset({...m,value:i,monthlyIncome:l});break;case"activeIncome":p.addActiveIncome({...m,amount:r});break;case"livingExpense":p.addLivingExpense({...m,amount:r});break;case"investmentAsset":p.addInvestmentAsset({...m,value:i});break;case"liability":p.addLiability({...m,amount:r,monthlyPayment:l});break;case"event":p.addEvent({title:n,date:u,time:c,repeat:d,category:e});break}se()}function se(){const n=document.getElementById("add-modal");n&&(n.classList.remove("active"),setTimeout(()=>n.remove(),300))}function Tt(){const n=x.isSetup(),e=x.isBioEnabled();return`
    ...
    `}function Rt(n){var o;const e=document.getElementById("auth-submit-btn"),a=document.getElementById("auth-bio-btn"),t=document.getElementById("auth-password"),s=async()=>{const i=t.value,r=document.getElementById("auth-confirm"),l=x.isSetup();try{let u;if(l)u=await x.unlock(i);else{if(!i||i.length<4)throw new Error("Contraseña demasiado corta");if(i!==r.value)throw new Error("Las contraseñas no coinciden");u=await x.setup(i)}await p.loadEncrypted(u),n()}catch(u){v.alert("Error",u.message)}};e==null||e.addEventListener("click",s),t==null||t.addEventListener("keypress",i=>{i.key==="Enter"&&s()}),(o=document.getElementById("auth-confirm"))==null||o.addEventListener("keypress",i=>{i.key==="Enter"&&s()}),a==null||a.addEventListener("click",async()=>{try{const i=await x.unlockWithBiometrics();await p.loadEncrypted(i),n()}catch(i){v.alert("Identificación",i.message)}}),x.isBioEnabled()&&setTimeout(async()=>{try{const i=await x.unlockWithBiometrics();await p.loadEncrypted(i),n()}catch{console.log("Auto-bio failed or cancelled")}},500)}const Dt="modulepreload",Bt=function(n){return"/life-dashboard/"+n},fe={},be=function(e,a,t){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),r=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(a.map(l=>{if(l=Bt(l),l in fe)return;fe[l]=!0;const u=l.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":Dt,u||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),u)return new Promise((m,h)=>{d.addEventListener("load",m),d.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return s.then(i=>{for(const r of i||[])r.status==="rejected"&&o(r.reason);return e().catch(o)})};function Pt(){const n=x.isBioEnabled(),e=C.hasToken();return`
    ...
    `,document.body.appendChild(e);const a=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};a(),window.addEventListener("beforeinstallprompt",a),(t=document.getElementById("pwa-banner-install"))==null||t.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:o}=await window.deferredPrompt.userChoice;o==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(s=document.getElementById("pwa-banner-close"))==null||s.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function Re(){const n=document.getElementById("bottom-nav");n.innerHTML=ce(D),de(e=>{D=e,I=null,localStorage.setItem("life-dashboard/app_current_page",D),localStorage.setItem("life-dashboard/app_current_sub_page",I),_(),R(),n.innerHTML=ce(D),de(a=>{D=a,I=null,localStorage.setItem("life-dashboard/app_current_page",D),localStorage.setItem("life-dashboard/app_current_sub_page",I),_(),R(),Re()})}),Ut(),R()}function R(){const n=document.getElementById("main-content");if(!n)return;const e=n.scrollTop;if(I==="compound"){n.innerHTML=st(),nt(()=>{I=null,it(),_(),R()}),n.scrollTop=e;return}if(I==="expenses"){n.innerHTML=xt(),$t(()=>{I=null,_(),R()}),n.scrollTop=e;return}if(I==="market"){n.innerHTML=ot(),lt(()=>{I=null,_(),R()}),n.scrollTop=e;return}switch(n.classList.toggle("no-padding-mobile",D==="health"),D){case"finance":_(),n.innerHTML=pe(),me(),ke();break;case"goals":O(),n.innerHTML=mt(),gt();break;case"calendar":n.innerHTML=ht(),kt(),O();break;case"health":n.innerHTML=ct(),pt(),O();break;case"settings":n.innerHTML=Pt(),Mt(),O();break;default:_(),n.innerHTML=pe(),me(),ke()}requestAnimationFrame(()=>{n.scrollTop=e})}function ke(){const n=document.getElementById("open-compound");n&&n.addEventListener("click",()=>{I="compound",localStorage.setItem("life-dashboard/app_current_sub_page",I),O(),R()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{I="market",localStorage.setItem("life-dashboard/app_current_sub_page",I),O(),R()});const a=document.getElementById("open-expenses");a&&a.addEventListener("click",()=>{I="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",I),O(),R()})}function Ut(){const n=document.querySelector(".fab");n&&n.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=g("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{if(D==="calendar")he("event");else if(D==="health"){const a=await ns.confirm("Registrar Métrica","¿Qué deseas registrar hoy?","Peso","Grasa");if(a===!0){const t=await ns.prompt("Registrar Peso","Ingresa tu peso actual en kg:","","number");t&&p.addWeightLog(t)}else if(a===!1){const t=await ns.prompt("Grasa Corporal","Ingresa tu % de grasa:","","number");t&&p.addFatLog(t)}}else he()}),document.body.appendChild(e)}function O(){const n=document.getElementById("main-fab");n&&(n.style.display="none")}function _(){const n=document.getElementById("main-fab");n&&(n.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",we):we();window.addEventListener("beforeinstallprompt",n=>{n.preventDefault(),window.deferredPrompt=n,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});
