var Ce=Object.defineProperty;var Le=(s,e,t)=>e in s?Ce(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var J=(s,e,t)=>Le(s,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Te="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",Re="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function Be(){var e,t,a,n,i,o,r,l,u,c,d,v,h,f,E;const s={EUR:1};try{const w=await(await fetch(Te)).json();s.BTC=((e=w.bitcoin)==null?void 0:e.eur)||4e4,s.ETH=((t=w.ethereum)==null?void 0:t.eur)||2200,s.XRP=((a=w.ripple)==null?void 0:a.eur)||.5,s.KAS=((n=w.kaspa)==null?void 0:n.eur)||.1,s.SOL=((i=w.solana)==null?void 0:i.eur)||90,s.XLM=((o=w.stellar)==null?void 0:o.eur)||.11,s.ALGO=((r=w.algorand)==null?void 0:r.eur)||.18,s.LTC=((l=w.litecoin)==null?void 0:l.eur)||65,s.SUI=((u=w.sui)==null?void 0:u.eur)||1.1,s.LINK=((c=w.chainlink)==null?void 0:c.eur)||14,s.RNDR=((d=w["render-token"])==null?void 0:d.eur)||4.5,s.ADA=((v=w.cardano)==null?void 0:v.eur)||.45,s.ONDO=((h=w["ondo-finance"])==null?void 0:h.eur)||.7,(f=w.bitcoin)!=null&&f.ars&&((E=w.bitcoin)!=null&&E.eur)&&(s.ARS=w.bitcoin.eur/w.bitcoin.ars);const C=await fetch(Re);if(C.ok){const L=await C.json();s.USD=1/L.rates.USD,s.CHF=1/L.rates.CHF,s.GBP=1/L.rates.GBP,s.AUD=1/L.rates.AUD}s.GOLD=2100,s.SP500=4700}catch(k){console.error("Failed to fetch some prices:",k),s.USD=s.USD||.92,s.CHF=s.CHF||1.05,s.GBP=s.GBP||1.15,s.AUD=s.AUD||.6,s.ARS=s.ARS||.001}return s}class D{static async hash(e,t="salt_life_dashboard_2026"){const n=new TextEncoder().encode(e+t),i=await crypto.subtle.digest("SHA-512",n);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,t){const a=new TextEncoder,n=await crypto.subtle.importKey("raw",a.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:a.encode(t),iterations:25e4,hash:"SHA-512"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,t){try{const a=crypto.getRandomValues(new Uint8Array(16)),n=crypto.getRandomValues(new Uint8Array(12)),i=await this.deriveKey(t,this.bufToBase64(a)),o=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(o),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},i,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(n),salt:this.bufToBase64(a),v:"5.0"}}catch(a){throw console.error("[Security] Encryption failed:",a),new Error("No se pudo encriptar la información")}}static async decrypt(e,t){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:a,iv:n,salt:i}=e,o=await this.deriveKey(t,i),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(n)},o,this.base64ToBuf(a)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(a){throw console.error("[Security] Decryption failed:",a),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(t=>t.charCodeAt(0)))}}const ne=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:D},Symbol.toStringTag,{value:"Module"})),A={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class x{static isSetup(){return!!localStorage.getItem(A.MASTER_HASH)}static async setup(e){const t=await D.hash(e),a=await D.deriveVaultKey(e);return localStorage.setItem(A.MASTER_HASH,t),sessionStorage.setItem(A.VAULT_KEY,a),a}static async unlock(e){const t=await D.hash(e),a=localStorage.getItem(A.MASTER_HASH);if(t===a){const n=await D.deriveVaultKey(e);return sessionStorage.setItem(A.VAULT_KEY,n),n}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const t=sessionStorage.getItem(A.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const a=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:a,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(A.BIO_ENABLED,"true"),localStorage.setItem(A.VAULT_KEY,t),!0}catch(a){throw console.error("Biometric setup failed:",a),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(A.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const t=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:t,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const a=localStorage.getItem(A.VAULT_KEY);if(a)return sessionStorage.setItem(A.VAULT_KEY,a),a;throw new Error("Llave no encontrada. Usa contraseña.")}catch(t){throw console.error("Biometric auth failed:",t),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(A.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(A.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(A.BIO_ENABLED)==="true"}}const De="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",Pe="https://www.googleapis.com/auth/drive.file";class T{static hasToken(){return!!this.accessToken&&localStorage.getItem("life-dashboard/drive_connected")==="true"}static async init(){return new Promise((e,t)=>{const a=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.tokenClient=google.accounts.oauth2.initTokenClient({client_id:De,scope:Pe,callback:n=>{if(n.error){console.error("[Drive] Auth callback error:",n);return}this.saveSession(n)}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&(console.log("[Drive] Attempting silent token restoration..."),this.tokenClient.requestAccessToken({prompt:"none"})),e(!0)}catch(n){console.error("[Drive] Init error:",n),t(n)}}):setTimeout(a,200)};a()})}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const t=Date.now()+(e.expires_in?e.expires_in*1e3:36e5);localStorage.setItem("life-dashboard/drive_token_expiry",t.toString())}static async authenticate(e=!1){return this.tokenClient||await this.init(),new Promise((t,a)=>{this.tokenClient.callback=n=>{if(n.error){e?(localStorage.setItem("life-dashboard/drive_connected","false"),a(new Error("Silent auth failed"))):a(new Error(n.error_description||"Fallo en la autenticación"));return}this.saveSession(n),t(n.access_token)},e?this.tokenClient.requestAccessToken({prompt:"none"}):this.tokenClient.requestAccessToken({prompt:"consent"})})}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(localStorage.getItem("life-dashboard/drive_connected")==="true"&&Date.now()>e-3e5){console.log("[Drive] Token expired or near expiry, refreshing...");try{return await this.authenticate(!0),this.accessToken}catch{throw console.warn("[Drive] Silent refresh failed, manual re-connect may be needed"),this.accessToken=null,new Error("Sesión de Drive expirada. Por favor reconecta en Configuración.")}}return this.accessToken}static async getOrCreateFolderPath(e){var n;await this.ensureValidToken(),(n=gapi.client)!=null&&n.drive||await this.init();const t=e.split("/").filter(i=>i);let a="root";for(const i of t)try{const o=`name = '${i}' and mimeType = 'application/vnd.google-apps.folder' and '${a}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)"})).result.files;if(l&&l.length>0)a=l[0].id;else{const u={name:i,mimeType:"application/vnd.google-apps.folder",parents:[a]};a=(await gapi.client.drive.files.create({resource:u,fields:"id"})).result.id}}catch(o){throw o.status===401?(this.accessToken=null,new Error("Sesión de Google expirada. Por favor reconecta.")):o}return a}static async pushData(e,t){var a,n,i;try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");(a=gapi.client)!=null&&a.drive||await this.init(),gapi.client.setToken({access_token:this.accessToken}),console.log("[Drive] Pushing full encrypted data...");const o=await this.getOrCreateFolderPath("/backup/life-dashboard/"),r=await D.encrypt(e,t),l="dashboard_vault_v5.bin",u=`name = '${l}' and '${o}' in parents and trashed = false`,d=(await gapi.client.drive.files.list({q:u,fields:"files(id)"})).result.files,v=new Blob([JSON.stringify(r)],{type:"application/json"});if(d&&d.length>0){const h=d[0].id,f=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${h}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:v});if(!f.ok)throw new Error(`Error al actualizar backup: ${f.status}`)}else{const h={name:l,parents:[o]},f=new FormData;f.append("metadata",new Blob([JSON.stringify(h)],{type:"application/json"})),f.append("file",v);const E=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:f});if(!E.ok)throw new Error(`Error al crear backup: ${E.status}`)}return!0}catch(o){throw console.error("[Drive] Push failed:",o),new Error(((i=(n=o.result)==null?void 0:n.error)==null?void 0:i.message)||o.message||"Fallo al subir datos a Drive")}}static async pullData(e){var t,a,n;try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");(t=gapi.client)!=null&&t.drive||await this.init(),gapi.client.setToken({access_token:this.accessToken}),console.log("[Drive] Pulling data...");const r=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,u=(await gapi.client.drive.files.list({q:r,fields:"files(id, name)"})).result.files;if(!u||u.length===0)return null;const c=u[0].id,d=await fetch(`https://www.googleapis.com/drive/v3/files/${c}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(!d.ok)throw new Error(`Error al descargar backup: ${d.status}`);const v=await d.json();return await D.decrypt(v,e)}catch(i){throw console.error("[Drive] Pull failed:",i),new Error(((n=(a=i.result)==null?void 0:a.error)==null?void 0:n.message)||i.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){var e,t,a;try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");(e=gapi.client)!=null&&e.drive||await this.init(),gapi.client.setToken({access_token:this.accessToken});const o=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:o,fields:"files(id)"})).result.files;if(l&&l.length>0){const u=l[0].id;return await gapi.client.drive.files.delete({fileId:u}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(n){throw console.error("[Drive] Deletion failed:",n),new Error(((a=(t=n.result)==null?void 0:t.error)==null?void 0:a.message)||n.message||"Fallo al borrar backup en Drive")}}}J(T,"tokenClient",null),J(T,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null);const ie={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>'};function g(s,e=""){return(ie[s]||ie.package).replace("<svg",`<svg class="${e}"`)}class Me{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,t="success",a=3e3){const n=document.createElement("div");n.className=`toast toast-${t} stagger-in`;const i=t==="success"?"check":t==="error"?"alertCircle":"info";n.innerHTML=`
        ...
        `,this.toastContainer.appendChild(n),setTimeout(()=>{n.classList.add("fade-out"),setTimeout(()=>n.remove(),500)},a)}alert(e,t){return new Promise(a=>{this._showModal({title:e,message:t,centered:!0,buttons:[{text:"Entendido",type:"primary",onClick:()=>a(!0)}]})})}confirm(e,t,a="Confirmar",n="Cancelar"){return new Promise(i=>{this._showModal({title:e,message:t,centered:!0,buttons:[{text:n,type:"secondary",onClick:()=>i(!1)},{text:a,type:"danger",onClick:()=>i(!0)}]})})}prompt(e,t,a="",n="text"){return new Promise(i=>{const o=`prompt-input-${Date.now()}`;this._showModal({title:e,message:t,centered:!0,content:`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>i(null)},{text:"Aceptar",type:"primary",onClick:()=>{const r=document.getElementById(o).value;i(r)}}]})})}select(e,t,a=[],n=4){return new Promise(i=>{const o=`display: grid; grid-template-columns: repeat(${n}, 1fr); gap: 8px; margin-top: 16px;`;this._showModal({title:e,message:t,centered:!0,content:`
                    <div style="${o}">
                        ${a.map((l,u)=>`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>n(!1)},{text:"Borrar Todo",type:"danger",id:o,disabled:!0,onClick:()=>n(!0)}]});const r=document.getElementById(i),l=document.getElementById(o);r.addEventListener("input",()=>{const u=r.value.trim().toUpperCase()===a.toUpperCase();l.disabled=!u,l.style.opacity=u?"1":"0.3",l.style.pointerEvents=u?"auto":"none"})})}stars(e,t){return new Promise(a=>{let n=5;this._showModal({title:e,message:t,centered:!0,content:`
                ...
                `,buttons:[{text:"Cancelar",type:"secondary",onClick:()=>a(null)},{text:"Guardar Calificación",type:"primary",onClick:()=>a(n)}]});const i=document.querySelector(".modal-overlay.active");if(i){const o=i.querySelectorAll(".star-btn");o.forEach(r=>{r.addEventListener("click",()=>{n=parseInt(r.dataset.value),o.forEach((l,u)=>{l.style.color=u<n?"var(--accent-tertiary)":"var(--text-muted)",l.style.transform=u<n?"scale(1.2)":"scale(1)"})})})}})}_showModal({title:e,message:t,content:a="",buttons:n=[],centered:i=!1}){const o=document.createElement("div");o.className=`modal-overlay ${i?"overlay-centered":""}`,o.style.zIndex="9999";const r=`modal-${Date.now()}-${Math.floor(Math.random()*1e3)}`;o.id=r;const l=`
  ...
  `}function Ve(s){const e=document.getElementById("edit-modal"),t=document.getElementById("edit-modal-close"),a=document.getElementById("btn-update"),n=document.getElementById("btn-delete");e.addEventListener("click",i=>{i.target===e&&X()}),t.addEventListener("click",X),a.addEventListener("click",()=>ze(s)),n.addEventListener("click",()=>qe(s))}function ze(s){var u,c,d,v,h,f,E,k,w;const e=(c=(u=document.getElementById("edit-name"))==null?void 0:u.value)==null?void 0:c.trim(),t=(d=document.getElementById("edit-type"))==null?void 0:d.value,a=(v=document.getElementById("edit-currency"))==null?void 0:v.value,n=(f=(h=document.getElementById("edit-details"))==null?void 0:h.value)==null?void 0:f.trim(),i=parseFloat((E=document.getElementById("edit-value"))==null?void 0:E.value)||0,o=parseFloat((k=document.getElementById("edit-amount"))==null?void 0:k.value)||0,r=parseFloat((w=document.getElementById("edit-monthly"))==null?void 0:w.value)||0;if(!e){m.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:t,currency:a,details:n};s.fields.includes("value")&&(l.value=i),s.fields.includes("amount")&&(l.amount=o),s.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),s.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),p[s.updateMethod](z.id,l),X()}function qe(s){m.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${z.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(p[s.deleteMethod](z.id),m.toast("Eliminado correctamente","info"),X())})}function X(){const s=document.getElementById("edit-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300)),z=null,F=null}function de(){const s=p.getState(),e=s.currencySymbol,t=p.getPassiveIncome(),a=p.getLivingExpenses(),n=p.getNetPassiveIncome(),i=p.getInvestmentAssetsValue(),o=p.getTotalLiabilities(),r=p.getNetWorth(),l=p.getAllIncomes(),u=p.getAllExpenses(),c=p.getNetIncome();return`
  ...
  `}function Ye(s){const e=[...s.passiveAssets,...s.investmentAssets],t=s.liabilities;if(e.length===0)return"";const a={Bitcoin:{value:0,color:"#f59e0b"},Altcoins:{value:0,color:"#6366f1"},Inmuebles:{value:0,color:"#a855f7"},Bolsa:{value:0,color:"#00d4aa"},Oro:{value:0,color:"#fbbf24"},"Otros/Efe.":{value:0,color:"#94a3b8"}};e.forEach(c=>{const d=p.convertValue(c.value||0,c.currency||"EUR");c.currency==="BTC"?a.Bitcoin.value+=d:c.currency==="ETH"||c.currency==="XRP"||c.type==="crypto"?a.Altcoins.value+=d:c.type==="property"||c.type==="rental"?a.Inmuebles.value+=d:c.type==="stocks"||c.type==="etf"||c.currency==="SP500"?a.Bolsa.value+=d:c.currency==="GOLD"?a.Oro.value+=d:a["Otros/Efe."].value+=d});const n=t.filter(c=>c.type==="mortgage").reduce((c,d)=>c+p.convertValue(d.amount||0,d.currency||"EUR"),0);a.Inmuebles.value=Math.max(0,a.Inmuebles.value-n),s.hideRealEstate&&(a.Inmuebles.value=0);const i=Object.entries(a).filter(([c,d])=>d.value>0).sort((c,d)=>d[1].value-c[1].value),o=i.reduce((c,[d,v])=>c+v.value,0);if(o===0)return`
    ...
    `;let r=0;const l=i.map(([c,d])=>{const v=d.value/o*100,h=r;return r+=v,{name:c,percentage:v,color:d.color,start:h}}),u=l.map(c=>`${c.color} ${c.start}% ${c.start+c.percentage}%`).join(", ");return`
  ...
  `}function We(s){const e=[...s.passiveAssets.map(a=>({...a,category:"passive"})),...s.investmentAssets.map(a=>({...a,category:"investment"})),...s.liabilities.map(a=>({...a,category:"liability"}))];if(e.length===0)return`
    ...
    <div class="asset-list">
      ${e.map(a=>{const n=Xe(a.currency||a.type),i=Je(a.currency||a.type),o=a.category==="liability",r=a.value||a.amount||0,l=p.convertValue(r,a.currency||"EUR");let u="";if(a.currency!==s.currency){const d={EUR:"€",USD:"$",BTC:"₿",ETH:"Ξ",XRP:"✕",GOLD:"oz",SP500:"pts",CHF:"Fr",GBP:"£",AUD:"A$",ARS:"$"}[a.currency]||a.currency;u=`<div class="asset-original-value">${r} ${d}</div>`}return`
  ...
  `}function Qe(s){const e=document.getElementById("back-to-finance"),t=document.getElementById("rate-slider"),a=document.getElementById("years-slider"),n=document.getElementById("principal-input"),i=document.getElementById("contribution-input"),o=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",s),n&&n.addEventListener("input",l=>{U=parseFloat(l.target.value)||0,N()}),i&&i.addEventListener("input",l=>{O=parseFloat(l.target.value)||0,N()}),o&&o.addEventListener("click",()=>{U=null;const l=p.getNetWorth();n.value=l,N()}),r&&r.addEventListener("click",()=>{O=null;const l=p.getNetIncome()*12;i.value=l,N()}),t&&t.addEventListener("input",l=>{_=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${_}%`,N()}),a&&a.addEventListener("input",l=>{P=parseInt(l.target.value),document.getElementById("years-value").textContent=`${P} años`,N()})}function N(){const e=p.getState().currencySymbol,t=U!==null?U:p.getNetWorth(),a=O!==null?O:p.getNetIncome()*12,n=ke(t,a,_,P),i=document.getElementById("future-value"),o=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),u=document.getElementById("total-contributed"),c=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),v=document.getElementById("projection-chart"),h=document.getElementById("projection-table");i&&(i.textContent=b(n.finalValue,e)),o&&(o.textContent=`Valor Futuro en ${P} años`),r&&(r.innerHTML=`${n.totalGrowth>=0?"📈":"📉"} ${n.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=b(t,e)),u&&(u.textContent=b(n.totalContributions,e),u.className=`stat-value ${n.totalContributions>=0?"positive":"negative"}`),c&&(c.textContent=b(n.totalInterest,e)),d&&(d.textContent=b(n.finalValue,e)),v&&(v.innerHTML=xe(n.yearlyBreakdown)),h&&(h.innerHTML=Se(n.yearlyBreakdown,e))}function et(){P=10,_=7,U=null,O=null}let q=p.getState().lastMarketData||[],K=q.length===0,S={key:"price",direction:"desc"};function tt(){const s=p.getState(),e=s.currency||"EUR",t=s.currencySymbol||"€";if(q.length===0){if(K)return ee(),`
        ...
        <div class="market-page stagger-children" style="padding-bottom: 80px;">
            ...
            ${a.map(n=>{const i=q.filter(o=>o.category===n);return i.length===0?"":at(n,i,t)}).join("")}
        </div>
    `}function at(s,e,t){const a=[...e].sort((n,i)=>{let o=n[S.key],r=i[S.key];return typeof o=="string"&&(o=o.toLowerCase()),typeof r=="string"&&(r=r.toLowerCase()),o<r?S.direction==="asc"?-1:1:o>r?S.direction==="asc"?1:-1:0});return`
          ...
          <div class="card routine-card">
            <div class="routine-header">
                ...
                <div style="display: flex; gap: 4px;">
                    <button class="icon-btn add-exercise-btn" data-id="${t.id}" style="color: var(--accent-primary);">
                        ${g("plus")}
                    </button>
            ...
            <div class="exercise-list">
                ${t.exercises.map((n,i)=>{const o=p.getExerciseStatus(t.id,i);let r="var(--text-muted)";o.color==="red"&&(r="var(--accent-danger)"),o.color==="orange"&&(r="var(--accent-warning)"),o.color==="green"&&(r="var(--accent-success)");const l=o.status==="done_today";let u="";return l&&o.lastLog&&(u=`<span style="font-size: 10px; color: var(--accent-tertiary);">★ ${o.lastLog.rating}</span>`),`
                    <div class="exercise-item-health ${l?"exercise-done":""}">
                        <div class="ex-health-main">
                            ...
                            <div class="ex-health-info" style="${o.color==="red"?"opacity: 0.6;":""}">
                                <div class="ex-health-name-row">
                                    <span class="ex-health-name clickable rename-exercise" data-routine="${t.id}" data-index="${i}">${n.name}</span>
                                    <div class="ex-reorder-btns">
                                        <button class="reorder-ex-btn" data-routine="${t.id}" data-index="${i}" data-dir="up">${g("chevronUp")}</button>
                                        <button class="reorder-ex-btn" data-routine="${t.id}" data-index="${i}" data-dir="down">${g("chevronDown")}</button>
                                    </div>
                                </div>
                                <div class="ex-health-stats">
                                    <span class="ex-clickable-val update-weight" data-routine="${t.id}" data-index="${i}">${n.weight||50}kg</span>
                                    <span style="opacity: 0.3;">•</span>
                                    <span class="ex-clickable-val update-reps" data-routine="${t.id}" data-index="${i}">${n.reps||10} reps</span>
                                    <span style="opacity: 0.3;">•</span>
                        ...
                        <div class="ex-health-actions">
                            <button class="delete-exercise-btn" data-routine="${t.id}" data-index="${i}" title="Eliminar ejercicio">
                                ${g("x")}
                            </button>
  ...
  `}function it(s){const e=s.weightLogs;return e.length<2?'<div class="empty-chart-msg">Registra al menos 2 pesos para ver el gráfico.</div>':`
    ...
    `}function ot(s,e){if(s.length<2)return"";const t=s.map(c=>c.weight),a=Math.min(...t,e)-1,i=Math.max(...t,e)+1-a,o=s[0].date,l=s[s.length-1].date-o||1;return`M${s.map((c,d)=>{const v=d===0?0:(c.date-o)/l*100,h=40-(c.weight-a)/i*40;return`${v},${h}`}).join(" L")}`}function rt(s){if(s.weightLogs.length===0)return"--";const t=s.weightLogs[s.weightLogs.length-1].weight-s.weightGoal;return t>0?t.toFixed(1):"¡Logrado!"}function ve(s){const e=new Date().setHours(0,0,0,0);return s.calorieLogs.filter(t=>new Date(t.date).setHours(0,0,0,0)===e).reduce((t,a)=>t+a.calories,0)}function lt(){var e,t,a,n;(e=document.getElementById("log-weight-btn"))==null||e.addEventListener("click",async()=>{const i=await m.prompt("Registrar Peso","Ingresa tu peso actual en kg:","Ej: 75.5","number");i&&!isNaN(i)&&(p.addWeightLog(i),m.toast("Peso registrado"))}),(t=document.getElementById("log-fat-btn"))==null||t.addEventListener("click",async()=>{const i=await m.prompt("Grasa Corporal","Ingresa tu % de grasa (deja en blanco si no lo sabes):","Ej: 18.2","number");if(i!==null){const o=parseFloat(i);isNaN(o)||(p.addFatLog(o),m.toast("Grasa registrada"))}}),document.querySelectorAll(".rename-routine").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.id,r=i.textContent,l=await m.prompt("Renombrar Rutina","Nuevo nombre:",r);l&&l!==r&&(p.renameRoutine(o,l),m.toast("Rutina renombrada"))})}),document.querySelectorAll(".add-exercise-btn").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.id,r=await m.prompt("Agregar Ejercicio","Nombre del ejercicio:","Ej: Press Militar");r&&(p.addExerciseToRoutine(o,{name:r}),m.toast("Ejercicio añadido"))})}),document.querySelectorAll(".delete-routine").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.id;await m.confirm("Borrar Rutina","¿Estás seguro de eliminar esta rutina?","BORRAR","CANCELAR")&&(p.deleteRoutine(o),m.toast("Rutina eliminada"))})}),document.querySelectorAll(".rename-exercise").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.routine,r=parseInt(i.dataset.index),l=i.textContent,u=await m.prompt("Renombrar Ejercicio","Nuevo nombre:",l);u&&u!==l&&(p.updateExercise(o,r,{name:u}),m.toast("Ejercicio renombrado"))})}),document.querySelectorAll(".delete-exercise-btn").forEach(i=>{i.addEventListener("click",async()=>{const o=i.dataset.routine,r=parseInt(i.dataset.index);await m.confirm("Eliminar Ejercicio","¿Quitar este ejercicio de la rutina?","Eliminar","Cancelar")&&(p.deleteExerciseFromRoutine(o,r),m.toast("Ejercicio eliminado"))})}),document.querySelectorAll(".reorder-routine-btn").forEach(i=>{i.addEventListener("click",o=>{o.stopPropagation();const r=parseInt(i.dataset.index),l=i.dataset.dir;p.reorderRoutine(r,l)})}),document.querySelectorAll(".reorder-ex-btn").forEach(i=>{i.addEventListener("click",o=>{o.stopPropagation();const r=i.dataset.routine,l=parseInt(i.dataset.index),u=i.dataset.dir;p.reorderExercise(r,l,u)})}),document.querySelectorAll(".update-weight").forEach(i=>{i.addEventListener("click",async o=>{o.stopPropagation();const r=i.dataset.routine,l=parseInt(i.dataset.index),u=[];for(let d=10;d<=150;d+=2.5)u.push(`${d}kg`);const c=await m.select("Seleccionar Peso","Elige el peso para este ejercicio:",u,4);if(c){const d=parseFloat(c.replace("kg",""));p.updateExercise(r,l,{weight:d}),m.toast("Peso actualizado")}})}),document.querySelectorAll(".update-reps").forEach(i=>{i.addEventListener("click",async o=>{o.stopPropagation();const r=i.dataset.routine,l=parseInt(i.dataset.index),u=[];for(let d=7;d<=20;d++)u.push(`${d} reps`);const c=await m.select("Seleccionar Reps","Elige las repeticiones objetivo:",u,4);if(c){const d=parseInt(c.replace(" reps",""));p.updateExercise(r,l,{reps:d}),m.toast("Reps actualizadas")}})}),document.querySelectorAll(".trigger-exercise-log").forEach(i=>{i.addEventListener("click",async o=>{o.stopPropagation();const r=i.dataset.routine,l=parseInt(i.dataset.index),u=i.dataset.name,c=await m.stars("Monitor de Gym",`¿Cómo fue tu desempeño en "${u}"?`);c&&(p.logExercise(r,l,c),m.toast("¡Entrenamiento guardado!","success"))})}),(a=document.getElementById("ai-scan-photo"))==null||a.addEventListener("click",()=>{const i=document.createElement("input");i.type="file",i.accept="image/*",i.onchange=async r=>{var u;const l=r.target.files[0];if(l){if(!pe.hasKey()){if(await m.confirm("IA no configurada","Añade tu Gemini API Key en Ajustes.","Configurar","Simulación")){(u=document.querySelector('[data-nav="settings"]'))==null||u.click();return}m.toast("Usando simulación...","info"),o();return}try{m.toast("Analizando con Gemini...","info");const c=await pe.analyzeFood(l);await m.confirm("IA Detectada",`Identificado: "${c.name}" (${c.calories} kcal). ¿Registrar?`)&&(p.addCalorieLog(c.calories,`${c.name} (AI)`),m.toast("Calorías registradas"))}catch(c){m.alert("Error IA",c.message)}}};function o(){setTimeout(async()=>{const r={name:"Bowl Saludable",cals:450};await m.confirm("IA Simulada",`Detectado "${r.name}" con ${r.cals} kcal. ¿Registrar?`)&&(p.addCalorieLog(r.cals,r.name),m.toast("Registrado"))},1e3)}i.click()}),(n=document.getElementById("add-routine-btn"))==null||n.addEventListener("click",async()=>{const i=await m.prompt("Nueva Rutina","Nombre (ej: Pecho y Triceps):","Día X");i&&(p.saveRoutine({name:i,exercises:[]}),m.toast("Rutina creada"))})}function ct(){const s=p.getState(),{goals:e}=s;return`
  ...
  `}function dt(s,e){const t=s.filter(a=>a.timeframe===e);return t.length===0?'<div class="empty-goals">No hay metas para este periodo.</div>':t.map(a=>`
      ...
      <div class="calendar-top-layout">
        ...
        <div class="card calendar-view-card">
            <div class="calendar-mini-header">
                ...
                <span class="current-month">${mt()}</span>
  ...
  `}function vt(s){const e=new Date,t=e.getMonth(),a=e.getFullYear(),n=e.getDate(),i=new Date(a,t+1,0).getDate(),o=new Date(a,t,1).getDay(),r=["D","L","M","M","J","V","S"],l=new Set;s.forEach(c=>{const d=new Date(c.date);d.getMonth()===t&&d.getFullYear()===a&&l.add(d.getDate())});let u=r.map(c=>`<div class="calendar-day-label">${c}</div>`).join("");for(let c=0;c<o;c++)u+='<div class="calendar-day empty"></div>';for(let c=1;c<=i;c++){const d=c===n,v=l.has(c);u+=`
            <div class="calendar-day ${d?"today":""} ${v?"has-event":""}">
                ${c}
                ${v?'<span class="event-dot-indicator"></span>':""}
            </div>
        `}return u}function mt(){const s=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],e=new Date;return`${s[e.getMonth()]} ${e.getFullYear()}`}function gt(s){const e={day:"numeric",month:"short"};return new Date(s).toLocaleDateString("es-ES",e).toUpperCase()}function ht(s){switch(s){case"reminder":return"bell";case"meeting":return"users";default:return"calendar"}}function yt(s){return{daily:"Diario",weekly:"Semanal",monthly:"Mensual",yearly:"Anual"}[s]||""}function bt(){document.querySelectorAll(".event-delete-btn").forEach(s=>{s.addEventListener("click",async()=>{await m.confirm("¿Eliminar evento?","¿Estás seguro de que quieres borrar este evento de tu agenda?")&&(p.deleteEvent(s.dataset.id),m.toast("Evento eliminado","info"))})})}function ft(){const s=p.getState(),e=s.currencySymbol,t=s.livingExpenses,a=s.otherExpenses||[],n=s.liabilities,i=p.sumItems(t,"amount"),o=p.sumItems(a,"amount"),r=p.sumItems(n,"monthlyPayment"),l=i+o+r,u=[...(t||[]).map(c=>({...c,category:"livingExpense",typeLabel:"Gasto de Vida"})),...(a||[]).map(c=>({...c,category:"otherExpense",typeLabel:"Otro Gasto"})),...(n||[]).filter(c=>c.monthlyPayment>0).map(c=>({...c,amount:c.monthlyPayment,category:"liability",typeLabel:"Deuda / Hipoteca"}))].sort((c,d)=>d.amount-c.amount);return`
  ...
  `}function wt(s,e){if(s.length===0)return`
        ...
        <div class="asset-list">
            ${s.map(a=>{const n=p.convertValue(a.amount,a.currency||"EUR"),i=Et(a.category);return`
  ...
  `}function Ie(){const s=ae[$],e=$==="investmentAsset"||$==="passiveAsset";if(e){const a=M.map(n=>({value:n.symbol,label:`${n.name} (${n.symbol})`}));[...me,...a]}let t="";return $==="passiveAsset"||$==="investmentAsset"?t=`
  ...
  `}function St(){const s=document.getElementById("add-modal"),e=document.getElementById("modal-close");s.addEventListener("click",a=>{a.target===s&&te()}),e.addEventListener("click",te);const t=s.querySelectorAll(".category-selector .type-option");t.forEach(a=>{a.addEventListener("click",()=>{$=a.dataset.category,t.forEach(n=>n.classList.remove("active")),a.classList.add("active"),document.getElementById("form-container").innerHTML=Ie(),he()})}),he()}function he(){const s=document.getElementById("btn-save");s&&s.addEventListener("click",It);const e=document.getElementById("mode-qty"),t=document.getElementById("mode-total"),a=document.getElementById("input-qty"),n=document.getElementById("input-value"),i=document.getElementById("input-currency"),o=document.getElementById("input-name");if(e&&t){const l=u=>{u==="qty"?(e.style.background="var(--accent-primary)",e.style.color="var(--bg-primary)",t.style.background="transparent",t.style.color="var(--text-secondary)",a.focus()):(t.style.background="var(--accent-primary)",t.style.color="var(--bg-primary)",e.style.background="transparent",e.style.color="var(--text-secondary)",n.focus())};e.addEventListener("click",()=>l("qty")),t.addEventListener("click",()=>l("total"))}const r=l=>{const u=p.getState().rates,c=i==null?void 0:i.value,d=u[c]||1;if(l==="qty"){const v=parseFloat(a.value)||0;n.value=(v*d).toFixed(2)}else{const v=parseFloat(n.value)||0;a.value=(v/d).toFixed(6)}};a==null||a.addEventListener("input",()=>r("qty")),n==null||n.addEventListener("input",()=>r("total")),i&&i.addEventListener("change",()=>{if(o&&!o.value){const l=i.options[i.selectedIndex].text;o.value=l.split(" (")[0]}r("qty")})}function It(){var h,f,E,k,w,C,L,j,G,H,Y,se;const s=(f=(h=document.getElementById("input-name"))==null?void 0:h.value)==null?void 0:f.trim(),e=(E=document.getElementById("input-type"))==null?void 0:E.value,t=(k=document.getElementById("input-currency"))==null?void 0:k.value,a=(C=(w=document.getElementById("input-details"))==null?void 0:w.value)==null?void 0:C.trim(),n=parseFloat((L=document.getElementById("input-value"))==null?void 0:L.value)||0,i=document.getElementById("input-qty"),o=i?parseFloat(i.value)||0:n,r=parseFloat((j=document.getElementById("input-amount"))==null?void 0:j.value)||0,l=parseFloat((G=document.getElementById("input-monthly"))==null?void 0:G.value)||0,u=(H=document.getElementById("input-date"))==null?void 0:H.value,c=(Y=document.getElementById("input-time"))==null?void 0:Y.value,d=(se=document.getElementById("input-repeat"))==null?void 0:se.value;if(!s){m.alert("Campo Obligatorio","Por favor ingresa un nombre para el elemento.");return}const v={name:s,type:e,currency:t,details:a};switch($){case"passiveAsset":p.addPassiveAsset({...v,value:o,monthlyIncome:l});break;case"activeIncome":p.addActiveIncome({...v,amount:r});break;case"livingExpense":p.addLivingExpense({...v,amount:r});break;case"investmentAsset":p.addInvestmentAsset({...v,value:o});break;case"liability":p.addLiability({...v,amount:r,monthlyPayment:l});break;case"event":p.addEvent({title:s,date:u,time:c,repeat:d,category:e});break}te()}function te(){const s=document.getElementById("add-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300))}function $t(){const s=x.isSetup(),e=x.isBioEnabled();return`
    ...
    `}function At(s){var i;const e=document.getElementById("auth-submit-btn"),t=document.getElementById("auth-bio-btn"),a=document.getElementById("auth-password"),n=async()=>{const o=a.value,r=document.getElementById("auth-confirm"),l=x.isSetup();try{let u;if(l)u=await x.unlock(o);else{if(!o||o.length<4)throw new Error("Contraseña demasiado corta");if(o!==r.value)throw new Error("Las contraseñas no coinciden");u=await x.setup(o)}await p.loadEncrypted(u),s()}catch(u){m.alert("Error",u.message)}};e==null||e.addEventListener("click",n),a==null||a.addEventListener("keypress",o=>{o.key==="Enter"&&n()}),(i=document.getElementById("auth-confirm"))==null||i.addEventListener("keypress",o=>{o.key==="Enter"&&n()}),t==null||t.addEventListener("click",async()=>{try{const o=await x.unlockWithBiometrics();await p.loadEncrypted(o),s()}catch(o){m.alert("Identificación",o.message)}}),x.isBioEnabled()&&setTimeout(async()=>{try{const o=await x.unlockWithBiometrics();await p.loadEncrypted(o),s()}catch{console.log("Auto-bio failed or cancelled")}},500)}const Ct="modulepreload",Lt=function(s){return"/life-dashboard/"+s},ye={},be=function(e,t,a){let n=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),r=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));n=Promise.allSettled(t.map(l=>{if(l=Lt(l),l in ye)return;ye[l]=!0;const u=l.endsWith(".css"),c=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":Ct,u||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),u)return new Promise((v,h)=>{d.addEventListener("load",v),d.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(o){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=o,window.dispatchEvent(r),!r.defaultPrevented)throw o}return n.then(o=>{for(const r of o||[])r.status==="rejected"&&i(r.reason);return e().catch(i)})};function Tt(){const s=x.isBioEnabled(),e=T.hasToken();return`
    ...
    `,document.body.appendChild(e);const t=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};t(),window.addEventListener("beforeinstallprompt",t),(a=document.getElementById("pwa-banner-install"))==null||a.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:i}=await window.deferredPrompt.userChoice;i==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(n=document.getElementById("pwa-banner-close"))==null||n.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function Ae(){const s=document.getElementById("bottom-nav");s.innerHTML=re(B),le(e=>{B=e,I=null,localStorage.setItem("life-dashboard/app_current_page",B),localStorage.setItem("life-dashboard/app_current_sub_page",I),V(),R(),s.innerHTML=re(B),le(t=>{B=t,I=null,localStorage.setItem("life-dashboard/app_current_page",B),localStorage.setItem("life-dashboard/app_current_sub_page",I),V(),R(),Ae()})}),Pt(),R()}function R(){const s=document.getElementById("main-content");if(I==="compound"){s.innerHTML=Ze(),Qe(()=>{I=null,et(),V(),R()});return}if(I==="expenses"){s.innerHTML=ft(),kt(()=>{I=null,V(),R()});return}if(I==="market"){s.innerHTML=tt(),st(()=>{I=null,V(),R()});return}switch(B){case"finance":s.innerHTML=de(),ue(),we();break;case"goals":s.innerHTML=ct(),ut();break;case"calendar":s.innerHTML=pt(),bt();break;case"health":s.innerHTML=nt(),lt();break;case"settings":s.innerHTML=Tt(),Rt(),W();break;default:s.innerHTML=de(),ue(),we()}}function we(){const s=document.getElementById("open-compound");s&&s.addEventListener("click",()=>{I="compound",localStorage.setItem("life-dashboard/app_current_sub_page",I),W(),R()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{I="market",localStorage.setItem("life-dashboard/app_current_sub_page",I),W(),R()});const t=document.getElementById("open-expenses");t&&t.addEventListener("click",()=>{I="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",I),W(),R()})}function Pt(){const s=document.querySelector(".fab");s&&s.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=g("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{if(B==="calendar")ge("event");else if(B==="health"){const t=await ns.confirm("Registrar Métrica","¿Qué deseas registrar hoy?","Peso","Grasa");if(t===!0){const a=await ns.prompt("Registrar Peso","Ingresa tu peso actual en kg:","","number");a&&p.addWeightLog(a)}else if(t===!1){const a=await ns.prompt("Grasa Corporal","Ingresa tu % de grasa:","","number");a&&p.addFatLog(a)}}else ge()}),document.body.appendChild(e)}function W(){const s=document.getElementById("main-fab");s&&(s.style.display="none")}function V(){const s=document.getElementById("main-fab");s&&(s.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",fe):fe();window.addEventListener("beforeinstallprompt",s=>{s.preventDefault(),window.deferredPrompt=s,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});
