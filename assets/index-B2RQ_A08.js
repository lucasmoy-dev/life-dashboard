var dt=Object.defineProperty;var ut=(a,e,s)=>e in a?dt(a,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[e]=s;var ue=(a,e,s)=>ut(a,typeof e!="symbol"?e+"":e,s);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();const pt="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",mt="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function vt(){var e,s,t,n,i,o,r,l,m,c,d,g,h,f,y;const a={EUR:1};try{const k=await(await fetch(pt)).json();a.BTC=((e=k.bitcoin)==null?void 0:e.eur)||4e4,a.ETH=((s=k.ethereum)==null?void 0:s.eur)||2200,a.XRP=((t=k.ripple)==null?void 0:t.eur)||.5,a.KAS=((n=k.kaspa)==null?void 0:n.eur)||.1,a.SOL=((i=k.solana)==null?void 0:i.eur)||90,a.XLM=((o=k.stellar)==null?void 0:o.eur)||.11,a.ALGO=((r=k.algorand)==null?void 0:r.eur)||.18,a.LTC=((l=k.litecoin)==null?void 0:l.eur)||65,a.SUI=((m=k.sui)==null?void 0:m.eur)||1.1,a.LINK=((c=k.chainlink)==null?void 0:c.eur)||14,a.RNDR=((d=k["render-token"])==null?void 0:d.eur)||4.5,a.ADA=((g=k.cardano)==null?void 0:g.eur)||.45,a.ONDO=((h=k["ondo-finance"])==null?void 0:h.eur)||.7,(f=k.bitcoin)!=null&&f.ars&&((y=k.bitcoin)!=null&&y.eur)&&(a.ARS=k.bitcoin.eur/k.bitcoin.ars);const I=await fetch(mt);if(I.ok){const E=await I.json();a.USD=1/E.rates.USD,a.CHF=1/E.rates.CHF,a.GBP=1/E.rates.GBP,a.AUD=1/E.rates.AUD}a.GOLD=2100,a.SP500=4700}catch(x){console.error("Failed to fetch some prices:",x),a.USD=a.USD||.92,a.CHF=a.CHF||1.05,a.GBP=a.GBP||1.15,a.AUD=a.AUD||.6,a.ARS=a.ARS||.001}return a}class H{static async hash(e,s="salt_life_dashboard_2026"){const n=new TextEncoder().encode(e+s),i=await crypto.subtle.digest("SHA-512",n);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,s){const t=new TextEncoder,n=await crypto.subtle.importKey("raw",t.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode(s),iterations:25e4,hash:"SHA-512"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,s){try{const t=crypto.getRandomValues(new Uint8Array(16)),n=crypto.getRandomValues(new Uint8Array(12)),i=await this.deriveKey(s,this.bufToBase64(t)),o=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(o),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},i,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(n),salt:this.bufToBase64(t),v:"5.0"}}catch(t){throw console.error("[Security] Encryption failed:",t),new Error("No se pudo encriptar la información")}}static async decrypt(e,s){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:t,iv:n,salt:i}=e,o=await this.deriveKey(s,i),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(n)},o,this.base64ToBuf(t)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(t){throw console.error("[Security] Decryption failed:",t),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(s=>s.charCodeAt(0)))}}const Te=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:H},Symbol.toStringTag,{value:"Module"})),M={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class S{static isSetup(){return!!localStorage.getItem(M.MASTER_HASH)}static async setup(e){const s=await H.hash(e),t=await H.deriveVaultKey(e);return localStorage.setItem(M.MASTER_HASH,s),sessionStorage.setItem(M.VAULT_KEY,t),t}static async unlock(e){const s=await H.hash(e),t=localStorage.getItem(M.MASTER_HASH);if(s===t){const n=await H.deriveVaultKey(e);return sessionStorage.setItem(M.VAULT_KEY,n),n}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const s=sessionStorage.getItem(M.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const t=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:t,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(M.BIO_ENABLED,"true"),localStorage.setItem(M.VAULT_KEY,s),!0}catch(t){throw console.error("Biometric setup failed:",t),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(M.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const s=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:s,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const t=localStorage.getItem(M.VAULT_KEY);if(t)return sessionStorage.setItem(M.VAULT_KEY,t),t;throw new Error("Llave no encontrada. Usa contraseña.")}catch(s){throw console.error("Biometric auth failed:",s),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(M.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(M.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(M.BIO_ENABLED)==="true"}}const xe="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",De=[71,79,67,83,80,88,45,112,121,52,68,109,80,83,107,45,100,75,55,99,73,66,116,106,65,81,75,90,70,75,118,95,66,87,95].map(a=>String.fromCharCode(a)).join(""),gt="https://www.googleapis.com/auth/drive.file";class j{static hasToken(){const e=!!this.accessToken;return localStorage.getItem("life-dashboard/drive_connected")==="true"&&e}static async init(){return this._initPromise?this._initPromise:(this._initPromise=new Promise((e,s)=>{const t=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.codeClient=google.accounts.oauth2.initCodeClient({client_id:xe,scope:gt,ux_mode:"popup",access_type:"offline",prompt:"consent",callback:async n=>{if(n.error){console.error("[Drive] Auth callback error:",n);return}if(n.code)try{const i=sessionStorage.getItem("life-dashboard/pkce_verifier"),o=localStorage.getItem("life-dashboard/drive_client_secret")||De,r=await this.exchangeCodeForTokens(n.code,i,xe,o);r.refresh_token&&await this.saveRefreshToken(r.refresh_token),this.saveSession(r),console.log("[Drive] Connected successfully via offline flow."),window.ns&&window.ns.toast("Google Drive vinculado"),typeof window.reRender=="function"&&window.reRender()}catch(i){console.error("[Drive] Token exchange error:",i),window.ns&&window.ns.alert("Error Auth","No se pudieron obtener tokens. Verifica el Client Secret.")}}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&this.ensureValidToken().catch(n=>{console.log("[Drive] Initial silent restoration skipped:",n.message)}),e(!0)}catch(n){console.error("[Drive] Init error:",n),s(n)}}):setTimeout(t,200)};t()}),this._initPromise)}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const s=e.expires_in||3600,t=Date.now()+s*1e3;localStorage.setItem("life-dashboard/drive_token_expiry",t.toString())}static async authenticate(){this.codeClient||await this.init();const{verifier:e}=await this.generatePKCE();sessionStorage.setItem("life-dashboard/pkce_verifier",e),this.codeClient.requestCode()}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(!(localStorage.getItem("life-dashboard/drive_connected")==="true"))return null;if(!this.accessToken||Date.now()>e-3e5){console.log("[Drive] Access token expired or near expiry, attempting refresh...");const n=await this.getRefreshToken();if(n)try{const i=localStorage.getItem("life-dashboard/drive_client_secret")||De,o=await this.refreshAccessToken(n,xe,i),r={access_token:o.access_token,expires_in:o.expires_in,refresh_token:o.refresh_token||n};return o.refresh_token&&await this.saveRefreshToken(o.refresh_token),this.saveSession(r),this.accessToken}catch(i){throw console.error("[Drive] Token refresh failed:",i),new Error("Sesión de Google Drive expirada. Por favor reconecta en Configuración.")}else throw console.warn("[Drive] No refresh token found."),new Error("Google Drive no está vinculado para acceso offline.")}return this.accessToken&&(!gapi.client.getToken()||gapi.client.getToken().access_token!==this.accessToken)&&gapi.client.setToken({access_token:this.accessToken}),this.accessToken}static async generatePKCE(){const e=Array.from(crypto.getRandomValues(new Uint8Array(32))).map(o=>("0"+o.toString(16)).slice(-2)).join(""),t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t),i=btoa(String.fromCharCode(...new Uint8Array(n))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return{verifier:e,challenge:i}}static async exchangeCodeForTokens(e,s,t,n=null){const i=new URLSearchParams({client_id:t,code:e,grant_type:"authorization_code",redirect_uri:"postmessage"});s&&!n&&i.append("code_verifier",s),n&&i.append("client_secret",n);const o=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:i});if(!o.ok){const r=await o.json();throw new Error(r.error_description||"Failed to exchange code")}return await o.json()}static async refreshAccessToken(e,s,t=null){const n=new URLSearchParams({client_id:s,refresh_token:e,grant_type:"refresh_token"});t&&n.append("client_secret",t);const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n});if(!i.ok){const o=await i.json();throw new Error(o.error_description||"Failed to refresh token")}return await i.json()}static async saveRefreshToken(e){return new Promise((s,t)=>{const n=indexedDB.open("LifeDashboardAuthDB",1);n.onupgradeneeded=i=>{const o=i.target.result;o.objectStoreNames.contains("tokens")||o.createObjectStore("tokens")},n.onsuccess=i=>{const r=i.target.result.transaction("tokens","readwrite");r.objectStore("tokens").put(e,"drive_refresh_token"),r.oncomplete=()=>s(),r.onerror=l=>t(l)},n.onerror=i=>t(i)})}static async getRefreshToken(){return new Promise((e,s)=>{const t=indexedDB.open("LifeDashboardAuthDB",1);t.onupgradeneeded=n=>{const i=n.target.result;i.objectStoreNames.contains("tokens")||i.createObjectStore("tokens")},t.onsuccess=n=>{const i=n.target.result;if(!i.objectStoreNames.contains("tokens")){e(null);return}const l=i.transaction("tokens","readonly").objectStore("tokens").get("drive_refresh_token");l.onsuccess=()=>e(l.result),l.onerror=m=>s(m)},t.onerror=n=>s(n)})}static async clearTokens(){return localStorage.removeItem("life-dashboard/drive_access_token"),localStorage.removeItem("life-dashboard/drive_connected"),localStorage.removeItem("life-dashboard/drive_token_expiry"),new Promise(e=>{const s=indexedDB.open("LifeDashboardAuthDB",1);s.onsuccess=t=>{const n=t.target.result;if(n.objectStoreNames.contains("tokens")){const i=n.transaction("tokens","readwrite");i.objectStore("tokens").clear(),i.oncomplete=()=>e()}else e()},s.onerror=()=>e()})}static async getOrCreateFolderPath(e){var n;await this.ensureValidToken(),(n=gapi.client)!=null&&n.drive||await this.init();const s=e.split("/").filter(i=>i);let t="root";for(const i of s){const o=`name = '${i}' and mimeType = 'application/vnd.google-apps.folder' and '${t}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)"})).result.files;if(l&&l.length>0)t=l[0].id;else{const m={name:i,mimeType:"application/vnd.google-apps.folder",parents:[t]};t=(await gapi.client.drive.files.create({resource:m,fields:"id"})).result.id}}return t}static async pushData(e,s,t=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pushing encrypted data...${t?" (Retry)":""}`);const n=await this.getOrCreateFolderPath("/backup/life-dashboard/"),i=await H.encrypt(e,s),o="dashboard_vault_v5.bin",r=`name = '${o}' and '${n}' in parents and trashed = false`,m=(await gapi.client.drive.files.list({q:r,fields:"files(id)"})).result.files,c=new Blob([JSON.stringify(i)],{type:"application/json"});if(m&&m.length>0){const d=m[0].id,g=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${d}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:c});if(g.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,s,!0);if(!g.ok)throw new Error(`Error al actualizar backup: ${g.status}`)}else{const d={name:o,parents:[n]},g=new FormData;g.append("metadata",new Blob([JSON.stringify(d)],{type:"application/json"})),g.append("file",c);const h=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:g});if(h.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,s,!0);if(!h.ok)throw new Error(`Error al crear backup: ${h.status}`)}return!0}catch(n){throw console.error("[Drive] Push failed:",n),new Error(n.message||"Fallo al subir datos a Drive")}}static async pullData(e,s=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pulling data...${s?" (Retry)":""}`);const i=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,r=(await gapi.client.drive.files.list({q:i,fields:"files(id, name)"})).result.files;if(!r||r.length===0)return null;const l=r[0].id,m=await fetch(`https://www.googleapis.com/drive/v3/files/${l}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(m.status===401&&!s)return await this.ensureValidToken(),await this.pullData(e,!0);if(!m.ok)throw new Error(`Error al descargar backup: ${m.status}`);const c=await m.json();return await H.decrypt(c,e)}catch(t){throw console.error("[Drive] Pull failed:",t),new Error(t.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");const t=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,i=(await gapi.client.drive.files.list({q:t,fields:"files(id)"})).result.files;if(i&&i.length>0){const o=i[0].id;return await gapi.client.drive.files.delete({fileId:o}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(e){throw console.error("[Drive] Deletion failed:",e),new Error(e.message||"Fallo al borrar backup en Drive")}}}ue(j,"codeClient",null),ue(j,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null),ue(j,"_initPromise",null);const Me={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',chevronUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>',chevronDown:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',uploadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12V21"/><path d="m16 16-4-4-4 4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>',moreVertical:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>',check:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',menu:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>',users:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',messageSquare:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',phone:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',instagram:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>',facebook:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>',linkedin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>',alertCircle:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>',fingerprint:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 15.1a7 7 0 0 0 10.9 0"/><path d="M6 13.6a7 7 0 0 0 4.6 2.4"/><path d="M13.4 16a7 7 0 0 0 4.6-2.4"/><path d="M8 12.1a5 5 0 0 0 6.9 0"/><path d="M9.1 11a3 3 0 0 0 3.9 0"/><path d="M12 18.5V20"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',palette:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.555C21.965 6.012 17.461 2 12 2z"/></svg>',star:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',eye:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>',eyeOff:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.52 13.52 0 0 0 2 12c0 0 3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><line x1="2" x2="22" y1="2" y2="22"/></svg>',play:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg>',pause:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>',clock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',barChart2:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>',brain:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 4.44-2.54Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-4.44-2.54Z"/></svg>',rocket:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-5c1.62-2.2 5-3 5-3"/><path d="M12 15v5s3.03-.55 5-2c2.2-1.62 3-5 3-5"/></svg>',coffee:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>',bookOpen:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>',dumbbell:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6.5 6.5 11 11"/><path d="m21 21-1-1"/><path d="m3 3 1 1"/><path d="m18 22 4-4"/><path d="m2 6 4-4"/><path d="m3 10 7-7"/><path d="m14 21 7-7"/></svg>',code:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',music:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>',monitor:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" x2="16" y1="21" y2="21"/><line x1="12" x2="12" y1="17" y2="21"/></svg>'};function p(a,e=""){return(Me[a]||Me.package).replace("<svg",`<svg class="${e}"`)}class ht{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,s="success",t=3e3){const n=document.createElement("div");n.className=`toast toast-${s} stagger-in`;const i=s==="success"?"check":s==="error"?"alertCircle":"info";n.innerHTML=`
          ...
          <div class="form-group" style="flex: 1;">
              ...
              <select class="form-input form-select" id="edit-currency">
                  <optgroup label="Divisas">
                      ${Et.map(i=>`<option value="${i.value}" ${i.value===a.currency?"selected":""}>${i.label}</option>`).join("")}
                  </optgroup>
                  ${s?`
  ...
  `}function It(a){const e=document.getElementById("edit-modal"),s=document.getElementById("edit-modal-close"),t=document.getElementById("btn-update"),n=document.getElementById("btn-delete");e.addEventListener("click",i=>{i.target===e&&ve()}),s.addEventListener("click",ve),t.addEventListener("click",()=>Lt(a)),n.addEventListener("click",()=>At(a))}function Lt(a){var m,c,d,g,h,f,y,x,k;const e=(c=(m=document.getElementById("edit-name"))==null?void 0:m.value)==null?void 0:c.trim(),s=(d=document.getElementById("edit-type"))==null?void 0:d.value,t=(g=document.getElementById("edit-currency"))==null?void 0:g.value,n=(f=(h=document.getElementById("edit-details"))==null?void 0:h.value)==null?void 0:f.trim(),i=parseFloat((y=document.getElementById("edit-value"))==null?void 0:y.value)||0,o=parseFloat((x=document.getElementById("edit-amount"))==null?void 0:x.value)||0,r=parseFloat((k=document.getElementById("edit-monthly"))==null?void 0:k.value)||0;if(!e){v.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:s,currency:t,details:n};a.fields.includes("value")&&(l.value=i),a.fields.includes("amount")&&(l.amount=o),a.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),a.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),u[a.updateMethod](ce.id,l),ve()}function At(a){v.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${ce.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(u[a.deleteMethod](ce.id),v.toast("Eliminado correctamente","info"),ve())})}function ve(){const a=document.getElementById("edit-modal");a&&(a.classList.remove("active"),setTimeout(()=>a.remove(),300)),ce=null,ee=null}let te=!1,se=!1,$={key:"price",direction:"desc"},ne="USD",N=null;function Ct(){const a=u.getState(),e=a.lastMarketData||[],s=a.marketFavorites||[];N===null&&(N=s.length>0?"favorites":"all"),!se&&!te&&Rt();const t=ne==="EUR"?"€":"$";let n=e;N==="favorites"&&(n=e.filter(o=>s.includes(o.id)));const i=Object.values(b);return`
        <div class="market-view animate-fade-in" style="padding: 4px;">
            ...
            <!-- Content -->
            ${n.length===0&&N==="favorites"?Mt():""}
            ${n.length===0&&N==="all"?Bt():""}
            
            ${i.map(o=>{const r=n.filter(l=>l.category===o);return r.length===0?"":Tt(o,r,t,s)}).join("")}
        </div>
    `}function Tt(a,e,s,t){const n=[...e].sort((i,o)=>{let r=i[$.key],l=o[$.key];return typeof r=="string"&&(r=r.toLowerCase()),typeof l=="string"&&(l=l.toLowerCase()),r<l?$.direction==="asc"?-1:1:r>l?$.direction==="asc"?1:-1:0});return`
            ...
            <div class="card market-table-card" style="padding: 0 !important; overflow: hidden; background: rgba(10, 15, 30, 0.4); border: 1px solid rgba(255,255,255,0.05); box-shadow: 0 4px 20px rgba(0,0,0,0.2);">
                <div class="table-container">
                    <table class="market-table">
                        ...
                        <tbody>
                            ${n.map(i=>Dt(i,s,t.includes(i.id))).join("")}
                        </tbody>
                    </table>
                </div>
            </div>
        </div>
    `}function Dt(a,e,s){let t=a.price;if(a.price!==null&&ne==="EUR"){const r=u.getState().rates.USD||.92;t=a.price*r}const n=Ee(a.change24h),i=Ee(a.change30d),o=Ee(a.change1y);return`
    ...
    `}function Ee(a){return a==null?"":te?a>=0?"text-positive":"text-negative":"text-accent-primary"}function Mt(){return`
    ...
    `}function jt(a,e){const s=e.currencySymbol,t=a.cost*(a.dividendYield/100)/12,n=u.convertValue(t,a.currency||e.currency);return`
    ...
    `}function Ut(){var s;(s=document.getElementById("btn-add-wealth-goal"))==null||s.addEventListener("click",async()=>{_e()}),document.querySelectorAll(".edit-wealth-goal").forEach(t=>{t.addEventListener("click",n=>{n.stopPropagation();const i=t.dataset.id,o=u.getState().wealthGoals.find(r=>r.id===i);o&&_e(o)})}),document.querySelectorAll(".delete-wealth-goal").forEach(t=>{t.addEventListener("click",async n=>{var r;n.stopPropagation();const i=t.dataset.id;await v.confirm("Eliminar objetivo","¿Estás seguro de que deseas eliminar este objetivo?")&&(u.deleteWealthGoal(i),(r=window.reRender)==null||r.call(window))})}),document.querySelectorAll(".reorder-wealth-goal").forEach(t=>{t.addEventListener("click",n=>{var r;n.stopPropagation();const i=t.dataset.id,o=t.dataset.dir;u.reorderWealthGoals(i,o),(r=window.reRender)==null||r.call(window)})});const a=document.getElementById("inflation-slider");a&&a.addEventListener("change",t=>{var n;u.setInflationRate(t.target.value),(n=window.reRender)==null||n.call(window)});const e=document.getElementById("years-slider");e&&e.addEventListener("change",t=>{var n;u.setProjectionYears(t.target.value),(n=window.reRender)==null||n.call(window)})}async function _e(a=null){const e=!!a,s=e?"Editar Objetivo":"Nuevo Objetivo Patrimonial",t=document.createElement("div");t.className="modal-overlay active overlay-centered",t.innerHTML=`
    ...
    <div class="finance-page stagger-children" style="padding-bottom: 80px;">
      ...
      ${P==="summary"?Ot(a,e):P==="goals"?_t():Ct()}
      
    </div>
  `}function Ot(a,e){const s=u.getPassiveIncome(),t=u.getLivingExpenses(),n=u.getNetPassiveIncome(),i=u.getInvestmentAssetsValue(),o=u.getTotalLiabilities(),r=u.getNetWorth(),l=u.getAllIncomes(),m=u.getAllExpenses(),c=u.getNetIncome();return`
  ...
  `}function Gt(a){const e=[...(a.activeIncomes||[]).map(t=>({...t,category:"activeIncome"})),...a.passiveAssets.map(t=>({...t,category:"passive"})),...a.investmentAssets.map(t=>({...t,category:"investment"})),...a.liabilities.map(t=>({...t,category:"liability"}))];if(e.length===0)return`
      <div class="empty-state">
    ...
    <div class="asset-list">
      ${e.map(t=>{const n=Ft(t.currency||t.type),i=qt(t.currency||t.type),o=t.category==="liability",r=t.value||t.amount||0,l=u.convertValue(r,t.currency||"EUR");let m="";if(t.currency!==a.currency){const d={EUR:"€",USD:"$",BTC:"₿",ETH:"Ξ",XRP:"✕",GOLD:"oz",SP500:"pts",CHF:"Fr",GBP:"£",AUD:"A$",ARS:"$"}[t.currency]||t.currency;m=`<div class="asset-original-value">${r} ${d}</div>`}return`
  ...
  `}function Ft(a){return{property:"property",rental:"property",stocks:"stocks",etf:"stocks",SP500:"stocks",crypto:"crypto",BTC:"crypto",ETH:"crypto",XRP:"crypto",GOLD:"investment",cash:"cash",USD:"cash",EUR:"cash",savings:"cash",vehicle:"vehicle",debt:"debt",loan:"debt",mortgage:"debt",creditcard:"debt",salary:"cash",freelance:"cash",business:"property"}[a]||"cash"}function qt(a){return{property:"building",rental:"building",stocks:"trendingUp",etf:"trendingUp",SP500:"trendingUp",crypto:"bitcoin",BTC:"bitcoin",ETH:"bitcoin",XRP:"bitcoin",GOLD:"package",cash:"dollarSign",USD:"dollarSign",EUR:"dollarSign",savings:"piggyBank",vehicle:"car",debt:"creditCard",loan:"landmark",mortgage:"home",creditcard:"creditCard",salary:"briefcase",freelance:"users",business:"building"}[a]||"dollarSign"}function Ue(){const a=document.getElementById("tab-summary"),e=document.getElementById("tab-markets"),s=document.getElementById("tab-goals");if(a&&e&&s&&(a.addEventListener("click",()=>{var o;P="summary",(o=window.reRender)==null||o.call(window)}),e.addEventListener("click",()=>{var o;P="markets",(o=window.reRender)==null||o.call(window)}),s.addEventListener("click",()=>{var o;P="goals",(o=window.reRender)==null||o.call(window)})),P==="markets"){Pt();return}if(P==="goals"){Ut();return}document.querySelectorAll(".asset-item").forEach(o=>{o.addEventListener("click",()=>{const r=o.dataset.id,l=o.dataset.category;Xe(r,l)})});const n=document.getElementById("toggle-real-estate");n&&n.addEventListener("change",()=>{u.toggleRealEstate()});const i=document.getElementById("display-currency-select");i&&i.addEventListener("change",o=>{u.setCurrency(o.target.value)})}let V=10,W=7,J=null,Z=null;function Ht(){const e=u.getState().currencySymbol,s=u.getNetWorth(),n=u.getNetIncome()*12,i=J!==null?J:s,o=Z!==null?Z:n,r=Je(i,o,W,V);return`
  ...
  `}function Qe(a,e){const s=[];for(let t=0;t<a.length;t++){const n=a[t];(t<5||(t+1)%5===0||t===a.length-1)&&s.push(n)}return`
    <div class="table-container">
  ...
  `}function Vt(a){const e=document.getElementById("back-to-finance"),s=document.getElementById("rate-slider"),t=document.getElementById("years-slider"),n=document.getElementById("principal-input"),i=document.getElementById("contribution-input"),o=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",a),n&&n.addEventListener("input",l=>{J=parseFloat(l.target.value)||0,Q()}),i&&i.addEventListener("input",l=>{Z=parseFloat(l.target.value)||0,Q()}),o&&o.addEventListener("click",()=>{J=null;const l=u.getNetWorth();n.value=l,Q()}),r&&r.addEventListener("click",()=>{Z=null;const l=u.getNetIncome()*12;i.value=l,Q()}),s&&s.addEventListener("input",l=>{W=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${W}%`,Q()}),t&&t.addEventListener("input",l=>{V=parseInt(l.target.value),document.getElementById("years-value").textContent=`${V} años`,Q()})}function Q(){const e=u.getState().currencySymbol,s=J!==null?J:u.getNetWorth(),t=Z!==null?Z:u.getNetIncome()*12,n=Je(s,t,W,V),i=document.getElementById("future-value"),o=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),m=document.getElementById("total-contributed"),c=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),g=document.getElementById("projection-chart"),h=document.getElementById("projection-table");i&&(i.textContent=w(n.finalValue,e)),o&&(o.textContent=`Valor Futuro en ${V} años`),r&&(r.innerHTML=`${n.totalGrowth>=0?"📈":"📉"} ${n.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=w(s,e)),m&&(m.textContent=w(n.totalContributions,e),m.className=`stat-value ${n.totalContributions>=0?"positive":"negative"}`),c&&(c.textContent=w(n.totalInterest,e)),d&&(d.textContent=w(n.finalValue,e)),g&&(g.innerHTML=Ze(n.yearlyBreakdown)),h&&(h.innerHTML=Qe(n.yearlyBreakdown,e))}function zt(){V=10,W=7,J=null,Z=null}let re=u.getState().lastMarketData||[],le=!1,L={key:"price",direction:"desc"},et="";function Kt(){const a=u.getState(),e=a.currency||"EUR",s=a.currencySymbol||"€";if((re.length===0||et!==e)&&(le||tt(),re.length===0))return`
        ...
        <div class="market-page stagger-children" style="padding-bottom: 80px;">
            ...
            ${t.map(n=>{const i=re.filter(o=>o.category===n);return i.length===0?"":Yt(n,i,s)}).join("")}
        </div>
    `}function Yt(a,e,s){const t=[...e].sort((n,i)=>{let o=n[L.key],r=i[L.key];return typeof o=="string"&&(o=o.toLowerCase()),typeof r=="string"&&(r=r.toLowerCase()),o<r?L.direction==="asc"?-1:1:o>r?L.direction==="asc"?1:-1:0});return`
            ...
            <div class="card market-table-card" style="padding: 0 !important; overflow: hidden; background: rgba(22, 33, 62, 0.4);">
                <div class="table-container market-table-container">
                    <table class="market-table">
                        <thead>
                            <tr>
                                <th data-sort="name" class="${L.key==="name"?"active "+L.direction:""}" style="padding-left: var(--spacing-md);">Activo</th>
                                <th data-sort="price" class="${L.key==="price"?"active "+L.direction:""}">Precio</th>
                                <th data-sort="change24h" class="${L.key==="change24h"?"active "+L.direction:""}">24h</th>
                                <th data-sort="change30d" class="${L.key==="change30d"?"active "+L.direction:""}" style="padding-right: var(--spacing-md);">30d</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${t.map(n=>`
                        ...
                        <div class="ex-health-main">
                            ...
                            <div class="ex-health-info">
                                ...
                                <div class="ex-health-stats">
                                    ...
                                    ${i.lastLog?`
                                        <span style="opacity: 0.3;">•</span>
                                        <span class="last-effort-badge-emoji" title="Último esfuerzo">${ea(i.lastLog.rating)}</span>
                                    `:""}
                                </div>
                            </div>
                        </div>
    ...
    `}function Zt(a){return`
      ...
      <div class="ai-calorie-card-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--spacing-md); margin-bottom: var(--spacing-2xl);">
          <div class="card ai-calorie-card" style="display: flex; flex-direction: column; align-items: center;">
              <div class="summary-value" style="font-size: 24px;">${ta(a)} kcal</div>
    ...
    `}function Qt(a){const e=[...a.weightLogs||[]].sort((O,we)=>O.date-we.date);if(e.length<1||!a.weightGoalDate)return`
        ...
        `;const s=e[0],t=e[e.length-1],n=s.date,i=new Date(a.weightGoalDate).getTime(),o=Date.now(),l=Math.max(i,o)-n,m=e.map(O=>O.weight),c=Math.min(...m,a.weightGoal)-2,g=Math.max(...m,s.weight)+2-c,h=300,f=150,y=O=>(O-n)/l*h,x=O=>f-(O-c)/g*f,k=y(i),I=x(a.weightGoal),E=y(n),B=x(s.weight),D=e.map((O,we)=>`${we===0?"M":"L"} ${y(O.date)} ${x(O.weight)}`).join(" "),R=y(o),z=i-n,K=o-n,rt=Math.min(1,K/z),lt=s.weight-(s.weight-a.weightGoal)*rt,be=t.weight-lt,Ae=a.weightGoal<s.weight?be<0:be>0,Ce=z/(1e3*60*60*24*7),ct=Ce>0?(s.weight-a.weightGoal)/Ce:0;return`
    <div class="card chart-card" style="margin-bottom: var(--spacing-lg);">
        <div class="card-header">
            <span class="card-title">Trayectoria de Peso</span>
            <span class="badge ${Ae?"badge-success":"badge-danger"}" style="font-size: 10px;">
                ${Ae?"Vas bien":"Por debajo del ritmo"} (${Math.abs(be).toFixed(1)}kg)
            </span>
        </div>
  ...
  `}function ia(a,e){return a.length===0?`
      ...
      <div class="calendar-top-layout">
        ...
        <div class="card calendar-view-card">
            <div class="calendar-mini-header">
                ...
                <span class="current-month">${da()}</span>
  ...
  `}function ha(a,e){if(a.length===0)return`
            <div class="empty-state">
        ...
        <div class="asset-list">
            ${a.map(t=>{const n=u.convertValue(t.amount,t.currency||"EUR"),i=ya(t.category);return`
    ...
    `}function ya(a){switch(a){case"liability":return"landmark";case"livingExpense":return"shoppingCart";default:return"creditCard"}}function fa(a){const e=document.getElementById("back-to-finance");e&&e.addEventListener("click",a),document.querySelectorAll(".expense-item").forEach(t=>{t.addEventListener("click",()=>{const n=t.dataset.id,i=t.dataset.category;Xe(n,i)})})}const ba="modulepreload",wa=function(a){return"/life-dashboard/"+a},Ne={},ge=function(e,s,t){let n=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),r=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));n=Promise.allSettled(s.map(l=>{if(l=wa(l),l in Ne)return;Ne[l]=!0;const m=l.endsWith(".css"),c=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${c}`))return;const d=document.createElement("link");if(d.rel=m?"stylesheet":ba,m||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),m)return new Promise((g,h)=>{d.addEventListener("load",g),d.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(o){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=o,window.dispatchEvent(r),!r.defaultPrevented)throw o}return n.then(o=>{for(const r of o||[])r.status==="rejected"&&i(r.reason);return e().catch(i)})};function xa(){const a=S.isBioEnabled(),e=j.hasToken();return`
    ...
    `}function Ia(a){const e=a.lastContact?Math.floor((Date.now()-new Date(a.lastContact).getTime())/864e5):null,s=a.color||"#3b82f6";return`
    ...
    `}function La(){window.socialListenersAttached||(window.socialListenersAttached=!0,document.addEventListener("click",a=>{const e=a.target.closest(".col-opts-btn");if(e){a.preventDefault(),a.stopPropagation(),Ma(e.dataset.id,e);return}if(a.target.closest("#add-social-col-btn")){Aa();return}if(a.target.closest("#add-person-btn")){window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person"}}));return}if(a.target.closest("#ideal-lead-btn")){Ca();return}if(a.target.closest("#communications-mgr-btn")){ge(()=>import("./CommunicationsModal-DCZJAQUO.js"),[]).then(n=>n.openCommunicationsModal());return}if(a.target.closest("#contact-sources-btn")){Ra();return}const s=a.target.closest(".person-chat-btn");if(s){a.preventDefault(),a.stopPropagation(),ge(()=>import("./CommunicationsModal-DCZJAQUO.js"),[]).then(n=>n.openCommunicationsModal(s.dataset.id));return}const t=a.target.closest(".person-card");if(t){Ta(t.dataset.id);return}}),document.addEventListener("dragstart",a=>{const e=a.target.closest(".person-card");e&&(a.dataTransfer.setData("text/plain",e.dataset.id),e.classList.add("dragging"))}),document.addEventListener("dragend",a=>{const e=a.target.closest(".person-card");e&&e.classList.remove("dragging")}),document.addEventListener("dragover",a=>{const e=a.target.closest(".kanban-cards");e&&(a.preventDefault(),e.classList.add("drag-over"))}),document.addEventListener("dragleave",a=>{const e=a.target.closest(".kanban-cards");e&&e.classList.remove("drag-over")}),document.addEventListener("drop",a=>{const e=a.target.closest(".kanban-cards");if(e){a.preventDefault(),e.classList.remove("drag-over");const s=a.dataTransfer.getData("text/plain"),t=e.dataset.colId;s&&t&&u.movePerson(s,t)}}))}async function Aa(){const a=await v.prompt("Etapa","Nombre de la etapa:");a&&(u.addSocialColumn({name:a,color:"#94a3b8"}),v.toast("Etapa agregada correctamente","success"))}async function Ca(){const a=u.getState().social.idealLeadProfile||"",e=await Da(a);e!==null&&(u.updateIdealLeadProfile(e),v.toast("Perfil Ideal actualizado"))}function Ta(a){const e=u.getState().social.people.find(s=>s.id===a);e&&window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person",person:e}}))}function Da(a){return new Promise(e=>{const s=document.createElement("div");s.className="modal-overlay active",s.style.zIndex="9999",s.innerHTML=`
            <div class="modal">
                <div class="modal-header">
        ...
        `,document.body.appendChild(s);const t=()=>{s.remove(),e(null)};s.querySelector(".modal-close").addEventListener("click",t),s.querySelector("#save-ideal-lead").addEventListener("click",()=>{const n=s.querySelector("#ideal-lead-text").value;s.remove(),e(n)}),s.addEventListener("click",n=>{n.target===s&&t()})})}function Ma(a,e){document.querySelectorAll(".column-options-menu").forEach(o=>o.remove());const s=u.getState().social.columns.find(o=>o.id===a);if(!s)return;const t=document.createElement("div");t.className="column-options-menu",t.innerHTML=`
    ...
    `;const n=e.getBoundingClientRect();t.style.position="fixed",t.style.top=`${n.bottom+8}px`,t.style.right=`${window.innerWidth-n.right}px`,t.style.zIndex="9999",document.body.appendChild(t),t.querySelectorAll(".menu-item").forEach(o=>{o.addEventListener("click",async()=>{const r=o.dataset.action;if(t.remove(),r==="edit"){const l=await v.prompt("Nombre de Columna","Nuevo nombre:",s.name);l!=null&&l.trim()&&u.updateSocialColumn(a,{name:l.trim()})}else if(r==="color"){const l=await Ba(s.color);l&&u.updateSocialColumn(a,{color:l})}else if(r==="delete")await v.confirm("Eliminar Etapa",`¿Eliminar "${s.name}"?`)&&u.deleteSocialColumn(a);else if(r==="move_up"||r==="move_down"){const l=[...u.getState().social.columns].sort((d,g)=>d.order-g.order),m=l.findIndex(d=>d.id===a);if(m===-1)return;const c=r==="move_up"?m-1:m+1;c>=0&&c<l.length&&([l[m].order,l[c].order]=[l[c].order,l[m].order],u.reorderSocialColumns(l))}})});const i=o=>{!t.contains(o.target)&&o.target!==e&&(t.remove(),document.removeEventListener("click",i))};setTimeout(()=>document.addEventListener("click",i),10)}function Ba(a){return new Promise(e=>{const s=document.createElement("div");s.className="modal-overlay active",s.style.zIndex="99999",s.innerHTML=`
        ...
        `,document.body.appendChild(s);const t=()=>{s.remove(),e(null)};s.querySelector(".modal-close").addEventListener("click",t),s.querySelector("#save-contact-sources").addEventListener("click",()=>{const i=s.querySelector("#contact-sources-text").value.split(",").map(o=>o.trim()).filter(o=>o.length>0);s.remove(),e(i)}),s.addEventListener("click",n=>{n.target===s&&t()})})}let de="tracker",T=null,fe=!1,ae=null;function _a(){const a=u.getState(),{activities:e=[],logs:s=[]}=a.timeInvest||{};return`
    ...
    `}function ja(a,e){var s;if(ae){const t=a.find(n=>n.id===ae);if(t&&((s=t.subActivities)==null?void 0:s.length)>0)return Ua(t)}return de==="tracker"?Oa(a):Na(a,e)}function Ua(a){return`
    ...
    `}function Na(a,e){const s=[];for(let c=6;c>=0;c--){const d=new Date;d.setDate(d.getDate()-c),s.push(d.toISOString().split("T")[0])}const t=["Dom","Lun","Mar","Mié","Jue","Vie","Sáb"],n=s.map(c=>{const d=e.filter(h=>h.date.startsWith(c)),g={};return d.forEach(h=>{g[h.activityId]=(g[h.activityId]||0)+(h.durationMinutes||0)}),g}),i=Math.max(...n.flatMap(c=>Object.values(c)),60),o=150,r=300,l=r/6,m=c=>n.map((d,g)=>{const h=d[c]||0,f=g*l,y=o-h/i*o;return`${g===0?"M":"L"} ${f} ${y}`}).join(" ");return`
    ...
    `}function Ga(a){var n;const e=a.find(i=>i.id===T.activityId),s=(n=e==null?void 0:e.subActivities)==null?void 0:n.find(i=>i.id===T.subActivityId),t=at(T.elapsedSeconds);return`
  ...
  `}function st(){const a=Le[C],e=C==="investmentAsset"||C==="passiveAsset";if(e){const t=Y.map(n=>({value:n.symbol,label:`${n.name} (${n.symbol})`}));[...He,...t]}let s="";return C==="passiveAsset"||C==="investmentAsset"?s=`
  ...
  `}function Ya(a){const e=a.querySelector("#person-modal-close"),s=a.querySelector("#btn-save-person-lead"),t=a.querySelector("#btn-delete-person"),n=a.querySelector("#person-rating-slider"),i=a.querySelector("#rating-value");if(a.addEventListener("click",l=>{l.target===a&&(console.log("[LeadModal] Overlay clicked, closing"),ye(a))}),e==null||e.addEventListener("click",()=>{console.log("[LeadModal] Close button clicked"),ye(a)}),n&&i){const l=()=>{console.log("[LeadModal] Slider updated:",n.value),i.textContent=n.value};n.oninput=l,n.onchange=l}s&&(s.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Save button clicked"),Xa(a)}),t&&(t.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Delete button clicked"),Wa(a)});const o=a.querySelectorAll(".goal-color-dot"),r=a.querySelector("#person-color-value");o.forEach(l=>{l.addEventListener("click",()=>{o.forEach(m=>m.classList.remove("active")),l.classList.add("active"),r&&(r.value=l.dataset.color),console.log("[LeadModal] Color selected:",l.dataset.color)})})}async function Wa(a){X&&await v.confirm("Eliminar Lead","¿Estás seguro de eliminar este lead?")&&(u.deletePerson(X),v.toast("Lead eliminado","success"),ye(a))}function Xa(a){var s,t,n,i,o,r,l,m,c,d,g,h,f;const e=a.querySelector("#btn-save-person-lead");if(e.disabled){console.log("[LeadModal] Save ignored, already processing");return}try{const y=(t=(s=a.querySelector("#person-name"))==null?void 0:s.value)==null?void 0:t.trim(),x=(i=(n=a.querySelector("#person-phone"))==null?void 0:n.value)==null?void 0:i.trim(),k=(r=(o=a.querySelector("#person-city"))==null?void 0:o.value)==null?void 0:r.trim(),I=(l=a.querySelector("#person-source"))==null?void 0:l.value,E=(m=a.querySelector("#person-rating-slider"))==null?void 0:m.value,B=(d=(c=a.querySelector("#person-desc"))==null?void 0:c.value)==null?void 0:d.trim(),D=(g=a.querySelector("#person-column"))==null?void 0:g.value,R=(h=a.querySelector("#person-color-value"))==null?void 0:h.value,z=(f=a.querySelector("#person-last-contact"))==null?void 0:f.value;if(console.log("[LeadModal] Attempting to save",{name:y,rating:E,columnId:D,color:R,lastContact:z}),!y){console.warn("[LeadModal] Save failed: Missing name"),v.toast("El nombre es obligatorio","error");return}e.disabled=!0,e.innerHTML='<span class="loading-spinner-sm"></span> Guardando...';const K={name:y,phone:x,city:k,source:I,rating:parseInt(E)||5,description:B,columnId:D,color:R,lastContact:z};X?(console.log("[LeadModal] Updating person",X),u.updatePerson(X,K),v.toast("Lead actualizado correctamente","success")):(console.log("[LeadModal] Adding new person"),u.addPerson(K),v.toast("Lead guardado correctamente","success")),console.log("[LeadModal] Save successful, closing modal"),ye(a)}catch(y){console.error("[LeadModal] Error saving lead:",y),v.toast("Error al guardar el lead","error"),e.disabled=!1,e.innerHTML=`${p("plus")} Lead`}}function ye(a){a&&(console.log("[LeadModal] Closing modal"),a.classList.remove("active"),setTimeout(()=>{a.parentNode&&(console.log("[LeadModal] Removing modal from DOM"),a.remove())},400))}function Ja(){const a=S.isSetup(),e=S.isBioEnabled();return`
    ...
    `}function Za(a){var i;const e=document.getElementById("auth-submit-btn"),s=document.getElementById("auth-bio-btn"),t=document.getElementById("auth-password"),n=async()=>{const o=t.value,r=document.getElementById("auth-confirm"),l=S.isSetup();try{let m;if(l)m=await S.unlock(o);else{if(!o||o.length<4)throw new Error("Contraseña demasiado corta");if(o!==r.value)throw new Error("Las contraseñas no coinciden");m=await S.setup(o)}await u.loadEncrypted(m),a()}catch(m){v.alert("Error",m.message)}};e==null||e.addEventListener("click",n),t==null||t.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),n())}),(i=document.getElementById("auth-confirm"))==null||i.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),n())}),s==null||s.addEventListener("click",async()=>{try{const o=await S.unlockWithBiometrics();await u.loadEncrypted(o),a()}catch(o){v.alert("Identificación",o.message)}}),S.isBioEnabled()&&setTimeout(async()=>{try{const o=await S.unlockWithBiometrics();await u.loadEncrypted(o),a()}catch{console.log("Auto-bio failed or cancelled")}},500)}let _=localStorage.getItem("life-dashboard/app_current_page")||"finance",A=localStorage.getItem("life-dashboard/app_current_sub_page")||null;A==="null"&&(A=null);async function ze(){window.addEventListener("open-add-modal",e=>{var t,n;const s=(t=e.detail)==null?void 0:t.type;s==="person"?nt((n=e.detail)==null?void 0:n.person):Se(s)}),j.init().catch(e=>console.warn("[Drive] Pre-init failed:",e));const a=S.getVaultKey();a?await u.loadEncrypted(a)?ot():(console.error("[Boot] Decryption failed, invalid vault key in session?"),S.logout(),Ke()):Ke()}function Ke(){const a=document.getElementById("app");a.innerHTML=Ja(),Za(()=>{ot()})}function ot(){const a=document.getElementById("app");a.innerHTML=`
        <main id="main-content"></main>
        <nav id="bottom-nav"></nav>
    `,it(),u.subscribe(()=>{U()}),window.reRender=()=>U(),Qa()}function Qa(){var t,n;const a=localStorage.getItem("life-dashboard/pwa_install_dismissed");if(a&&(Date.now()-parseInt(a))/864e5<7||window.matchMedia("(display-mode: standalone)").matches)return;const e=document.createElement("div");e.className="pwa-install-banner",e.id="pwa-install-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(e);const s=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};s(),window.addEventListener("beforeinstallprompt",s),(t=document.getElementById("pwa-banner-install"))==null||t.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:i}=await window.deferredPrompt.userChoice;i==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(n=document.getElementById("pwa-banner-close"))==null||n.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function it(){const a=document.getElementById("bottom-nav");a.innerHTML=Re(_),Pe(e=>{_=e,A=null,localStorage.setItem("life-dashboard/app_current_page",_),localStorage.setItem("life-dashboard/app_current_sub_page",A),G(),U(),a.innerHTML=Re(_),Pe(s=>{_=s,A=null,localStorage.setItem("life-dashboard/app_current_page",_),localStorage.setItem("life-dashboard/app_current_sub_page",A),G(),U(),it()})}),es(),U()}function U(){const a=document.getElementById("main-content");if(!a)return;const e=a.scrollTop;if(A==="compound"){a.innerHTML=Ht(),Vt(()=>{A=null,zt(),G(),U()}),a.scrollTop=e;return}if(A==="expenses"){a.innerHTML=ga(),fa(()=>{A=null,G(),U()}),a.scrollTop=e;return}if(A==="market"){a.innerHTML=Kt(),Wt(()=>{A=null,G(),U()}),a.scrollTop=e;return}switch(a.classList.toggle("no-padding-mobile",_==="health"),_){case"finance":G(),a.innerHTML=je(),Ue(),Ye();break;case"goals":F(),a.innerHTML=oa(),ra();break;case"time-invest":F(),a.innerHTML=_a(),Fa();break;case"social":F(),a.innerHTML=Sa(),La();break;case"health":a.innerHTML=Xt(),aa(),F();break;case"menu":a.innerHTML=Ea(),$a(s=>{_=s,G(),U()}),F();break;case"calendar":a.innerHTML=la(),va(),G();break;case"settings":a.innerHTML=xa(),ka(),F();break;default:G(),a.innerHTML=je(),Ue(),Ye()}requestAnimationFrame(()=>{a.scrollTop=e})}function Ye(){const a=document.getElementById("open-compound");a&&a.addEventListener("click",()=>{A="compound",localStorage.setItem("life-dashboard/app_current_sub_page",A),F(),U()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{A="market",localStorage.setItem("life-dashboard/app_current_sub_page",A),F(),U()});const s=document.getElementById("open-expenses");s&&s.addEventListener("click",()=>{A="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",A),F(),U()})}function es(){const a=document.querySelector(".fab");a&&a.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=p("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{if(_==="calendar")Se("event");else if(_==="health"){const s=await ns.confirm("Log Metric","What do you want to record today?","Weight","Body Fat");if(s===!0){const t=await ns.prompt("Log Weight","Enter your current weight in kg:","","number");t&&u.addWeightLog(t)}else if(s===!1){const t=await ns.prompt("Body Fat","Enter your body fat %:","","number");t&&u.addFatLog(t)}}else _==="social"?nt():Se()}),document.body.appendChild(e)}function F(){const a=document.getElementById("main-fab");a&&(a.style.display="none")}function G(){const a=document.getElementById("main-fab");a&&(a.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ze):ze();window.addEventListener("beforeinstallprompt",a=>{a.preventDefault(),window.deferredPrompt=a,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});export{p as g,v as n,u as s};
