var Ke=Object.defineProperty;var Ye=(s,e,a)=>e in s?Ke(s,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[e]=a;var re=(s,e,a)=>Ye(s,typeof e!="symbol"?e+"":e,a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&t(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const We="https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,ripple,kaspa,solana,stellar,algorand,litecoin,sui,chainlink,render-token,cardano,ondo-finance&vs_currencies=eur,ars",Xe="https://api.frankfurter.app/latest?from=EUR&to=USD,CHF,GBP,AUD";async function Je(){var e,a,t,n,o,i,r,l,p,u,d,g,f,h,b;const s={EUR:1};try{const w=await(await fetch(We)).json();s.BTC=((e=w.bitcoin)==null?void 0:e.eur)||4e4,s.ETH=((a=w.ethereum)==null?void 0:a.eur)||2200,s.XRP=((t=w.ripple)==null?void 0:t.eur)||.5,s.KAS=((n=w.kaspa)==null?void 0:n.eur)||.1,s.SOL=((o=w.solana)==null?void 0:o.eur)||90,s.XLM=((i=w.stellar)==null?void 0:i.eur)||.11,s.ALGO=((r=w.algorand)==null?void 0:r.eur)||.18,s.LTC=((l=w.litecoin)==null?void 0:l.eur)||65,s.SUI=((p=w.sui)==null?void 0:p.eur)||1.1,s.LINK=((u=w.chainlink)==null?void 0:u.eur)||14,s.RNDR=((d=w["render-token"])==null?void 0:d.eur)||4.5,s.ADA=((g=w.cardano)==null?void 0:g.eur)||.45,s.ONDO=((f=w["ondo-finance"])==null?void 0:f.eur)||.7,(h=w.bitcoin)!=null&&h.ars&&((b=w.bitcoin)!=null&&b.eur)&&(s.ARS=w.bitcoin.eur/w.bitcoin.ars);const S=await fetch(Xe);if(S.ok){const $=await S.json();s.USD=1/$.rates.USD,s.CHF=1/$.rates.CHF,s.GBP=1/$.rates.GBP,s.AUD=1/$.rates.AUD}s.GOLD=2100,s.SP500=4700}catch(E){console.error("Failed to fetch some prices:",E),s.USD=s.USD||.92,s.CHF=s.CHF||1.05,s.GBP=s.GBP||1.15,s.AUD=s.AUD||.6,s.ARS=s.ARS||.001}return s}class F{static async hash(e,a="salt_life_dashboard_2026"){const n=new TextEncoder().encode(e+a),o=await crypto.subtle.digest("SHA-512",n);return Array.from(new Uint8Array(o)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveVaultKey(e){return await this.hash(e,"vault_v4_dashboard_key")}static async deriveKey(e,a){const t=new TextEncoder,n=await crypto.subtle.importKey("raw",t.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode(a),iterations:25e4,hash:"SHA-512"},n,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,a){try{const t=crypto.getRandomValues(new Uint8Array(16)),n=crypto.getRandomValues(new Uint8Array(12)),o=await this.deriveKey(a,this.bufToBase64(t)),i=typeof e=="string"?e:JSON.stringify(e),r=new TextEncoder().encode(i),l=await crypto.subtle.encrypt({name:"AES-GCM",iv:n},o,r);return{payload:this.bufToBase64(new Uint8Array(l)),iv:this.bufToBase64(n),salt:this.bufToBase64(t),v:"5.0"}}catch(t){throw console.error("[Security] Encryption failed:",t),new Error("No se pudo encriptar la información")}}static async decrypt(e,a){try{if(!e||!e.payload||!e.iv||!e.salt)throw new Error("Formato de datos encriptados inválido");const{payload:t,iv:n,salt:o}=e,i=await this.deriveKey(a,o),r=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.base64ToBuf(n)},i,this.base64ToBuf(t)),l=new TextDecoder().decode(r);try{return JSON.parse(l)}catch{return l}}catch(t){throw console.error("[Security] Decryption failed:",t),new Error("Contraseña incorrecta o datos corruptos")}}static bufToBase64(e){return btoa(String.fromCharCode(...new Uint8Array(e)))}static base64ToBuf(e){return new Uint8Array(atob(e).split("").map(a=>a.charCodeAt(0)))}}const we=Object.freeze(Object.defineProperty({__proto__:null,SecurityService:F},Symbol.toStringTag,{value:"Module"})),D={MASTER_HASH:"life-dashboard/db_master_hash",VAULT_KEY:"life-dashboard/db_vault_key",BIO_ENABLED:"life-dashboard/db_bio_enabled"};class C{static isSetup(){return!!localStorage.getItem(D.MASTER_HASH)}static async setup(e){const a=await F.hash(e),t=await F.deriveVaultKey(e);return localStorage.setItem(D.MASTER_HASH,a),sessionStorage.setItem(D.VAULT_KEY,t),t}static async unlock(e){const a=await F.hash(e),t=localStorage.getItem(D.MASTER_HASH);if(a===t){const n=await F.deriveVaultKey(e);return sessionStorage.setItem(D.VAULT_KEY,n),n}throw new Error("Contraseña incorrecta")}static async registerBiometrics(e){await this.unlock(e);const a=sessionStorage.getItem(D.VAULT_KEY);if(!window.PublicKeyCredential)throw new Error("Biometría no soportada en este dispositivo");try{const t=crypto.getRandomValues(new Uint8Array(32));return await navigator.credentials.create({publicKey:{challenge:t,rp:{name:"Life Dashboard",id:window.location.hostname},user:{id:crypto.getRandomValues(new Uint8Array(16)),name:"user",displayName:"User"},pubKeyCredParams:[{alg:-7,type:"public-key"}],timeout:6e4,authenticatorSelection:{authenticatorAttachment:"platform"},attestation:"none"}}),localStorage.setItem(D.BIO_ENABLED,"true"),localStorage.setItem(D.VAULT_KEY,a),!0}catch(t){throw console.error("Biometric setup failed:",t),new Error("Error al configurar biometría")}}static async unlockWithBiometrics(){if(!(localStorage.getItem(D.BIO_ENABLED)==="true"))throw new Error("Biometría no activada");try{const a=crypto.getRandomValues(new Uint8Array(32));await navigator.credentials.get({publicKey:{challenge:a,rpId:window.location.hostname,userVerification:"required",timeout:6e4}});const t=localStorage.getItem(D.VAULT_KEY);if(t)return sessionStorage.setItem(D.VAULT_KEY,t),t;throw new Error("Llave no encontrada. Usa contraseña.")}catch(a){throw console.error("Biometric auth failed:",a),new Error("Fallo de identificación biométrica")}}static logout(){sessionStorage.removeItem(D.VAULT_KEY)}static getVaultKey(){return sessionStorage.getItem(D.VAULT_KEY)}static isBioEnabled(){return localStorage.getItem(D.BIO_ENABLED)==="true"}}const me="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com",Ee=[71,79,67,83,80,88,45,112,121,52,68,109,80,83,107,45,100,75,55,99,73,66,116,106,65,81,75,90,70,75,118,95,66,87,95].map(s=>String.fromCharCode(s)).join(""),Ze="https://www.googleapis.com/auth/drive.file";class G{static hasToken(){const e=!!this.accessToken;return localStorage.getItem("life-dashboard/drive_connected")==="true"&&e}static async init(){return this._initPromise?this._initPromise:(this._initPromise=new Promise((e,a)=>{const t=()=>{window.gapi&&window.google?gapi.load("client",async()=>{try{await gapi.client.init({discoveryDocs:["https://www.googleapis.com/discovery/v1/apis/drive/v3/rest"]}),this.codeClient=google.accounts.oauth2.initCodeClient({client_id:me,scope:Ze,ux_mode:"popup",access_type:"offline",prompt:"consent",callback:async n=>{if(n.error){console.error("[Drive] Auth callback error:",n);return}if(n.code)try{const o=sessionStorage.getItem("life-dashboard/pkce_verifier"),i=localStorage.getItem("life-dashboard/drive_client_secret")||Ee,r=await this.exchangeCodeForTokens(n.code,o,me,i);r.refresh_token&&await this.saveRefreshToken(r.refresh_token),this.saveSession(r),console.log("[Drive] Connected successfully via offline flow."),window.ns&&window.ns.toast("Google Drive vinculado"),typeof window.reRender=="function"&&window.reRender()}catch(o){console.error("[Drive] Token exchange error:",o),window.ns&&window.ns.alert("Error Auth","No se pudieron obtener tokens. Verifica el Client Secret.")}}}),localStorage.getItem("life-dashboard/drive_connected")==="true"&&this.ensureValidToken().catch(n=>{console.log("[Drive] Initial silent restoration skipped:",n.message)}),e(!0)}catch(n){console.error("[Drive] Init error:",n),a(n)}}):setTimeout(t,200)};t()}),this._initPromise)}static saveSession(e){this.accessToken=e.access_token,gapi.client.setToken({access_token:e.access_token}),localStorage.setItem("life-dashboard/drive_access_token",e.access_token),localStorage.setItem("life-dashboard/drive_connected","true");const a=e.expires_in||3600,t=Date.now()+a*1e3;localStorage.setItem("life-dashboard/drive_token_expiry",t.toString())}static async authenticate(){this.codeClient||await this.init();const{verifier:e}=await this.generatePKCE();sessionStorage.setItem("life-dashboard/pkce_verifier",e),this.codeClient.requestCode()}static async ensureValidToken(){const e=parseInt(localStorage.getItem("life-dashboard/drive_token_expiry")||"0");if(!(localStorage.getItem("life-dashboard/drive_connected")==="true"))return null;if(!this.accessToken||Date.now()>e-3e5){console.log("[Drive] Access token expired or near expiry, attempting refresh...");const n=await this.getRefreshToken();if(n)try{const o=localStorage.getItem("life-dashboard/drive_client_secret")||Ee,i=await this.refreshAccessToken(n,me,o),r={access_token:i.access_token,expires_in:i.expires_in,refresh_token:i.refresh_token||n};return i.refresh_token&&await this.saveRefreshToken(i.refresh_token),this.saveSession(r),this.accessToken}catch(o){throw console.error("[Drive] Token refresh failed:",o),new Error("Sesión de Google Drive expirada. Por favor reconecta en Configuración.")}else throw console.warn("[Drive] No refresh token found."),new Error("Google Drive no está vinculado para acceso offline.")}return this.accessToken&&(!gapi.client.getToken()||gapi.client.getToken().access_token!==this.accessToken)&&gapi.client.setToken({access_token:this.accessToken}),this.accessToken}static async generatePKCE(){const e=Array.from(crypto.getRandomValues(new Uint8Array(32))).map(i=>("0"+i.toString(16)).slice(-2)).join(""),t=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",t),o=btoa(String.fromCharCode(...new Uint8Array(n))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"");return{verifier:e,challenge:o}}static async exchangeCodeForTokens(e,a,t,n=null){const o=new URLSearchParams({client_id:t,code:e,grant_type:"authorization_code",redirect_uri:"postmessage"});a&&!n&&o.append("code_verifier",a),n&&o.append("client_secret",n);const i=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:o});if(!i.ok){const r=await i.json();throw new Error(r.error_description||"Failed to exchange code")}return await i.json()}static async refreshAccessToken(e,a,t=null){const n=new URLSearchParams({client_id:a,refresh_token:e,grant_type:"refresh_token"});t&&n.append("client_secret",t);const o=await fetch("https://oauth2.googleapis.com/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:n});if(!o.ok){const i=await o.json();throw new Error(i.error_description||"Failed to refresh token")}return await o.json()}static async saveRefreshToken(e){return new Promise((a,t)=>{const n=indexedDB.open("LifeDashboardAuthDB",1);n.onupgradeneeded=o=>{const i=o.target.result;i.objectStoreNames.contains("tokens")||i.createObjectStore("tokens")},n.onsuccess=o=>{const r=o.target.result.transaction("tokens","readwrite");r.objectStore("tokens").put(e,"drive_refresh_token"),r.oncomplete=()=>a(),r.onerror=l=>t(l)},n.onerror=o=>t(o)})}static async getRefreshToken(){return new Promise((e,a)=>{const t=indexedDB.open("LifeDashboardAuthDB",1);t.onupgradeneeded=n=>{const o=n.target.result;o.objectStoreNames.contains("tokens")||o.createObjectStore("tokens")},t.onsuccess=n=>{const o=n.target.result;if(!o.objectStoreNames.contains("tokens")){e(null);return}const l=o.transaction("tokens","readonly").objectStore("tokens").get("drive_refresh_token");l.onsuccess=()=>e(l.result),l.onerror=p=>a(p)},t.onerror=n=>a(n)})}static async clearTokens(){return localStorage.removeItem("life-dashboard/drive_access_token"),localStorage.removeItem("life-dashboard/drive_connected"),localStorage.removeItem("life-dashboard/drive_token_expiry"),new Promise(e=>{const a=indexedDB.open("LifeDashboardAuthDB",1);a.onsuccess=t=>{const n=t.target.result;if(n.objectStoreNames.contains("tokens")){const o=n.transaction("tokens","readwrite");o.objectStore("tokens").clear(),o.oncomplete=()=>e()}else e()},a.onerror=()=>e()})}static async getOrCreateFolderPath(e){var n;await this.ensureValidToken(),(n=gapi.client)!=null&&n.drive||await this.init();const a=e.split("/").filter(o=>o);let t="root";for(const o of a){const i=`name = '${o}' and mimeType = 'application/vnd.google-apps.folder' and '${t}' in parents and trashed = false`,l=(await gapi.client.drive.files.list({q:i,fields:"files(id, name)"})).result.files;if(l&&l.length>0)t=l[0].id;else{const p={name:o,mimeType:"application/vnd.google-apps.folder",parents:[t]};t=(await gapi.client.drive.files.create({resource:p,fields:"id"})).result.id}}return t}static async pushData(e,a,t=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pushing encrypted data...${t?" (Retry)":""}`);const n=await this.getOrCreateFolderPath("/backup/life-dashboard/"),o=await F.encrypt(e,a),i="dashboard_vault_v5.bin",r=`name = '${i}' and '${n}' in parents and trashed = false`,p=(await gapi.client.drive.files.list({q:r,fields:"files(id)"})).result.files,u=new Blob([JSON.stringify(o)],{type:"application/json"});if(p&&p.length>0){const d=p[0].id,g=await fetch(`https://www.googleapis.com/upload/drive/v3/files/${d}?uploadType=media`,{method:"PATCH",headers:{Authorization:`Bearer ${this.accessToken}`},body:u});if(g.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,a,!0);if(!g.ok)throw new Error(`Error al actualizar backup: ${g.status}`)}else{const d={name:i,parents:[n]},g=new FormData;g.append("metadata",new Blob([JSON.stringify(d)],{type:"application/json"})),g.append("file",u);const f=await fetch("https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart",{method:"POST",headers:{Authorization:`Bearer ${this.accessToken}`},body:g});if(f.status===401&&!t)return await this.ensureValidToken(),await this.pushData(e,a,!0);if(!f.ok)throw new Error(`Error al crear backup: ${f.status}`)}return!0}catch(n){throw console.error("[Drive] Push failed:",n),new Error(n.message||"Fallo al subir datos a Drive")}}static async pullData(e,a=!1){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");console.log(`[Drive] Pulling data...${a?" (Retry)":""}`);const o=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,r=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)"})).result.files;if(!r||r.length===0)return null;const l=r[0].id,p=await fetch(`https://www.googleapis.com/drive/v3/files/${l}?alt=media`,{headers:{Authorization:`Bearer ${this.accessToken}`}});if(p.status===401&&!a)return await this.ensureValidToken(),await this.pullData(e,!0);if(!p.ok)throw new Error(`Error al descargar backup: ${p.status}`);const u=await p.json();return await F.decrypt(u,e)}catch(t){throw console.error("[Drive] Pull failed:",t),new Error(t.message||"Fallo al recuperar datos de Drive")}}static async deleteBackup(){try{if(await this.ensureValidToken(),!this.accessToken)throw new Error("Cloud not connected");const t=`name = 'dashboard_vault_v5.bin' and '${await this.getOrCreateFolderPath("/backup/life-dashboard/")}' in parents and trashed = false`,o=(await gapi.client.drive.files.list({q:t,fields:"files(id)"})).result.files;if(o&&o.length>0){const i=o[0].id;return await gapi.client.drive.files.delete({fileId:i}),console.log("[Drive] Backup deleted successfully"),!0}return!1}catch(e){throw console.error("[Drive] Deletion failed:",e),new Error(e.message||"Fallo al borrar backup en Drive")}}}re(G,"codeClient",null),re(G,"accessToken",localStorage.getItem("life-dashboard/drive_access_token")||null),re(G,"_initPromise",null);const ke={wallet:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/></svg>',target:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',calendar:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',heart:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',settings:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>',building:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',home:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',trendingUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',bitcoin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.215-6.893m-1.215 6.893-3.94-.694m5.155-6.2L8.29 4.26m5.908 1.042.348-1.97M7.48 20.364l3.126-17.727"/></svg>',dollarSign:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',car:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C1.4 11.3 1 12.1 1 13v3c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/></svg>',creditCard:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>',landmark:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" x2="21" y1="22" y2="22"/><line x1="6" x2="6" y1="18" y2="11"/><line x1="10" x2="10" y1="18" y2="11"/><line x1="14" x2="14" y1="18" y2="11"/><line x1="18" x2="18" y1="18" y2="11"/><polygon points="12 2 20 7 4 7"/></svg>',plus:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>',x:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',chevronRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>',chevronLeft:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>',chevronUp:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m18 15-6-6-6 6"/></svg>',chevronDown:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>',calculator:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="18"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/></svg>',arrowUpRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>',arrowDownRight:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7 7 10 10"/><path d="M17 7v10H7"/></svg>',piggyBank:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h.01"/></svg>',receipt:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 17.5v-11"/></svg>',coins:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg>',scale:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',briefcase:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',zap:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',download:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>',downloadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></svg>',uploadCloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12V21"/><path d="m16 16-4-4-4 4"/></svg>',cloud:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>',shield:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',link:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',refreshCw:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>',lock:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>',logOut:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>',package:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>',moreVertical:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>',check:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',menu:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>',users:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',messageSquare:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',phone:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',instagram:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>',facebook:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>',linkedin:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>',alertCircle:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>',fingerprint:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 6"/><path d="M5 15.1a7 7 0 0 0 10.9 0"/><path d="M6 13.6a7 7 0 0 0 4.6 2.4"/><path d="M13.4 16a7 7 0 0 0 4.6-2.4"/><path d="M8 12.1a5 5 0 0 0 6.9 0"/><path d="M9.1 11a3 3 0 0 0 3.9 0"/><path d="M12 18.5V20"/></svg>',trash:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>',edit:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg>',palette:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.555C21.965 6.012 17.461 2 12 2z"/></svg>',star:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',eye:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>',eyeOff:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.52 13.52 0 0 0 2 12c0 0 3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><line x1="2" x2="22" y1="2" y2="22"/></svg>'};function m(s,e=""){return(ke[s]||ke.package).replace("<svg",`<svg class="${e}"`)}class Qe{constructor(){this.toastContainer=null,this._initToastContainer()}_initToastContainer(){document.getElementById("toast-container")||(this.toastContainer=document.createElement("div"),this.toastContainer.id="toast-container",this.toastContainer.className="toast-container",document.body.appendChild(this.toastContainer))}toast(e,a="success",t=3e3){const n=document.createElement("div");n.className=`toast toast-${a} stagger-in`;const o=a==="success"?"check":a==="error"?"alertCircle":"info";n.innerHTML=`
          ...
          <div class="form-group" style="flex: 1;">
              ...
              <select class="form-input form-select" id="edit-currency">
                  <optgroup label="Divisas">
                      ${it.map(o=>`<option value="${o.value}" ${o.value===s.currency?"selected":""}>${o.label}</option>`).join("")}
                  </optgroup>
                  ${a?`
  ...
  `}function ct(s){const e=document.getElementById("edit-modal"),a=document.getElementById("edit-modal-close"),t=document.getElementById("btn-update"),n=document.getElementById("btn-delete");e.addEventListener("click",o=>{o.target===e&&de()}),a.addEventListener("click",de),t.addEventListener("click",()=>dt(s)),n.addEventListener("click",()=>ut(s))}function dt(s){var p,u,d,g,f,h,b,E,w;const e=(u=(p=document.getElementById("edit-name"))==null?void 0:p.value)==null?void 0:u.trim(),a=(d=document.getElementById("edit-type"))==null?void 0:d.value,t=(g=document.getElementById("edit-currency"))==null?void 0:g.value,n=(h=(f=document.getElementById("edit-details"))==null?void 0:f.value)==null?void 0:h.trim(),o=parseFloat((b=document.getElementById("edit-value"))==null?void 0:b.value)||0,i=parseFloat((E=document.getElementById("edit-amount"))==null?void 0:E.value)||0,r=parseFloat((w=document.getElementById("edit-monthly"))==null?void 0:w.value)||0;if(!e){v.alert("Requerido","El nombre es obligatorio para guardar los cambios.");return}const l={name:e,type:a,currency:t,details:n};s.fields.includes("value")&&(l.value=o),s.fields.includes("amount")&&(l.amount=i),s.fields.includes("monthlyIncome")&&(l.monthlyIncome=r),s.fields.includes("monthlyPayment")&&(l.monthlyPayment=r),c[s.updateMethod](ie.id,l),de()}function ut(s){v.confirm("¿Eliminar?",`¿Estás seguro de que quieres borrar "${ie.name}"? Esta acción no se puede deshacer.`).then(e=>{e&&(c[s.deleteMethod](ie.id),v.toast("Eliminado correctamente","info"),de())})}function de(){const s=document.getElementById("edit-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300)),ie=null,J=null}let Z=!1,Q=!1,x={key:"price",direction:"desc"},ee="USD",U=null;function pt(){const s=c.getState(),e=s.lastMarketData||[],a=s.marketFavorites||[];U===null&&(U=a.length>0?"favorites":"all"),!Q&&!Z&&yt();const t=ee==="EUR"?"€":"$";let n=e;U==="favorites"&&(n=e.filter(i=>a.includes(i.id)));const o=Object.values(y);return`
        <div class="market-view animate-fade-in" style="padding: 4px;">
            ...
            <div class="market-controls-row">
                ...
                <div class="market-status-badge ${Z?"market-status-fresh":"market-status-cached"}" title="Tasa de refresco: 5 min">
                    ${Q?'<div class="loading-spinner-sm" style="width:10px; height:10px;"></div>':m(Z?"check":"save","tiny-icon")}
            ...
            <!-- Content -->
            ${n.length===0&&U==="favorites"?gt():""}
            ${n.length===0&&U==="all"?ht():""}
            
            ${o.map(i=>{const r=n.filter(l=>l.category===i);return r.length===0?"":mt(i,r,t,a)}).join("")}
        </div>
    `}function mt(s,e,a,t){const n=[...e].sort((o,i)=>{let r=o[x.key],l=i[x.key];return typeof r=="string"&&(r=r.toLowerCase()),typeof l=="string"&&(l=l.toLowerCase()),r<l?x.direction==="asc"?-1:1:r>l?x.direction==="asc"?1:-1:0});return`
                    ...
                    <table class="market-table">
                        <thead>
                            <tr>
                                ...
                                <th data-sort="name" class="sortable ${x.key==="name"?x.direction:""}">Nombre</th>
                                <th data-sort="price" class="sortable text-right ${x.key==="price"?x.direction:""}">Precio</th>
                                <th data-sort="change24h" class="sortable text-right ${x.key==="change24h"?x.direction:""}">24h</th>
                                <th data-sort="change30d" class="sortable text-right ${x.key==="change30d"?x.direction:""}">30d</th>
                                <th data-sort="change1y" class="sortable text-right ${x.key==="change1y"?x.direction:""}">1y</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${n.map(o=>vt(o,a,t.includes(o.id))).join("")}
                        </tbody>
                    </table>
                </div>
            </div>
        </div>
    `}function vt(s,e,a){let t=s.price;if(s.price!==null&&ee==="EUR"){const r=c.getState().rates.USD||.92;t=s.price*r}const n=ge(s.change24h),o=ge(s.change30d),i=ge(s.change1y);return`
        <tr class="market-row" data-id="${s.id}">
            ...
            <td class="text-right font-mono" style="font-weight: 700; color: var(--text-primary);">${t!==null?k(t,e):"-"}</td>
    ...
    `}function ge(s){return s==null?"":Z?s>=0?"text-positive":"text-negative":"text-accent-primary"}function gt(){return`
    ...
    `}async function yt(){var s,e;if(!Q){Q=!0,(s=window.reRender)==null||s.call(window);try{const a=await _e();c.saveMarketData(a),Z=!0}catch(a){console.error("Market update failed",a)}finally{Q=!1,(e=window.reRender)==null||e.call(window)}}}function ft(){var s,e,a;document.querySelectorAll(".capsule-btn").forEach(t=>{t.addEventListener("click",()=>{var o;const n=t.dataset.curr;n!==ee&&(ee=n,(o=window.reRender)==null||o.call(window))})}),(s=document.getElementById("filter-all"))==null||s.addEventListener("click",()=>{var t;U="all",(t=window.reRender)==null||t.call(window)}),(e=document.getElementById("filter-favs"))==null||e.addEventListener("click",()=>{var t;U="favorites",(t=window.reRender)==null||t.call(window)}),(a=document.getElementById("btn-show-all"))==null||a.addEventListener("click",()=>{var t;U="all",(t=window.reRender)==null||t.call(window)}),document.querySelectorAll(".btn-favorite").forEach(t=>{t.addEventListener("click",n=>{var i;n.stopPropagation();const o=t.dataset.id;c.toggleMarketFavorite(o),(i=window.reRender)==null||i.call(window)})}),document.querySelectorAll(".market-table th.sortable").forEach(t=>{t.addEventListener("click",()=>{var o;const n=t.dataset.sort;x.key===n?x.direction=x.direction==="asc"?"desc":"asc":(x.key=n,x.direction="desc",n==="name"&&(x.direction="asc")),(o=window.reRender)==null||o.call(window)})})}function bt(){const s=c.getState(),{wealthGoals:e=[],inflationRate:a=3,projectionYears:t=10,currencySymbol:n}=s,o=c.getAllExpenses();let i=0;e.forEach(d=>{const g=d.cost*(d.dividendYield/100)/12;i+=c.convertValue(g,d.currency||s.currency)});const r=i-o,l=o*Math.pow(1+a/100,t);let p=0;e.forEach(d=>{const f=d.cost*Math.pow(1+d.annualGrowth/100,t)*(d.dividendYield/100)/12;p+=c.convertValue(f,d.currency||s.currency)});const u=p-l;return`
            ...
            <div class="projection-grid">
                <div class="projection-col">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="positive">${k(i,n)}</span>
                    </div>
                    <div class="stat-row">
                        <span>Gastos Totales</span>
                        <span class="negative">${k(o,n)}</span>
                    </div>
                    <div class="stat-row divider">
                        <span>Neto</span>
                        <span class="${r>=0?"positive":"negative"}">${k(r,n)}</span>
                    </div>
                </div>
                ...
                <div class="projection-col">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="positive">${k(p,n)}</span>
                    </div>
                    <div class="stat-row">
                        <span>Gastos Est.</span>
                        <span class="negative">${k(l,n)}</span>
                    </div>
                    <div class="stat-row divider">
                        <span>Neto Proyectado</span>
                        <span class="${u>=0?"positive":"negative"}">${k(u,n)}</span>
                    </div>
                </div>
            </div>
    ...
    `}function wt(s,e){const a=e.currencySymbol,t=s.cost*(s.dividendYield/100)/12,n=c.convertValue(t,s.currency||e.currency);return`
    <div class="card wealth-goal-card" data-id="${s.id}">
        <div class="goal-card-main">
            <div class="goal-card-info">
                <div class="goal-name">${s.name}</div>
                <div class="goal-cost">${k(s.cost,s.currency||e.currency)} cost</div>
            </div>
            <div class="goal-card-yield">
                <div class="yield-value">+${k(n,a)}/mes</div>
    ...
    `,document.body.appendChild(t);const n=t.querySelector(".close-modal-btn"),o=t.querySelector("#save-goal-btn"),i=()=>{t.classList.remove("active"),setTimeout(()=>t.remove(),300)};n.addEventListener("click",i),t.addEventListener("click",r=>{r.target===t&&i()}),o.addEventListener("click",()=>{var f;const r=t.querySelector("#goal-name").value,l=parseFloat(t.querySelector("#goal-cost").value),p=parseFloat(t.querySelector("#goal-growth").value)||0,u=parseFloat(t.querySelector("#goal-dividend").value)||0,d=t.querySelector("#goal-currency").value;if(!r||isNaN(l)){v.toast("Completa nombre y coste","error");return}const g={name:r,cost:l,annualGrowth:p,dividendYield:u,currency:d};e?(c.updateWealthGoal(s.id,g),v.toast("Objetivo actualizado")):(c.addWealthGoal(g),v.toast("Objetivo creado")),i(),(f=window.reRender)==null||f.call(window)})}let R="summary";function Ce(){const s=c.getState(),e=s.currencySymbol;return setTimeout(R==="markets"||R==="goals"?N:j,0),`
    <div class="finance-page stagger-children" style="padding-bottom: 80px;">
      ...
      <div class="segmented-control">
        <button class="segment-btn ${R==="summary"?"active":""}" id="tab-summary">
            Summary
        </button>
        <button class="segment-btn ${R==="markets"?"active":""}" id="tab-markets">
            Markets
        </button>
        <button class="segment-btn ${R==="goals"?"active":""}" id="tab-goals">
            Goals
        </button>
      </div>
      
      ${R==="summary"?kt(s,e):R==="markets"?pt():bt()}
      
    </div>
  `}function kt(s,e){const a=c.getPassiveIncome(),t=c.getLivingExpenses(),n=c.getNetPassiveIncome(),o=c.getInvestmentAssetsValue(),i=c.getTotalLiabilities(),r=c.getNetWorth(),l=c.getAllIncomes(),p=c.getAllExpenses(),u=c.getNetIncome();return`
      <div class="finance-top-grid animate-fade-in">
        ...
        <div class="card">
          ...
          <div class="stat-row">
            ...
            <span class="stat-value positive">${k(a,e)}</span>
          </div>
          <div class="stat-row">
            <span class="stat-label">
            ...
            <span class="stat-value negative">${k(t,e)}</span>
          </div>
        </div>
        ...
        <div class="card highlight-card ${n<0?"highlight-card-negative":""}">
          ...
          <div class="highlight-value ${n<0?"highlight-value-negative":""}">${k(n,e)}</div>
          <div class="highlight-label ${n<0?"highlight-label-negative":""}">
            ${n>=0?"🎉 ¡Libertad financiera alcanzada!":`Faltan ${k(Math.abs(n),e)}/mes`}
          </div>
        </div>
      </div>
      ...
      <div class="finance-balance-grid">
        <div class="summary-grid">
          <div class="summary-item">
            <div class="summary-value text-primary-accent">${k(o,e)}</div>
            <div class="summary-label">Activos</div>
          </div>
          <div class="summary-item">
            <div class="summary-value text-warning">${k(i,e)}</div>
      ...
      <div class="card">
        <div class="stat-row">
          ...
          <span class="stat-value positive">${k(l,e)}</span>
        </div>
        <div class="stat-row">
          <span class="stat-label">
            <span class="stat-dot expense"></span>
          ...
          <span class="stat-value negative">${k(p,e)}</span>
        </div>
  ...
  `}function xt(s){const e=[...s.passiveAssets,...s.investmentAssets],a=s.liabilities;if(e.length===0)return"";const t={Bitcoin:{value:0,color:"#f59e0b"},Altcoins:{value:0,color:"#6366f1"},Inmuebles:{value:0,color:"#a855f7"},Bolsa:{value:0,color:"#00d4aa"},Oro:{value:0,color:"#fbbf24"},"Otros/Efe.":{value:0,color:"#94a3b8"}};e.forEach(u=>{const d=c.convertValue(u.value||0,u.currency||"EUR");u.currency==="BTC"?t.Bitcoin.value+=d:u.currency==="ETH"||u.currency==="XRP"||u.type==="crypto"?t.Altcoins.value+=d:u.type==="property"||u.type==="rental"?t.Inmuebles.value+=d:u.type==="stocks"||u.type==="etf"||u.currency==="SP500"?t.Bolsa.value+=d:u.currency==="GOLD"?t.Oro.value+=d:t["Otros/Efe."].value+=d});const n=a.filter(u=>u.type==="mortgage").reduce((u,d)=>u+c.convertValue(d.amount||0,d.currency||"EUR"),0);t.Inmuebles.value=Math.max(0,t.Inmuebles.value-n),s.hideRealEstate&&(t.Inmuebles.value=0);const o=Object.entries(t).filter(([u,d])=>d.value>0).sort((u,d)=>d[1].value-u[1].value),i=o.reduce((u,[d,g])=>u+g.value,0);if(i===0)return`
    ...
    `;let r=0;const l=o.map(([u,d])=>{const g=d.value/i*100,f=r;return r+=g,{name:u,percentage:g,color:d.color,start:f}}),p=l.map(u=>`${u.color} ${u.start}% ${u.start+u.percentage}%`).join(", ");return`
      ...
      <div class="allocation-container">
        <div class="pie-chart" style="background: conic-gradient(${p});">
          <div class="pie-center">
            <div class="pie-total">${k(i,s.currencySymbol)}</div>
  ...
  `}function St(s){const e=[...(s.activeIncomes||[]).map(t=>({...t,category:"activeIncome"})),...s.passiveAssets.map(t=>({...t,category:"passive"})),...s.investmentAssets.map(t=>({...t,category:"investment"})),...s.liabilities.map(t=>({...t,category:"liability"}))];if(e.length===0)return`
      <div class="empty-state">
    ...
    <div class="asset-list">
      ${e.map(t=>{const n=$t(t.currency||t.type),o=It(t.currency||t.type),i=t.category==="liability",r=t.value||t.amount||0,l=c.convertValue(r,t.currency||"EUR");let p="";if(t.currency!==s.currency){const d={EUR:"€",USD:"$",BTC:"₿",ETH:"Ξ",XRP:"✕",GOLD:"oz",SP500:"pts",CHF:"Fr",GBP:"£",AUD:"A$",ARS:"$"}[t.currency]||t.currency;p=`<div class="asset-original-value">${r} ${d}</div>`}return`
          <div class="asset-item" data-id="${t.id}" data-category="${t.category}">
            ...
            <div>
              <div class="asset-value ${i?"text-warning":""}">
                ${t.category==="activeIncome"?"+":i?"-":""}${k(l,a)}
                ${t.category==="activeIncome"?'<span style="font-size: 10px; opacity: 0.7; font-weight: 400;">/mes</span>':""}
              </div>
              ${t.monthlyIncome?`<div class="asset-yield">+${k(c.convertValue(t.monthlyIncome,t.currency),a)}/mes</div>`:""}
              ${t.monthlyPayment?`<div class="asset-yield text-negative">-${k(c.convertValue(t.monthlyPayment,t.currency),a)}/mes</div>`:""}
            </div>
          </div>
        `}).join("")}
    </div>
  `}function $t(s){return{property:"property",rental:"property",stocks:"stocks",etf:"stocks",SP500:"stocks",crypto:"crypto",BTC:"crypto",ETH:"crypto",XRP:"crypto",GOLD:"investment",cash:"cash",USD:"cash",EUR:"cash",savings:"cash",vehicle:"vehicle",debt:"debt",loan:"debt",mortgage:"debt",creditcard:"debt",salary:"cash",freelance:"cash",business:"property"}[s]||"cash"}function It(s){return{property:"building",rental:"building",stocks:"trendingUp",etf:"trendingUp",SP500:"trendingUp",crypto:"bitcoin",BTC:"bitcoin",ETH:"bitcoin",XRP:"bitcoin",GOLD:"package",cash:"dollarSign",USD:"dollarSign",EUR:"dollarSign",savings:"piggyBank",vehicle:"car",debt:"creditCard",loan:"landmark",mortgage:"home",creditcard:"creditCard",salary:"briefcase",freelance:"users",business:"building"}[s]||"dollarSign"}function Ae(){const s=document.getElementById("tab-summary"),e=document.getElementById("tab-markets"),a=document.getElementById("tab-goals");if(s&&e&&a&&(s.addEventListener("click",()=>{var i;R="summary",(i=window.reRender)==null||i.call(window)}),e.addEventListener("click",()=>{var i;R="markets",(i=window.reRender)==null||i.call(window)}),a.addEventListener("click",()=>{var i;R="goals",(i=window.reRender)==null||i.call(window)})),R==="markets"){ft();return}if(R==="goals"){Et();return}document.querySelectorAll(".asset-item").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.id,l=i.dataset.category;Ue(r,l)})});const n=document.getElementById("toggle-real-estate");n&&n.addEventListener("change",()=>{c.toggleRealEstate()});const o=document.getElementById("display-currency-select");o&&o.addEventListener("change",i=>{c.setCurrency(i.target.value)})}let q=10,z=7,Y=null,W=null;function Ct(){const e=c.getState().currencySymbol,a=c.getNetWorth(),n=c.getNetIncome()*12,o=Y!==null?Y:a,i=W!==null?W:n,r=je(o,i,z,q);return`
    <div class="compound-page stagger-children" style="padding-bottom: 80px;">
      ...
      <div class="card">
        ...
        <div class="compound-input-group">
          ...
          <div class="compound-input-hint">Patrimonio actual: ${k(a,e)}</div>
        </div>
        ...
        <div class="compound-input-group">
          ...
          <div class="compound-input-hint">Ingreso neto anual: ${k(n,e)}</div>
        </div>
      ...
      <div class="card highlight-card">
        ...
        <div class="highlight-value" id="future-value">${k(r.finalValue,e)}</div>
      ...
      <div class="card">
        ...
        <div class="stat-row">
          ...
          <span class="stat-value neutral" id="initial-capital">${k(o,e)}</span>
        </div>
        ...
        <div class="stat-row">
          ...
          <span class="stat-value ${r.totalContributions>=0?"positive":"negative"}" id="total-contributed">${k(r.totalContributions,e)}</span>
        </div>
        ...
        <div class="stat-row">
          ...
          <span class="stat-value" style="color: var(--accent-secondary);" id="total-interest">${k(r.totalInterest,e)}</span>
        </div>
        ...
        <div class="stat-row" style="padding-top: var(--spacing-md); border-top: 1px solid rgba(255,255,255,0.1); margin-top: var(--spacing-sm);">
          ...
          <span class="stat-value positive" style="font-size: 20px;" id="final-value-breakdown">${k(r.finalValue,e)}</span>
        </div>
      </div>
  ...
  `}function Ne(s,e){const a=[];for(let t=0;t<s.length;t++){const n=s[t];(t<5||(t+1)%5===0||t===s.length-1)&&a.push(n)}return`
    <div class="table-container">
      <table class="projection-data-table">
        ...
        <tbody>
          ${a.map(t=>`
            <tr>
              <td>${t.year}</td>
              <td class="${t.endBalance>=0?"positive":"negative"}">${k(t.endBalance,e)}</td>
              <td style="color: var(--accent-secondary);">+${k(t.interest,e)}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    </div>
  `}function At(s){const e=document.getElementById("back-to-finance"),a=document.getElementById("rate-slider"),t=document.getElementById("years-slider"),n=document.getElementById("principal-input"),o=document.getElementById("contribution-input"),i=document.getElementById("reset-principal"),r=document.getElementById("reset-contribution");e&&e.addEventListener("click",s),n&&n.addEventListener("input",l=>{Y=parseFloat(l.target.value)||0,X()}),o&&o.addEventListener("input",l=>{W=parseFloat(l.target.value)||0,X()}),i&&i.addEventListener("click",()=>{Y=null;const l=c.getNetWorth();n.value=l,X()}),r&&r.addEventListener("click",()=>{W=null;const l=c.getNetIncome()*12;o.value=l,X()}),a&&a.addEventListener("input",l=>{z=parseFloat(l.target.value),document.getElementById("rate-value").textContent=`${z}%`,X()}),t&&t.addEventListener("input",l=>{q=parseInt(l.target.value),document.getElementById("years-value").textContent=`${q} años`,X()})}function X(){const e=c.getState().currencySymbol,a=Y!==null?Y:c.getNetWorth(),t=W!==null?W:c.getNetIncome()*12,n=je(a,t,z,q),o=document.getElementById("future-value"),i=document.getElementById("future-value-title"),r=document.getElementById("growth-label"),l=document.getElementById("initial-capital"),p=document.getElementById("total-contributed"),u=document.getElementById("total-interest"),d=document.getElementById("final-value-breakdown"),g=document.getElementById("projection-chart"),f=document.getElementById("projection-table");o&&(o.textContent=k(n.finalValue,e)),i&&(i.textContent=`Valor Futuro en ${q} años`),r&&(r.innerHTML=`${n.totalGrowth>=0?"📈":"📉"} ${n.growthMultiple.toFixed(1)}x tu capital inicial`),l&&(l.textContent=k(a,e)),p&&(p.textContent=k(n.totalContributions,e),p.className=`stat-value ${n.totalContributions>=0?"positive":"negative"}`),u&&(u.textContent=k(n.totalInterest,e)),d&&(d.textContent=k(n.finalValue,e)),g&&(g.innerHTML=Oe(n.yearlyBreakdown)),f&&(f.innerHTML=Ne(n.yearlyBreakdown,e))}function Lt(){q=10,z=7,Y=null,W=null}let ne=c.getState().lastMarketData||[],oe=!1,I={key:"price",direction:"desc"},Fe="";function Tt(){const s=c.getState(),e=s.currency||"EUR",a=s.currencySymbol||"€";if((ne.length===0||Fe!==e)&&(oe||Ge(),ne.length===0))return`
        ...
        <div class="market-page stagger-children" style="padding-bottom: 80px;">
            ...
            ${t.map(n=>{const o=ne.filter(i=>i.category===n);return o.length===0?"":Dt(n,o,a)}).join("")}
        </div>
    `}function Dt(s,e,a){const t=[...e].sort((n,o)=>{let i=n[I.key],r=o[I.key];return typeof i=="string"&&(i=i.toLowerCase()),typeof r=="string"&&(r=r.toLowerCase()),i<r?I.direction==="asc"?-1:1:i>r?I.direction==="asc"?1:-1:0});return`
                        ...
                        <tbody>
                            ${t.map(n=>`
                                <tr>
                                    ...
                                    <td style="font-weight: 600; font-variant-numeric: tabular-nums;">${n.price!==null?k(n.price,a):"-"}</td>
                        ...
                        <div class="ex-health-main">
                            ...
                            <div class="ex-health-info">
                                ...
                                <div class="ex-health-stats">
                                    ...
                                    ${o.lastLog?`
                                        <span style="opacity: 0.3;">•</span>
                                        <span class="last-effort-badge-emoji" title="Último esfuerzo">${_t(o.lastLog.rating)}</span>
                                    `:""}
                                </div>
                            </div>
                        </div>
    ...
    `}function Pt(s){return`
      ...
      <div class="card ai-calorie-card" style="margin-bottom: var(--spacing-2xl); display: flex; flex-direction: column; align-items: center;">
          <div class="summary-value" style="font-size: 28px;">${Ut(s)} kcal</div>
  ...
  `}function Gt(s,e){return s.length===0?`
        ...
        <div class="goal-card-premium ${t.completed?"is-completed":""}" 
            ...
            <div class="goal-card-body">
                <div class="goal-checkbox-premium toggle-goal" data-id="${t.id}" style="border-color: ${i}aa; background: ${t.completed?i:"transparent"}">
                    ${t.completed?m("check","check-icon-white"):""}
                </div>
                <div class="goal-main-content">
                    ...
                    <div class="goal-header-row" style="margin-top: 4px;">
                        <div class="goal-actions-mini">
                            <button class="action-btn-mini add-subgoal" data-id="${t.id}" title="Hito">${m("plus")}</button>
                            <button class="action-btn-mini delete-goal" data-id="${t.id}" title="Borrar">${m("trash")}</button>
                        </div>
                    </div>
                        ...
                        <div class="subgoals-list-premium">
                            ${t.subGoals.map((r,l)=>`
                                <div class="subgoal-item-premium ${r.completed?"sub-done":""} toggle-subgoal" data-id="${t.id}" data-idx="${l}">
                                    <div class="sub-check" style="color: ${i}">${m(r.completed?"check":"plus","sub-check-svg")}</div>
      ...
      <div class="calendar-top-layout">
        ...
        <div class="card calendar-view-card">
            <div class="calendar-mini-header">
                ...
                <span class="current-month">${zt()}</span>
  ...
  `}function Vt(s){const e=O.getMonth(),a=O.getFullYear(),t=new Date().getDate(),n=new Date().getMonth()===e&&new Date().getFullYear()===a,o=new Date(a,e+1,0).getDate(),i=new Date(a,e,1).getDay(),r=["D","L","M","M","J","V","S"],l=new Set;s.forEach(u=>{const d=new Date(u.date);d.getMonth()===e&&d.getFullYear()===a&&l.add(d.getDate())});let p=r.map(u=>`<div class="calendar-day-label">${u}</div>`).join("");for(let u=0;u<i;u++)p+='<div class="calendar-day empty"></div>';for(let u=1;u<=o;u++){const d=n&&u===t,g=l.has(u);p+=`
            <div class="calendar-day ${d?"today":""} ${g?"has-event":""}">
                ${u}
                ${g?'<span class="event-dot-indicator"></span>':""}
            </div>
        `}return p}function zt(){return`${["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"][O.getMonth()]} ${O.getFullYear()}`}function Kt(s){const e={day:"numeric",month:"short"};return new Date(s).toLocaleDateString("es-ES",e).toUpperCase()}function Yt(s){switch(s){case"reminder":return"bell";case"meeting":return"users";default:return"calendar"}}function Wt(s){return{daily:"Diario",weekly:"Semanal",monthly:"Mensual",yearly:"Anual"}[s]||""}function Xt(){var s,e,a;(s=document.querySelector(".prev-month"))==null||s.addEventListener("click",()=>{O.setMonth(O.getMonth()-1),typeof window.reRender=="function"&&window.reRender()}),(e=document.querySelector(".next-month"))==null||e.addEventListener("click",()=>{O.setMonth(O.getMonth()+1),typeof window.reRender=="function"&&window.reRender()}),document.querySelectorAll(".event-delete-btn").forEach(t=>{t.addEventListener("click",async()=>{await v.confirm("¿Eliminar evento?","¿Borrar este evento de tu agenda?")&&(c.deleteEvent(t.dataset.id),v.toast("Evento eliminado"))})}),(a=document.getElementById("add-event-manual-btn"))==null||a.addEventListener("click",async()=>{const t=await v.prompt("Nuevo Evento","Título del evento:");if(!t)return;const n=await v.prompt("Fecha","Formato YYYY-MM-DD:",new Date().toISOString().split("T")[0]);if(!n)return;const o=await v.prompt("Hora","Formato HH:MM:","10:00");if(!o)return;const i=[{value:"event",label:"Evento"},{value:"reminder",label:"Recordatorio"},{value:"meeting",label:"Reunión"}],r=await v.select("Categoría","Tipo de evento:",i,0);c.addEvent({title:t,date:n,time:o,category:r||"event",repeat:"none"}),v.toast("Evento agendado","success")})}function Jt(){const s=c.getState(),e=s.currencySymbol,a=s.livingExpenses,t=s.otherExpenses||[],n=s.liabilities,o=c.sumItems(a,"amount"),i=c.sumItems(t,"amount"),r=c.sumItems(n,"monthlyPayment"),l=o+i+r,p=[...(a||[]).map(u=>({...u,category:"livingExpense",typeLabel:"Gasto de Vida"})),...(t||[]).map(u=>({...u,category:"otherExpense",typeLabel:"Otro Gasto"})),...(n||[]).filter(u=>u.monthlyPayment>0).map(u=>({...u,amount:u.monthlyPayment,category:"liability",typeLabel:"Deuda / Hipoteca"}))].sort((u,d)=>d.amount-u.amount);return`
      ...
      <div class="card">
        ...
        <div class="expense-breakdown-row">
            <div class="breakdown-item">
                <div class="breakdown-val">${k(o,e)}</div>
                <div class="breakdown-lbl">Vida</div>
            </div>
            <div class="breakdown-item">
                <div class="breakdown-val">${k(r,e)}</div>
                <div class="breakdown-lbl">Deuda</div>
            </div>
            <div class="breakdown-item">
                <div class="breakdown-val">${k(i,e)}</div>
  ...
  `}function Zt(s,e){if(s.length===0)return`
            <div class="empty-state">
        ...
        <div class="asset-list">
            ${s.map(t=>{const n=c.convertValue(t.amount,t.currency||"EUR"),o=Qt(t.category);return`
    ...
    `}function Qt(s){switch(s){case"liability":return"landmark";case"livingExpense":return"shoppingCart";default:return"creditCard"}}function ea(s){const e=document.getElementById("back-to-finance");e&&e.addEventListener("click",s),document.querySelectorAll(".expense-item").forEach(t=>{t.addEventListener("click",()=>{const n=t.dataset.id,o=t.dataset.category;Ue(n,o)})})}const ta="modulepreload",aa=function(s){return"/life-dashboard/"+s},Te={},ue=function(e,a,t){let n=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),r=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));n=Promise.allSettled(a.map(l=>{if(l=aa(l),l in Te)return;Te[l]=!0;const p=l.endsWith(".css"),u=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const d=document.createElement("link");if(d.rel=p?"stylesheet":ta,p||(d.as="script"),d.crossOrigin="",d.href=l,r&&d.setAttribute("nonce",r),document.head.appendChild(d),p)return new Promise((g,f)=>{d.addEventListener("load",g),d.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(i){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i}return n.then(i=>{for(const r of i||[])r.status==="rejected"&&o(r.reason);return e().catch(o)})};function sa(){const s=C.isBioEnabled(),e=G.hasToken();return`
    <div class="settings-page stagger-children">
        ...
        <section class="settings-section">
            ...
            <div class="card premium-settings-card">
                ...
                <div class="settings-item-row clickable" id="btn-force-update">
                    ...
                    <div class="settings-action-icon">${m("refreshCw")}</div>
                </div>
        ...
        <footer class="settings-footer">
            <p>Life Dashboard Pro v1.0.82</p>
            <p>© 2026 Privacy First Zero-Knowledge System</p>
        </footer>
    </div>
    `}function na(){var t,n,o,i,r,l,p,u,d,g,f;(t=document.getElementById("toggle-bio"))==null||t.addEventListener("change",async h=>{if(h.target.checked){const E=await v.prompt("Activar Biometría","Introduce tu contraseña maestra para confirmar:","Tu contraseña","password");if(E)try{await C.registerBiometrics(E),v.toast("Biometría activada correctamente")}catch(w){await v.alert("Error",w.message),h.target.checked=!1}else h.target.checked=!1}else localStorage.setItem("life-dashboard/db_bio_enabled","false"),v.toast("Biometría desactivada","info")});const s=document.getElementById("btn-install-pwa");s&&setTimeout(()=>{if(window.deferredPrompt){const h=document.getElementById("install-pwa-card");h&&(h.style.display="block"),s.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:b}=await window.deferredPrompt.userChoice;if(b==="accepted"){v.toast("Instalando aplicación...");const E=document.getElementById("install-pwa-card");E&&(E.style.display="none")}window.deferredPrompt=null})}},1e3),(n=document.getElementById("connect-drive-btn"))==null||n.addEventListener("click",async()=>{try{await G.authenticate(),v.toast("Google Drive conectado"),typeof window.reRender=="function"&&window.reRender()}catch(h){v.alert("Error",h.message||"Error al conectar")}}),(o=document.getElementById("upload-drive-btn"))==null||o.addEventListener("click",async()=>{const h=document.getElementById("upload-drive-btn"),b=h.innerHTML;try{if(!await v.confirm("Subir a la Nube","Esto reemplazará TODO lo que tengas en Google Drive con tus datos locales. ¿Continuar?"))return;h.innerHTML='<div class="loading-spinner-sm"></div>',h.style.pointerEvents="none";const w=C.getVaultKey();await G.pushData(c.getState(),w),v.toast("Bóveda subida correctamente")}catch(E){console.error(E),v.alert("Error al subir",E.message)}finally{h.innerHTML=b,h.style.pointerEvents="auto"}}),(i=document.getElementById("download-drive-btn"))==null||i.addEventListener("click",async()=>{const h=document.getElementById("download-drive-btn"),b=h.innerHTML;try{if(!await v.confirm("Descargar de la Nube","Esto reemplazará TODOS tus datos locales con los que hay en la nube. Esta acción no se puede deshacer. ¿Continuar?"))return;h.innerHTML='<div class="loading-spinner-sm"></div>',h.style.pointerEvents="none";const w=C.getVaultKey(),S=await G.pullData(w);S?(c.resetState(S),await c.saveState(),v.toast("Datos descargados correctamente","success"),setTimeout(()=>window.location.reload(),1e3)):v.alert("Error","No se encontró una bóveda válida en Drive o el descifrado falló (¿Contraseña incorrecta?)")}catch(E){console.error("[Settings] Download failed:",E),v.alert("Error de Descarga",E.message||"Error desconocido al bajar datos")}finally{h.innerHTML=b,h.style.pointerEvents="auto"}}),(r=document.getElementById("export-data-btn"))==null||r.addEventListener("click",async()=>{try{v.toast("Preparando archivo encriptado...","info");const h=c.getState(),b=C.getVaultKey(),{SecurityService:E}=await ue(async()=>{const{SecurityService:M}=await Promise.resolve().then(()=>we);return{SecurityService:M}},void 0),w=await E.encrypt(h,b),S=new Blob([JSON.stringify(w)],{type:"application/octet-stream"}),$=URL.createObjectURL(S),T=document.createElement("a"),B=new Date().toISOString().split("T")[0];T.href=$,T.download=`life_dashboard_backup_${B}.bin`,document.body.appendChild(T),T.click(),document.body.removeChild(T),URL.revokeObjectURL($),v.toast("Backup exportado correctamente")}catch(h){console.error("Export error:",h),v.alert("Error de Exportación","No se pudieron encriptar o descargar los datos.")}});const e=document.getElementById("import-backup-btn"),a=document.getElementById("import-backup-input");e==null||e.addEventListener("click",()=>{a==null||a.click()}),a==null||a.addEventListener("change",async h=>{var w;const b=(w=h.target.files)==null?void 0:w[0];if(!b)return;if(!await v.confirm("¿Importar Backup?","Esto sobreescribirá todos tus datos locales con los del archivo. ¿Deseas continuar?")){a.value="";return}try{const S=await b.text(),$=JSON.parse(S),T=C.getVaultKey(),{SecurityService:B}=await ue(async()=>{const{SecurityService:H}=await Promise.resolve().then(()=>we);return{SecurityService:H}},void 0),M=await B.decrypt($,T);if(M)c.setState(M),await c.saveState(),v.toast("Backup importado correctamente"),setTimeout(()=>window.location.reload(),1e3);else throw new Error("No se pudo descifrar el archivo")}catch(S){console.error("Import error:",S),v.alert("Error de Importación","El archivo no es válido o la contraseña no coincide con la usada para el backup.")}finally{a.value=""}}),(l=document.getElementById("btn-logout"))==null||l.addEventListener("click",async()=>{await v.confirm("¿Cerrar sesión?","El acceso quedará bloqueado hasta que introduzcas tu clave.")&&(C.logout(),window.location.reload())}),(p=document.getElementById("btn-force-update"))==null||p.addEventListener("click",async()=>{if(await v.confirm("¿Forzar Actualización?","Esto recargará la página y limpiará la caché para obtener la última versión.")){if(window.caches)try{const b=await caches.keys();for(let E of b)await caches.delete(E)}catch(b){console.error("Error clearing cache",b)}window.location.reload(!0)}}),(u=document.getElementById("btn-save-gemini"))==null||u.addEventListener("click",()=>{var b;const h=(b=document.getElementById("gemini-api-key"))==null?void 0:b.value;h!==void 0&&(localStorage.setItem("life-dashboard/db_gemini_api_key",h.trim()),v.toast("API Key de Gemini guardada"))}),(d=document.getElementById("btn-save-drive-secret"))==null||d.addEventListener("click",()=>{const b=document.getElementById("drive-client-secret").value.trim();b?(localStorage.setItem("life-dashboard/drive_client_secret",b),v.toast("Secreto guardado correctamente")):(localStorage.removeItem("life-dashboard/drive_client_secret"),v.toast("Secreto eliminado, usando valor por defecto","info")),G.init().catch(console.error)}),(g=document.getElementById("toggle-drive-secret"))==null||g.addEventListener("click",h=>{const b=document.getElementById("drive-client-secret"),E=h.currentTarget,w=b.type==="password";b.type=w?"text":"password",E.innerHTML=m(w?"eyeOff":"eye")}),(f=document.getElementById("btn-factory-reset"))==null||f.addEventListener("click",async()=>{if(await v.hardConfirm("Borrar todos los datos","Esta acción eliminará permanentemente todos tus activos, ingresos, agenda y configuraciones de este dispositivo.","BORRAR")){const b="life-dashboard/";if(Object.keys(localStorage).forEach(E=>{E.startsWith(b)&&localStorage.removeItem(E)}),Object.keys(sessionStorage).forEach(E=>{E.startsWith(b)&&sessionStorage.removeItem(E)}),window.indexedDB.databases&&(await window.indexedDB.databases()).forEach(w=>window.indexedDB.deleteDatabase(w.name)),navigator.serviceWorker){const E=await navigator.serviceWorker.getRegistrations();for(let w of E)w.unregister()}v.toast("Aplicación reseteada","info"),setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now()},1e3)}})}function oa(){return`
    ...
    `}function ia(s){var e,a;(e=document.getElementById("open-calendar"))==null||e.addEventListener("click",()=>{s("calendar")}),(a=document.getElementById("open-settings"))==null||a.addEventListener("click",()=>{s("settings")})}function ra(){const{social:s}=c.getState(),{people:e,columns:a}=s;return`
            ...
            ${a.sort((t,n)=>t.order-n.order).map(t=>{const n=e.filter(o=>o.columnId===t.id);return`
                <div class="kanban-column" data-col-id="${t.id}">
                    <div class="kanban-column-header">
                        ...
                        <button class="icon-btn col-opts-btn" data-id="${t.id}">${m("moreVertical")}</button>
                    </div>
    ...
    `}function la(s){const e=s.lastContact?Math.floor((Date.now()-new Date(s.lastContact).getTime())/864e5):null,a=s.color||"#3b82f6";return`
    ...
    `}function ca(){window.socialListenersAttached||(window.socialListenersAttached=!0,document.addEventListener("click",s=>{const e=s.target.closest(".col-opts-btn");if(e){s.preventDefault(),s.stopPropagation(),va(e.dataset.id,e);return}if(s.target.closest("#add-social-col-btn")){da();return}if(s.target.closest("#add-person-btn")){window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person"}}));return}if(s.target.closest("#ideal-lead-btn")){ua();return}if(s.target.closest("#communications-mgr-btn")){ue(()=>import("./CommunicationsModal-DdeQO8TO.js"),[]).then(n=>n.openCommunicationsModal());return}if(s.target.closest("#contact-sources-btn")){ha();return}const a=s.target.closest(".person-chat-btn");if(a){s.preventDefault(),s.stopPropagation(),ue(()=>import("./CommunicationsModal-DdeQO8TO.js"),[]).then(n=>n.openCommunicationsModal(a.dataset.id));return}const t=s.target.closest(".person-card");if(t){pa(t.dataset.id);return}}),document.addEventListener("dragstart",s=>{const e=s.target.closest(".person-card");e&&(s.dataTransfer.setData("text/plain",e.dataset.id),e.classList.add("dragging"))}),document.addEventListener("dragend",s=>{const e=s.target.closest(".person-card");e&&e.classList.remove("dragging")}),document.addEventListener("dragover",s=>{const e=s.target.closest(".kanban-cards");e&&(s.preventDefault(),e.classList.add("drag-over"))}),document.addEventListener("dragleave",s=>{const e=s.target.closest(".kanban-cards");e&&e.classList.remove("drag-over")}),document.addEventListener("drop",s=>{const e=s.target.closest(".kanban-cards");if(e){s.preventDefault(),e.classList.remove("drag-over");const a=s.dataTransfer.getData("text/plain"),t=e.dataset.colId;a&&t&&c.movePerson(a,t)}}))}async function da(){const s=await v.prompt("Etapa","Nombre de la etapa:");s&&(c.addSocialColumn({name:s,color:"#94a3b8"}),v.toast("Etapa agregada correctamente","success"))}async function ua(){const s=c.getState().social.idealLeadProfile||"",e=await ma(s);e!==null&&(c.updateIdealLeadProfile(e),v.toast("Perfil Ideal actualizado"))}function pa(s){const e=c.getState().social.people.find(a=>a.id===s);e&&window.dispatchEvent(new CustomEvent("open-add-modal",{detail:{type:"person",person:e}}))}function ma(s){return new Promise(e=>{const a=document.createElement("div");a.className="modal-overlay active",a.style.zIndex="9999",a.innerHTML=`
            <div class="modal">
                <div class="modal-header">
        ...
        `,document.body.appendChild(a);const t=()=>{a.remove(),e(null)};a.querySelector(".modal-close").addEventListener("click",t),a.querySelector("#save-ideal-lead").addEventListener("click",()=>{const n=a.querySelector("#ideal-lead-text").value;a.remove(),e(n)}),a.addEventListener("click",n=>{n.target===a&&t()})})}function va(s,e){document.querySelectorAll(".column-options-menu").forEach(i=>i.remove());const a=c.getState().social.columns.find(i=>i.id===s);if(!a)return;const t=document.createElement("div");t.className="column-options-menu",t.innerHTML=`
    ...
    `;const n=e.getBoundingClientRect();t.style.position="fixed",t.style.top=`${n.bottom+8}px`,t.style.right=`${window.innerWidth-n.right}px`,t.style.zIndex="9999",document.body.appendChild(t),t.querySelectorAll(".menu-item").forEach(i=>{i.addEventListener("click",async()=>{const r=i.dataset.action;if(t.remove(),r==="edit"){const l=await v.prompt("Nombre de Columna","Nuevo nombre:",a.name);l!=null&&l.trim()&&c.updateSocialColumn(s,{name:l.trim()})}else if(r==="color"){const l=await ga(a.color);l&&c.updateSocialColumn(s,{color:l})}else if(r==="delete")await v.confirm("Eliminar Etapa",`¿Eliminar "${a.name}"?`)&&c.deleteSocialColumn(s);else if(r==="move_up"||r==="move_down"){const l=[...c.getState().social.columns].sort((d,g)=>d.order-g.order),p=l.findIndex(d=>d.id===s);if(p===-1)return;const u=r==="move_up"?p-1:p+1;u>=0&&u<l.length&&([l[p].order,l[u].order]=[l[u].order,l[p].order],c.reorderSocialColumns(l))}})});const o=i=>{!t.contains(i.target)&&i.target!==e&&(t.remove(),document.removeEventListener("click",o))};setTimeout(()=>document.addEventListener("click",o),10)}function ga(s){return new Promise(e=>{const a=document.createElement("div");a.className="modal-overlay active",a.style.zIndex="99999",a.innerHTML=`
        ...
        `,document.body.appendChild(a);const t=()=>{a.remove(),e(null)};a.querySelector(".modal-close").addEventListener("click",t),a.querySelectorAll(".color-swatch").forEach(n=>n.addEventListener("click",()=>{a.querySelector("#stage-color-input").value=n.dataset.color,a.querySelectorAll(".color-swatch").forEach(o=>o.style.borderColor="transparent"),n.style.borderColor="white"})),a.querySelector("#save-stage-color").addEventListener("click",()=>{const n=a.querySelector("#stage-color-input").value;a.remove(),e(n)}),a.addEventListener("click",n=>{n.target===a&&t()})})}async function ha(){const{contactSources:s}=c.getState().social,e=await ya(s);e&&(c.updateContactSources(e),v.toast("Fuentes de contacto actualizadas"))}function ya(s){return new Promise(e=>{const a=document.createElement("div");a.className="modal-overlay active",a.style.zIndex="9999",a.innerHTML=`
  ...
  `}function qe(){const s=be[L],e=L==="investmentAsset"||L==="passiveAsset";if(e){const t=V.map(n=>({value:n.symbol,label:`${n.name} (${n.symbol})`}));[...De,...t]}let a="";return L==="passiveAsset"||L==="investmentAsset"?a=`
    ...
    <div class="form-row">
        ...
        <div class="form-group" style="flex: 1.5;">
            ...
            <select class="form-input form-select" id="input-currency">
                <optgroup label="Divisas">
                    ${De.map(t=>`<option value="${t.value}">${t.label}</option>`).join("")}
                </optgroup>
                ${e?`
  ...
  `}function ba(){const s=document.getElementById("add-modal"),e=document.getElementById("modal-close");s.addEventListener("click",t=>{t.target===s&&fe()}),e.addEventListener("click",fe);const a=s.querySelectorAll(".category-selector .type-option");a.forEach(t=>{t.addEventListener("click",()=>{L=t.dataset.category,a.forEach(n=>n.classList.remove("active")),t.classList.add("active"),document.getElementById("form-container").innerHTML=qe(),Me()})}),Me()}function Me(){const s=document.getElementById("btn-save");s&&s.addEventListener("click",wa);const e=document.getElementById("mode-qty"),a=document.getElementById("mode-total"),t=document.getElementById("input-qty"),n=document.getElementById("input-value"),o=document.getElementById("input-currency"),i=document.getElementById("input-name");if(e&&a){const l=p=>{p==="qty"?(e.style.background="var(--accent-primary)",e.style.color="var(--bg-primary)",a.style.background="transparent",a.style.color="var(--text-secondary)",t.focus()):(a.style.background="var(--accent-primary)",a.style.color="var(--bg-primary)",e.style.background="transparent",e.style.color="var(--text-secondary)",n.focus())};e.addEventListener("click",()=>l("qty")),a.addEventListener("click",()=>l("total"))}const r=l=>{const p=c.getState().rates,u=o==null?void 0:o.value,d=p[u]||1;if(l==="qty"){const g=parseFloat(t.value)||0;n.value=(g*d).toFixed(2)}else{const g=parseFloat(n.value)||0;t.value=(g/d).toFixed(6)}};t==null||t.addEventListener("input",()=>r("qty")),n==null||n.addEventListener("input",()=>r("total")),o&&o.addEventListener("change",()=>{if(i&&!i.value){const l=o.options[o.selectedIndex].text;i.value=l.split(" (")[0]}r("qty")})}function wa(){var f,h,b,E,w,S,$,T,B,M,H,ae;const s=(h=(f=document.getElementById("input-name"))==null?void 0:f.value)==null?void 0:h.trim(),e=(b=document.getElementById("input-type"))==null?void 0:b.value,a=(E=document.getElementById("input-currency"))==null?void 0:E.value,t=(S=(w=document.getElementById("input-details"))==null?void 0:w.value)==null?void 0:S.trim(),n=parseFloat(($=document.getElementById("input-value"))==null?void 0:$.value)||0,o=document.getElementById("input-qty"),i=o?parseFloat(o.value)||0:n,r=parseFloat((T=document.getElementById("input-amount"))==null?void 0:T.value)||0,l=parseFloat((B=document.getElementById("input-monthly"))==null?void 0:B.value)||0,p=(M=document.getElementById("input-date"))==null?void 0:M.value,u=(H=document.getElementById("input-time"))==null?void 0:H.value,d=(ae=document.getElementById("input-repeat"))==null?void 0:ae.value;if(!s){v.alert("Campo Obligatorio","Por favor ingresa un nombre para el elemento.");return}const g={name:s,type:e,currency:a,details:t};switch(L){case"passiveAsset":c.addPassiveAsset({...g,value:i,monthlyIncome:l});break;case"activeIncome":c.addActiveIncome({...g,amount:r});break;case"livingExpense":c.addLivingExpense({...g,amount:r});break;case"investmentAsset":c.addInvestmentAsset({...g,value:i});break;case"liability":c.addLiability({...g,amount:r,monthlyPayment:l});break;case"event":c.addEvent({title:s,date:p,time:u,repeat:d,category:e});break}fe()}function fe(){const s=document.getElementById("add-modal");s&&(s.classList.remove("active"),setTimeout(()=>s.remove(),300))}let K=null;function He(s=null){console.log("[LeadModal] Opening modal",{personToEdit:s});const e=document.getElementById("add-person-modal");e&&(console.log("[LeadModal] Removing existing modal"),e.remove()),K=s?s.id:null;const a=document.createElement("div");a.className="modal-overlay",a.id="add-person-modal",a.setAttribute("role","dialog"),a.innerHTML=Ea(s),document.body.appendChild(a),setTimeout(()=>{var t;a.classList.add("active"),(t=a.querySelector("#person-name"))==null||t.focus()},50),ka(a)}function Ea(s=null){const e=s?"Editar Lead":"Lead",a=s?"Guardar Cambios":"Lead";return`
    <div class="modal">
      <div class="modal-handle"></div>
      <div class="modal-header">
  ...
  `}function ka(s){const e=s.querySelector("#person-modal-close"),a=s.querySelector("#btn-save-person-lead"),t=s.querySelector("#btn-delete-person"),n=s.querySelector("#person-rating-slider"),o=s.querySelector("#rating-value");if(s.addEventListener("click",l=>{l.target===s&&(console.log("[LeadModal] Overlay clicked, closing"),pe(s))}),e==null||e.addEventListener("click",()=>{console.log("[LeadModal] Close button clicked"),pe(s)}),n&&o){const l=()=>{console.log("[LeadModal] Slider updated:",n.value),o.textContent=n.value};n.oninput=l,n.onchange=l}a&&(a.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Save button clicked"),Sa(s)}),t&&(t.onclick=l=>{l.preventDefault(),console.log("[LeadModal] Delete button clicked"),xa(s)});const i=s.querySelectorAll(".goal-color-dot"),r=s.querySelector("#person-color-value");i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(p=>p.classList.remove("active")),l.classList.add("active"),r&&(r.value=l.dataset.color),console.log("[LeadModal] Color selected:",l.dataset.color)})})}async function xa(s){K&&await v.confirm("Eliminar Lead","¿Estás seguro de eliminar este lead?")&&(c.deletePerson(K),v.toast("Lead eliminado","success"),pe(s))}function Sa(s){var a,t,n,o,i,r,l,p,u,d,g,f,h;const e=s.querySelector("#btn-save-person-lead");if(e.disabled){console.log("[LeadModal] Save ignored, already processing");return}try{const b=(t=(a=s.querySelector("#person-name"))==null?void 0:a.value)==null?void 0:t.trim(),E=(o=(n=s.querySelector("#person-phone"))==null?void 0:n.value)==null?void 0:o.trim(),w=(r=(i=s.querySelector("#person-city"))==null?void 0:i.value)==null?void 0:r.trim(),S=(l=s.querySelector("#person-source"))==null?void 0:l.value,$=(p=s.querySelector("#person-rating-slider"))==null?void 0:p.value,T=(d=(u=s.querySelector("#person-desc"))==null?void 0:u.value)==null?void 0:d.trim(),B=(g=s.querySelector("#person-column"))==null?void 0:g.value,M=(f=s.querySelector("#person-color-value"))==null?void 0:f.value,H=(h=s.querySelector("#person-last-contact"))==null?void 0:h.value;if(console.log("[LeadModal] Attempting to save",{name:b,rating:$,columnId:B,color:M,lastContact:H}),!b){console.warn("[LeadModal] Save failed: Missing name"),v.toast("El nombre es obligatorio","error");return}e.disabled=!0,e.innerHTML='<span class="loading-spinner-sm"></span> Guardando...';const ae={name:b,phone:E,city:w,source:S,rating:parseInt($)||5,description:T,columnId:B,color:M,lastContact:H};K?(console.log("[LeadModal] Updating person",K),c.updatePerson(K,ae),v.toast("Lead actualizado correctamente","success")):(console.log("[LeadModal] Adding new person"),c.addPerson(ae),v.toast("Lead guardado correctamente","success")),console.log("[LeadModal] Save successful, closing modal"),pe(s)}catch(b){console.error("[LeadModal] Error saving lead:",b),v.toast("Error al guardar el lead","error"),e.disabled=!1,e.innerHTML=`${m("plus")} Lead`}}function pe(s){s&&(console.log("[LeadModal] Closing modal"),s.classList.remove("active"),setTimeout(()=>{s.parentNode&&(console.log("[LeadModal] Removing modal from DOM"),s.remove())},400))}function $a(){const s=C.isSetup(),e=C.isBioEnabled();return`
    ...
    `}function Ia(s){var o;const e=document.getElementById("auth-submit-btn"),a=document.getElementById("auth-bio-btn"),t=document.getElementById("auth-password"),n=async()=>{const i=t.value,r=document.getElementById("auth-confirm"),l=C.isSetup();try{let p;if(l)p=await C.unlock(i);else{if(!i||i.length<4)throw new Error("Contraseña demasiado corta");if(i!==r.value)throw new Error("Las contraseñas no coinciden");p=await C.setup(i)}await c.loadEncrypted(p),s()}catch(p){v.alert("Error",p.message)}};e==null||e.addEventListener("click",n),t==null||t.addEventListener("keydown",i=>{i.key==="Enter"&&(i.preventDefault(),n())}),(o=document.getElementById("auth-confirm"))==null||o.addEventListener("keydown",i=>{i.key==="Enter"&&(i.preventDefault(),n())}),a==null||a.addEventListener("click",async()=>{try{const i=await C.unlockWithBiometrics();await c.loadEncrypted(i),s()}catch(i){v.alert("Identificación",i.message)}}),C.isBioEnabled()&&setTimeout(async()=>{try{const i=await C.unlockWithBiometrics();await c.loadEncrypted(i),s()}catch{console.log("Auto-bio failed or cancelled")}},500)}let P=localStorage.getItem("life-dashboard/app_current_page")||"finance",A=localStorage.getItem("life-dashboard/app_current_sub_page")||null;A==="null"&&(A=null);async function Be(){window.addEventListener("open-add-modal",e=>{var t,n;const a=(t=e.detail)==null?void 0:t.type;a==="person"?He((n=e.detail)==null?void 0:n.person):ye(a)}),G.init().catch(e=>console.warn("[Drive] Pre-init failed:",e));const s=C.getVaultKey();s?await c.loadEncrypted(s)?Ve():(console.error("[Boot] Decryption failed, invalid vault key in session?"),C.logout(),Re()):Re()}function Re(){const s=document.getElementById("app");s.innerHTML=$a(),Ia(()=>{Ve()})}function Ve(){const s=document.getElementById("app");s.innerHTML=`
        <main id="main-content"></main>
        <nav id="bottom-nav"></nav>
    `,ze(),c.subscribe(()=>{_()}),window.reRender=()=>_(),Ca()}function Ca(){var t,n;const s=localStorage.getItem("life-dashboard/pwa_install_dismissed");if(s&&(Date.now()-parseInt(s))/864e5<7||window.matchMedia("(display-mode: standalone)").matches)return;const e=document.createElement("div");e.className="pwa-install-banner",e.id="pwa-install-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(e);const a=()=>{window.deferredPrompt&&setTimeout(()=>{e.classList.add("visible")},2e3)};a(),window.addEventListener("beforeinstallprompt",a),(t=document.getElementById("pwa-banner-install"))==null||t.addEventListener("click",async()=>{if(!window.deferredPrompt)return;window.deferredPrompt.prompt();const{outcome:o}=await window.deferredPrompt.userChoice;o==="accepted"&&(e.classList.remove("visible"),setTimeout(()=>e.remove(),500)),window.deferredPrompt=null}),(n=document.getElementById("pwa-banner-close"))==null||n.addEventListener("click",()=>{e.classList.remove("visible"),localStorage.setItem("life-dashboard/pwa_install_dismissed",Date.now().toString()),setTimeout(()=>e.remove(),500)})}function ze(){const s=document.getElementById("bottom-nav");s.innerHTML=Se(P),$e(e=>{P=e,A=null,localStorage.setItem("life-dashboard/app_current_page",P),localStorage.setItem("life-dashboard/app_current_sub_page",A),j(),_(),s.innerHTML=Se(P),$e(a=>{P=a,A=null,localStorage.setItem("life-dashboard/app_current_page",P),localStorage.setItem("life-dashboard/app_current_sub_page",A),j(),_(),ze()})}),Aa(),_()}function _(){const s=document.getElementById("main-content");if(!s)return;const e=s.scrollTop;if(A==="compound"){s.innerHTML=Ct(),At(()=>{A=null,Lt(),j(),_()}),s.scrollTop=e;return}if(A==="expenses"){s.innerHTML=Jt(),ea(()=>{A=null,j(),_()}),s.scrollTop=e;return}if(A==="market"){s.innerHTML=Tt(),Mt(()=>{A=null,j(),_()}),s.scrollTop=e;return}switch(s.classList.toggle("no-padding-mobile",P==="health"),P){case"finance":j(),s.innerHTML=Ce(),Ae(),Pe();break;case"goals":N(),s.innerHTML=Ft(),qt();break;case"social":N(),s.innerHTML=ra(),ca();break;case"health":s.innerHTML=Bt(),jt(),N();break;case"menu":s.innerHTML=oa(),ia(a=>{P=a,j(),_()}),N();break;case"calendar":s.innerHTML=Ht(),Xt(),j();break;case"settings":s.innerHTML=sa(),na(),N();break;default:j(),s.innerHTML=Ce(),Ae(),Pe()}requestAnimationFrame(()=>{s.scrollTop=e})}function Pe(){const s=document.getElementById("open-compound");s&&s.addEventListener("click",()=>{A="compound",localStorage.setItem("life-dashboard/app_current_sub_page",A),N(),_()});const e=document.getElementById("open-markets");e&&e.addEventListener("click",()=>{A="market",localStorage.setItem("life-dashboard/app_current_sub_page",A),N(),_()});const a=document.getElementById("open-expenses");a&&a.addEventListener("click",()=>{A="expenses",localStorage.setItem("life-dashboard/app_current_sub_page",A),N(),_()})}function Aa(){const s=document.querySelector(".fab");s&&s.remove();const e=document.createElement("button");e.className="fab",e.id="main-fab",e.innerHTML=m("plus","fab-icon"),e.setAttribute("aria-label","Agregar"),e.addEventListener("click",async()=>{if(P==="calendar")ye("event");else if(P==="health"){const a=await ns.confirm("Log Metric","What do you want to record today?","Weight","Body Fat");if(a===!0){const t=await ns.prompt("Log Weight","Enter your current weight in kg:","","number");t&&c.addWeightLog(t)}else if(a===!1){const t=await ns.prompt("Body Fat","Enter your body fat %:","","number");t&&c.addFatLog(t)}}else P==="social"?He():ye()}),document.body.appendChild(e)}function N(){const s=document.getElementById("main-fab");s&&(s.style.display="none")}function j(){const s=document.getElementById("main-fab");s&&(s.style.display="flex")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Be):Be();window.addEventListener("beforeinstallprompt",s=>{s.preventDefault(),window.deferredPrompt=s,console.log("PWA Install Prompt ready");const e=document.getElementById("install-pwa-card");e&&(e.style.display="block")});export{m as g,v as n,c as s};
