  ...
  `}function Ct(){const n=document.getElementById("add-modal"),e=document.getElementById("modal-close");n.addEventListener("click",t=>{t.target===n&&se()}),e.addEventListener("click",se);const a=n.querySelectorAll(".category-selector .type-option");a.forEach(t=>{t.addEventListener("click",()=>{$=t.dataset.category,a.forEach(s=>s.classList.remove("active")),t.classList.add("active"),document.getElementById("form-container").innerHTML=Le(),ye()})}),ye()}function ye(){const n=document.getElementById("btn-save");n&&n.addEventListener("click",Lt);const e=document.getElementById("mode-qty"),a=document.getElementById("mode-total"),t=document.getElementById("input-qty"),s=document.getElementById("input-value"),o=document.getElementById("input-currency"),i=document.getElementById("input-name");if(e&&a){const l=u=>{u==="qty"?(e.style.background="var(--accent-primary)",e.style.color="var(--bg-primary)",a.style.background="transparent",a.style.color="var(--text-secondary)",t.focus()):(a.style.background="var(--accent-primary)",a.style.color="var(--bg-primary)",e.style.background="transparent",e.style.color="var(--text-secondary)",s.focus())};e.addEventListener("click",()=>l("qty")),a.addEventListener("click",()=>l("total"))}const r=l=>{const u=p.getState().rates,c=o==null?void 0:o.value,d=u[c]||1;if(l==="qty"){const m=parseFloat(t.value)||0;s.value=(m*d).toFixed(2)}else{const m=parseFloat(s.value)||0;t.value=(m/d).toFixed(6)}};t==null||t.addEventListener("input",()=>r("qty")),s==null||s.addEventListener("input",()=>r("total")),o&&o.addEventListener("change",()=>{if(i&&!i.value){const l=o.options[o.selectedIndex].text;i.value=l.split(" (")[0]}r("qty")})}function Lt(){var h,w,E,k,b,L,T,V,K,q,J,ie;const n=(w=(h=document.getElementById("input-name"))==null?void 0:h.value)==null?void 0:w.trim(),e=(E=document.getElementById("input-type"))==null?void 0:E.value,a=(k=document.getElementById("input-currency"))==null?void 0:k.value,t=(L=(b=document.getElementById("input-details"))==null?void 0:b.value)==null?void 0:L.trim(),s=parseFloat((T=document.getElementById("input-value"))==null?void 0:T.value)||0,o=document.getElementById("input-qty"),i=o?parseFloat(o.value)||0:s,r=parseFloat((V=document.getElementById("input-amount"))==null?void 0:V.value)||0,l=parseFloat((K=document.getElementById("input-monthly"))==null?void 0:K.value)||0,u=(q=document.getElementById("input-date"))==null?void 0:q.value,c=(J=document.getElementById("input-time"))==null?void 0:J.value,d=(ie=document.getElementById("input-repeat"))==null?void 0:ie.value;if(!n){v.alert("Campo Obligatorio","Por favor ingresa un nombre para el elemento.");return}const m={name:n,type:e,currency:a,details:t};switch($){case"passiveAsset":p.addPassiveAsset({...m,value:i,monthlyIncome:l});break;case"activeIncome":p.addActiveIncome({...m,amount:r});break;case"livingExpense":p.addLivingExpense({...m,amount:r});break;case"investmentAsset":p.addInvestmentAsset({...m,value:i});break;case"liability":p.addLiability({...m,amount:r,monthlyPayment:l});break;case"event":p.addEvent({title:n,date:u,time:c,repeat:d,category:e});break}se()}function se(){const n=document.getElementById("add-modal");n&&(n.classList.remove("active"),setTimeout(()=>n.remove(),300))}function Tt(){const n=x.isSetup(),e=x.isBioEnabled();return`
    ...
    <div class="settings-page stagger-children">
        ...
        <footer class="settings-footer">
            <p>Life Dashboard Pro v1.0.72</p>
