import{s as d,g as r,n as u}from"./index-sJ_Gg9DC.js";function y(t=null){const e=document.createElement("div");e.className="modal-overlay active",e.id="communications-modal",e.style.zIndex="10000";const n=t?d.getState().social.people.find(i=>i.id===t):null;p(e,n),document.body.appendChild(e),m(e,n)}function p(t,e=null){const{communications:n}=d.getState().social,i=[...n].sort((a,o)=>a.order-o.order);t.innerHTML=`
